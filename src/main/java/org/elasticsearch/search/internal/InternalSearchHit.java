...
index|]
decl_stmt|;
DECL|field|MAX_TERM_AS_TEXT
specifier|private
specifier|static
specifier|final
name|Text
name|MAX_TERM_AS_TEXT
init|=
operator|new
name|StringAndBytesText
argument_list|(
...
expr_stmt|;
block|}
comment|/**      * @deprecated In favor for {@link #matchedQueries(String[])}      */
annotation|@
name|Deprecated
...
condition|)
block|{
comment|// We don't display MAX_TERM in JSON responses in case some clients have UTF-8 parsers that wouldn't accept a
comment|// non-character in the response, even though this is valid UTF-8
name|builder
operator|.
name|nullValue
argument_list|()
