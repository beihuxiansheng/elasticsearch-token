...
return|;
block|}
comment|/**      * Sets the time zone to use when bucketing the values. Can either be in the form of "-10:00" or      * one of the values listed here: http://joda-time.sourceforge.net/timezones.html.      */
DECL|method|zone
specifier|public
name|DateHistogramFacetBuilder
name|zone
