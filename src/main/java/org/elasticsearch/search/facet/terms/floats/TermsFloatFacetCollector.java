...
begin_class
DECL|class|TermsFloatFacetCollector
specifier|public
class|class
...
name|script
decl_stmt|;
DECL|method|TermsFloatFacetCollector
specifier|public
name|TermsFloatFacetCollector
parameter_list|(
name|String
...
name|fieldName
operator|+
literal|"] doesn't is not of float type, can't run terms float facet collector on it"
argument_list|)
throw|;
block|}
name|this
