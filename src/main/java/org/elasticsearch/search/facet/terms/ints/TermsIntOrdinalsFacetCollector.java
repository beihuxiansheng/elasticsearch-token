...
begin_class
DECL|class|TermsIntOrdinalsFacetCollector
specifier|public
class|class
name|TermsIntOrdinalsFacetCollector
extends|extends
name|AbstractFacetCollector
block|{
...
name|excluded
decl_stmt|;
DECL|method|TermsIntOrdinalsFacetCollector
specifier|public
name|TermsIntOrdinalsFacetCollector
parameter_list|(
name|String
...
name|fieldName
operator|+
literal|"] doesn't have a type, can't run terms int facet collector on it"
argument_list|)
throw|;
block|}
...
name|fieldName
operator|+
literal|"] is not of int type, can't run terms int facet collector on it"
argument_list|)
throw|;
block|}
name|this
