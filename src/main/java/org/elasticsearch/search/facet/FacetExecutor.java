...
begin_comment
comment|/**  * A facet processor ends up actually executing the relevant facet for a specific  * search request.  *<p/>  * The facet executor requires at least one of the {@link #collector()} or {@link #post()} methods to be  * implemented.  */
end_comment
...
parameter_list|()
function_decl|;
comment|/**      * A post based facet that executes the facet using the aggregated docs relevant.      */
DECL|method|post
specifier|public
specifier|abstract
name|Post
