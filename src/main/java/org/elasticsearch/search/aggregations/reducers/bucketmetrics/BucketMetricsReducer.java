...
begin_comment
comment|/**  * A class of sibling reducers which calculate metrics across the buckets of a  * sibling aggregation  */
end_comment

begin_class
DECL|class|BucketMetricsReducer
specifier|public
specifier|abstract
class|class
...
name|gapPolicy
decl_stmt|;
DECL|method|BucketMetricsReducer
specifier|public
name|BucketMetricsReducer
parameter_list|()
block|{
...
parameter_list|()
block|{     }
comment|/**      * Called after a collection run is finished to build the aggregation for      * the collected state.      *       * @param reducers      *            the reducers to add to the resulting aggregation      * @param metadata      *            the metadata to add to the resulting aggregation      * @return      */
