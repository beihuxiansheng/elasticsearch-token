...
begin_comment
comment|/**  * A set of static helpers to simplify working with aggregation buckets, in particular  * providing utilities that help reducers.  */
end_comment
