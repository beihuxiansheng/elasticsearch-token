...
return|;
block|}
comment|/**      * Adds a script field under the given name with the provided script.      *      * @param name      *            The name of the field      * @param script      *            The script      * @deprecated Use {@link #scriptField(String, Script)} instead.      */
annotation|@
name|Deprecated
DECL|method|scriptField
specifier|public
...
return|;
block|}
comment|/**      * Adds a script field.      *      * @param name      *            The name of the field      * @param script      *            The script to execute      * @param params      *            The script parameters      * @deprecated Use {@link #scriptField(String, Script)} instead.      */
annotation|@
name|Deprecated
DECL|method|scriptField
specifier|public
...
return|;
block|}
comment|/**      * Adds a script field.      *      * @param name      *            The name of the field      * @param lang      *            The language of the script      * @param script      *            The script to execute      * @param params      *            The script parameters (can be<tt>null</tt>)      * @deprecated Use {@link #scriptField(String, Script)} instead.      */
annotation|@
name|Deprecated
DECL|method|scriptField
specifier|public
