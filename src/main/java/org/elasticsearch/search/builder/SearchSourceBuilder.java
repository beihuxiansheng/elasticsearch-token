...
name|queryBinary
decl_stmt|;
DECL|field|queryBinaryOffset
specifier|private
name|int
name|queryBinaryOffset
decl_stmt|;
DECL|field|queryBinaryLength
specifier|private
name|int
...
name|filterBinary
decl_stmt|;
DECL|field|filterBinaryOffset
specifier|private
name|int
name|filterBinaryOffset
decl_stmt|;
DECL|field|filterBinaryLength
specifier|private
name|int
...
name|facetsBinary
decl_stmt|;
DECL|field|facetBinaryOffset
specifier|private
name|int
name|facetBinaryOffset
decl_stmt|;
DECL|field|facetBinaryLength
specifier|private
name|int
...
name|ElasticSearchGenerationException
argument_list|(
literal|"failed to generate query from builder"
argument_list|,
name|e
argument_list|)
throw|;
...
name|ElasticSearchGenerationException
argument_list|(
literal|"failed to generate filter from builder"
argument_list|,
name|e
argument_list|)
throw|;
