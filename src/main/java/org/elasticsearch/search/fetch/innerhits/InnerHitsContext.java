...
condition|)
block|{
comment|// Active _parent field has been selected, so we want a children doc as inner hits.
name|field
operator|=
name|ParentFieldMapper
operator|.
...
block|{
comment|// No active _parent field has been selected, so we want parent docs as inner hits.
name|field
operator|=
name|UidFieldMapper
operator|.
