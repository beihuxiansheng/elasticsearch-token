...
argument_list|()
expr_stmt|;
comment|// LUCENE 4 UPGRADE: do we really need to use Field instead of IndexableField?
name|value
operator|=
name|mapper
operator|.
...
condition|)
block|{
comment|//LUCENE 4 UPGRADE: I think all sourceFields are of type Field
return|return
name|documentMapper
operator|.
name|sourceMapper
