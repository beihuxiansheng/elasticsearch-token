...
block|}
block|,
comment|/**      * Median of the values.      *      * Note that apply/reduce do not work with MED since median cannot be derived from      * an accumulator algorithm without using internal memory.      */
