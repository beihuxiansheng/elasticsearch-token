...
name|collateQuery
decl_stmt|;
DECL|field|collateFilter
specifier|private
name|String
name|collateFilter
decl_stmt|;
DECL|field|collatePreference
specifier|private
name|String
name|collatePreference
decl_stmt|;
...
return|;
block|}
comment|/**      * Sets a filter used for filtering out suggested phrases (collation).      */
DECL|method|collateFilter
specifier|public
name|PhraseSuggestionBuilder
name|collateFilter
parameter_list|(
...
return|;
block|}
comment|/**      * Sets routing preferences for executing filter query (collation).      */
DECL|method|collatePreference
specifier|public
name|PhraseSuggestionBuilder
name|collatePreference
parameter_list|(
