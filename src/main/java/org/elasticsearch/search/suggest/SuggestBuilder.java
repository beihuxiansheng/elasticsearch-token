...
return|;
block|}
comment|/**      * Returns a {@link org.elasticsearch.common.bytes.BytesReference}      * representing the suggest lookup request.      * Builds the request as {@link org.elasticsearch.client.Requests#CONTENT_TYPE}      */
...
return|;
block|}
comment|/**      * Returns a {@link org.elasticsearch.common.bytes.BytesReference}      * representing the suggest lookup request.      * Builds the request as the provided<code>contentType</code>      */
DECL|method|buildAsBytes
specifier|public
name|BytesReference
name|buildAsBytes
...
argument_list|(
literal|"Failed to build suggest query"
argument_list|,
name|e
argument_list|)
throw|;
...
name|SuggestBuilderException
argument_list|(
literal|"Failed to build suggest"
argument_list|,
name|e
argument_list|)
throw|;
