...
return|;
block|}
comment|/**      * Creates a fuzzy completion suggestion lookup query with the provided<code>name</code>      *      * @param name The suggestion name      * @return a {@link org.elasticsearch.search.suggest.completion.CompletionSuggestionFuzzyBuilder}      * instance      */
DECL|method|fuzzyCompletionSuggestion
specifier|public
specifier|static
name|CompletionSuggestionFuzzyBuilder
