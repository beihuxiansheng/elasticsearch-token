...
name|defaultConfig
decl_stmt|;
comment|/**      * Create a new {@link GeolocationContextMapping} with a given precision      *       * @param precision      *            length of the geohashes      * @param neighbors      *            should neighbors be indexed      * @param defaultLocation      *            location to use, if it is not provided by the document      */
...
return|;
block|}
comment|/**          * Set the precision use o make suggestions          *           * @param precision          *            precision as distance in meters          * @return this          */
DECL|method|precision
specifier|public
name|Builder
name|precision
...
return|;
block|}
comment|/**          * Set the precision use o make suggestions          *           * @param precision          *            maximum length of geohashes          * @return this          */
DECL|method|precision
specifier|public
name|Builder
name|precision
