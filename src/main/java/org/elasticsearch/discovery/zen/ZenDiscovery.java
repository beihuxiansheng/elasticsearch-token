...
name|PingContextProvider
block|{
DECL|field|SETTING_REJOIN_ON_MASTER_GONE
specifier|public
specifier|final
specifier|static
name|String
...
decl_stmt|;
DECL|field|SETTING_JOIN_TIMEOUT
specifier|public
specifier|final
specifier|static
name|String
...
decl_stmt|;
DECL|field|SETTING_JOIN_RETRY_ATTEMPTS
specifier|public
specifier|final
specifier|static
name|String
...
decl_stmt|;
DECL|field|SETTING_JOIN_RETRY_DELAY
specifier|public
specifier|final
specifier|static
name|String
name|SETTING_JOIN_RETRY_DELAY
init|=
literal|"discovery.zen.join_retry_delay"
decl_stmt|;
DECL|field|SETTING_MAX_PINGS_FROM_ANOTHER_MASTER
specifier|public
specifier|final
specifier|static
name|String
name|SETTING_MAX_PINGS_FROM_ANOTHER_MASTER
init|=
literal|"discovery.zen.max_pings_from_another_master"
decl_stmt|;
DECL|field|SETTING_SEND_LEAVE_REQUEST
specifier|public
specifier|final
specifier|static
name|String
name|SETTING_SEND_LEAVE_REQUEST
init|=
literal|"discovery.zen.send_leave_request"
decl_stmt|;
DECL|field|SETTING_MASTER_ELECTION_FILTER_CLIENT
specifier|public
specifier|final
specifier|static
name|String
name|SETTING_MASTER_ELECTION_FILTER_CLIENT
init|=
literal|"discovery.zen.master_election.filter_client"
decl_stmt|;
DECL|field|SETTING_MASTER_ELECTION_FILTER_DATA
specifier|public
specifier|final
specifier|static
name|String
name|SETTING_MASTER_ELECTION_FILTER_DATA
init|=
...
name|nodeService
decl_stmt|;
DECL|field|processJoinRequests
specifier|private
specifier|final
name|BlockingQueue
argument_list|<
...
name|electMasterService
expr_stmt|;
comment|// keep using componentSettings for BWC, in case this class gets extended.
name|TimeValue
name|pingTimeout
init|=
...
block|{
comment|// if we're not a master it means another node published a cluster state while we were pinging
comment|// make sure we go through another pinging round and actively join it
name|joinThreadControl
operator|.
name|markThreadAsDoneAndStartNew
argument_list|(
...
return|;
block|}
comment|// Note: we do not have to start master fault detection here because it's set at {@link #handleNewClusterStateFromMaster }
...
comment|//    return disconnectFromCluster(newState, "not enough master nodes on new cluster state wreceived from [" + newState.nodes().masterNode() + "]");
comment|//}
...
block|}
block|}
comment|/**      * Picks the cluster state with highest version with the same master from the queue. All cluster states with      * lower versions are ignored. If a cluster state with a different master is seen the processing logic stops and the      * last processed state is returned.      */
DECL|method|selectNextStateToProcess
specifier|static
name|ClusterState
name|selectNextStateToProcess
parameter_list|(
...
return|return;
block|}
comment|// nodes pre 1.4.0 do not send this information
if|if
condition|(
name|pingRequest
operator|.
