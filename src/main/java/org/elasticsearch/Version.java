...
argument_list|)
decl_stmt|;
DECL|field|V_1_4_0_Beta_ID
specifier|public
specifier|static
specifier|final
name|int
name|V_1_4_0_Beta_ID
init|=
comment|/*00*/
literal|1040001
decl_stmt|;
DECL|field|V_1_4_0_Beta
specifier|public
specifier|static
specifier|final
name|Version
...
block|}
block|}
comment|/**      * Return the {@link Version} of Elasticsearch that has been used to create an index given its settings.      */
...
operator|==
literal|null
comment|// if the UUDI is there the index has actually been created otherwise this might be a test
operator|||
name|indexSettings
operator|.
name|getAsVersion
...
name|SETTING_VERSION_CREATED
operator|+
literal|" not set in IndexSettings"
assert|;
return|return
name|indexSettings
operator|.
