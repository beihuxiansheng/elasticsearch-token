...
literal|null
operator|:
literal|"real index settings with a shard number must be used"
assert|;
specifier|final
name|List
argument_list|<
...
return|;
block|}
comment|/**      * Returns all data paths including custom index paths      */
...
block|}
block|}
comment|/**      * Returns all paths where lucene data will be stored      */
...
block|}
block|}
comment|/**      * Returns all shard paths including custom shard path      */
...
name|ElasticsearchIllegalArgumentException
argument_list|(
literal|"custom data_paths for indices is disabled"
argument_list|)
throw|;
block|}
if|if
