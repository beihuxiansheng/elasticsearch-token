...
block|}
block|}
comment|/**      * Deletes an indexes data directory recursively iff all of the indexes      * shards locks were successfully acquired. If any of the indexes shard directories can't be locked      * non of the shards will be deleted      *      * @param index the index to delete      * @throws Exception if any of the shards data directories can't be locked or deleted      */
...
return|;
block|}
comment|/**      * Returns an array of all of the nodes data locations.      * @deprecated use {@link #nodeDataPaths()}  instead      */
annotation|@
name|Deprecated
...
return|;
block|}
comment|/**      * Returns all data paths for the given index.      * @deprecated use {@link #indexPaths(org.elasticsearch.index.Index)} instead      */
annotation|@
name|Deprecated
...
return|;
block|}
comment|/**      * Returns all data paths for the given shards ID      * @deprecated use {@link #shardPaths(org.elasticsearch.index.shard.ShardId)} instead      */
annotation|@
name|Deprecated
...
block|}
block|}
comment|/**      * Returns an array of {@link File} build from the correspondent element      * in the input array using {@link java.nio.file.Path#toFile()} )}      * @param files the files to get paths for      */
annotation|@
name|Deprecated
