...
name|ROOT
argument_list|,
literal|"using [%d] data paths, net usable_space [%s], net total_space [%s], spins? [%s], types [%s]"
argument_list|,
name|nodePaths
operator|.
name|length
...
return|;
block|}
comment|// TODO: move somewhere more "util"?  But, this is somewhat hacky code ... not great to publicize it any more:
