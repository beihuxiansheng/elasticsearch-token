...
expr_stmt|;
block|}
comment|// here as setter injection not to break backward comp. with extensions of this class..
annotation|@
name|Inject
DECL|method|setNodeIndexDeletedAction
specifier|public
name|void
name|setNodeIndexDeletedAction
parameter_list|(
name|NodeIndexDeletedAction
name|nodeIndexDeletedAction
parameter_list|)
