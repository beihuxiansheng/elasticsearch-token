...
name|ClusterStateListener
block|{
DECL|field|requiresStatePersistence
specifier|private
name|boolean
name|requiresStatePersistence
decl_stmt|;
...
literal|false
decl_stmt|;
DECL|field|metaDataPersistedAtLeastOnce
specifier|private
specifier|volatile
name|boolean
name|metaDataPersistedAtLeastOnce
init|=
literal|false
decl_stmt|;
annotation|@
...
name|warn
argument_list|(
literal|"failed to serialize local gateway state"
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
name|warn
argument_list|(
literal|"failed to write local gateway state to {}"
argument_list|,
name|e
argument_list|,
name|stateFile
...
name|event
decl_stmt|;
DECL|field|stateToWrite
specifier|private
specifier|final
name|LocalGatewayStartedShards
name|stateToWrite
decl_stmt|;
DECL|method|PersistShards
specifier|public
name|PersistShards
parameter_list|(
name|ClusterChangedEvent
...
name|warn
argument_list|(
literal|"failed to serialize local gateway shard states"
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
name|warn
argument_list|(
literal|"failed to write local gateway shards state to {}"
argument_list|,
name|e
argument_list|,
name|stateFile
