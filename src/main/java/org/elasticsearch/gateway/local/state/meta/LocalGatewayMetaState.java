...
name|debug
argument_list|(
literal|"[{}] failed to delete index - at least one shards is still locked"
argument_list|,
name|ex
argument_list|,
name|current
...
condition|)
block|{
comment|// no shards - try to remove the directory
name|nodeEnv
operator|.
name|deleteIndexDirectorySafe
argument_list|(
...
name|warn
argument_list|(
literal|"[{}] skipping locked dangling index, exists on local file system, but not in cluster metadata, auto import to cluster state is set to [{}]"
argument_list|,
name|ex
argument_list|,
name|indexName
...
literal|null
argument_list|,
literal|"org.elasticsearch.cluster.routing.operation.hash."
argument_list|,
