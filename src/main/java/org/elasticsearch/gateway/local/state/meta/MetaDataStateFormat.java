...
comment|//       we iterate only over the ones with the max version
for|for
control|(
name|FileAndVersion
name|fileAndVersion
...
condition|)
block|{
comment|// here we where not able to load the latest version from neither of the data dirs
comment|// this case is exceptional and we should not continue
name|ExceptionsHelper
operator|.
