...
expr_stmt|;
block|}
comment|// on *nix, try to grant read perms to file stores / SSD detection
if|if
condition|(
operator|!
name|Constants
...
argument_list|)
decl_stmt|;
comment|// mount point for fstat() calls against it
if|if
condition|(
name|mount
operator|.
...
expr_stmt|;
block|}
comment|// block device: add it for SSD detection
if|if
condition|(
name|store
operator|.
