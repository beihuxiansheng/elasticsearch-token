...
decl_stmt|;
name|boolean
name|mustOrMustNotBeforeShould
init|=
literal|false
decl_stmt|;
for|for
...
condition|)
block|{
comment|// Sort the clause only once if we encounter a should before a must or must_not clause
name|Collections
operator|.
name|sort
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Because we sorted the clause we also need to sort the result clauses
name|Collections
operator|.
name|sort
argument_list|(
