...
begin_comment
comment|// LUCENE 4.1 UPGRADE: Just use TermsFilter once upgrading to 4.1, its a copy
end_comment
...
literal|31
decl_stmt|;
comment|/**      * Creates a new {@link XTermsFilter} from the given list. The list      * can contain duplicate terms and multiple fields.      */
...
expr_stmt|;
block|}
comment|/**      * Creates a new {@link XTermsFilter} from the given {@link BytesRef} list for      * a single field.      */
DECL|method|XTermsFilter
specifier|public
name|XTermsFilter
parameter_list|(
...
expr_stmt|;
block|}
comment|/**      * Creates a new {@link XTermsFilter} from the given {@link BytesRef} array for      * a single field.      */
DECL|method|XTermsFilter
specifier|public
name|XTermsFilter
parameter_list|(
