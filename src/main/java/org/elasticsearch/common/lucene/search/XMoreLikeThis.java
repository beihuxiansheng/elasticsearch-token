...
block|{
comment|//    static {
comment|//        assert Version.CURRENT.luceneVersion == org.apache.lucene.util.Version.LUCENE_4_9: "Remove this class once we upgrade to Lucene 5.0";
comment|//    }
...
name|DEFAULT_BOOST
decl_stmt|;
comment|/**      * Current set of skip terms.      */
DECL|field|skipTerms
specifier|private
name|Set
argument_list|<
name|Term
...
expr_stmt|;
block|}
comment|/**      * Sets a list of terms to never select from      */
DECL|method|setSkipTerms
specifier|public
name|void
name|setSkipTerms
parameter_list|(
...
return|;
block|}
comment|/**      * Return a query that will return docs like the passed Terms.      *      * @return a query that will return docs like the passed Terms.      */
DECL|method|like
specifier|public
name|Query
name|like
...
return|;
block|}
comment|/**      * Return a query that will return docs like the passed Fields.      *      * @return a query that will return docs like the passed Fields.      */
DECL|method|like
specifier|public
name|Query
name|like
...
return|;
block|}
comment|/**      * Create a PriorityQueue from a word->tf map.      *      * @param words a map of words keyed on the word(String) with Int objects as the values.      * @param fieldNames an array of field names to override defaults.      */
DECL|method|createQueue
specifier|private
name|PriorityQueue
argument_list|<
...
expr_stmt|;
block|}
comment|/**      * Adds terms and frequencies found in vector into the Map termFreqMap      *      * @param termFreqMap a Map of terms and their frequencies      * @param vector List of terms and their frequencies for a doc/field      * @param fieldName Optional field name of the terms for skip terms      */
DECL|method|addTermFrequencies
specifier|private
name|void
name|addTermFrequencies
...
return|;
block|}
comment|/**      * determines if the passed term is to be skipped all together      */
DECL|method|isSkipTerm
specifier|private
name|boolean
name|isSkipTerm
parameter_list|(
