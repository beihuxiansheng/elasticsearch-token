...
block|{
DECL|field|FILTER_ATOMIC_READER_IN
specifier|private
specifier|static
specifier|final
name|Field
name|FILTER_ATOMIC_READER_IN
decl_stmt|;
static|static
block|{
assert|assert
...
argument_list|)
operator|:
literal|"Lucene 4.8 has FilterAtomicReader.unwrap"
assert|;
name|Field
name|in
init|=
...
try|try
block|{
comment|// and another one bites the dust...
name|in
operator|=
name|FilterAtomicReader
operator|.
