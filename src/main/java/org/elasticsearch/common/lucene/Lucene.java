...
return|;
block|}
comment|/**      * Tries to acquire a lock on the given directory. The returned lock must be closed once      * the lock is released. If the lock can't be obtained a {@link LockObtainFailedException} is thrown.      */
annotation|@
name|SuppressForbidden
argument_list|(
name|reason
operator|=
literal|"this method uses trappy Directory#makeLock API"
argument_list|)
