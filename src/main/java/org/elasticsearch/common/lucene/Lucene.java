...
parameter_list|()
block|{      }
comment|// LUCENE UPGRADE this is a workaround for LUCENE-4870
...
throw|;
block|}
comment|// this is ok - we might have run into a access
comment|// exception here or even worse a too many open files exception.
block|}
return|return
literal|null
return|;
