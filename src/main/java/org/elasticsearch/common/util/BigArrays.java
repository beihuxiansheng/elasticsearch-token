...
name|AbstractComponent
block|{
comment|// TODO: switch to a circuit breaker that is shared not only on big arrays level, and applies to other request level data structures
...
name|ElasticsearchIllegalStateException
argument_list|(
literal|"Maximum number of bytes allocated exceeded: ["
operator|+
name|totalSizeInBytes
operator|+
literal|"] (> "
...
return|;
block|}
comment|/**      * Return an approximate number of bytes that have been allocated but not released yet.      */
DECL|method|sizeInBytes
specifier|public
name|long
name|sizeInBytes
