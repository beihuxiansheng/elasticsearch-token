...
begin_comment
comment|/**  * A hash table from native doubles to objects. This implementation resolves collisions  * using open-addressing and does not support null values. This class is not thread-safe.  */
end_comment

begin_class
DECL|class|DoubleObjectPagedHashMap
specifier|public
class|class
name|DoubleObjectPagedHashMap
parameter_list|<
name|T
parameter_list|>
extends|extends
...
name|values
decl_stmt|;
DECL|method|DoubleObjectPagedHashMap
specifier|public
name|DoubleObjectPagedHashMap
parameter_list|(
name|BigArrays
