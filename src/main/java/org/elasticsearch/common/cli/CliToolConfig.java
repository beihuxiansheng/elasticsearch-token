...
parameter_list|()
block|{
comment|// TODO Remove this when commons-cli 1.3 will be released
comment|// and replace by return options;
comment|// See https://issues.apache.org/jira/browse/CLI-183
name|Options
name|copy
init|=
operator|new
