...
begin_comment
comment|/**  * An immutable map implementation based on open hash map.  *<p/>  * Can be constructed using a {@link #builder()}, or using {@link #builder(org.elasticsearch.common.collect.ImmutableOpenLongMap)} (which is an optimized  * option to copy over existing content and modify it).  */
end_comment

begin_class
DECL|class|ImmutableOpenLongMap
specifier|public
specifier|final
class|class
name|ImmutableOpenLongMap
parameter_list|<
name|VType
parameter_list|>
...
name|map
decl_stmt|;
DECL|method|ImmutableOpenLongMap
specifier|private
name|ImmutableOpenLongMap
parameter_list|(
name|LongObjectHashMap
...
name|putAll
parameter_list|(
name|LongObjectAssociativeContainer
argument_list|<
name|?
extends|extends
name|VType
