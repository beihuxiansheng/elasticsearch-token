...
argument_list|)
expr_stmt|;
comment|/**          * This is here just to give us an option to rollback the change, if its stable, we should remove          * the option to even set it.          */
name|DEFAULT_GATHERING
operator|=
name|Booleans
operator|.
