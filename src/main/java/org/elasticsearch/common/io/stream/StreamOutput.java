...
name|IOException
block|{
comment|// always write the bytes...
comment|// TODO: TextBytesOptimization we could potentially optimize this, and write the bytes directly to the output stream converting to UTF8 in case its a string
name|writeBytesReference
argument_list|(
name|text
operator|.
