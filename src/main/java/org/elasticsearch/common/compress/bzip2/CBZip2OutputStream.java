...
return|;
block|}
comment|/**      * Constructs a new<tt>CBZip2OutputStream</tt> with a blocksize of 900k.      *<p/>      *<p>      *<b>Attention:</b>The caller is resonsible to write the two BZip2 magic      * bytes<tt>"BZ"</tt> to the specified stream prior to calling this      * constructor.      *</p>      *      * @param out *      *            the destination stream.      * @throws java.io.IOException  if an I/O error occurs in the specified stream.      * @throws NullPointerException if<code>out == null</code>.      */
DECL|method|CBZip2OutputStream
specifier|public
name|CBZip2OutputStream
parameter_list|(
specifier|final
...
expr_stmt|;
block|}
comment|/**      * Constructs a new<tt>CBZip2OutputStream</tt> with specified blocksize.      *<p/>      *<p>      *<b>Attention:</b>The caller is resonsible to write the two BZip2 magic      * bytes<tt>"BZ"</tt> to the specified stream prior to calling this      * constructor.      *</p>      *      * @param out       the destination stream.      * @param blockSize the blockSize as 100k units.      * @throws java.io.IOException      if an I/O error occurs in the specified stream.      * @throws IllegalArgumentException if<code>(blockSize< 1) || (blockSize> 9)</code>.      * @throws NullPointerException     if<code>out == null</code>.      * @see #MIN_BLOCKSIZE      * @see #MAX_BLOCKSIZE      */
DECL|method|CBZip2OutputStream
specifier|public
name|CBZip2OutputStream
parameter_list|(
...
expr_stmt|;
block|}
comment|/**      * This is the most hammered method of this class.      *<p/>      *<p>      * This is the version using unrolled loops. Normally I never use such ones      * in Java code. The unrolling has shown a noticable performance improvement      * on JRE 1.4.2 (Linux i586 / HotSpot Client). Of course it depends on the      * JIT compiler of the vm.      *</p>      */
DECL|method|mainSimpleSort
specifier|private
name|boolean
name|mainSimpleSort
parameter_list|(
