...
argument_list|)
expr_stmt|;
name|processDisableDynamicDeprecatedSetting
argument_list|(
name|settings
argument_list|,
name|scriptEngines
...
block|}
block|}
DECL|method|processDisableDynamicDeprecatedSetting
specifier|private
name|void
name|processDisableDynamicDeprecatedSetting
parameter_list|(
...
parameter_list|)
block|{
comment|//read deprecated disable_dynamic setting, apply only if none of the new settings is used
name|String
name|disableDynamicSetting
init|=
name|settings
operator|.
name|get
...
name|warn
argument_list|(
literal|"deprecated setting [{}] is set, replace with fine-grained scripting settings (e.g. script.inline, script.indexed, script.file)"
argument_list|,
name|ScriptService
operator|.
name|DISABLE_DYNAMIC_SCRIPTING_SETTING
...
name|ElasticsearchIllegalArgumentException
argument_list|(
literal|"conflicting scripting settings have been specified, use either "
operator|+
name|ScriptService
operator|.
name|DISABLE_DYNAMIC_SCRIPTING_SETTING
operator|+
literal|" (deprecated) or the newer fine-grained settings (e.g. script.inline, script.indexed, script.file), not both at the same time:\n"
operator|+
name|processedSettings
argument_list|)
throw|;
