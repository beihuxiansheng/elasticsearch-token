...
begin_package
DECL|package|org.elasticsearch.rest.action.admin.cluster.snapshots.restore
package|package
name|org
operator|.
name|elasticsearch
...
begin_class
DECL|class|RestRestoreSnapshotAction
specifier|public
class|class
...
annotation|@
name|Inject
DECL|method|RestRestoreSnapshotAction
specifier|public
name|RestRestoreSnapshotAction
parameter_list|(
name|Settings
...
name|POST
argument_list|,
literal|"/_snapshot/{repository}/{snapshot}/_restore"
argument_list|,
name|this
argument_list|)
expr_stmt|;
