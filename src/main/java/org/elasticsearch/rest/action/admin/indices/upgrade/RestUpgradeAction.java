...
argument_list|()
expr_stmt|;
comment|// TODO: getIndices().values() is what IndicesSegmentsResponse uses, but this will produce different orders with jdk8?
for|for
control|(
name|IndexSegments
name|indexSegments
...
expr_stmt|;
block|}
DECL|method|buildUpgradeStatus
name|void
name|buildUpgradeStatus
parameter_list|(
name|IndexSegments
