...
literal|"target"
argument_list|,
literal|"alias:t;text-align:right;desc:bytes of source shard"
argument_list|)
operator|.
name|addCell
argument_list|(
literal|"recovered"
argument_list|,
literal|"alias:r;text-align:right;desc:bytes recovered so far"
argument_list|)
operator|.
name|addCell
argument_list|(
literal|"percent"
argument_list|,
literal|"alias:per,ratio;text-align:right;desc:percent recovered so far"
argument_list|)
operator|.
name|addCell
argument_list|(
literal|"host"
argument_list|,
literal|"alias:h;desc:node host where source shard lives"
argument_list|)
operator|.
name|addCell
argument_list|(
...
literal|"node"
argument_list|,
literal|"alias:n;desc:node name where source shard lives"
argument_list|)
operator|.
name|endHeaders
argument_list|()
