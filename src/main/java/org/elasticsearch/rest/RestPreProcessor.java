...
parameter_list|()
function_decl|;
comment|/**      * Process the request, returning<tt>false</tt> if no further processing should be done. Note,      * make sure to send a response if returning<tt>false</tt>, otherwise, no response will be sent.      */
DECL|method|process
name|boolean
name|process
parameter_list|(
