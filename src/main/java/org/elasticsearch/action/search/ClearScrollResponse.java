...
block|{
comment|// On older nodes we can't tell how many search contexts where freed, so we assume at least one,
comment|// so that the rest api doesn't return 404 where SC were indeed freed.
name|numFreed
operator|=
literal|1
expr_stmt|;
