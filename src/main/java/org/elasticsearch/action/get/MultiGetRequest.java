...
block|{
comment|// post 0.90.1, we maintain the semantic difference between not setting fields (default to _source)
comment|// and setting fields to empty array (no data to return)
name|int
name|size
init|=
name|in
