...
parameter_list|()
block|{     }
comment|/**      * Constructs a new exists request against the provided indices. No indices provided means it will      * run against all indices.      */
DECL|method|ExistsRequest
specifier|public
name|ExistsRequest
parameter_list|(
...
return|;
block|}
comment|/**      * The minimum score of the documents to include in the count. Defaults to<tt>-1</tt> which means all      * documents will be considered.      */
DECL|method|minScore
specifier|public
name|ExistsRequest
name|minScore
...
return|;
block|}
comment|/**      * Routing preference for executing the search on shards      */
