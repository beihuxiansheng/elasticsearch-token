...
block|{
comment|// If 1.3.0 or earlier, only a single CircuitBreakerStats can be read
name|CircuitBreakerStats
name|fdStats
init|=
name|CircuitBreakerStats
...
block|{
comment|// Writing to a 1.3.0 or earlier stream expects only a single breaker stats
name|out
operator|.
name|writeOptionalStreamable
argument_list|(
