...
parameter_list|()
block|{     }
comment|/**      * Constructs a new close index request for the specified index.      */
DECL|method|CloseIndexRequest
specifier|public
name|CloseIndexRequest
parameter_list|(
...
return|;
block|}
comment|/**      * Specifies what type of requested indices to ignore and how to deal wild wildcard expressions.      * For example indices that don't exist.      *      * @param indicesOptions the desired behaviour regarding indices to ignore and wildcard indices expressions      * @return the request itself      */
DECL|method|indicesOptions
specifier|public
name|CloseIndexRequest
name|indicesOptions
