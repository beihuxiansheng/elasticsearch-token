...
name|actionName
operator|+
name|getReplicaOperationNameSuffix
argument_list|()
expr_stmt|;
name|this
operator|.
...
expr_stmt|;
block|}
DECL|method|getReplicaOperationNameSuffix
specifier|public
specifier|static
name|String
name|getReplicaOperationNameSuffix
...
if|if
condition|(
name|raiseFailureIfHaveNotEnoughActiveShardCopies
argument_list|(
name|shard
argument_list|,
name|clusterState
...
decl_stmt|;
name|int
name|numberOfUnassignedReplicas
init|=
literal|0
decl_stmt|;
if|if
...
block|}
block|}
DECL|method|raiseFailureIfHaveNotEnoughActiveShardCopies
name|boolean
name|raiseFailureIfHaveNotEnoughActiveShardCopies
parameter_list|(
name|ShardRouting
...
argument_list|)
expr_stmt|;
comment|// A dedicated exception would be nice...
name|retryBecauseUnavailable
argument_list|(
name|shard
operator|.
...
argument_list|()
decl_stmt|;
comment|// nocommit the Broadcast operations use AtomicReferencArray, Boaz wants to figure out why, this here is just a hack
DECL|field|replicaResponses
specifier|private
specifier|final
name|CopyOnWriteArrayList
argument_list|<
...
name|pending
decl_stmt|;
DECL|field|numberOfShardInstances
specifier|private
specifier|final
name|int
name|numberOfShardInstances
decl_stmt|;
DECL|method|ReplicationState
specifier|public
name|ReplicationState
parameter_list|(
name|PrimaryOperationRequest
