...
begin_comment
comment|/**  * Base request builder for master node read operations that can be executed on the local node as well  */
end_comment

begin_class
DECL|class|MasterNodeReadOperationRequestBuilder
specifier|public
specifier|abstract
class|class
...
argument_list|>
block|{
DECL|method|MasterNodeReadOperationRequestBuilder
specifier|protected
name|MasterNodeReadOperationRequestBuilder
parameter_list|(
name|ElasticsearchClient
