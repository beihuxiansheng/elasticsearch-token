...
begin_comment
comment|/**  * Interface that allows to mark action responses that support acknowledgements.  * Facilitates consistency across different api.  */
end_comment

begin_interface
DECL|interface|AcknowledgedResponse
specifier|public
interface|interface
