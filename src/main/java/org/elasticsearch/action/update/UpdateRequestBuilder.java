...
return|;
block|}
comment|/**      * The indexed script to execute. Note, make sure not to send different script each times and instead      * use script params if possible with the same (automatically compiled) script.      *<p>      * The script works with the variable<code>ctx</code>, which is bound to the entry,      * e.g.<code>ctx._source.mycounter += 1</code>.      *      * @see #setScriptLang(String)      * @see #setScriptParams(Map)      */
DECL|method|setIndexedScript
specifier|public
name|UpdateRequestBuilder
name|setIndexedScript
parameter_list|(
name|String
name|script
parameter_list|)
...
return|;
block|}
comment|/**      * The on disk script to execute. Note, make sure not to send different script each times and instead      * use script params if possible with the same (automatically compiled) script.      *<p>      * The script works with the variable<code>ctx</code>, which is bound to the entry,      * e.g.<code>ctx._source.mycounter += 1</code>.      *      * @see #setScriptLang(String)      * @see #setScriptParams(Map)      */
DECL|method|setOnDiskScript
specifier|public
name|UpdateRequestBuilder
name|setOnDiskScript
parameter_list|(
name|String
name|script
parameter_list|)
...
return|;
block|}
comment|/**      * The inline script to execute. Note, make sure not to send different script each times and instead      * use script params if possible with the same (automatically compiled) script.      *<p>      * The script works with the variable<code>ctx</code>, which is bound to the entry,      * e.g.<code>ctx._source.mycounter += 1</code>.      *      * @see #setScriptLang(String)      * @see #setScriptParams(Map)      */
DECL|method|setInlineScript
specifier|public
name|UpdateRequestBuilder
