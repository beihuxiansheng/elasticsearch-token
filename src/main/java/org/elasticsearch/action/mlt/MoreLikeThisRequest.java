...
parameter_list|()
block|{
comment|//we create two fake indices subrequests as we don't have the actual ones yet
comment|//since they get created later on in TransportMoreLikeThisAction
name|List
argument_list|<
name|IndicesRequest
argument_list|>
...
literal|false
expr_stmt|;
comment|// hard-coded behavior until Elasticsearch 1.2
block|}
name|searchType
operator|=
name|SearchType
...
condition|)
block|{
comment|//searchQueryHint was unused and removed in 1.4
if|if
condition|(
name|in
operator|.
