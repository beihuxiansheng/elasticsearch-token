...
block|}
block|}
comment|/**      * Aborts actively running benchmarks on the cluster      *      * @param id        Benchmark id to abort      * @param listener  Response listener      */
...
name|debug
argument_list|(
literal|"Starting benchmark for ID [{}]"
argument_list|,
name|request
operator|.
name|benchmarkName
