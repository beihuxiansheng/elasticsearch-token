...
block|}
block|}
comment|/**      * Aborts a benchmark with the given id      *      * @param benchmarkId   The benchmark to abort      * @return              Abort response      */
...
name|ElasticsearchException
argument_list|(
literal|"Failed to clear caches before benchmark round"
argument_list|,
name|e
argument_list|)
throw|;
