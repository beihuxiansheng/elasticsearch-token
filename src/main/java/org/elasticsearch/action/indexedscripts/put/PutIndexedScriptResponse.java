...
begin_comment
comment|/**  * A response of an index operation,  *  * @see PutIndexedScriptRequest  * @see org.elasticsearch.client.Client#putIndexedScript(PutIndexedScriptRequest)  */
end_comment

begin_class
DECL|class|PutIndexedScriptResponse
specifier|public
class|class
...
name|created
decl_stmt|;
DECL|method|PutIndexedScriptResponse
specifier|public
name|PutIndexedScriptResponse
parameter_list|()
block|{     }
