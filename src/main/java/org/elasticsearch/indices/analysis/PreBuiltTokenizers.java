...
parameter_list|)
block|{
comment|// see NGramTokenizerFactory for an explanation of this logic:
comment|// 4.4 patch was used before 4.4 was released
if|if
condition|(
name|version
operator|.
...
parameter_list|)
block|{
comment|// see EdgeNGramTokenizerFactory for an explanation of this logic:
comment|// 4.4 patch was used before 4.4 was released
if|if
condition|(
name|version
