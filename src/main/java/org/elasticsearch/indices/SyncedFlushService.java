...
condition|)
block|{
comment|// 1 means that there are no write operations are in flight (>1) and the shard is not closed (0).
name|actionListener
operator|.
name|onResponse
argument_list|(
...
block|}
block|}
DECL|method|getActiveShardRoutings
specifier|final
name|IndexShardRoutingTable
name|getActiveShardRoutings
parameter_list|(
