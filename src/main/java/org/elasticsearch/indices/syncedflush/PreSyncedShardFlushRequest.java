...
begin_class
DECL|class|PreSyncedShardFlushRequest
class|class
...
name|shardRouting
decl_stmt|;
comment|// we need our own request because it has to include the shard routing
DECL|field|request
specifier|private
...
argument_list|()
decl_stmt|;
DECL|method|PreSyncedShardFlushRequest
name|PreSyncedShardFlushRequest
parameter_list|()
block|{     }
DECL|method|PreSyncedShardFlushRequest
