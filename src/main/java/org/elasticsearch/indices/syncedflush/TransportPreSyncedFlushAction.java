...
begin_comment
comment|/**  * Sync Commit Action.  */
end_comment

begin_class
DECL|class|TransportPreSyncedFlushAction
specifier|public
class|class
...
argument_list|,
name|PreSyncedShardFlushRequest
argument_list|,
...
name|NAME
init|=
literal|"indices:admin/presyncedflush"
decl_stmt|;
annotation|@
name|Inject
DECL|method|TransportPreSyncedFlushAction
specifier|public
name|TransportPreSyncedFlushAction
parameter_list|(
name|Settings
...
return|;
block|}
comment|/**      * The sync commit request works against one primary and all of its copies.      */
annotation|@
name|Override
DECL|method|shards
specifier|protected
