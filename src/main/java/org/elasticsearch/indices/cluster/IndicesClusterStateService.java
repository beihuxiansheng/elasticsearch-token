...
condition|)
block|{
comment|// both are initializing, see if they are different instanceof of the shard routing, so they got switched on us
if|if
condition|(
name|currentRoutingEntry
operator|.
...
expr_stmt|;
block|}
comment|// recovering from different nodes..., restart recovery
if|if
condition|(
name|currentRoutingEntry
operator|.
