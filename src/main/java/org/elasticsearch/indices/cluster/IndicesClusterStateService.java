...
name|debug
argument_list|(
literal|"deleted index [{}] from filesystem"
argument_list|,
name|index
argument_list|)
expr_stmt|;
...
name|debug
argument_list|(
literal|"[{}][{}] removing shard on failed recovery [{}]"
argument_list|,
name|shardRouting
operator|.
name|index
...
name|warn
argument_list|(
literal|"[{}][{}] failed to delete shard after recovery failure"
argument_list|,
name|e1
argument_list|,
name|indexService
...
name|warn
argument_list|(
literal|"[{}][{}] sending failed shard after recovery failure"
argument_list|,
name|failure
argument_list|,
name|indexService
