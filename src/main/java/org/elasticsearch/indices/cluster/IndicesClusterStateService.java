...
name|trace
argument_list|(
literal|"can't recover replica because primary shard {} is assigned to an unknown node. ignoring."
argument_list|,
name|entry
argument_list|)
expr_stmt|;
...
name|trace
argument_list|(
literal|"can't recover replica for {} because a primary shard can not be found. ignoring."
argument_list|,
name|shardRouting
operator|.
name|shardId
...
name|trace
argument_list|(
literal|"can't recover from remote primary shard {} because it is assigned to an unknown node [{}]. ignoring."
argument_list|,
name|shardRouting
operator|.
name|shardId
