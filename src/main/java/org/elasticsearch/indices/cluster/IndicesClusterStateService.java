...
name|nodeMappingRefreshAction
decl_stmt|;
DECL|field|nodeAliasesUpdatedAction
specifier|private
specifier|final
name|NodeAliasesUpdatedAction
name|nodeAliasesUpdatedAction
decl_stmt|;
DECL|field|nodeIndicesStateUpdatedAction
specifier|private
specifier|final
...
argument_list|)
expr_stmt|;
name|notifyIndicesStateChanged
argument_list|(
name|event
argument_list|)
expr_stmt|;
...
block|}
block|}
DECL|method|notifyIndicesStateChanged
specifier|private
name|void
name|notifyIndicesStateChanged
parameter_list|(
...
parameter_list|)
block|{
comment|//handles open/close index notifications
if|if
condition|(
name|event
operator|.
...
block|}
block|}
comment|// Notify client that alias changes were applied
name|nodeAliasesUpdatedAction
operator|.
...
condition|)
block|{
comment|// It's the same failed shard - keep it
continue|continue
name|shards
continue|;
block|}
...
block|{
comment|// Different version - remove it
break|break;
block|}
block|}
block|}
