...
begin_comment
comment|/**  * Azure file system implementation of the BlobStoreRepository  *<p/>  * Azure file system repository supports the following settings:  *<dl>  *<dt>{@code container}</dt><dd>Azure container name. Defaults to elasticsearch-snapshots</dd>  *<dt>{@code base_path}</dt><dd>Specifies the path within bucket to repository data. Defaults to root directory.</dd>  *<dt>{@code concurrent_streams}</dt><dd>Number of concurrent read/write stream (per repository on each node). Defaults to 5.</dd>  *<dt>{@code chunk_size}</dt><dd>Large file can be divided into chunks. This parameter specifies the chunk size. Defaults to 64mb.</dd>  *<dt>{@code compress}</dt><dd>If set to true metadata files will be stored compressed. Defaults to false.</dd>  *</dl>  */
end_comment
...
name|compress
decl_stmt|;
comment|/**      * Constructs new shared file system repository      *      * @param name                 repository name      * @param repositorySettings   repository settings      * @param indexShardRepository index shard repository      * @param azureStorageService  Azure Storage service      * @throws java.io.IOException      */
annotation|@
name|Inject
...
name|debug
argument_list|(
literal|"using container [{}], chunk_size [{}], concurrent_streams [{}], compress [{}], base_path [{}]"
argument_list|,
name|container
argument_list|,
name|chunkSize
