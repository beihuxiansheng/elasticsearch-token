...
parameter_list|)
function_decl|;
comment|/**      * Explicitly sync flush one or more indices      *      * @param request The seal indices request      * @return A result future      */
DECL|method|sealIndices
name|ActionFuture
argument_list|<
name|SealIndicesResponse
argument_list|>
...
parameter_list|)
function_decl|;
comment|/**      * Explicitly sync flush one or more indices      *      * @param request  The seal indices request      * @param listener A listener to be notified with a result      */
DECL|method|sealIndices
name|void
name|sealIndices
parameter_list|(
...
parameter_list|)
function_decl|;
comment|/**      * Explicitly seal one or more indices      */
DECL|method|prepareSealIndices
name|SealIndicesRequestBuilder
