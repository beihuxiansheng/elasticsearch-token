...
condition|)
block|{
comment|// use discovered information but do keep the original transport address, so people can control which address
comment|// is exactly used.
name|DiscoveryNode
name|nodeWithInfo
init|=
name|nodeInfo
...
block|{
comment|// although we asked for one node, our target may not have completed initialization yet and doesn't have
