...
name|IOException
function_decl|;
comment|/**              * Returns true if this custom metadata should be persisted as part of global cluster state              */
...
argument_list|()
decl_stmt|;
DECL|field|GLOBAL_PERSISTENT_ONLY_PARAM
specifier|public
specifier|static
specifier|final
name|String
...
init|=
literal|"global_persistent_only"
decl_stmt|;
DECL|field|version
specifier|private
specifier|final
