...
literal|"index.uuid"
decl_stmt|;
DECL|field|SETTING_LEGACY_ROUTING_HASH_FUNCTION
specifier|public
specifier|static
specifier|final
name|String
...
init|=
literal|"index.legacy.routing.hash.type"
decl_stmt|;
DECL|field|SETTING_LEGACY_ROUTING_USE_TYPE
specifier|public
specifier|static
specifier|final
name|String
...
literal|"_na_"
decl_stmt|;
comment|// hard-coded hash function as of 2.0
comment|// older indices will read which hash function to use in their index settings
DECL|field|MURMUR3_HASH_FUNCTION
specifier|private
specifier|static
specifier|final
name|HashFunction
name|MURMUR3_HASH_FUNCTION
init|=
operator|new
name|Murmur3HashFunction
argument_list|()
...
specifier|final
name|HashFunction
name|routingHashFunction
decl_stmt|;
DECL|field|useTypeForRouting
specifier|private
specifier|final
name|boolean
name|useTypeForRouting
decl_stmt|;
...
return|;
block|}
comment|/**      * Return the {@link HashFunction} that should be used for routing.      */
DECL|method|routingHashFunction
specifier|public
name|HashFunction
name|routingHashFunction
parameter_list|()
...
return|;
block|}
DECL|method|getRoutingHashFunction
specifier|public
name|HashFunction
name|getRoutingHashFunction
parameter_list|()
block|{
return|return
name|routingHashFunction
...
return|;
block|}
comment|/**      * Return whether routing should use the _type in addition to the _id in      * order to decide which shard a document should go to.      */
DECL|method|routingUseType
specifier|public
name|boolean
name|routingUseType
parameter_list|()
...
return|;
block|}
DECL|method|getRoutingUseType
specifier|public
name|boolean
name|getRoutingUseType
parameter_list|()
block|{
return|return
name|routingUseType
