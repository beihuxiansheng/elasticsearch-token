...
return|;
block|}
comment|/**      * All the shard copies for the provided shard id grouped. Each group is a single element, consisting      * either of the primary shard of one replica.      *      * @param shardId the shard id for the copies we want      * @return All the shard copies (primary and replicas) for the shardId      * @throws IndexMissingException If an index passed does not exists      * @see IndexRoutingTable#groupByAllIt()      */
DECL|method|allActiveShardCopiesGrouped
specifier|public
name|GroupShardsIterator
name|allActiveShardCopiesGrouped
parameter_list|(
name|ShardId
name|shardId
parameter_list|)
