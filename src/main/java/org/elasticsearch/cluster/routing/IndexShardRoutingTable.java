...
return|;
block|}
comment|/**      * Adds from list to list, starting from the given index (wrapping around if needed).      */
annotation|@
name|SuppressWarnings
argument_list|(
literal|"unchecked"
argument_list|)
DECL|method|addToListFromIndex
specifier|private
name|void
name|addToListFromIndex
parameter_list|(
...
block|}
block|}
comment|// TODO: we can move to random based on ThreadLocalRandom, or make it pluggable
DECL|method|pickIndex
specifier|private
name|int
name|pickIndex
parameter_list|()
