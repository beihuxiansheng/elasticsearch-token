...
name|changed
operator||=
name|electPrimariesAndUnassignDanglingReplicas
argument_list|(
name|allocation
argument_list|)
expr_stmt|;
...
return|;
block|}
DECL|method|electPrimariesAndUnassignDanglingReplicas
specifier|private
name|boolean
name|electPrimariesAndUnassignDanglingReplicas
parameter_list|(
...
block|}
block|}
comment|// go over and remove dangling replicas that are initializing, but we couldn't elect primary ones...
name|List
argument_list|<
name|ShardRouting
argument_list|>
