...
block|}
block|}
comment|/**      * A list that makes a full copy of the original list and applies all      * modification to the copied list once {@link TransactionalList#commit()}      * is called.      *       */
annotation|@
name|SuppressWarnings
argument_list|(
literal|"serial"
argument_list|)
DECL|class|TransactionalList
specifier|private
specifier|static
specifier|final
class|class
...
parameter_list|()
block|{
comment|/* Ensure that the actual source list is not modified while              * the transaction is running */
assert|assert
name|assertingList
operator|.
name|equals
...
argument_list|)
operator|:
literal|"The list was modified outside of the scope"
assert|;
name|originalList
operator|.
name|clear
