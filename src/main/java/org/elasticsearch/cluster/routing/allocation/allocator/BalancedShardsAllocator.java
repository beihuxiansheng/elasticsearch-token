...
literal|0.45f
decl_stmt|;
comment|/**      * The primary balance factor was introduces as a tie-breaker to make the initial allocation      * more deterministic. Yet other mechanism have been added ensure that the algorithm is more deterministic such that this      * setting is not needed anymore. Additionally, this setting was abused to balance shards based on their primary flag which can lead      * to unexpected behavior when allocating or balancing the shards.      *      * @deprecated the threshold primary balance factor is deprecated and should not be used.      */
annotation|@
name|Deprecated
