...
name|debug
argument_list|(
literal|"updating thread_pool [{}], type [{}], size [{}], queue_size [{}], queue_type [{}]"
argument_list|,
name|name
argument_list|,
name|type
...
block|{
comment|// queueSize.singles()< 0, just treat it as unbounded queue
return|return
name|ConcurrentCollections
operator|.
name|newBlockingQueue
...
argument_list|)
expr_stmt|;
comment|// here to conform with remobed waitTime
name|out
operator|.
name|writeBoolean
argument_list|(
