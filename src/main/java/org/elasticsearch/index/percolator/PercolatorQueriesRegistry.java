...
name|trace
argument_list|(
literal|"trying to enable realtime percolation for index [{}] and shard[{}] on node[{}]"
argument_list|,
name|shardId
operator|.
name|index
...
name|debug
argument_list|(
literal|"enabling realtime percolating for index [{}] and shard[{}] on node[{}]"
argument_list|,
name|shardId
operator|.
name|index
...
name|trace
argument_list|(
literal|"trying to disable realtime percolation for index [{}] and shard[{}] on node[{}]"
argument_list|,
name|shardId
operator|.
name|index
...
name|debug
argument_list|(
literal|"disabling realtime percolating for index [{}] and shard[{}] on node[{}]"
argument_list|,
name|shardId
operator|.
name|index
