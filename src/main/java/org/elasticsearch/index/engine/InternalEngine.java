...
name|warn
argument_list|(
literal|"ignoring committed translog id [{}] ([{}] set to true)"
argument_list|,
name|committedTranslogId
argument_list|,
name|EngineConfig
...
annotation|@
name|Nullable
DECL|method|loadCommittedTranslogId
specifier|private
name|Long
name|loadCommittedTranslogId
parameter_list|(
...
name|trace
argument_list|(
literal|"committing writer with translog id [{}] "
argument_list|,
name|translogId
argument_list|)
expr_stmt|;
