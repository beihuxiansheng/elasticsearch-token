...
name|failedEngineListener
expr_stmt|;
comment|// will be decremented in close()
name|store
operator|.
name|incRef
argument_list|()
...
argument_list|(
literal|"addFailedEngineListener is not supported by InternalEngineImpl. Use InternalEngine."
argument_list|)
throw|;
block|}
annotation|@
...
name|UnsupportedOperationException
argument_list|(
literal|"stop() is not supported by InternalEngineImpl. Use InternalEngine."
argument_list|)
throw|;
block|}
