...
decl_stmt|;
comment|/**      * Index setting to change the low level lucene codec used for writing new segments.      * This setting is realtime updateable.      */
...
expr_stmt|;
block|}
comment|/**      * Sets the index concurrency      * @see #getIndexConcurrency()      */
DECL|method|setIndexConcurrency
specifier|public
name|void
name|setIndexConcurrency
parameter_list|(
name|int
name|indexConcurrency
parameter_list|)
...
return|;
block|}
comment|/**      * Basic realtime updateable settings listener that can be used ot receive notification      * if an index setting changed.      */
DECL|class|EngineSettingsListener
specifier|public
specifier|static
specifier|abstract
class|class
...
name|config
decl_stmt|;
DECL|method|EngineSettingsListener
specifier|public
name|EngineSettingsListener
parameter_list|(
name|ESLogger
...
block|}
block|}
comment|/**          * This method is called if  any of the settings that are exposed as realtime updateble settings has changed.          * This method should be overwritten by subclasses to react on settings changes.          */
DECL|method|onChange
specifier|protected
specifier|abstract
name|void
name|onChange
