...
expr_stmt|;
block|}
comment|/**      * @param parentType   The parent type      * @param parentFilter The filter that will be matched with parent documents      */
DECL|method|HasParentFilterBuilder
specifier|public
name|HasParentFilterBuilder
parameter_list|(
...
return|;
block|}
comment|/**      * Expert: Sets the low level parent to child filtering implementation. Can be: 'bitset' or 'uid'      *<p/>      * This option is experimental and will be removed.      */
