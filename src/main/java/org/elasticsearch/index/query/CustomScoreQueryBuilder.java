...
begin_comment
comment|/**  * A query that uses a script to compute or influence the score of documents  * that match with the inner query or filter.  *   * @deprecated use {@link FunctionScoreQueryBuilder} instead.  */
end_comment
