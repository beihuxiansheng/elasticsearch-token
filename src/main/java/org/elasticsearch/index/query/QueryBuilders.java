...
return|;
block|}
comment|/**      * A filter based on a bounding box defined by geohash. The field this filter is applied to      * must have<code>{&quot;type&quot;:&quot;geo_point&quot;,&quot;geohash&quot;:true}</code>      * to work.      *      * @param name The geo point field name.      */
...
return|;
block|}
comment|/**      * Create a new {@link OrQueryBuilder} composed of the given filters.      * @deprecated Use {@link #boolQuery()} instead      */
annotation|@
name|Deprecated
DECL|method|orQuery
specifier|public
...
return|;
block|}
comment|/**      * Create a new {@link AndQueryBuilder} composed of the given filters.      * @deprecated Use {@link #boolQuery()} instead      */
annotation|@
name|Deprecated
...
return|;
block|}
comment|/**      * @deprecated Useless now that queries and filters are merged: pass the      *             query as a filter directly.      */
annotation|@
name|Deprecated
