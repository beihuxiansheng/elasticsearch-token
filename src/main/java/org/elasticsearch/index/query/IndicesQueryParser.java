...
condition|)
block|{
comment|//TODO We are able to decide whether to parse the query or not only if indices in the query appears first
name|queryFound
operator|=
literal|true
expr_stmt|;
...
argument_list|()
expr_stmt|;
comment|// skip the query object without parsing it
block|}
else|else
block|{
name|query
