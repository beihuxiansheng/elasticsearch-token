...
argument_list|)
decl_stmt|;
DECL|field|PERCENT_TERMS_TO_MATCH
specifier|public
specifier|static
specifier|final
name|ParseField
...
block|{
comment|// TODO how about fields content fetched from _source?
name|removeUnsupportedFields
argument_list|(
name|item
argument_list|,
...
argument_list|)
decl_stmt|;
comment|// collapse the text onto the same field name
name|Collection
argument_list|<
name|LikeText
argument_list|>
name|likeTextsCollapsed
init|=
name|collapseTextOnField
argument_list|(
name|likeTexts
argument_list|)
decl_stmt|;
comment|// right now we are just building a boolean query
name|BooleanQuery
name|boolQuery
init|=
operator|new
...
return|;
block|}
DECL|method|collapseTextOnField
specifier|public
specifier|static
name|Collection
argument_list|<
