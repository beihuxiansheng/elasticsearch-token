...
expr_stmt|;
block|}
comment|/**      * Sets the {@link ShapeRelation} that defines how the Shape used in the      * Query must relate to indexed Shapes      *      * @param relation ShapeRelation used in the filter      * @return this      */
