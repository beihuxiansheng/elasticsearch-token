...
block|}
block|}
comment|/**      * Use the captured bytes to parse the inner filter using the specified      * types. The original QueryParseContext's parser is switched during this      * parsing, so this method is NOT thread-safe.      * @param types types to be used during the inner filter parsing      * @return {@link XConstantScoreQuery} wrapping the filter parsed from the bytes captured in {@code freeze()}      */
DECL|method|asFilter
specifier|public
name|Query
name|asFilter
parameter_list|(
...
block|}
block|}
comment|/**      * InnerFilter is an extension of {@code XContentStructure} that eagerly      * parses the filter in a streaming manner if the types are available at      * construction time.      */
DECL|class|InnerFilter
specifier|public
specifier|static
class|class
name|InnerFilter
...
block|}
block|}
comment|/**          * Return the filter as an          * {@link org.elasticsearch.common.lucene.search.XConstantScoreQuery}          * represented by the XContentStructure object,          * returning the cached Query if it has already been parsed.          * @param types types to be used during the inner filter parsing          */
annotation|@
name|Override
DECL|method|asFilter
specifier|public
