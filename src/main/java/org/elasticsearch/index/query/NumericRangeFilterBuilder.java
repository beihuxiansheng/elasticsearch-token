...
begin_comment
comment|/**  * A filter that restricts search results to values that are within the given numeric range.  *  *<p>Uses the field data cache (loading all the values for the specified field into memory).  *  * @author kimchy (shay.banon)  */
end_comment
...
DECL|method|NumericRangeFilterBuilder
specifier|public
name|NumericRangeFilterBuilder
parameter_list|(
name|String
