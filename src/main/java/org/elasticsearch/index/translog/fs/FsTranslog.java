...
condition|)
block|{
comment|// check if we are closed and if we are still current - then this translog is closed and we can exit
throw|throw
operator|new
name|TranslogException
argument_list|(
...
name|trace
argument_list|(
literal|"try open translog file {} locations {}"
argument_list|,
name|translogName
argument_list|,
name|location
...
comment|// we used to rename the foo into foo.recovering since foo was reused / overwritten but we fixed that in 2.0
for|for
control|(
name|Path
name|recoveryFiles
...
name|trace
argument_list|(
literal|"opening iterator for translog file: {} length: {}"
argument_list|,
name|recoveringTranslogFile
argument_list|,
name|Files
...
name|trace
argument_list|(
literal|"translog file NOT found in {}"
argument_list|,
name|location
argument_list|)
expr_stmt|;
...
DECL|class|OperationIteratorImpl
specifier|private
specifier|static
class|class
name|OperationIteratorImpl
...
name|logger
decl_stmt|;
DECL|method|OperationIteratorImpl
name|OperationIteratorImpl
parameter_list|(
name|ESLogger
name|logger
...
name|ElasticsearchException
argument_list|(
literal|"failed to close stream input"
argument_list|,
name|ex
argument_list|)
throw|;
