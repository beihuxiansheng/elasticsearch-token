...
decl_stmt|;
DECL|field|fixIndexOnStartup
specifier|private
specifier|final
name|boolean
name|fixIndexOnStartup
decl_stmt|;
...
name|getAsBoolean
argument_list|(
literal|"index.shard.check_on_startup_and_fix"
argument_list|,
literal|false
argument_list|)
expr_stmt|;
...
condition|)
block|{
comment|// we need to wrap it to delete nested docs as well...
name|IncludeAllChildrenQuery
name|nestedQuery
init|=
operator|new
