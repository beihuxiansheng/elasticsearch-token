...
begin_comment
comment|/**  * This {@link org.apache.lucene.index.IndexDeletionPolicy} implementation that  * keeps only the most recent commit and immediately removes  * all prior commits after a new commit is done.  This is  * the default deletion policy.  */
end_comment

begin_class
DECL|class|KeepOnlyLastDeletionPolicy
specifier|public
class|class
...
name|IndexDeletionPolicy
block|{
DECL|method|KeepOnlyLastDeletionPolicy
annotation|@
name|Inject
specifier|public
name|KeepOnlyLastDeletionPolicy
