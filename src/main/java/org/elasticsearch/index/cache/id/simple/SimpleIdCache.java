...
parameter_list|()
block|{
comment|// Make a copy of the live id readers...
name|Map
argument_list|<
name|Object
argument_list|,
...
argument_list|)
decl_stmt|;
comment|// ... and only if the id reader still exists in live readers we decrement stats,
comment|// this will prevent double onRemoval calls
if|if
condition|(
name|removed
operator|!=
