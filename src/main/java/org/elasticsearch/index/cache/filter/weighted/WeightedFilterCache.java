...
argument_list|(
literal|"Cannot cache instances of ResolvableFilter: "
operator|+
name|filterToCache
argument_list|)
throw|;
...
block|}
block|}
comment|/** A weigher for the Guava filter cache that uses a minimum entry size */
...
argument_list|>
block|{
DECL|field|minimumEntrySize
specifier|private
specifier|final
name|int
name|minimumEntrySize
decl_stmt|;
DECL|method|FilterCacheValueWeigher
specifier|public
name|FilterCacheValueWeigher
parameter_list|(
name|int
