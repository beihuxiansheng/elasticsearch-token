...
name|LUCENE_4_9
operator|:
literal|"Remove the special case for NRTCachingDirectory - it implements FilterDirectory in 4.10"
assert|;
block|}
...
block|{}
comment|// no instance
comment|/**      * Try and extract a store directory out of a directory, tries to take into      * account the fact that a directory is a filter directory, and/or a compound dir.      */
annotation|@
name|Nullable
...
condition|)
block|{
comment|// remove this when we upgrade to Lucene 4.10
name|current
operator|=
operator|(
operator|(
