...
expr_stmt|;
block|}
DECL|method|useLuceneChecksum
specifier|private
specifier|static
specifier|final
name|boolean
name|useLuceneChecksum
parameter_list|(
name|Version
name|version
parameter_list|,
...
literal|false
operator|)
comment|// no legacy checksum and a guarantee that lucene has checksums
operator|||
name|version
operator|.
name|onOrAfter
...
argument_list|)
return|;
comment|// OR we know that we didn't even write legacy checksums anymore when this segment was written.
block|}
