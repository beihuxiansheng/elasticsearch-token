...
begin_comment
comment|/**  * The default doc values format. This format takes no parameter.  */
end_comment

begin_class
DECL|class|DefaultDocValuesFormatProvider
specifier|public
class|class
...
annotation|@
name|Inject
DECL|method|DefaultDocValuesFormatProvider
specifier|public
name|DefaultDocValuesFormatProvider
parameter_list|(
annotation|@
