...
name|indexSettings
decl_stmt|;
DECL|field|customPostingsFormatProviders
specifier|private
specifier|final
name|Map
argument_list|<
...
argument_list|>
argument_list|>
name|customPostingsFormatProviders
init|=
name|Maps
operator|.
name|newHashMap
argument_list|()
decl_stmt|;
DECL|field|customDocValuesFormatProviders
specifier|private
specifier|final
name|Map
argument_list|<
...
argument_list|>
argument_list|>
name|customDocValuesFormatProviders
init|=
name|Maps
operator|.
name|newHashMap
...
return|;
block|}
DECL|method|addDocValuesFormat
specifier|public
name|CodecModule
name|addDocValuesFormat
parameter_list|(
name|String
name|name
parameter_list|,
...
return|;
block|}
DECL|method|configurePostingsFormats
specifier|private
name|void
name|configurePostingsFormats
parameter_list|()
block|{
name|Map
argument_list|<
...
expr_stmt|;
block|}
DECL|method|configureDocValuesFormats
specifier|private
name|void
name|configureDocValuesFormats
parameter_list|()
block|{
name|Map
argument_list|<
...
name|ElasticsearchIllegalArgumentException
argument_list|(
literal|"DocValuesFormat Factory ["
operator|+
name|name
operator|+
literal|"] must have a type associated with it"
...
literal|null
argument_list|,
literal|"org.elasticsearch.index.codec.docvaluesformat."
argument_list|,
literal|"DocValuesFormatProvider"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
name|sType
operator|+
literal|"] for docValuesFormat Factory ["
operator|+
name|name
operator|+
literal|"] can't be found"
...
name|Factory
argument_list|>
name|docValuesFormatFactoryBinder
init|=
name|MapBinder
operator|.
name|newMapBinder
