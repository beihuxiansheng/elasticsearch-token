...
parameter_list|)
function_decl|;
comment|/**      * Go over all the possible values in their geo point format for a specific doc.      */
...
block|}
comment|/**      * Go over all the possible values in their geo point format for a specific doc.      */
DECL|method|forEachLatLonValueInDoc
name|void
...
parameter_list|)
function_decl|;
DECL|interface|LatLonValueInDocProc
specifier|public
specifier|static
interface|interface
name|LatLonValueInDocProc
