...
return|;
block|}
comment|// NOTE: careful if we change the API here: unnecessary branch for< 0 here hurts a lot.
comment|// so if we already know the count (from setDocument), its bad to do it redundantly.
