...
annotation|@
name|Override
DECL|method|addRootObjectUpdate
specifier|public
name|void
...
literal|1.0f
decl_stmt|;
DECL|field|rootMapperDynamicUpdates
specifier|private
specifier|final
name|List
argument_list|<
...
parameter_list|()
function_decl|;
comment|/**      * Add a dynamic update to the root object mapper.      * TODO: can we nuke it, it is only needed for copy_to      */
DECL|method|addRootObjectUpdate
specifier|public
specifier|abstract
name|void
...
parameter_list|)
function_decl|;
comment|/**      * Get dynamic updates to the root object mapper.      * TODO: can we nuke it, it is only needed for copy_to      */
DECL|method|updates
specifier|public
specifier|abstract
name|List
