...
condition|)
block|{
comment|// within a new mapper, no need to traverse, just parse
name|objectMapper
operator|.
name|parse
argument_list|(
...
block|{
comment|// create a context of new mapper, so we batch aggregate all the changes within
comment|// this object mapper once, and traverse all of them to add them in a single go
name|context
operator|.
