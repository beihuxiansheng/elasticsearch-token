...
name|Defaults
block|{
DECL|field|BYTE_FIELD_TYPE
specifier|public
specifier|static
specifier|final
name|FieldType
name|BYTE_FIELD_TYPE
init|=
operator|new
name|FieldType
argument_list|(
...
block|}
block|}
DECL|class|CustomByteNumericField
specifier|public
specifier|static
class|class
name|CustomByteNumericField
...
name|mapper
decl_stmt|;
DECL|method|CustomByteNumericField
specifier|public
name|CustomByteNumericField
parameter_list|(
name|NumberFieldMapper
