...
argument_list|)
expr_stmt|;
comment|// we can set this to another index option when we move away from storing payload..
comment|//NESTED_FIELD_TYPE.setIndexOptions(FieldInfo.IndexOptions.DOCS_ONLY);
name|NESTED_FIELD_TYPE
operator|.
name|freeze
argument_list|()
