...
name|get
argument_list|(
literal|"index.mapper.default_mapping_location"
argument_list|)
decl_stmt|;
specifier|final
name|URL
...
name|get
argument_list|(
literal|"index.mapper.default_percolator_mapping_location"
argument_list|)
decl_stmt|;
name|URL
...
return|;
block|}
comment|/**      * Returns smart field mappers based on a smart name. A smart name is any of full name or index name.      *<p/>      *<p>It will first try to find it based on the full name (with the dots if its a compound name). If      * it is not found, will try and find it based on the indexName (which can be controlled in the mapping).      *<p/>      *<p>If nothing is found, returns null.      */
DECL|method|smartName
specifier|public
name|SmartNameFieldMappers
name|smartName
