...
condition|)
block|{
comment|// If a specific format is already defined here, we should use it
name|builder
operator|.
name|date
argument_list|(
...
condition|)
block|{
comment|// We try to get CONTENT_LENGTH from Tika first
name|context
operator|.
name|externalValue
argument_list|(
...
block|{
comment|// Otherwise, we use our byte[] length
name|context
operator|.
name|externalValue
argument_list|(
