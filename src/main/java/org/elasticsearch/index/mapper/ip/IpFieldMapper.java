...
return|;
block|}
comment|/**      * IPs should return as a string.      *      * @param value      */
annotation|@
name|Override
...
parameter_list|)
block|{
comment|// Lucene 4 Upgrade: It's surprising this uses FuzzyQuery instead of NumericRangeQuery
name|int
name|edits
init|=
name|FuzzyQuery
