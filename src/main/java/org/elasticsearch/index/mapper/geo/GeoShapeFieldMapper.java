...
argument_list|)
expr_stmt|;
comment|// TODO: this shallow copy is probably not good...need to extract the parameters and recreate the tree and strategies?
name|this
operator|.
name|defaultStrategy
operator|=
...
argument_list|()
operator|+
literal|"] has different field type"
argument_list|)
expr_stmt|;
return|return;
block|}
...
argument_list|()
operator|+
literal|"] has different tree_levels or precision"
argument_list|)
expr_stmt|;
block|}
...
return|return;
block|}
comment|// change distance error percent
name|this
operator|.
name|fieldType
operator|=
...
argument_list|)
expr_stmt|;
comment|// change orientation - this is allowed because existing dateline spanning shapes
comment|// have already been unwound and segmented
name|this
operator|.
name|fieldType
argument_list|()
