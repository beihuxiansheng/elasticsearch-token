...
condition|)
block|{
comment|// TODO: validate the mapping update on the master node
comment|// lock to avoid concurrency issues with mapping updates coming from the API
synchronized|synchronized
init|(
name|this
init|)
block|{
comment|// simulate on the first time to check if the mapping update is applicable
name|MergeContext
name|mergeContext
init|=
...
name|MapperParsingException
argument_list|(
literal|"Could not apply generated dynamic mappings: "
operator|+
name|Arrays
operator|.
name|toString
...
block|{
comment|// then apply it for real
name|mappingsModified
operator|=
literal|true
expr_stmt|;
