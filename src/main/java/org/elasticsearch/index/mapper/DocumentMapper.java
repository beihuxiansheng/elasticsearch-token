...
parameter_list|)
block|{
comment|// we have to fire up any new mappers even on a failure, because they
comment|// have been added internally to each compound mapper...
comment|// ... we have no option to "rollback" a change, which is very tricky in our copy on change system...
if|if
condition|(
operator|!
name|context
