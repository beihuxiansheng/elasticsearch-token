...
literal|false
decl_stmt|;
DECL|field|startOfThrottleMillis
specifier|volatile
name|long
name|startOfThrottleMillis
decl_stmt|;
DECL|method|stats
specifier|public
name|IndexingStats
...
condition|)
block|{
comment|//Timeslip must have happened, have to ignore this value
name|currentThrottleMillis
operator|=
literal|0
expr_stmt|;
...
literal|0
operator|:
literal|"Bad state of startOfThrottleMillis"
assert|;
name|long
