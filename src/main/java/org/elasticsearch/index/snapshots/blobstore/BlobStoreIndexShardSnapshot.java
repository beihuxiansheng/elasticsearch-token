...
name|numberOfParts
decl_stmt|;
comment|/**          * Constructs a new instance of file info          *          * @param name         file name as stored in the blob store          * @param physicalName original file name          * @param length       total length of the file          * @param partSize     size of the single chunk          * @param checksum     checksum for the file          */
...
name|indexFiles
decl_stmt|;
comment|/**      * Constructs new shard snapshot metadata from snapshot metadata      *      * @param snapshot     snapshot id      * @param indexVersion index version      * @param indexFiles   list of files in the shard      */
