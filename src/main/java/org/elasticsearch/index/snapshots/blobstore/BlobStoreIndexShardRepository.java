...
name|inputStream
decl_stmt|;
DECL|field|inputStreamIndexInput
specifier|private
specifier|final
name|InputStreamIndexInput
name|inputStreamIndexInput
decl_stmt|;
DECL|method|BlobPartWriter
specifier|private
name|BlobPartWriter
parameter_list|(
name|IndexInput
...
try|try
block|{
comment|// We have more parts to go
name|writeBlob
argument_list|(
name|indexInput
argument_list|,
...
block|{
comment|// Last part - verify checksum
try|try
block|{
name|Store
operator|.
...
block|}
block|}
DECL|method|cleanupFailedSnapshot
specifier|private
name|void
name|cleanupFailedSnapshot
parameter_list|(
...
comment|// TODO this API should really support a stream!
name|blobContainer
operator|.
name|readBlob
argument_list|(
