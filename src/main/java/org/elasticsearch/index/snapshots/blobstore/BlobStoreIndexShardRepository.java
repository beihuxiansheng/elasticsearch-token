...
literal|"index-"
decl_stmt|;
DECL|field|SNAPSHOT_TEMP_PREFIX
specifier|protected
specifier|static
specifier|final
name|String
name|SNAPSHOT_TEMP_PREFIX
init|=
literal|"pending-"
decl_stmt|;
...
return|;
block|}
comment|/**      * Serializes snapshot to JSON      *      * @param snapshot snapshot      * @param output the stream to output the snapshot JSON representation to      * @throws IOException if an IOException occurs      */
...
name|shardId
argument_list|,
literal|"Failed to rename file list"
argument_list|,
name|e
argument_list|)
throw|;
