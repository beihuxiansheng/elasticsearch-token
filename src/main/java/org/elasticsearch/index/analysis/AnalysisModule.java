...
argument_list|(
literal|"failed to find char filter type ["
operator|+
name|charFilterSettings
operator|.
name|get
...
condition|)
block|{
comment|// don't register it here, we will use explicitly register it in the AnalysisService
comment|//charFilterBinder.addBinding(charFilterName).toInstance(indicesAnalysisService.charFilterFactoryFactory(charFilterName));
block|}
else|else
block|{
name|charFilterBinder
...
name|IllegalArgumentException
argument_list|(
literal|"failed to find token filter type ["
operator|+
name|tokenFilterSettings
operator|.
name|get
...
block|{
comment|// don't register it here, we will use explicitly register it in the AnalysisService
comment|// tokenFilterBinder.addBinding(tokenFilterName).toInstance(indicesAnalysisService.tokenFilterFactoryFactory(tokenFilterName));
block|}
else|else
block|{
name|tokenFilterBinder
...
name|IllegalArgumentException
argument_list|(
literal|"failed to find tokenizer type ["
operator|+
name|tokenizerSettings
operator|.
name|get
...
block|{
comment|// don't register it here, we will use explicitly register it in the AnalysisService
comment|// tokenizerBinder.addBinding(tokenizerName).toProvider(FactoryProvider.newFactory(TokenizerFactoryFactory.class, clazz)).in(Scopes.SINGLETON);
block|}
else|else
block|{
name|tokenizerBinder
...
name|IllegalArgumentException
argument_list|(
literal|"failed to find analyzer type ["
operator|+
name|analyzerSettings
operator|.
name|get
...
block|{
comment|// don't register it here, we will use explicitly register it in the AnalysisService
comment|// analyzerBinder.addBinding(analyzerName).toProvider(FactoryProvider.newFactory(AnalyzerProviderFactory.class, clazz)).in(Scopes.SINGLETON);
block|}
else|else
block|{
name|analyzerBinder
