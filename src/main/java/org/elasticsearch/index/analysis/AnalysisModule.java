...
condition|)
block|{
comment|// don't register it here, we will do it in AnalysisService
comment|//binder.addBinding(name).toInstance(indicesAnalysisService.tokenizerFactoryFactory(name));
block|}
else|else
block|{
name|binder
...
condition|)
block|{
comment|// don't register here, we will register it in the AnalysisService
comment|//binder.addBinding(name).toInstance(indicesAnalysisService.analyzerProviderFactory(name));
block|}
else|else
block|{
name|binder
...
throw|;
block|}
comment|// if it requires settings, and it has none, then don't register it
if|if
condition|(
name|tokenizerSettings
operator|.
