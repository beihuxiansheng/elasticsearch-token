...
expr_stmt|;
block|}
comment|// If 1, causes parts of words to be generated: "PowerShot" => "Power" "Shot"
name|this
operator|.
name|generateWordParts
operator|=
...
argument_list|)
expr_stmt|;
comment|// If 1, causes number subwords to be generated: "500-42" => "500" "42"
name|this
operator|.
name|generateNumberParts
operator|=
...
argument_list|)
expr_stmt|;
comment|// If 1, causes maximum runs of number parts to be catenated: "500-42" => "50042"
name|this
operator|.
name|catenateNumbers
operator|=
...
argument_list|)
expr_stmt|;
comment|// If 1, causes all subword parts to be catenated: "wi-fi-4000" => "wifi4000"
name|this
operator|.
name|catenateAll
operator|=
...
argument_list|)
expr_stmt|;
comment|// If 1, includes original words in subwords: "500-42" => "500" "42" "500-42"
name|this
operator|.
name|preserveOriginal
operator|=
...
argument_list|)
expr_stmt|;
comment|// If 1, causes trailing "'s" to be removed for each subword: "O'Neil's" => "O", "Neil"
name|this
operator|.
name|stemEnglishPossessive
operator|=
