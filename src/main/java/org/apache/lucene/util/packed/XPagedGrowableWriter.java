...
decl_stmt|;
comment|/**    * Create a new {@link XPagedGrowableWriter} instance.    *    * @param size the number of values to store.    * @param pageSize the number of values per page    * @param startBitsPerValue the initial number of bits per value    * @param acceptableOverheadRatio an acceptable overhead ratio    */
DECL|method|XPagedGrowableWriter
specifier|public
name|XPagedGrowableWriter
parameter_list|(
name|long
