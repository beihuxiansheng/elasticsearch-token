...
begin_comment
comment|/**  * Base implementation for {@link XPagedMutable} and {@link PagedGrowableWriter}.  * @lucene.internal  */
end_comment

begin_class
DECL|class|XAbstractPagedMutable
specifier|abstract
class|class
...
name|bitsPerValue
decl_stmt|;
DECL|method|XAbstractPagedMutable
name|XAbstractPagedMutable
parameter_list|(
name|int
name|bitsPerValue
