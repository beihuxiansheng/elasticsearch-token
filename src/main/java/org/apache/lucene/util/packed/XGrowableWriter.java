...
begin_comment
comment|/**  * Implements {@link XPackedInts.Mutable}, but grows the  * bit count of the underlying packed ints on-demand.  *<p>Beware that this class will accept to set negative values but in order  * to do this, it will grow the number of bits per value to 64.  *  *<p>@lucene.internal</p>  */
end_comment

begin_class
DECL|class|XGrowableWriter
specifier|public
class|class
name|XGrowableWriter
