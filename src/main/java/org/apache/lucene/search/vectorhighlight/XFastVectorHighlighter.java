...
begin_class
DECL|class|XFastVectorHighlighter
specifier|public
class|class
...
DECL|method|XFastVectorHighlighter
specifier|public
name|XFastVectorHighlighter
parameter_list|()
block|{
...
expr_stmt|;
block|}
comment|/**    * a constructor. Using {@link XSimpleFragListBuilder} and {@link XScoreOrderFragmentsBuilder}.    *     * @param phraseHighlight true or false for phrase highlighting    * @param fieldMatch true of false for field matching    */
DECL|method|XFastVectorHighlighter
specifier|public
name|XFastVectorHighlighter
parameter_list|(
...
expr_stmt|;
block|}
comment|/**    * a constructor. A {@link XFragListBuilder} and a {@link XFragmentsBuilder} can be specified (plugins).    *     * @param phraseHighlight true of false for phrase highlighting    * @param fieldMatch true of false for field matching    * @param fragListBuilder an instance of {@link XFragListBuilder}    * @param fragmentsBuilder an instance of {@link XFragmentsBuilder}    */
DECL|method|XFastVectorHighlighter
specifier|public
name|XFastVectorHighlighter
parameter_list|(
...
expr_stmt|;
block|}
comment|/**    * create a {@link XFieldQuery} object.    *     * @param query a query    * @return the created {@link XFieldQuery} object    */
...
return|;
block|}
comment|/**    * return the best fragment.    *     * @param fieldQuery {@link XFieldQuery} object    * @param reader {@link IndexReader} of the index    * @param docId document id to be highlighted    * @param fieldName field of the document to be highlighted    * @param fragCharSize the length (number of chars) of a fragment    * @return the best fragment (snippet) string    * @throws IOException If there is a low-level I/O error    */
...
return|;
block|}
comment|/**    * return the best fragments.    *     * @param fieldQuery {@link XFieldQuery} object    * @param reader {@link IndexReader} of the index    * @param docId document id to be highlighted    * @param fieldName field of the document to be highlighted    * @param fragCharSize the length (number of chars) of a fragment    * @param maxNumFragments maximum number of fragments    * @return created fragments or null when no fragments created.    *         size of the array can be less than maxNumFragments    * @throws IOException If there is a low-level I/O error    */
