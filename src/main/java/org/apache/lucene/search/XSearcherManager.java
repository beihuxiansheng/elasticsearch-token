...
expr_stmt|;
block|}
comment|/**    * Creates and returns a new XSearcherManager from the given {@link Directory}.    * @param dir the directory to open the DirectoryReader on.    * @param searcherFactory An optional {@link SearcherFactory}. Pass    *<code>null</code> if you don't require the searcher to be warmed    *        before going live or other custom behavior.    *            * @throws IOException if there is a low-level I/O error    */
DECL|method|XSearcherManager
specifier|public
name|XSearcherManager
parameter_list|(
