...
begin_class
DECL|class|XNativeFSLockFactory
specifier|public
class|class
...
name|LUCENE_48
operator|:
literal|"Remove this class in Lucene 4.9"
assert|;
block|}
comment|/**    * Create a XNativeFSLockFactory instance, with null (unset)    * lock directory. When you pass this factory to a {@link FSDirectory}    * subclass, the lock directory is automatically set to the    * directory itself. Be sure to create one instance for each directory    * your create!    */
DECL|method|XNativeFSLockFactory
specifier|public
name|XNativeFSLockFactory
parameter_list|()
block|{
...
expr_stmt|;
block|}
comment|/**    * Create a XNativeFSLockFactory instance, storing lock    * files into the specified lockDirName:    *    * @param lockDirName where lock files are created.    */
DECL|method|XNativeFSLockFactory
specifier|public
name|XNativeFSLockFactory
parameter_list|(
...
expr_stmt|;
block|}
comment|/**    * Create a XNativeFSLockFactory instance, storing lock    * files into the specified lockDir:    *     * @param lockDir where lock files are created.    */
DECL|method|XNativeFSLockFactory
specifier|public
name|XNativeFSLockFactory
parameter_list|(
