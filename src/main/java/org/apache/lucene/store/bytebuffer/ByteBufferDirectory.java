...
return|;
block|}
DECL|field|SMALL_FILES_SUFFIXES
specifier|private
specifier|final
specifier|static
name|ImmutableSet
...
literal|"del"
argument_list|,
comment|// 1 bit per doc
literal|"cfe"
argument_list|,
comment|// compound file metadata
literal|"si"
argument_list|,
comment|// segment info
literal|"fnm"
comment|// field info (metadata like omit norms etc)
argument_list|)
decl_stmt|;
DECL|method|isSmallFile
specifier|private
specifier|static
name|boolean
name|isSmallFile
