...
begin_comment
comment|/**  * Exactly the same as Lucene {@link BufferedIndexOutput} but with the ability to set the buffer size  */
end_comment
...
begin_class
DECL|class|OpenBufferedIndexOutput
specifier|public
specifier|abstract
class|class
...
DECL|method|OpenBufferedIndexOutput
specifier|protected
name|OpenBufferedIndexOutput
parameter_list|(
name|int
