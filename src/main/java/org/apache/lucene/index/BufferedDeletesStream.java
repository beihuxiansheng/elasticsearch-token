...
begin_comment
comment|// LUCENE MONITOR: We copied this class from Lucene, effectively overriding it with our implementation
end_comment

begin_comment
comment|// if it comes first in the classpath, allowing for faster apply deletes based on terms
end_comment
...
block|}
block|}
comment|// ES CHANGE: Add bloom filter usage
