...
begin_comment
comment|// LUCENE UPGRADE - this is a copy of the StemmerOverrideFilter from Lucene - update with 4.3
end_comment

begin_class
DECL|class|XStemmerOverrideFilter
specifier|public
specifier|final
class|class
...
argument_list|()
decl_stmt|;
comment|/**        * Adds an input string and it's stemmer overwrite output to this builder.        *         * @param input the input char sequence         * @param output the stemmer override output char sequence        * @return<code>false</code> iff the input has already been added to this builder otherwise<code>true</code>.        */
DECL|method|add
specifier|public
name|boolean
name|add
