...
begin_comment
comment|/**  * {@link XCharacterUtils} provides a unified interface to Character-related  * operations to implement backwards compatible character operations based on a  * {@link Version} instance.  *  * @lucene.internal  */
end_comment

begin_class
DECL|class|XCharacterUtils
specifier|public
specifier|abstract
class|class
...
argument_list|()
decl_stmt|;
comment|/**    * Returns a {@link XCharacterUtils} implementation according to the given    * {@link Version} instance.    *    * @param matchVersion    *          a version instance    * @return a {@link XCharacterUtils} implementation according to the given    *         {@link Version} instance.    */
...
return|;
block|}
comment|/** Return a {@link XCharacterUtils} instance compatible with Java 1.4. */
...
return|;
block|}
DECL|class|Java5XCharacterUtils
specifier|private
specifier|static
specifier|final
class|class
...
name|XCharacterUtils
block|{
DECL|method|Java5XCharacterUtils
name|Java5XCharacterUtils
parameter_list|()
block|{     }
annotation|@
...
block|}
block|}
DECL|class|Java4XCharacterUtils
specifier|private
specifier|static
specifier|final
class|class
...
name|XCharacterUtils
block|{
DECL|method|Java4XCharacterUtils
name|Java4XCharacterUtils
parameter_list|()
block|{     }
annotation|@
...
block|}
block|}
comment|/**    * A simple IO buffer to use with    * {@link XCharacterUtils#fill(CharacterBuffer, Reader)}.    */
