...
begin_class
DECL|class|CustomAnalyzerWrapper
specifier|public
specifier|abstract
class|class
...
name|Analyzer
block|{
comment|/**      * Creates a new CustomAnalyzerWrapper.  Since the {@link Analyzer.ReuseStrategy} of      * the wrapped Analyzers are unknown, {@link Analyzer.PerFieldReuseStrategy} is assumed      */
