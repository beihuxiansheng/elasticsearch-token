...
begin_comment
comment|/** The base for the original two SPT's: Geohash and Quad. Don't subclass this for new SPTs.  * @lucene.internal  *  * NOTE: Will be removed upon commit of LUCENE-6422  */
end_comment
...
return|;
block|}
comment|/** Copied from {@link org.apache.lucene.util.StringHelper#startsWith(org.apache.lucene.util.BytesRef, org.apache.lucene.util.BytesRef)}    *  which calls this. This is to avoid creating a BytesRef.  */
...
return|;
block|}
comment|/** Copied from {@link org.apache.lucene.util.BytesRef#compareTo(org.apache.lucene.util.BytesRef)}.    * This is to avoid creating a BytesRef. */
DECL|method|compare
specifier|protected
specifier|static
name|int
