...
literal|1.0f
decl_stmt|;
comment|//CHANGE made minNr... a float for fractions
...
literal|0
decl_stmt|;
comment|/**    * Creates a new {@link XCommonTermsQuery}    *     * @param highFreqOccur    *          {@link Occur} used for high frequency terms    * @param lowFreqOccur    *          {@link Occur} used for low frequency terms    * @param maxTermFrequency    *          a value in [0..1] (or absolute number>=1) representing the    *          maximum threshold of a terms document frequency to be considered a    *          low frequency term.    * @throws IllegalArgumentException    *           if {@link Occur#MUST_NOT} is pass as lowFreqOccur or    *           highFreqOccur    */
DECL|method|XCommonTermsQuery
specifier|public
name|XCommonTermsQuery
parameter_list|(
name|Occur
...
return|;
block|}
comment|//CHANGE added to get num optional
...
comment|//CHANGE returns now a float
DECL|method|getMinimumNumberShouldMatch
specifier|public
name|float
name|getMinimumNumberShouldMatch
