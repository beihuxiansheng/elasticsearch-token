...
name|next
decl_stmt|;
comment|// bypass acquireRead on common uncontended case
return|return
operator|(
operator|(
name|whead
...
condition|)
block|{
comment|// help release stale waiters
name|WNode
name|c
decl_stmt|;
name|Thread
...
argument_list|)
expr_stmt|;
comment|// wake up uncancelled co-waiters
block|}
for|for
control|(
name|WNode
