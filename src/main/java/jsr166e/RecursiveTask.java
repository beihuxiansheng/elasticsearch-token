...
name|result
decl_stmt|;
comment|/**      * The main computation performed by this task.      * @return the result of the computation      */
DECL|method|compute
specifier|protected
specifier|abstract
name|V
