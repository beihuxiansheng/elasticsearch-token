...
condition|)
block|{
comment|// we default to local mode to speed up tests running in IDEs etc.
comment|// compared to a mvn default value this will also work if executed from an IDE.
name|System
operator|.
name|setProperty
argument_list|(
