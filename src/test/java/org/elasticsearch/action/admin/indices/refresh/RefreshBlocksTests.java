...
name|TEST
argument_list|)
DECL|class|RefreshBlocksTests
specifier|public
class|class
name|RefreshBlocksTests
extends|extends
name|ElasticsearchIntegrationTest
block|{
annotation|@
name|Test
DECL|method|testRefreshWithBlocks
specifier|public
name|void
name|testRefreshWithBlocks
parameter_list|()
block|{
name|createIndex
argument_list|(
...
block|}
block|}
comment|// Refreshing all indices is blocked when the cluster is read-only
try|try
block|{
name|RefreshResponse
name|response
