...
annotation|@
name|Slow
DECL|class|GetTermVectorsTests
specifier|public
class|class
name|GetTermVectorsTests
extends|extends
...
literal|"field1"
argument_list|,
literal|"type=string,term_vector=with_positions_offsets,analyzer=keyword"
argument_list|)
argument_list|)
expr_stmt|;
name|assertAcked
...
literal|"field1"
argument_list|,
literal|"type=string,term_vector=no,analyzer=keyword"
argument_list|)
argument_list|)
expr_stmt|;
name|ensureGreen
