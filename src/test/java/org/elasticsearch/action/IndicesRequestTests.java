...
parameter_list|()
block|{
comment|//make sure there is a node client around before each test starts
name|nodeClient
operator|=
...
name|String
index|[]
name|deleteByQueryShardActions
init|=
operator|new
name|String
index|[]
...
argument_list|()
expr_stmt|;
comment|//get might end up being executed locally, only optionally over the transport
name|assertSameIndicesOptionalRequests
argument_list|(
operator|new
name|String
...
argument_list|)
expr_stmt|;
comment|//query might end up being executed locally as well, only optionally over the transport
name|assertSameIndicesOptionalRequests
argument_list|(
name|moreLikeThisRequest
operator|.
...
argument_list|)
expr_stmt|;
comment|//free context messages are not necessarily sent through the transport, but if they are, check their indices
name|assertSameIndicesOptionalRequests
argument_list|(
name|moreLikeThisRequest
operator|.
