...
DECL|method|testIndicesQueryHideParsingExceptions
specifier|public
name|void
name|testIndicesQueryHideParsingExceptions
parameter_list|()
throws|throws
name|Exception
block|{
...
name|fail
argument_list|(
literal|"Should have failed with a SearchPhaseExecutionException because all shards failed with a nested QueryParsingException"
argument_list|)
expr_stmt|;
comment|// If no failure happens, the HasChildQuery may have changed behavior when provided with wrong types
block|}
catch|catch
parameter_list|(
name|SearchPhaseExecutionException
...
parameter_list|)
block|{
comment|// There is no easy way to ensure we got a QueryParsingException
block|}
name|response
operator|=
name|client
...
name|Test
comment|// https://github.com/elasticsearch/elasticsearch/issues/2416
DECL|method|testIndicesFilterHideParsingExceptions
specifier|public
name|void
name|testIndicesFilterHideParsingExceptions
parameter_list|()
throws|throws
name|Exception
block|{
