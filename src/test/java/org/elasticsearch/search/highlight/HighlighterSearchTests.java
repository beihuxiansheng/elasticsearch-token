...
argument_list|)
expr_stmt|;
comment|//no snippets produced for prefix query, not supported by postings highlighter
name|assertThat
argument_list|(
name|searchResponse
operator|.
...
argument_list|)
expr_stmt|;
comment|//lets fall back to the standard highlighter then, what people would do with unsupported queries
name|logger
operator|.
name|info
argument_list|(
...
literal|"field1"
argument_list|,
literal|"Sentence test "
operator|+
name|i
operator|+
literal|". Sentence two."
argument_list|)
operator|.
name|get
argument_list|()
