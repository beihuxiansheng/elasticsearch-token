...
annotation|@
name|Test
DECL|method|testPlainHighlighterForceSource
specifier|public
name|void
name|testPlainHighlighterForceSource
parameter_list|()
throws|throws
name|Exception
block|{
...
literal|"field1"
argument_list|,
literal|"type=string,store=yes,term_vector=with_positions_offsets,index_options=offsets"
argument_list|)
operator|.
name|get
argument_list|()
...
argument_list|)
expr_stmt|;
comment|//But be careful.  It'll blow up if there is a result paste the end of the field.
name|resp
operator|=
name|req
operator|.
...
name|assertThat
argument_list|(
literal|"Expected ShardFailures"
argument_list|,
name|resp
operator|.
...
argument_list|)
expr_stmt|;
comment|//field2 is now returned highlighted thanks to require_field_match set to false
name|assertHighlight
argument_list|(
name|searchResponse
argument_list|,
...
annotation|@
name|Test
comment|//https://github.com/elasticsearch/elasticsearch/issues/4116
DECL|method|testPostingsHighlighterCustomIndexName
specifier|public
name|void
name|testPostingsHighlighterCustomIndexName
parameter_list|()
block|{
name|assertAcked
argument_list|(
...
literal|"field1"
argument_list|,
literal|"type=string,index_options=offsets,index_name=my_field"
argument_list|)
argument_list|)
expr_stmt|;
name|ensureGreen
...
literal|"field1"
argument_list|,
literal|"First sentence. Second sentence."
argument_list|)
operator|.
name|get
argument_list|()
...
annotation|@
name|Test
DECL|method|testFastVectorHighlighterCustomIndexName
specifier|public
name|void
name|testFastVectorHighlighterCustomIndexName
parameter_list|()
block|{
name|assertAcked
argument_list|(
...
literal|"field1"
argument_list|,
literal|"type=string,term_vector=with_positions_offsets,index_name=my_field"
argument_list|)
argument_list|)
expr_stmt|;
name|ensureGreen
...
name|equalTo
argument_list|(
literal|"<em>First</em> sentence. Second sentence."
argument_list|)
argument_list|)
expr_stmt|;
name|searchResponse
...
annotation|@
name|Test
DECL|method|testPlainHighlighterCustomIndexName
specifier|public
name|void
name|testPlainHighlighterCustomIndexName
parameter_list|()
block|{
name|assertAcked
argument_list|(
...
literal|"field1"
argument_list|,
literal|"type=string,index_name=my_field"
argument_list|)
argument_list|)
expr_stmt|;
name|ensureGreen
