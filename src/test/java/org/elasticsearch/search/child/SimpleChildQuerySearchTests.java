...
argument_list|)
expr_stmt|;
comment|// only when querying with has_child the fixed bitsets are loaded
name|SearchResponse
name|searchResponse
init|=
name|client
...
literal|"test"
argument_list|)
comment|// Use setShortCircuitCutoff(0), otherwise the parent filter isn't used.
operator|.
name|setQuery
argument_list|(
name|hasChildQuery
...
annotation|@
name|Test
DECL|method|testDeleteByQuery_has_child
specifier|public
name|void
name|testDeleteByQuery_has_child
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|()
expr_stmt|;
comment|// p4 will not be found via search api, but will be deleted via delete_by_query api!
name|client
argument_list|()
operator|.
name|prepareIndex
...
argument_list|)
expr_stmt|;
comment|// Delete by query doesn't support p/c queries. If the delete by query has a different execution mode
comment|// that doesn't rely on IW#deleteByQuery() then this test can be changed.
name|DeleteByQueryResponse
name|deleteByQueryResponse
init|=
name|client
...
annotation|@
name|Test
DECL|method|testDeleteByQuery_has_child_SingleRefresh
specifier|public
name|void
name|testDeleteByQuery_has_child_SingleRefresh
parameter_list|()
throws|throws
name|Exception
block|{
...
annotation|@
name|Test
DECL|method|testDeleteByQuery_has_parent
specifier|public
name|void
name|testDeleteByQuery_has_parent
parameter_list|()
throws|throws
name|Exception
block|{
