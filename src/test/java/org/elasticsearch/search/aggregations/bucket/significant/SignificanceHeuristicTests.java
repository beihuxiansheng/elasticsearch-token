...
argument_list|()
decl_stmt|;
comment|// test default with string
name|XContentParser
name|stParser
init|=
name|JsonXContent
...
name|createParser
argument_list|(
literal|"{\"field\":\"text\", \"jlh\":{}, \"min_doc_count\":200}"
argument_list|)
decl_stmt|;
name|stParser
operator|.
...
argument_list|()
expr_stmt|;
comment|// test default with builders
...
argument_list|()
expr_stmt|;
comment|// test mutual_information with string
name|stParser
operator|=
name|JsonXContent
operator|.
...
name|createParser
argument_list|(
literal|"{\"field\":\"text\", \"mutual_information\":{\"include_negatives\": false}, \"min_doc_count\":200}"
argument_list|)
expr_stmt|;
name|stParser
operator|.
...
argument_list|()
expr_stmt|;
comment|// test mutual_information with builders
name|stBuilder
operator|=
operator|new
name|SignificantTermsBuilder
...
name|createParser
argument_list|(
literal|"{\"field\":\"text\", \"mutual_information\":{\"include_negatives\": false, \"some_unknown_field\": false}\"min_doc_count\":200}"
argument_list|)
expr_stmt|;
name|stParser
operator|.
...
try|try
block|{
comment|// 2. unknown field in jlh_score
name|stParser
operator|=
name|JsonXContent
operator|.
...
name|createParser
argument_list|(
literal|"{\"field\":\"text\", \"jlh\":{\"unknown_field\": true}, \"min_doc_count\":200}"
argument_list|)
expr_stmt|;
name|stParser
operator|.
