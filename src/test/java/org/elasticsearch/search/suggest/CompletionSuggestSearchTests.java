...
name|bugUrl
operator|=
literal|"path_type issue"
argument_list|)
comment|// If the path_type is set to `just_name` and the multi field is updated (for example another multi field is added)
comment|// then if the path isn't specified again the path_type isn't taken into account and full path names are generated.
DECL|method|testThatUpgradeToMultiFieldWorks_bug
specifier|public
name|void
name|testThatUpgradeToMultiFieldWorks_bug
parameter_list|()
throws|throws
name|Exception
block|{
