...
name|assertThat
argument_list|(
literal|"shard paths with a custom data_path should contain regular paths and custom path"
argument_list|,
name|env
operator|.
name|shardPaths
...
name|assertThat
argument_list|(
literal|"index paths with no custom settings uses the regular template"
argument_list|,
name|env
operator|.
name|indexPaths
...
name|assertThat
argument_list|(
literal|"index paths with custom data_path setting is the same as the data_path"
argument_list|,
name|env
operator|.
name|indexPaths
...
return|;
block|}
comment|/** Adds the {@code pathsToAdd} string array to the given paths list and returns it */
DECL|method|addPaths
specifier|private
name|Path
index|[]
name|addPaths
