...
name|fail
argument_list|(
literal|"isolated node still has a master or the wrong blocks. Cluster state:\n"
operator|+
name|lastState
index|[
literal|0
...
name|fail
argument_list|(
literal|"isolated node still has a master or the wrong blocks (expected 'all' block). Cluster state:\n"
operator|+
name|lastState
index|[
literal|0
