...
argument_list|)
expr_stmt|;
comment|// Reads on the wrong side of the split are allowed
name|client
argument_list|(
name|isolatedNode
argument_list|)
...
argument_list|()
expr_stmt|;
comment|// Writes on the wrong side of the split are *not* allowed
name|executeBlockedApi
argument_list|(
name|client
argument_list|(
name|isolatedNode
...
argument_list|)
expr_stmt|;
comment|// Now reads and writes on the wrong side of the split are allowed
name|executeBlockedApi
argument_list|(
name|client
argument_list|(
...
name|info
argument_list|(
literal|"verifying request[{}] on isolated [{}] and fail"
argument_list|,
name|builder
operator|.
name|getClass
