...
argument_list|()
decl_stmt|;
DECL|method|startMulticastCluster
specifier|private
name|List
argument_list|<
name|String
...
comment|// TODO: with local transport the threads of the source node enter the target node, since everything is local and like above we can't simulate GC on one node
comment|// with netty transport the threads of different nodes don't touch each other due to the network threading Netty uses
name|List
argument_list|<
name|String
argument_list|>
