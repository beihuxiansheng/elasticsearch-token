...
index|[]
block|{
literal|"test person 1 name.first"
block|,
literal|"test person 2 name.first"
block|,
literal|"test person 3 name.first"
block|,
literal|"test person 4 name.first"
block|}
argument_list|)
argument_list|)
expr_stmt|;
...
index|[]
block|{
literal|"test person 1 name.last"
block|,
literal|"test person 2 name.last"
block|,
literal|"test person 3 name.last"
block|,
literal|"test person 4 name.last"
block|}
argument_list|)
argument_list|)
expr_stmt|;
...
argument_list|)
expr_stmt|;
comment|// check each clause is for each item
name|BooleanClause
index|[]
name|boolClauses
init|=
...
expr_stmt|;
block|}
comment|// check last clause is for 'like_text'
name|BooleanClause
name|boolClause
init|=
name|boolClauses
...
argument_list|(
literal|"Not the same more like this 'fields'"
argument_list|,
operator|new
name|String
index|[]
