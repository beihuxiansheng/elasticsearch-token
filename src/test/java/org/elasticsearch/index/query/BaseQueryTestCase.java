...
parameter_list|()
function_decl|;
comment|/**      * Subclass should handle assertions on the lucene query produced by the query builder under test here      */
...
expr_stmt|;
block|}
comment|/**      * Test serialization and deserialization of the test query.      * @throws IOException      */
annotation|@
name|Test
