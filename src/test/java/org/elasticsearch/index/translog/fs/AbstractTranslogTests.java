...
literal|"ExtrasFS"
argument_list|)
DECL|class|AbstractTranslogTests
specifier|public
specifier|abstract
class|class
...
name|warn
argument_list|(
literal|"error while checking for unreferenced files in translog"
argument_list|)
expr_stmt|;
block|}
block|}
...
expr_stmt|;
block|}
DECL|method|assertTranslogFilesClosed
specifier|protected
name|void
name|assertTranslogFilesClosed
parameter_list|()
throws|throws
name|Exception
block|{
