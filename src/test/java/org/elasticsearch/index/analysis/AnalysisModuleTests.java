...
argument_list|)
expr_stmt|;
name|assertLuceneAnalyzerVersion
argument_list|(
name|Version
operator|.
name|CURRENT
...
expr_stmt|;
block|}
comment|// ugly reflection based hack to extract the lucene version from an analyzer
DECL|method|assertLuceneAnalyzerVersion
specifier|private
name|void
name|assertLuceneAnalyzerVersion
parameter_list|(
