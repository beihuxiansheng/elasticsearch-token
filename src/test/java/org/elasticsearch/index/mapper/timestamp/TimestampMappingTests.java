...
condition|)
block|{
comment|// if the only index value left is not_analyzed, then the doc values setting will be the same, but in the
comment|// other two cases, it will change
name|expectedConflicts
operator|.
name|add
argument_list|(
...
block|}
block|}
DECL|method|testDocValuesSerialization
specifier|public
name|void
name|testDocValuesSerialization
parameter_list|()
throws|throws
name|Exception
block|{
