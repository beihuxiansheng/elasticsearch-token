...
block|}
block|}
comment|/**      * Test case for #9204      */
annotation|@
name|Test
DECL|method|testMergingNullValues
specifier|public
name|void
name|testMergingNullValues
parameter_list|()
throws|throws
name|Exception
block|{
comment|// From trying to add another field with default = null
name|String
name|mapping
init|=
name|XContentFactory
...
argument_list|()
expr_stmt|;
comment|// From trying to update from null to non null
name|mapping
operator|=
name|XContentFactory
operator|.
...
argument_list|()
expr_stmt|;
comment|// From trying to update from non null to null
name|mapping
operator|=
name|XContentFactory
operator|.
