...
name|ElasticsearchLuceneTestCase
block|{
DECL|field|TRANSLOG_PRIMARY_LOCATION
specifier|public
specifier|static
specifier|final
name|String
name|TRANSLOG_PRIMARY_LOCATION
init|=
literal|"work/fs-translog/JVM_"
operator|+
name|CHILD_JVM_ID
operator|+
literal|"/primary"
decl_stmt|;
DECL|field|TRANSLOG_REPLICA_LOCATION
specifier|public
specifier|static
specifier|final
name|String
name|TRANSLOG_REPLICA_LOCATION
init|=
literal|"work/fs-translog/JVM_"
operator|+
name|CHILD_JVM_ID
...
argument_list|()
expr_stmt|;
comment|// clean up shared directory
name|assertBusy
argument_list|(
operator|new
name|Runnable
...
name|fail
argument_list|(
literal|"failed to delete translogs before tests."
operator|+
name|ExceptionsHelper
operator|.
