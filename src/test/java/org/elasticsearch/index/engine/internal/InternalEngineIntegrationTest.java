...
expr_stmt|;
block|}
DECL|method|testForceOptimize
specifier|public
name|void
name|testForceOptimize
parameter_list|()
throws|throws
name|ExecutionException
throws|,
...
literal|1
argument_list|)
comment|// this is important otherwise the MP will still trigger a merge even if there is only one segment
operator|.
name|put
argument_list|(
name|InternalEngine
