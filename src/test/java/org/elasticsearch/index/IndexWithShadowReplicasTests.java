...
argument_list|)
expr_stmt|;
comment|// node1 is master, stop that one, since we only have primaries,
comment|// usually this would mean data loss, but not on shared fs!
name|internalCluster
argument_list|()
operator|.
