...
block|}
decl_stmt|;
comment|// either uid (faster, in general a bit more memory) or indirect (slower, but in general a bit less memory)
for|for
control|(
name|String
name|executionType
...
name|executionType
operator|+
literal|"] filter with match_all query as parent query"
argument_list|)
expr_stmt|;
name|totalQueryTime
operator|=
...
name|executionType
operator|+
literal|"] with match_all query as parent query Query Avg: "
operator|+
operator|(
name|totalQueryTime
operator|/
