...
name|println
argument_list|(
literal|"--> has_child filter with single parent match Query Avg: "
operator|+
operator|(
name|totalQueryTime
operator|/
...
name|println
argument_list|(
literal|"--> has_child filter with exponential parent results Query Avg: "
operator|+
operator|(
name|totalQueryTime
operator|/
...
name|println
argument_list|(
literal|"--> has_child query with single parent match Query Avg: "
operator|+
operator|(
name|totalQueryTime
operator|/
...
name|println
argument_list|(
literal|"--> has_child query with exponential parent results Query Avg: "
operator|+
operator|(
name|totalQueryTime
operator|/
