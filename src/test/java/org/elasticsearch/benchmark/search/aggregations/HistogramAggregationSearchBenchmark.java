...
begin_class
DECL|class|HistogramAggregationSearchBenchmark
specifier|public
class|class
name|HistogramAggregationSearchBenchmark
block|{
DECL|field|COUNT
specifier|static
specifier|final
...
name|println
argument_list|(
literal|"--> Histogram Aggregation (date) "
operator|+
operator|(
name|totalQueryTime
operator|/
...
name|println
argument_list|(
literal|"--> Histogram Aggregation (date/l_value) "
operator|+
operator|(
name|totalQueryTime
operator|/
