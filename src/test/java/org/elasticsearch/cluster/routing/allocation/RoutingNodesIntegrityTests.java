...
begin_class
DECL|class|RoutingNodesIntegrityTests
specifier|public
class|class
name|RoutingNodesIntegrityTests
extends|extends
name|ElasticsearchAllocationTestCase
block|{
DECL|field|logger
...
argument_list|)
expr_stmt|;
comment|// all shards are unassigned. so no inactive shards or primaries.
name|assertThat
argument_list|(
name|routingNodes
operator|.
...
name|info
argument_list|(
literal|"Reroute, start the primaries"
argument_list|)
expr_stmt|;
name|routingNodes
operator|=
...
name|info
argument_list|(
literal|"Reroute, start the replicas"
argument_list|)
expr_stmt|;
name|routingNodes
operator|=
...
argument_list|)
expr_stmt|;
comment|// replica got promoted to primary
name|assertThat
argument_list|(
name|routingNodes
operator|.
...
name|info
argument_list|(
literal|"Start Recovering shards round 1"
argument_list|)
expr_stmt|;
name|routingNodes
operator|=
...
name|info
argument_list|(
literal|"Start Recovering shards round 2"
argument_list|)
expr_stmt|;
name|routingNodes
operator|=
