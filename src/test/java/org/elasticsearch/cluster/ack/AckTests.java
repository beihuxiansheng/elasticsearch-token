...
parameter_list|()
block|{
comment|// TODO: this test fails CheckIndex test for some reason ... seems like the index is being deleted while we run CheckIndex??
name|assertAcked
argument_list|(
name|client
argument_list|()
...
name|settingsBuilder
argument_list|()
comment|// Never run CheckIndex in the end:
operator|.
name|put
argument_list|(
name|MockFSDirectoryService
