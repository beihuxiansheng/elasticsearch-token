...
name|class
argument_list|)
DECL|method|testParsingExceptionIfMultipleFieldsWithSameName
specifier|public
name|void
name|testParsingExceptionIfMultipleFieldsWithSameName
parameter_list|()
throws|throws
name|Exception
block|{
...
literal|2
decl_stmt|;
comment|// so, we added a mapping for "type", but now we index "type1".
comment|// this will result in two fields "type.num" and "type1.num"
name|client
argument_list|()
operator|.
name|index
