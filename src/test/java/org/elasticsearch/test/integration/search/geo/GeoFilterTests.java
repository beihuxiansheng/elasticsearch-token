...
annotation|@
name|Test
DECL|method|testGeoHashFilter
specifier|public
name|void
name|testGeoHashFilter
parameter_list|()
throws|throws
name|IOException
block|{
...
name|info
argument_list|(
literal|"Testing geohash boundingbox filter for [{}]"
argument_list|,
name|geohash
argument_list|)
expr_stmt|;
...
argument_list|()
expr_stmt|;
comment|// Result of this geohash search should contain the geohash only
name|SearchResponse
name|results1
init|=
name|client
...
name|setFilter
argument_list|(
literal|"{\"geohash_cell\": {\"field\": \"pin\", \"geohash\": \""
operator|+
name|geohash
operator|+
literal|"\", \"neighbors\": false}}"
argument_list|)
operator|.
name|execute
argument_list|()
...
argument_list|()
decl_stmt|;
comment|// Result of the parent query should contain the parent it self, its neighbors, the child and all its neighbors
name|assertHitCount
argument_list|(
name|results2
argument_list|,
