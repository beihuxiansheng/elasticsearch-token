...
DECL|method|multiPercolatorRecovery
specifier|private
name|void
name|multiPercolatorRecovery
parameter_list|(
...
name|preparePercolate
argument_list|()
comment|//                                                .setPreference(preference)
operator|.
name|setIndices
argument_list|(
literal|"test"
