...
comment|// NOTE: concurrently updating the mapping of the same type and index can still return before all (relevant) nodes are updated.
comment|//       The fix for that tracked on issues #3508
name|createIndex
argument_list|(
literal|"test1"
argument_list|)
