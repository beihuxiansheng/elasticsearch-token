...
name|info
argument_list|(
literal|"--> deleting_by_query with alias0, should delete"
argument_list|)
expr_stmt|;
name|client
operator|.
...
annotation|@
name|Test
DECL|method|testAliasSearchRoutingWithConcreteAndAliasedIndices
specifier|public
name|void
name|testAliasSearchRoutingWithConcreteAndAliasedIndices
parameter_list|()
throws|throws
name|Exception
block|{
...
annotation|@
name|Test
DECL|method|testRequiredRoutingMappingWithAlias
specifier|public
name|void
name|testRequiredRoutingMappingWithAlias
parameter_list|()
throws|throws
name|Exception
block|{
