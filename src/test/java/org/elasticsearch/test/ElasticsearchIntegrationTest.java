...
decl_stmt|;
DECL|field|COMPATIBILITY_VERSION
specifier|private
specifier|static
specifier|final
name|Version
...
name|fail
argument_list|(
literal|"failed to find mappings on all nodes for index "
operator|+
name|index
operator|+
literal|", type "
...
name|fail
argument_list|(
literal|"failed to find mappings for index "
operator|+
name|index
operator|+
literal|", type "
...
name|SuiteScopeTest
block|{     }
comment|/**      * If a test is annotated with {@link org.elasticsearch.test.ElasticsearchIntegrationTest.CompatibilityVersion}      * all randomized settings will only contain settings or mappings which are compatible with the specified version ID.      */
annotation|@
name|Retention
argument_list|(
name|RetentionPolicy
...
return|;
block|}
DECL|method|compatibiltyVersion
specifier|private
name|Version
name|compatibiltyVersion
parameter_list|(
