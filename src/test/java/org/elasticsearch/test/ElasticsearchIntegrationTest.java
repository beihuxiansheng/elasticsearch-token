...
literal|1
function_decl|;
comment|/**          * Returns the minimum number of nodes in the cluster. Default is {@link org.elasticsearch.test.TestCluster#DEFAULT_MIN_NUM_NODES}.          * Ignored when {@link ClusterScope#numNodes()} is set.          */
...
function_decl|;
comment|/**          * Returns the maximum number of nodes in the cluster.  Default is {@link org.elasticsearch.test.TestCluster#DEFAULT_MAX_NUM_NODES}.          * Ignored when {@link ClusterScope#numNodes()} is set.          */
