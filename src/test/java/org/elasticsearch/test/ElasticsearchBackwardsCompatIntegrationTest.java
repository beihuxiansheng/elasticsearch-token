...
condition|)
block|{
comment|// choose a random version
comment|// TODO: how can we put the version selected in the repeat test output?
name|File
index|[]
name|subdirs
init|=
...
name|IllegalArgumentException
argument_list|(
literal|"Backwards dir "
operator|+
name|path
operator|+
literal|" must be a directory, and contain elasticsearch releases"
argument_list|)
throw|;
block|}
name|dir
...
name|IllegalArgumentException
argument_list|(
literal|"Backcompat elasticsearch version could not be parsed: "
operator|+
name|version
argument_list|)
throw|;
