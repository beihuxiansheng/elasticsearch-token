...
literal|1
decl_stmt|;
DECL|field|DEFAULT_ENABLE_RANDOM_BENCH_NODES
specifier|static
specifier|final
name|boolean
...
decl_stmt|;
DECL|field|enableRandomBenchNodes
specifier|private
specifier|final
name|boolean
...
argument_list|)
expr_stmt|;
comment|// more shared - we need to retry more often
block|}
elseif|else
if|if
condition|(
...
block|}
block|}
DECL|method|benchNodeAndClients
specifier|private
specifier|synchronized
name|Collection
argument_list|<
...
argument_list|,
operator|new
name|BenchNodePredicate
argument_list|()
argument_list|)
return|;
block|}
DECL|class|BenchNodePredicate
specifier|private
specifier|static
specifier|final
class|class
