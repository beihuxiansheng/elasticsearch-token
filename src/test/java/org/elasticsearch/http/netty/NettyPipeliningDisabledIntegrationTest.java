...
literal|1
argument_list|)
DECL|class|NettyPipeliningDisabledIntegrationTest
specifier|public
class|class
name|NettyPipeliningDisabledIntegrationTest
extends|extends
name|ElasticsearchIntegrationTest
block|{
annotation|@
...
name|ROOT
argument_list|,
literal|"Expected returned http message ids to be out of order: %s"
argument_list|,
name|opaqueIds
argument_list|)
decl_stmt|;
