...
expr_stmt|;
block|}
comment|// the cluster node communication on start up is sufficient to increase the counter
comment|// no need to do anything specific
name|int
name|count
init|=
name|SENT_REQUEST_COUNTER
...
argument_list|)
expr_stmt|;
comment|// sending a new request via client node will increase the sent requests
name|internalCluster
argument_list|()
operator|.
