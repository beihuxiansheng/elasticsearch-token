...
argument_list|()
expr_stmt|;
comment|// This returns the number of delete operations stats (not Lucene delete count)
name|currentDeleteCount
operator|=
name|response
operator|.
...
condition|)
do|;
comment|// TTL deletes one doc, but it is indexed in the primary shard and replica shard.
name|assertThat
argument_list|(
name|currentDeleteCount
argument_list|,
