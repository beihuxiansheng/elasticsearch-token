...
begin_class
DECL|class|GceSameTagsTest
specifier|public
class|class
name|GceSameTagsTest
extends|extends
name|GceAbstractTest
block|{
DECL|method|GceSameTagsTest
specifier|public
name|GceSameTagsTest
parameter_list|()
block|{
...
annotation|@
name|Test
DECL|method|two_nodes_should_run_two_tags
specifier|public
name|void
name|two_nodes_should_run_two_tags
parameter_list|()
block|{
comment|// Then we start our node for tests
name|nodeBuilder
...
annotation|@
name|Test
DECL|method|two_nodes_should_run_one_tag
specifier|public
name|void
name|two_nodes_should_run_one_tag
parameter_list|()
block|{
comment|// Then we start our node for tests
name|nodeBuilder
