...
argument_list|()
expr_stmt|;
comment|// set the balancing threshold to something very highish such that no rebalancing happens after the upgrade
name|builder
operator|=
name|ImmutableSettings
operator|.
...
argument_list|()
expr_stmt|;
comment|// we are done - enable allocation again
name|builder
operator|=
name|ImmutableSettings
operator|.
