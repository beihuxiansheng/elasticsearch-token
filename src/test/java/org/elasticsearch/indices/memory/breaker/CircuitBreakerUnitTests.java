...
annotation|@
name|Test
DECL|method|testRegisterBuiltInBreakerForbidden
specifier|public
name|void
name|testRegisterBuiltInBreakerForbidden
parameter_list|()
throws|throws
name|Exception
block|{
...
name|fail
argument_list|(
literal|"registering built-in breaker is forbidden but did not throw an exception"
argument_list|)
expr_stmt|;
block|}
catch|catch
