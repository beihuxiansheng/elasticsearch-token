...
name|TestLogging
argument_list|(
literal|"indices.recovery:TRACE,index.store:TRACE"
argument_list|)
DECL|method|testSyncFlushedRecovery
specifier|public
name|void
name|testSyncFlushedRecovery
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|()
expr_stmt|;
comment|// prevent any rebalance actions during the recovery
name|assertAcked
argument_list|(
name|prepareCreate
argument_list|(
