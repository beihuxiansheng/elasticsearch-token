...
argument_list|)
operator|+
literal|"should have contained GroovyScriptCompilationException"
argument_list|,
name|ExceptionsHelper
operator|.
name|detailedMessage
...
name|contains
argument_list|(
literal|"GroovyScriptCompilationException"
argument_list|)
argument_list|,
name|equalTo
argument_list|(
...
argument_list|)
operator|+
literal|"should have contained Method calls not allowed on [java.lang.Runtime]"
argument_list|,
name|ExceptionsHelper
operator|.
name|detailedMessage
