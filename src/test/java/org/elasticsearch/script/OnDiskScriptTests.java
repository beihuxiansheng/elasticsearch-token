...
name|query
init|=
literal|"{ \"query\" : { \"match_all\": {}} , \"script_fields\" : { \"test1\" : { \"file\" : \"script1\" }, \"test2\" : { \"file\" : \"script2\", \"params\":{\"factor\":3}  }}, size:1}"
decl_stmt|;
name|SearchResponse
name|searchResponse
init|=
...
annotation|@
name|Test
DECL|method|testFieldOnDiskBackwardCompatScript
specifier|public
name|void
name|testFieldOnDiskBackwardCompatScript
parameter_list|()
throws|throws
name|ExecutionException
throws|,
...
name|query
init|=
literal|"{ \"query\" : { \"match_all\": {}} , \"script_fields\" : { \"test1\" : { \"script\" : \"script1\" }, \"test2\" : { \"script\" : \"script2\", \"params\":{\"factor\":3}  }}, size:1}"
decl_stmt|;
name|SearchResponse
name|searchResponse
init|=
