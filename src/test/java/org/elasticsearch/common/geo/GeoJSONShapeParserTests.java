...
specifier|public
name|void
name|testParse_invalidMultipoint
parameter_list|()
throws|throws
name|IOException
block|{
...
annotation|@
name|Test
DECL|method|testParse_polygonNoHolesOGCCompliance
specifier|public
name|void
name|testParse_polygonNoHolesOGCCompliance
parameter_list|()
throws|throws
name|IOException
block|{
comment|// test ccw poly (large poly intended to not cross dateline)
name|String
name|polygonGeoJson
init|=
name|XContentFactory
...
argument_list|()
decl_stmt|;
comment|// test cw poly (small poly expected to cross dateline)
name|polygonGeoJson
operator|=
name|XContentFactory
operator|.
...
block|}
comment|//    @Test
comment|//    public void testParse_polygonWithHolesWKTReorder() throws IOException {
comment|//
comment|//    }
annotation|@
name|Test
