...
name|IOException
block|{
comment|/**          * TODO parser should fail if poly is not composed of an array of LinearRings          * This test only checks number of coordinates, not the validity of the LinearRing          */
