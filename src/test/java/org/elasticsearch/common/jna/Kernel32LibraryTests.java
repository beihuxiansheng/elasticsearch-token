...
name|bugUrl
operator|=
literal|"https://github.com/elasticsearch/elasticsearch/issues/9802"
argument_list|)
DECL|class|Kernel32LibraryTests
specifier|public
class|class
name|Kernel32LibraryTests
extends|extends
name|ElasticsearchTestCase
block|{
...
annotation|@
name|Test
DECL|method|testKernel32Library
specifier|public
name|void
name|testKernel32Library
parameter_list|()
block|{
name|ConsoleCtrlHandler
name|handler
...
name|contains
argument_list|(
literal|"console ctrl handler cannot be set"
argument_list|)
argument_list|,
name|equalTo
argument_list|(
