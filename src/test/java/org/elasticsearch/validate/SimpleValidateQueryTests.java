...
annotation|@
name|BeforeClass
DECL|method|enableFilterCache
specifier|public
specifier|static
name|void
name|enableFilterCache
parameter_list|()
block|{
assert|assert
name|hasFilterCache
...
name|filter
argument_list|(
literal|"GeoPolygonFilter(pin.location, [[40.0, -70.0], [30.0, -80.0], [20.0, -90.0], [40.0, -70.0]]))"
argument_list|)
argument_list|)
operator|+
name|typeFilter
...
name|filter
argument_list|(
literal|"GeoBoundingBoxFilter(pin.location, [40.0, -80.0], [20.0, -70.0]))"
argument_list|)
argument_list|)
operator|+
name|typeFilter
...
name|filter
argument_list|(
literal|"GeoDistanceFilter(pin.location, PLANE, 15.0, 10.0, 20.0))"
argument_list|)
argument_list|)
operator|+
name|typeFilter
...
name|filter
argument_list|(
literal|"GeoDistanceRangeFilter(pin.location, PLANE, [15.0 - 25.0], 10.0, 20.0))"
argument_list|)
argument_list|)
operator|+
name|typeFilter
...
name|filter
argument_list|(
literal|"GeoDistanceRangeFilter(pin.location, PLANE, ["
operator|+
name|DistanceUnit
operator|.
name|DEFAULT
...
name|filtered
argument_list|(
literal|"filtered(foo:1)->CustomQueryWrappingFilter(child_filter[child-type/type1](filtered(foo:1)->"
operator|+
name|filter
argument_list|(
