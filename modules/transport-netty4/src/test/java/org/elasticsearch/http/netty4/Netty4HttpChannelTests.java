...
block|}
block|}
DECL|method|testReleaseOnSendToClosedChannel
specifier|public
name|void
name|testReleaseOnSendToClosedChannel
parameter_list|()
block|{
specifier|final
name|Settings
...
argument_list|)
expr_stmt|;
comment|// ESTestCase#after will invoke ensureAllArraysAreReleased which will fail if the response content was not released
block|}
block|}
DECL|method|testReleaseOnSendToChannelAfterException
specifier|public
name|void
name|testReleaseOnSendToChannelAfterException
parameter_list|()
throws|throws
name|IOException
block|{
...
argument_list|)
expr_stmt|;
comment|// ensure we have reserved bytes
if|if
condition|(
name|randomBoolean
argument_list|()
...
argument_list|)
decl_stmt|;
comment|// send a response, the channel close status should match
name|assertTrue
argument_list|(
name|embeddedChannel
operator|.
