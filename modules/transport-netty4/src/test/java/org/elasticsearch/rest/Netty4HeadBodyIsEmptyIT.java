...
expr_stmt|;
block|}
DECL|method|testTypeDoesNotExist
specifier|public
name|void
name|testTypeDoesNotExist
parameter_list|()
throws|throws
name|IOException
block|{
...
name|headTestCase
argument_list|(
literal|"/test/_mapping/does-not-exist"
argument_list|,
name|emptyMap
argument_list|()
argument_list|,
...
name|headTestCase
argument_list|(
literal|"/text/_mapping/test,does-not-exist"
argument_list|,
name|emptyMap
argument_list|()
argument_list|,
