...
argument_list|()
decl_stmt|;
comment|// If the Throwable is an Error something has gone very wrong and Netty4MessageChannelHandler is
comment|// going to cause that to bubble up and kill the process.
if|if
condition|(
name|cause
operator|instanceof
