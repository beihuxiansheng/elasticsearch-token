...
begin_comment
comment|/**  * Builder used to configure and build a {@link Netty4CorsConfig} instance.  *  * This class was lifted from the Netty project:  *  https://github.com/netty/netty  */
end_comment

begin_class
DECL|class|Netty4CorsConfigBuilder
specifier|public
specifier|final
class|class
...
return|;
block|}
comment|/**      * Creates a {@link Netty4CorsConfigBuilder} instance with the specified origin.      *      * @return {@link Netty4CorsConfigBuilder} to support method chaining.      */
...
return|;
block|}
comment|/**      * Create a {@link Netty4CorsConfigBuilder} instance with the specified pattern origin.      *      * @param pattern the regular expression pattern to match incoming origins on.      * @return {@link Netty4CorsConfigBuilder} with the configured origin pattern.      */
...
return|;
block|}
comment|/**      * Creates a {@link Netty4CorsConfigBuilder} instance with the specified origins.      *      * @return {@link Netty4CorsConfigBuilder} to support method chaining.      */
...
DECL|method|Netty4CorsConfigBuilder
name|Netty4CorsConfigBuilder
parameter_list|(
specifier|final
name|String
...
return|;
block|}
comment|/**      * Disables CORS support.      *      * @return {@link Netty4CorsConfigBuilder} to support method chaining.      */
DECL|method|disable
specifier|public
name|Netty4CorsConfigBuilder
name|disable
...
return|;
block|}
comment|/**      * Specifies the allowed set of HTTP Request Methods that should be returned in the      * CORS 'Access-Control-Request-Method' response header.      *      * @param methods the {@link HttpMethod}s that should be allowed.      * @return {@link Netty4CorsConfigBuilder} to support method chaining.      */
...
return|;
block|}
comment|/**      * Returns HTTP response headers that should be added to a CORS preflight response.      *      * An intermediary like a load balancer might require that a CORS preflight request      * have certain headers set. This enables such headers to be added.      *      * @param name the name of the HTTP header.      * @param value the values for the HTTP header.      * @param<T> the type of values that the Iterable contains.      * @return {@link Netty4CorsConfigBuilder} to support method chaining.      */
DECL|method|preflightResponseHeader
specifier|public
parameter_list|<
name|T
...
return|;
block|}
comment|/**      * Specifies that no preflight response headers should be added to a preflight response.      *      * @return {@link Netty4CorsConfigBuilder} to support method chaining.      */
...
return|;
block|}
comment|/**      * Builds a {@link Netty4CorsConfig} with settings specified by previous method calls.      *      * @return {@link Netty4CorsConfig} the configured CorsConfig instance.      */
DECL|method|build
specifier|public
