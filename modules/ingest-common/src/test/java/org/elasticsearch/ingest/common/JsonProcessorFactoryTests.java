...
expr_stmt|;
block|}
DECL|method|testCreateWithAddToRoot
specifier|public
name|void
name|testCreateWithAddToRoot
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
DECL|method|testCreateWithBothTargetFieldAndAddToRoot
specifier|public
name|void
name|testCreateWithBothTargetFieldAndAddToRoot
parameter_list|()
throws|throws
name|Exception
block|{
...
name|equalTo
argument_list|(
literal|"[target_field] Cannot set a target field while also setting `add_to_root` to true"
argument_list|)
argument_list|)
expr_stmt|;
block|}
