...
expr_stmt|;
block|}
DECL|method|testExcludeKeys
specifier|public
name|void
name|testExcludeKeys
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
DECL|method|testIncludeAndExcludeKeys
specifier|public
name|void
name|testIncludeAndExcludeKeys
parameter_list|()
throws|throws
name|Exception
block|{
...
name|ingestDocument
argument_list|,
literal|"first=hello&second=world&second=universe&third=bar"
argument_list|)
decl_stmt|;
name|Processor
name|processor
