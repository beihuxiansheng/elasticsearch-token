...
expr_stmt|;
block|}
DECL|method|testNoMatchingPatternName
specifier|public
name|void
name|testNoMatchingPatternName
parameter_list|()
block|{
name|String
name|fieldName
...
name|equalTo
argument_list|(
literal|"Unable to find pattern [NOTONE] in Grok's pattern dictionary"
argument_list|)
argument_list|)
expr_stmt|;
block|}
...
expr_stmt|;
block|}
DECL|method|testCombineSamePatternNameAcrossPatterns
specifier|public
name|void
name|testCombineSamePatternNameAcrossPatterns
parameter_list|()
throws|throws
name|Exception
block|{
...
name|asList
argument_list|(
literal|"%{ONE:first}-%{TWO:second}"
argument_list|,
literal|"%{ONE:first}-%{THREE:second}"
argument_list|)
argument_list|,
name|fieldName
argument_list|,
...
expr_stmt|;
block|}
DECL|method|testFirstWinNamedCapture
specifier|public
name|void
name|testFirstWinNamedCapture
parameter_list|()
throws|throws
name|Exception
block|{
...
name|singletonList
argument_list|(
literal|"%{ONETWO:first}%{ONETWO:first}"
argument_list|)
argument_list|,
name|fieldName
argument_list|,
...
expr_stmt|;
block|}
DECL|method|testUnmatchedNamesNotIncludedInDocument
specifier|public
name|void
name|testUnmatchedNamesNotIncludedInDocument
parameter_list|()
throws|throws
name|Exception
block|{
...
name|singletonList
argument_list|(
literal|"%{ONETWO:first}|%{THREE:second}"
argument_list|)
argument_list|,
name|fieldName
argument_list|,
