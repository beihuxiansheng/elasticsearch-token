...
block|}
block|}
DECL|method|testRenameNonExistingFieldWithIgnoreMissing
specifier|public
name|void
name|testRenameNonExistingFieldWithIgnoreMissing
parameter_list|()
throws|throws
name|Exception
block|{
...
block|}
block|}
DECL|method|testRenameLeafIntoBranch
specifier|public
name|void
name|testRenameLeafIntoBranch
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// for fun lets try to restore it (which don't allow today)
name|Processor
name|processor3
init|=
operator|new
...
name|equalTo
argument_list|(
literal|"field [foo] already exists"
argument_list|)
argument_list|)
expr_stmt|;
block|}
