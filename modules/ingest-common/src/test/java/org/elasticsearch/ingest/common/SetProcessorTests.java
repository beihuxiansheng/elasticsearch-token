...
name|equalTo
argument_list|(
literal|"cannot set [inner] with parent object of type [java.lang.String] as "
operator|+
literal|"part of path [field.inner]"
argument_list|)
argument_list|)
expr_stmt|;
block|}
block|}
DECL|method|testSetNewFieldWithOverrideDisabled
specifier|public
name|void
name|testSetNewFieldWithOverrideDisabled
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
DECL|method|testSetExistingFieldWithOverrideDisabled
specifier|public
name|void
name|testSetExistingFieldWithOverrideDisabled
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
DECL|method|testSetExistingNullFieldWithOverrideDisabled
specifier|public
name|void
name|testSetExistingNullFieldWithOverrideDisabled
parameter_list|()
throws|throws
name|Exception
block|{
