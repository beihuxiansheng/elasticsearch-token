...
expr_stmt|;
block|}
DECL|method|testNoMatchingPatternInDictionary
specifier|public
name|void
name|testNoMatchingPatternInDictionary
parameter_list|()
block|{
name|Exception
name|e
...
name|equalTo
argument_list|(
literal|"Unable to find pattern [NOTFOUND] in Grok's pattern dictionary"
argument_list|)
argument_list|)
expr_stmt|;
block|}
