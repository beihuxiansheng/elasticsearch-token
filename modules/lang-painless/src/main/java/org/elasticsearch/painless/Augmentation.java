...
return|;
block|}
comment|/**      * Encode a String in Base64. Use {@link Base64.Encoder#encodeToString(byte[])} if you have to encode bytes rather than a string.      */
DECL|method|encodeBase64
specifier|public
specifier|static
name|String
name|encodeBase64
...
return|;
block|}
comment|/**      * Decode some Base64 bytes and build a UTF-8 encoded string. Use {@link Base64.Decoder#decode(String)} if you'd prefer bytes to work      * with bytes.      */
DECL|method|decodeBase64
specifier|public
specifier|static
name|String
name|decodeBase64
