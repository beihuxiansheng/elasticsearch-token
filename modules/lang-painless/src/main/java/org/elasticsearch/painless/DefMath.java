...
block|}
comment|// this is safe for our uses of it here only, because we change just the return value,
comment|// the original method itself does all the type checks correctly.
return|return
name|MethodHandles
operator|.
