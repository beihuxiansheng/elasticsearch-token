...
parameter_list|()
block|{
comment|// we have a methodhandle already (e.g. whitelisted class)
comment|// just return its type
if|if
condition|(
name|handle
operator|!=
...
condition|)
block|{
comment|// static method: straightforward copy
name|params
operator|=
operator|new
name|Class
...
condition|)
block|{
comment|// constructor: returns the owner class
name|params
operator|=
operator|new
name|Class
...
block|{
comment|// virtual/interface method: add receiver class
name|params
operator|=
operator|new
name|Class
...
try|try
block|{
comment|// TODO: we *have* to remove all these public members and use getter methods to encapsulate!
specifier|final
name|Class
argument_list|<
name|?
