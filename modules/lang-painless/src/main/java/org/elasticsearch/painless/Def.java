...
throw|;
block|}
comment|/** pointer to Array.getLength(Object) */
DECL|field|ARRAY_LENGTH
specifier|private
specifier|static
specifier|final
name|MethodHandle
...
try|try
block|{
comment|// TODO: maybe specialize handles for different array types. this may be slower, but simple :)
name|ARRAY_LENGTH
operator|=
name|lookup
operator|.
...
comment|/**      * Performs an actual array store.      * @param array array object      * @param index map key, array index (integer), or list index (integer)      * @param value value to store in the array.      */
annotation|@
...
block|}
block|}
comment|/**      * Performs an actual array load.      * @param array array object      * @param index map key, array index (integer), or list index (integer)      */
annotation|@
name|SuppressWarnings
argument_list|(
literal|"rawtypes"
