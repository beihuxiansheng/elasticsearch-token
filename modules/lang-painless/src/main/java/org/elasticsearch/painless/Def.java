...
name|ITERATOR
decl_stmt|;
comment|/** pointer to {@link Def#mapIndexNormalize}. */
DECL|field|MAP_INDEX_NORMALIZE
specifier|private
specifier|static
specifier|final
name|MethodHandle
name|MAP_INDEX_NORMALIZE
decl_stmt|;
comment|/** pointer to {@link Def#listIndexNormalize}. */
DECL|field|LIST_INDEX_NORMALIZE
specifier|private
specifier|static
specifier|final
name|MethodHandle
...
throw|;
block|}
comment|/**      * Returns a method handle to normalize the index into an array. This is what makes lists and arrays stored in {@code def} support      * negative offsets.      * @param receiverClass Class of the array to store the value in      * @return a MethodHandle that accepts the receiver as first argument, the index as second argument, and returns the normalized index      *   to use with array loads and array stores      */
DECL|method|lookupIndexNormalize
specifier|static
name|MethodHandle
...
block|{
return|return
name|ArrayIndexNormalizeHelper
operator|.
name|arrayIndexNormalizer
argument_list|(
name|receiverClass
argument_list|)
return|;
...
condition|)
block|{
comment|// noop so that mymap[key] doesn't do funny things with negative keys
return|return
name|MAP_INDEX_NORMALIZE
return|;
block|}
...
name|IllegalArgumentException
argument_list|(
literal|"Attempting to address a non-array-like type "
operator|+
literal|"["
operator|+
name|receiverClass
...
block|}
block|}
comment|/**      * "Normalizes" the index into a {@code Map} by making no change to the index.      */
DECL|method|mapIndexNormalize
specifier|public
specifier|static
name|Object
name|mapIndexNormalize
parameter_list|(
specifier|final
name|Map
argument_list|<
...
return|;
block|}
comment|/**      * "Normalizes" the idnex into a {@code List} by flipping negative indexes around so they are "from the end" of the list.      */
DECL|method|listIndexNormalize
specifier|public
specifier|static
name|int
name|listIndexNormalize
parameter_list|(
specifier|final
name|List
argument_list|<
...
return|;
block|}
comment|/**      * Methods to normalize array indices to support negative indices into arrays stored in {@code def}s.      */
annotation|@
name|SuppressWarnings
argument_list|(
literal|"unused"
argument_list|)
comment|// normalizeIndex() methods are are actually used, javac just does not know :)
DECL|class|ArrayIndexNormalizeHelper
specifier|private
specifier|static
specifier|final
class|class
...
return|;
block|}
DECL|method|arrayIndexNormalizer
specifier|static
name|MethodHandle
name|arrayIndexNormalizer
parameter_list|(
...
return|;
block|}
DECL|method|ArrayIndexNormalizeHelper
specifier|private
name|ArrayIndexNormalizeHelper
parameter_list|()
block|{}
