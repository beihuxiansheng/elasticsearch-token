...
block|}
block|}
comment|/** Writes a dynamic binary instruction: returnType, lhs, and rhs can be different */
DECL|method|writeDynamicBinaryInstruction
specifier|public
name|void
...
block|}
block|}
comment|/** Writes a static binary instruction */
...
name|AssertionError
argument_list|(
literal|"Should never call this method on MethodWriter, use endMethod() instead"
argument_list|)
throw|;
block|}
comment|/**      * Writes a dynamic call for a def method.      * @param name method name      * @param methodType callsite signature      * @param flavor type of call      * @param params flavor-specific parameters      */
DECL|method|invokeDefCall
specifier|public
name|void
name|invokeDefCall
parameter_list|(
