...
argument_list|)
decl_stmt|;
comment|/** box methods to replace the GeneratorAdapter's slow way of boxing */
DECL|field|BOOLEAN_VALUE_OF
specifier|public
specifier|final
specifier|static
name|Method
