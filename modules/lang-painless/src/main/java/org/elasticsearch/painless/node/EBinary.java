...
argument_list|)
expr_stmt|;
comment|// It'd be nice to be able to do constant folding here but we can't because constants aren't flowing through EChain
name|promote
operator|=
name|Definition
operator|.
