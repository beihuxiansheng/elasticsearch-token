...
name|implMethodASM
decl_stmt|;
comment|/**      * Creates a new FunctionRef.      * @param expected interface type to implement.      * @param type the left hand side of a method reference expression      * @param call the right hand side of a method reference expression      */
