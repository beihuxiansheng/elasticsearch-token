...
name|implMethodASM
decl_stmt|;
comment|/**      * Creates a new FunctionRef.      * @param expected interface type to implement.      * @param type the left hand side of a method reference expression      * @param call the right hand side of a method reference expression      * @param captures captured arguments      */
...
condition|)
block|{
comment|// drop the receiver, we capture it
name|samMethodType
operator|=
name|impl
operator|.
...
block|{
comment|// ensure the receiver type is exact and not a superclass type
name|samMethodType
operator|=
name|impl
operator|.
