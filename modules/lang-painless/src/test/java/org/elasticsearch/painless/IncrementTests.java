...
expr_stmt|;
block|}
comment|/** incrementing def values */
DECL|method|testIncrementDef
specifier|public
name|void
name|testIncrementDef
parameter_list|()
block|{
name|assertEquals
argument_list|(
...
name|exec
argument_list|(
literal|"def x = (short)0; return x++;"
argument_list|)
argument_list|)
expr_stmt|;
name|assertEquals
