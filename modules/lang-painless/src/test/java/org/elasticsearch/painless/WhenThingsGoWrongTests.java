...
expr_stmt|;
block|}
DECL|method|testBadStringEscape
specifier|public
name|void
name|testBadStringEscape
parameter_list|()
block|{
name|Exception
name|e
...
name|assertEquals
argument_list|(
literal|"unexpected character ['\\a]. The only valid escape sequences in strings starting with ['] are [\\\\] and [\\']."
argument_list|,
name|e
operator|.
name|getMessage
...
expr_stmt|;
block|}
DECL|method|testRegularUnexpectedCharacter
specifier|public
name|void
name|testRegularUnexpectedCharacter
parameter_list|()
block|{
name|Exception
name|e
...
name|assertEquals
argument_list|(
literal|"unexpected character ['cat]."
argument_list|,
name|e
operator|.
name|getMessage
