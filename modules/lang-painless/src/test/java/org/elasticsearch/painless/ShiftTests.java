...
expr_stmt|;
block|}
DECL|method|testBogusCompoundAssignmentDef
specifier|public
name|void
name|testBogusCompoundAssignmentDef
parameter_list|()
block|{
name|expectScriptThrows
argument_list|(
...
name|exec
argument_list|(
literal|"def x = 1L; float y = 2; x<<= y;"
argument_list|)
expr_stmt|;
block|}
argument_list|)
...
name|exec
argument_list|(
literal|"def x = 1; double y = 2L; x<<= y;"
argument_list|)
expr_stmt|;
block|}
argument_list|)
...
name|exec
argument_list|(
literal|"float x = 1F; def y = 2; x<<= y;"
argument_list|)
expr_stmt|;
block|}
argument_list|)
...
name|exec
argument_list|(
literal|"double x = 1D; def y = 2L; x<<= y;"
argument_list|)
expr_stmt|;
block|}
argument_list|)
