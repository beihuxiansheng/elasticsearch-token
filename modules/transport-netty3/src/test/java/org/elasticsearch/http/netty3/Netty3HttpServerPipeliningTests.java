...
begin_class
DECL|class|Netty3HttpServerPipeliningTests
specifier|public
class|class
name|Netty3HttpServerPipeliningTests
extends|extends
name|ESTestCase
block|{
...
specifier|private
name|CustomNetty3HttpServerTransport
...
argument_list|)
decl_stmt|;
comment|// we cannot be sure about the order of the responses, but the slow ones should come last
name|assertThat
argument_list|(
name|responseBodies
argument_list|,
...
block|}
block|}
DECL|class|CustomNetty3HttpServerTransport
class|class
name|CustomNetty3HttpServerTransport
extends|extends
name|Netty3HttpServerTransport
...
name|executorService
decl_stmt|;
DECL|method|CustomNetty3HttpServerTransport
specifier|public
name|CustomNetty3HttpServerTransport
parameter_list|(
name|Settings
