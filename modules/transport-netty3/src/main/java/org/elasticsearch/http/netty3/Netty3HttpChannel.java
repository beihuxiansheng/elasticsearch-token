...
name|threadContext
decl_stmt|;
comment|/**      * @param transport                   The corresponding<code>Netty3HttpServerTransport</code> where this channel belongs to.      * @param request                     The request that is handled by this channel.      * @param orderedUpstreamMessageEvent If HTTP pipelining is enabled provide the corresponding Netty upstream event. May be null if      *                                    HTTP pipelining is disabled.      * @param detailedErrorsEnabled       true iff error messages should include stack traces.      */
DECL|method|Netty3HttpChannel
specifier|public
name|Netty3HttpChannel
parameter_list|(
name|Netty3HttpServerTransport
