...
name|equalTo
argument_list|(
literal|"[has_parent] join field [join_field] doesn't hold [just_a_type] as a parent"
argument_list|)
argument_list|)
expr_stmt|;
block|}
...
name|containsString
argument_list|(
literal|"[has_parent] join field [join_field] doesn't hold [unmapped] as a parent"
argument_list|)
argument_list|)
expr_stmt|;
block|}
