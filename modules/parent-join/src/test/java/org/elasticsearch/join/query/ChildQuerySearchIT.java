...
literal|"join_field"
argument_list|,
literal|"type=join,parent=child,child=grandchild"
argument_list|)
argument_list|)
expr_stmt|;
block|}
...
block|{
comment|// doesn't make sense for join field, because query string& term query om this field have no special logic.
block|}
comment|// HAS CHILD
name|searchResponse
operator|=
...
name|bugUrl
operator|=
literal|"wait for inner hits to be fixed"
argument_list|)
...
literal|"join_field"
argument_list|,
literal|"type=join,parent-type=child-type"
argument_list|)
argument_list|)
expr_stmt|;
block|}
