...
return|;
block|}
DECL|method|checkIndexCompatibility
specifier|private
specifier|static
name|void
name|checkIndexCompatibility
parameter_list|(
name|IndexSettings
name|settings
parameter_list|,
...
argument_list|(
literal|"cannot create join field ["
operator|+
name|name
operator|+
literal|"] "
...
block|}
block|}
DECL|method|checkObjectOrNested
specifier|private
specifier|static
name|void
name|checkObjectOrNested
parameter_list|(
name|ContentPath
name|path
parameter_list|,
