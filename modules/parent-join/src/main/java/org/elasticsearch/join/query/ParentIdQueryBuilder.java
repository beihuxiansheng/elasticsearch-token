...
condition|)
block|{
comment|// BWC for indices with multiple types
return|return
name|doToQueryBWC
argument_list|(
name|context
...
name|NAME
operator|+
literal|"] no join field found for index ["
operator|+
name|indexName
operator|+
literal|"]"
...
name|NAME
operator|+
literal|"] no relation found for child ["
operator|+
name|type
operator|+
literal|"]"
...
return|;
block|}
comment|/**      * Creates parent_id query from a {@link ParentFieldMapper}      * Only used for BWC with multi-types indices      */
DECL|method|doToQueryBWC
specifier|private
name|Query
name|doToQueryBWC
parameter_list|(
