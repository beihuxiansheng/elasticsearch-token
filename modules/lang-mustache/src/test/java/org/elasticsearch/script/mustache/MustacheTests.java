...
name|put
argument_list|(
literal|"https://www.elastic.co"
argument_list|,
literal|"https%3A%2F%2Fwww.elastic.co"
argument_list|)
expr_stmt|;
name|urls
operator|.
...
argument_list|,
literal|"%3Clogstash-%7Bnow%2Fd%7D%3E"
argument_list|)
expr_stmt|;
name|urls
operator|.
name|put
argument_list|(
literal|"?query=(foo:A OR baz:B) AND title:/joh?n(ath[oa]n)/ AND date:{* TO 2012-01}"
argument_list|,
literal|"%3Fquery%3D%28foo%3AA+OR+baz%3AB%29+AND+title%3A%2Fjoh%3Fn%28ath%5Boa%5Dn%29%2F+AND+date%3A%7B*+TO+2012-01%7D"
argument_list|)
expr_stmt|;
for|for
control|(
...
block|}
block|}
DECL|method|testUrlEncoderWithParam
specifier|public
name|void
name|testUrlEncoderWithParam
parameter_list|()
throws|throws
name|Exception
block|{
name|assertScript
argument_list|(
literal|"{{#url}}{{index}}{{/url}}"
argument_list|,
name|singletonMap
argument_list|(
literal|"index"
argument_list|,
literal|"<logstash-{now/d{YYYY.MM.dd|+12:00}}>"
argument_list|)
argument_list|,
name|equalTo
argument_list|(
literal|"%3Clogstash-%7Bnow%2Fd%7BYYYY.MM.dd%7C%2B12%3A00%7D%7D%3E"
argument_list|)
argument_list|)
expr_stmt|;
specifier|final
...
expr_stmt|;
block|}
DECL|method|testUrlEncoderWithJoin
specifier|public
name|void
name|testUrlEncoderWithJoin
parameter_list|()
block|{
name|Map
argument_list|<
...
name|assertScript
argument_list|(
literal|"?query={{#url}}{{#join}}emails{{/join}}{{/url}}"
argument_list|,
name|params
argument_list|,
name|equalTo
argument_list|(
literal|"?query=john%40smith.com%2Cjohn.smith%40email.com%2Cjsmith%40email.com"
argument_list|)
argument_list|)
expr_stmt|;
name|params
...
index|[]
block|{
literal|"<logstash-{now/d-2d}>"
block|,
literal|"<logstash-{now/d-1d}>"
block|,
literal|"<logstash-{now/d}>"
block|}
argument_list|)
...
name|assertScript
argument_list|(
literal|"{{#url}}https://localhost:9200/{{#join}}indices{{/join}}/_stats{{/url}}"
argument_list|,
name|params
argument_list|,
name|equalTo
argument_list|(
literal|"https%3A%2F%2Flocalhost%3A9200%2F%3Clogstash-%7Bnow%2Fd-2d%7D"
operator|+
literal|"%3E%2C%3Clogstash-%7Bnow%2Fd-1d%7D%3E%2C%3Clogstash-%7Bnow%2Fd%7D%3E%2F_stats"
argument_list|)
argument_list|)
expr_stmt|;
name|params
...
name|assertScript
argument_list|(
literal|"{{#url}}{{#join delimiter='+'}}fibonacci{{/join delimiter='+'}}{{/url}}"
argument_list|,
name|params
argument_list|,
name|equalTo
argument_list|(
literal|"1%2B1%2B2%2B3%2B5%2B8%2B13%2B21%2B34%2B55"
argument_list|)
argument_list|)
expr_stmt|;
block|}
