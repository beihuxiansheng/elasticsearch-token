...
begin_package
DECL|package|org.elasticsearch.index.mapper.json.multifield
package|package
name|org
operator|.
name|elasticsearch
...
annotation|@
name|Test
DECL|class|JsonMultiFieldTests
specifier|public
class|class
name|JsonMultiFieldTests
block|{
...
argument_list|(
literal|"/org/elasticsearch/index/mapper/json/multifield/test-mapping.json"
argument_list|)
decl_stmt|;
name|JsonDocumentMapper
name|docMapper
...
argument_list|(
literal|"/org/elasticsearch/index/mapper/json/multifield/test-data.json"
argument_list|)
decl_stmt|;
name|Document
name|doc
