...
expr_stmt|;
block|}
DECL|method|testCustomScoreQuery1
annotation|@
name|Test
specifier|public
name|void
name|testCustomScoreQuery1
parameter_list|()
throws|throws
name|IOException
block|{
...
name|copyToStringFromClasspath
argument_list|(
literal|"/org/elasticsearch/index/query/xcontent/custom_score1.json"
argument_list|)
decl_stmt|;
name|Query
name|parsedQuery
