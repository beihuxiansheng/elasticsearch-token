...
begin_package
DECL|package|org.elasticsearch.index.mapper.json.simple
package|package
name|org
operator|.
name|elasticsearch
...
begin_class
DECL|class|SimpleJsonMapperTests
specifier|public
class|class
name|SimpleJsonMapperTests
block|{
...
argument_list|(
literal|"/org/elasticsearch/index/mapper/json/simple/test1.json"
argument_list|)
decl_stmt|;
name|Document
name|doc
...
name|copyToStringFromClasspath
argument_list|(
literal|"/org/elasticsearch/index/mapper/json/simple/test-mapping.json"
argument_list|)
decl_stmt|;
name|JsonDocumentMapper
name|docMapper
...
comment|//        System.out.println("Json: " + docMapper.sourceMapper().value(doc));
block|}
DECL|method|testSimpleParserMappingWithNoType
annotation|@
name|Test
specifier|public
name|void
name|testSimpleParserMappingWithNoType
parameter_list|()
throws|throws
name|Exception
block|{
...
name|copyToStringFromClasspath
argument_list|(
literal|"/org/elasticsearch/index/mapper/json/simple/test-mapping-notype.json"
argument_list|)
decl_stmt|;
name|JsonDocumentMapper
name|docMapper
...
name|copyToStringFromClasspath
argument_list|(
literal|"/org/elasticsearch/index/mapper/json/simple/test1-notype-noid.json"
argument_list|)
decl_stmt|;
name|Document
name|doc
