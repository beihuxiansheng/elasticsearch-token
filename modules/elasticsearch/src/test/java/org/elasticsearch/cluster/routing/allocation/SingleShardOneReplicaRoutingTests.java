...
begin_class
DECL|class|SingleShardOneReplicaRoutingTests
specifier|public
class|class
name|SingleShardOneReplicaRoutingTests
block|{
DECL|field|logger
specifier|private
specifier|final
...
name|info
argument_list|(
literal|"Add another node and perform rerouting, nothing will happen since primary shards not started"
argument_list|)
expr_stmt|;
name|clusterState
operator|=
