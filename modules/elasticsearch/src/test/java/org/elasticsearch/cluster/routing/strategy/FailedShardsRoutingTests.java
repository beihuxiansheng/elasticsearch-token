...
name|info
argument_list|(
literal|"Do another reroute, should try and assign again to node 3"
argument_list|)
expr_stmt|;
name|prevRoutingTable
operator|=
...
expr_stmt|;
block|}
DECL|method|test10ShardsWith1ReplicaFailure
annotation|@
name|Test
specifier|public
name|void
...
argument_list|()
expr_stmt|;
comment|// nothing will change, since primary shards have not started yet
name|assertThat
argument_list|(
name|prevRoutingTable
operator|==
...
name|info
argument_list|(
literal|"Fail backup shards on node2"
argument_list|)
expr_stmt|;
name|routingNodes
operator|=
