...
argument_list|(
name|PingResponseRequestHandler
operator|.
name|ACTION
argument_list|,
operator|new
...
argument_list|)
expr_stmt|;
comment|// bind to receive interface
name|multicastSocket
operator|.
name|bind
argument_list|(
...
block|}
block|}
DECL|class|PingResponseRequestHandler
specifier|private
class|class
name|PingResponseRequestHandler
extends|extends
...
block|}
block|}
DECL|class|WrappedPingResponse
class|class
name|WrappedPingResponse
implements|implements
name|Streamable
...
name|pingResponse
decl_stmt|;
DECL|method|WrappedPingResponse
name|WrappedPingResponse
parameter_list|()
block|{         }
DECL|method|WrappedPingResponse
