...
name|loadClass
argument_list|(
literal|"org.elasticsearch.discovery.jgroups.JgroupsDiscovery"
argument_list|)
expr_stmt|;
name|defaultDiscoveryModule
operator|=
...
name|loadClass
argument_list|(
literal|"org.elasticsearch.discovery.jgroups.JgroupsDiscoveryModule"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
parameter_list|)
block|{
comment|// TODO default to the local one
block|}
name|Class
argument_list|<
name|?
