...
parameter_list|)
block|{
comment|// clean blacklist, it becomes really big, and it can always get regenerated if needed
try|try
block|{
name|Field
name|stateField
...
name|contains
argument_list|(
literal|"InheritingState"
argument_list|)
condition|)
block|{
name|Field
name|blacklistedKeysField
init|=
name|state
operator|.
name|getClass
...
name|ElasticSearchIllegalStateException
argument_list|(
literal|"Failed to clear state from injector"
argument_list|,
name|e
argument_list|)
throw|;
block|}
comment|// clean constructors cache
try|try
block|{
name|Field
name|constructorsField
init|=
name|injector
operator|.
name|getClass
...
name|ElasticSearchIllegalStateException
argument_list|(
literal|"Failed to clear constructors cache from injector"
argument_list|,
name|e
argument_list|)
throw|;
block|}
comment|// clean method cache
try|try
block|{
name|Field
name|membersField
