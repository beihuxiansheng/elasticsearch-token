...
return|;
block|}
comment|/**      * Method for compressing given input data using LZF encoding and      * block structure (compatible with lzf command line utility).      * Result consists of a sequence of chunks.      *      * @since 0.8.1      */
DECL|method|encode
specifier|public
specifier|static
name|byte
...
argument_list|)
decl_stmt|;
comment|// important: may be able to reuse buffers
name|enc
operator|.
name|close
argument_list|()
