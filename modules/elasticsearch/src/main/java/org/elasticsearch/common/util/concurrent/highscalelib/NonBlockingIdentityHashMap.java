...
DECL|method|NonBlockingIdentityHashMap
specifier|public
name|NonBlockingIdentityHashMap
parameter_list|()
block|{
...
block|}
comment|// --- CHM -----------------------------------------------------------------
comment|// The control structure for the NonBlockingIdentityHashMap
DECL|class|CHM
specifier|private
specifier|static
specifier|final
...
begin_comment
comment|// End NonBlockingIdentityHashMap class
end_comment
