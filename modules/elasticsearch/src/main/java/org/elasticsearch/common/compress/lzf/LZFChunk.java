...
literal|0xFFFF
decl_stmt|;
comment|/**      * Header can be either 7 bytes (compressed) or 5 bytes (uncompressed)      * long      */
DECL|field|MAX_HEADER_LEN
specifier|public
specifier|static
specifier|final
name|int
...
return|;
block|}
DECL|method|writeCompressedHeader
specifier|public
specifier|static
name|void
...
return|;
block|}
DECL|method|writeNonCompressedHeader
specifier|public
specifier|static
name|void
