...
name|_map
decl_stmt|;
DECL|method|TObjectFloatIterator
specifier|public
name|TObjectFloatIterator
parameter_list|(
name|TObjectFloatHashMap
...
expr_stmt|;
block|}
comment|/**      * Returns the index of the next value in the data structure      * or a negative value if the iterator is exhausted.      *      * @return an<code>float</code> value      */
