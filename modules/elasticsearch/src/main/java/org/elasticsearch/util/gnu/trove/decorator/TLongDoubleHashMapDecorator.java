...
DECL|method|TLongDoubleHashMapDecorator
specifier|public
name|TLongDoubleHashMapDecorator
parameter_list|()
block|{     }
...
block|}
block|}
comment|/**      * Inserts a key/value pair into the map.      *      * @param key   an<code>Object</code> value      * @param value an<code>Object</code> value      * @return the previous value associated with<tt>key</tt>,      *         or Double(0) if none was found.      */
DECL|method|put
specifier|public
name|Double
name|put
...
expr_stmt|;
block|}
comment|/**      * Deletes a key/value pair from the map.      *      * @param key an<code>Object</code> value      * @return the removed value, or Double(0) if it was not found in the map      */
DECL|method|remove
specifier|public
name|Double
name|remove
...
begin_comment
comment|// TLongDoubleHashMapDecorator
end_comment
