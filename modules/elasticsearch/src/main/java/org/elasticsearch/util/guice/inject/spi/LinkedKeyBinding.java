...
argument_list|>
block|{
comment|/**    * Returns the linked key used to resolve injections. That binding can be retrieved from an    * injector using {@link org.elasticsearch.util.guice.inject.Injector#getBinding(Key) Injector.getBinding(key)}.    */
