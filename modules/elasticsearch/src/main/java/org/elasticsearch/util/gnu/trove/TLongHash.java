...
begin_comment
comment|/**  * An open addressed hashing implementation for long primitives.  *<p/>  * Created: Sun Nov  4 08:56:06 2001  *  * @author Eric D. Friedman  * @version $Id: PHash.template,v 1.2 2007/06/29 22:39:46 robeden Exp $  */
end_comment

begin_class
DECL|class|TLongHash
specifier|abstract
specifier|public
class|class
name|TLongHash
...
decl_stmt|;
comment|/**      * Creates a new<code>TLongHash</code> instance with the default      * capacity and load factor.      */
DECL|method|TLongHash
specifier|public
name|TLongHash
parameter_list|()
block|{
...
expr_stmt|;
block|}
comment|/**      * Creates a new<code>TLongHash</code> instance whose capacity      * is the next highest prime above<tt>initialCapacity + 1</tt>      * unless that value is already prime.      *      * @param initialCapacity an<code>int</code> value      */
DECL|method|TLongHash
specifier|public
name|TLongHash
parameter_list|(
...
expr_stmt|;
block|}
comment|/**      * Creates a new<code>TLongHash</code> instance with a prime      * value at or near the specified capacity and load factor.      *      * @param initialCapacity used to find a prime capacity for the table.      * @param loadFactor      used to calculate the threshold over which      *                        rehashing takes place.      */
DECL|method|TLongHash
specifier|public
name|TLongHash
parameter_list|(
...
return|;
block|}
comment|/**      * Searches the set for<tt>val</tt>      *      * @param val an<code>long</code> value      * @return a<code>boolean</code> value      */
...
expr_stmt|;
block|}
comment|/**      * Locates the index of<tt>val</tt>.      *      * @param val an<code>long</code> value      * @return the index of<tt>val</tt> or -1 if it isn't in the set.      */
DECL|method|index
specifier|protected
name|int
name|index
...
return|;
block|}
comment|/**      * Locates the index at which<tt>val</tt> can be inserted.  if      * there is already a value equal()ing<tt>val</tt> in the set,      * returns that value as a negative integer.      *      * @param val an<code>long</code> value      * @return an<code>int</code> value      */
...
block|}
block|}
comment|/**      * Default implementation of TLongHashingStrategy:      * delegates hashing to HashFunctions.hash(long).      *      * @param val the value to hash      * @return the hashcode.      */
