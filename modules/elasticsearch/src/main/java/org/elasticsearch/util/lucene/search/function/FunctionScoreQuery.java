...
begin_comment
comment|/**  * A query that allows for a pluggable boost function to be applied to it.  *  * @author kimchy (shay.banon)  */
end_comment
...
return|;
block|}
DECL|method|getFunctionProvider
specifier|public
name|FunctionProvider
