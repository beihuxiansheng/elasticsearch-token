...
block|}
block|}
comment|/**    * Converts a constant string binding to the required type.    *    * @return the binding if it could be resolved, or null if the binding doesn't exist    * @throws org.elasticsearch.util.guice.inject.internal.ErrorsException if there was an error resolving the binding    */
