...
argument_list|)
decl_stmt|;
comment|/**    * Returns an annotation instance that is not equal to any other annotation    * instances, for use in creating distinct {@link org.elasticsearch.util.guice.inject.Key}s.    */
DECL|method|create
specifier|public
specifier|static
name|Annotation
