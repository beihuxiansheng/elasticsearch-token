...
return|;
block|}
comment|/**    * Returns a predicate that evaluates to {@code true} if the object being    * tested is an instance of the given class. If the object being tested    * is {@code null} this predicate evaluates to {@code false}.    *    *<p>If you want to filter an {@code Iterable} to narrow its type, consider    * using {@link org.elasticsearch.util.collect.Iterables#filter(Iterable, Class)}    * in preference.    */
annotation|@
name|GwtIncompatible
argument_list|(
...
name|target
decl_stmt|;
DECL|method|IsEqualToPredicate
specifier|private
name|IsEqualToPredicate
parameter_list|(
name|T
...
name|clazz
decl_stmt|;
DECL|method|InstanceOfPredicate
specifier|private
name|InstanceOfPredicate
parameter_list|(
name|Class
...
name|f
decl_stmt|;
DECL|method|CompositionPredicate
specifier|private
name|CompositionPredicate
parameter_list|(
name|Predicate
...
DECL|method|iterableElementsEqual
specifier|private
specifier|static
name|boolean
name|iterableElementsEqual
