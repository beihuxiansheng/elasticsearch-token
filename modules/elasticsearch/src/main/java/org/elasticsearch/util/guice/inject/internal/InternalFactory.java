...
parameter_list|>
block|{
comment|/**    * Creates an object to be injected.    *    * @param context of this injection    * @throws org.elasticsearch.util.guice.inject.internal.ErrorsException if a value cannot be provided    * @return instance to be injected    */
DECL|method|get
name|T
name|get
parameter_list|(
