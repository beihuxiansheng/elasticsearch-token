...
return|;
block|}
comment|/**          * Creates a new node. Uses relaxed write because item can only          * be seen if followed by CAS.          */
DECL|method|Node
name|Node
parameter_list|(
name|Object
...
block|}
block|}
comment|/**      * Unlinks matched nodes encountered in a traversal from head.      */
DECL|method|sweep
specifier|private
name|void
name|sweep
...
expr_stmt|;
block|}
comment|/**      * Inserts the specified element at the tail of this queue.      * As the queue is unbounded, this method will never block or      * return {@code false}.      *      * @return {@code true} (as specified by      *         {@link BlockingQueue#offer(Object,long,TimeUnit) BlockingQueue.offer})      * @throws NullPointerException if the specified element is null      */
DECL|method|offer
specifier|public
name|boolean
name|offer
...
return|;
block|}
comment|/**      * Inserts the specified element at the tail of this queue.      * As the queue is unbounded, this method will never return {@code false}.      *      * @return {@code true} (as specified by      *         {@link BlockingQueue#offer(Object) BlockingQueue.offer})      * @throws NullPointerException if the specified element is null      */
DECL|method|offer
specifier|public
name|boolean
name|offer
...
return|;
block|}
comment|/**      * Always returns {@code Integer.MAX_VALUE} because a      * {@code LinkedTransferQueue} is not capacity constrained.      *      * @return {@code Integer.MAX_VALUE} (as specified by      *         {@link BlockingQueue#remainingCapacity()})      */
...
return|;
block|}
comment|/**      * Saves the state to a stream (that is, serializes it).      *      * @param s the stream      * @serialData All of the elements (each an {@code E}) in      * the proper order, followed by a null      */
