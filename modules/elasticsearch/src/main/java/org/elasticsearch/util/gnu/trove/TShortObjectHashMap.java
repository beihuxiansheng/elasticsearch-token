...
begin_comment
comment|/**  * An open addressed Map implementation for short keys and Object values.  *<p/>  * Created: Sun Nov  4 08:52:45 2001  *  * @author Eric D. Friedman  */
end_comment

begin_class
DECL|class|TShortObjectHashMap
specifier|public
class|class
...
name|_values
decl_stmt|;
comment|/**      * Creates a new<code>TShortObjectHashMap</code> instance with the default      * capacity and load factor.      */
DECL|method|TShortObjectHashMap
specifier|public
name|TShortObjectHashMap
parameter_list|()
block|{
...
expr_stmt|;
block|}
comment|/**      * Creates a new<code>TShortObjectHashMap</code> instance with a prime      * capacity equal to or greater than<tt>initialCapacity</tt> and      * with the default load factor.      *      * @param initialCapacity an<code>int</code> value      */
DECL|method|TShortObjectHashMap
specifier|public
name|TShortObjectHashMap
parameter_list|(
...
expr_stmt|;
block|}
comment|/**      * Creates a new<code>TShortObjectHashMap</code> instance with a prime      * capacity equal to or greater than<tt>initialCapacity</tt> and      * with the specified load factor.      *      * @param initialCapacity an<code>int</code> value      * @param loadFactor      a<code>float</code> value      */
DECL|method|TShortObjectHashMap
specifier|public
name|TShortObjectHashMap
parameter_list|(
...
expr_stmt|;
block|}
comment|/**      * Creates a new<code>TShortObjectHashMap</code> instance with the default      * capacity and load factor.      *      * @param strategy used to compute hash codes and to compare keys.      */
DECL|method|TShortObjectHashMap
specifier|public
name|TShortObjectHashMap
parameter_list|(
...
expr_stmt|;
block|}
comment|/**      * Creates a new<code>TShortObjectHashMap</code> instance whose capacity      * is the next highest prime above<tt>initialCapacity + 1</tt>      * unless that value is already prime.      *      * @param initialCapacity an<code>int</code> value      * @param strategy        used to compute hash codes and to compare keys.      */
DECL|method|TShortObjectHashMap
specifier|public
name|TShortObjectHashMap
parameter_list|(
...
return|;
block|}
comment|/**      * @return a TShortObjectIterator with access to this map's keys and values      */
...
return|;
block|}
comment|/**      * Inserts a key/value pair into the map.      *      * @param key   an<code>short</code> value      * @param value an<code>Object</code> value      * @return the previous value associated with<tt>key</tt>,      *         or {@code null} if none was found.      */
DECL|method|put
specifier|public
name|V
name|put
...
return|;
block|}
comment|/**      * Inserts a key/value pair into the map if the specified key is not already      * associated with a value.      *      * @param key   an<code>short</code> value      * @param value an<code>Object</code> value      * @return the previous value associated with<tt>key</tt>,      *         or {@code null} if none was found.      */
...
expr_stmt|;
block|}
comment|/**      * Deletes a key/value pair from the map.      *      * @param key an<code>short</code> value      * @return an<code>Object</code> value or (short)0 if no such mapping exists.      */
DECL|method|remove
specifier|public
name|V
name|remove
...
return|;
block|}
comment|/**      * Executes<tt>procedure</tt> for each key/value entry in the      * map.      *      * @param procedure a<code>TOShortObjectProcedure</code> value      * @return false if the loop over the entries terminated because      *         the procedure returned false for some entry.      */
