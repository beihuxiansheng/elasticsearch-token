...
argument_list|>
block|{
comment|/**    * Returns the key whose binding is used to {@link Provider#get provide instances}. That binding    * can be retrieved from an injector using {@link org.elasticsearch.util.inject.Injector#getBinding(Key)    * Injector.getBinding(providedKey)}    */
