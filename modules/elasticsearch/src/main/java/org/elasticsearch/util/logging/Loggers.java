...
begin_comment
comment|/**  * A set of utilities around Logging.  *<p/>  *<p>The most important is the {@link #getLogger(Class)} which should be used instead of  * {@link org.slf4j.LoggerFactory#getLogger(Class)}. It will use the package name as the  * logging level without the actual class name.  *  * @author kimchy (Shay Banon)  */
end_comment
