...
parameter_list|()
function_decl|;
comment|/**    * Returns the key for the source binding. That binding can e retrieved from an injector using    * {@link org.elasticsearch.util.guice.inject.Injector#getBinding(Key) Injector.getBinding(key)}.    */
