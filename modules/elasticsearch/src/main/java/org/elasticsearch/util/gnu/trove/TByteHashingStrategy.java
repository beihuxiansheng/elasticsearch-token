...
begin_interface
DECL|interface|TByteHashingStrategy
specifier|public
interface|interface
...
name|Serializable
block|{
comment|/**      * Computes a hash code for the specified byte.  Implementors      * can use the byte's own value or a custom scheme designed to      * minimize collisions for a known set of input.      *      * @param val byte for which the hashcode is to be computed      * @return the hashCode      */
