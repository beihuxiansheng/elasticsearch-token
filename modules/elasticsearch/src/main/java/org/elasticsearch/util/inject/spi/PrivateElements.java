...
begin_comment
comment|/**  * A private collection of elements that are hidden from the enclosing injector or module by  * default. See {@link org.elasticsearch.util.inject.PrivateModule PrivateModule} for details.  *  * @author jessewilson@google.com (Jesse Wilson)  * @since 2.0  */
end_comment
