...
begin_interface
DECL|interface|TIntHashingStrategy
specifier|public
interface|interface
...
name|Serializable
block|{
comment|/**      * Computes a hash code for the specified int.  Implementors      * can use the int's own value or a custom scheme designed to      * minimize collisions for a known set of input.      *      * @param val int for which the hashcode is to be computed      * @return the hashCode      */
