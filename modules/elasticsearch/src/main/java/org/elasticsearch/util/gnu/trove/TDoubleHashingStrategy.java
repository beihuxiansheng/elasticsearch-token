...
begin_interface
DECL|interface|TDoubleHashingStrategy
specifier|public
interface|interface
name|TDoubleHashingStrategy
extends|extends
name|Serializable
block|{
comment|/**      * Computes a hash code for the specified double.  Implementors      * can use the double's own value or a custom scheme designed to      * minimize collisions for a known set of input.      *      * @param val double for which the hashcode is to be computed      * @return the hashCode      */
...
begin_comment
comment|// TDoubleHashingStrategy
end_comment
