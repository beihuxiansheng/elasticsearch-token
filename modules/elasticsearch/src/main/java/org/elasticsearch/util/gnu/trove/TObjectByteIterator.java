...
name|_map
decl_stmt|;
DECL|method|TObjectByteIterator
specifier|public
name|TObjectByteIterator
parameter_list|(
name|TObjectByteHashMap
...
expr_stmt|;
block|}
comment|/**      * Returns the index of the next value in the data structure      * or a negative value if the iterator is exhausted.      *      * @return an<code>byte</code> value      */
