...
return|;
block|}
comment|/**    * Ensures that an {@code Iterable} object passed as a parameter to the    * calling method is not null and contains no null elements.    *    * @param iterable the iterable to check the contents of    * @return the non-null {@code iterable} reference just validated    * @throws NullPointerException if {@code iterable} is null or contains at    *     least one null element    */
...
return|;
block|}
comment|/**    * Ensures that an {@code Iterable} object passed as a parameter to the    * calling method is not null and contains no null elements.    *    * @param iterable the iterable to check the contents of    * @param errorMessage the exception message to use if the check fails; will    *     be converted to a string using {@link String#valueOf(Object)}    * @return the non-null {@code iterable} reference just validated    * @throws NullPointerException if {@code iterable} is null or contains at    *     least one null element    */
DECL|method|checkContentsNotNull
specifier|public
specifier|static
parameter_list|<
...
parameter_list|)
block|{
comment|// A NPE implies that the collection doesn't contain null.
return|return
literal|false
return|;
block|}
