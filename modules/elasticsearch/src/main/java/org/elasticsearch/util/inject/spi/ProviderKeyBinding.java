...
argument_list|>
block|{
comment|/**    * Returns the key used to resolve the provider's binding. That binding can be retrieved from an    * injector using {@link org.elasticsearch.util.inject.Injector#getBinding(Key)    * Injector.getBinding(providerKey)}    */
