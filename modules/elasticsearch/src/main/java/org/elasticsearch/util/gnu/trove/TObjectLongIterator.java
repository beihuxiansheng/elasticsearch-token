...
name|_map
decl_stmt|;
DECL|method|TObjectLongIterator
specifier|public
name|TObjectLongIterator
parameter_list|(
name|TObjectLongHashMap
...
expr_stmt|;
block|}
comment|/**      * Returns the index of the next value in the data structure      * or a negative value if the iterator is exhausted.      *      * @return an<code>long</code> value      */
