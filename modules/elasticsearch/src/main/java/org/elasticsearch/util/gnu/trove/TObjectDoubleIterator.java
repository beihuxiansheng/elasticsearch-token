...
name|_map
decl_stmt|;
DECL|method|TObjectDoubleIterator
specifier|public
name|TObjectDoubleIterator
parameter_list|(
name|TObjectDoubleHashMap
...
expr_stmt|;
block|}
comment|/**      * Returns the index of the next value in the data structure      * or a negative value if the iterator is exhausted.      *      * @return an<code>double</code> value      */
