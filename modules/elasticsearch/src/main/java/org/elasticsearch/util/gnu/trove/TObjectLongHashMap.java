...
begin_comment
comment|/**  * An open addressed Map implementation for Object keys and long values.  *<p/>  * Created: Sun Nov  4 08:52:45 2001  *  * @author Eric D. Friedman  */
end_comment

begin_class
DECL|class|TObjectLongHashMap
specifier|public
class|class
...
name|_values
decl_stmt|;
comment|/**      * Creates a new<code>TObjectLongHashMap</code> instance with the default      * capacity and load factor.      */
DECL|method|TObjectLongHashMap
specifier|public
name|TObjectLongHashMap
parameter_list|()
block|{
...
expr_stmt|;
block|}
comment|/**      * Creates a new<code>TObjectLongHashMap</code> instance with a prime      * capacity equal to or greater than<tt>initialCapacity</tt> and      * with the default load factor.      *      * @param initialCapacity an<code>int</code> value      */
DECL|method|TObjectLongHashMap
specifier|public
name|TObjectLongHashMap
parameter_list|(
...
expr_stmt|;
block|}
comment|/**      * Creates a new<code>TObjectLongHashMap</code> instance with a prime      * capacity equal to or greater than<tt>initialCapacity</tt> and      * with the specified load factor.      *      * @param initialCapacity an<code>int</code> value      * @param loadFactor      a<code>float</code> value      */
DECL|method|TObjectLongHashMap
specifier|public
name|TObjectLongHashMap
parameter_list|(
...
expr_stmt|;
block|}
comment|/**      * Creates a new<code>TObjectLongHashMap</code> instance with the default      * capacity and load factor.      *      * @param strategy used to compute hash codes and to compare keys.      */
DECL|method|TObjectLongHashMap
specifier|public
name|TObjectLongHashMap
parameter_list|(
...
expr_stmt|;
block|}
comment|/**      * Creates a new<code>TObjectLongHashMap</code> instance whose capacity      * is the next highest prime above<tt>initialCapacity + 1</tt>      * unless that value is already prime.      *      * @param initialCapacity an<code>int</code> value      * @param strategy        used to compute hash codes and to compare keys.      */
DECL|method|TObjectLongHashMap
specifier|public
name|TObjectLongHashMap
parameter_list|(
...
return|;
block|}
comment|/**      * Inserts a key/value pair into the map.      *      * @param key   an<code>Object</code> value      * @param value an<code>long</code> value      * @return the previous value associated with<tt>key</tt>,      *         or (long)0 if none was found.      */
DECL|method|put
specifier|public
name|long
name|put
...
return|;
block|}
comment|/**      * Inserts a key/value pair into the map if the specified key is not already      * associated with a value.      *      * @param key   an<code>Object</code> value      * @param value an<code>long</code> value      * @return the previous value associated with<tt>key</tt>,      *         or (long)0 if none was found.      */
...
block|}
block|}
comment|/**      * retrieves the value for<tt>key</tt>      *      * @param key an<code>Object</code> value      * @return the value of<tt>key</tt> or (long)0 if no such mapping exists.      */
DECL|method|get
specifier|public
name|long
name|get
...
expr_stmt|;
block|}
comment|/**      * Deletes a key/value pair from the map.      *      * @param key an<code>Object</code> value      * @return an<code>long</code> value or (long)0 if no such mapping exists.      */
DECL|method|remove
specifier|public
name|long
name|remove
...
return|;
block|}
comment|/**      * Executes<tt>procedure</tt> for each key/value entry in the      * map.      *      * @param procedure a<code>TOObjectLongProcedure</code> value      * @return false if the loop over the entries terminated because      *         the procedure returned false for some entry.      */
