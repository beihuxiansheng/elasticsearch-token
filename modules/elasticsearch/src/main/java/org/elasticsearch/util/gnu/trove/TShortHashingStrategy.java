...
begin_interface
DECL|interface|TShortHashingStrategy
specifier|public
interface|interface
...
name|Serializable
block|{
comment|/**      * Computes a hash code for the specified short.  Implementors      * can use the short's own value or a custom scheme designed to      * minimize collisions for a known set of input.      *      * @param val short for which the hashcode is to be computed      * @return the hashCode      */
