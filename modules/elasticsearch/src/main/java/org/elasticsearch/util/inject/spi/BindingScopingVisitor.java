...
parameter_list|)
function_decl|;
comment|/**    * Visit a scope annotation. This scope strategy is found only on module bindings. The instance    * that implements this scope is registered by {@link org.elasticsearch.util.inject.Binder#bindScope(Class,    * Scope) Binder.bindScope()}.    */
