...
begin_comment
comment|/**  * An open addressed Map implementation for short keys and int values.  *<p/>  * Created: Sun Nov  4 08:52:45 2001  *  * @author Eric D. Friedman  */
end_comment

begin_class
DECL|class|TShortIntHashMap
specifier|public
class|class
...
name|_values
decl_stmt|;
comment|/**      * Creates a new<code>TShortIntHashMap</code> instance with the default      * capacity and load factor.      */
DECL|method|TShortIntHashMap
specifier|public
name|TShortIntHashMap
parameter_list|()
block|{
...
expr_stmt|;
block|}
comment|/**      * Creates a new<code>TShortIntHashMap</code> instance with a prime      * capacity equal to or greater than<tt>initialCapacity</tt> and      * with the default load factor.      *      * @param initialCapacity an<code>int</code> value      */
DECL|method|TShortIntHashMap
specifier|public
name|TShortIntHashMap
parameter_list|(
...
expr_stmt|;
block|}
comment|/**      * Creates a new<code>TShortIntHashMap</code> instance with a prime      * capacity equal to or greater than<tt>initialCapacity</tt> and      * with the specified load factor.      *      * @param initialCapacity an<code>int</code> value      * @param loadFactor      a<code>float</code> value      */
DECL|method|TShortIntHashMap
specifier|public
name|TShortIntHashMap
parameter_list|(
...
expr_stmt|;
block|}
comment|/**      * Creates a new<code>TShortIntHashMap</code> instance with the default      * capacity and load factor.      *      * @param strategy used to compute hash codes and to compare keys.      */
DECL|method|TShortIntHashMap
specifier|public
name|TShortIntHashMap
parameter_list|(
...
expr_stmt|;
block|}
comment|/**      * Creates a new<code>TShortIntHashMap</code> instance whose capacity      * is the next highest prime above<tt>initialCapacity + 1</tt>      * unless that value is already prime.      *      * @param initialCapacity an<code>int</code> value      * @param strategy        used to compute hash codes and to compare keys.      */
DECL|method|TShortIntHashMap
specifier|public
name|TShortIntHashMap
parameter_list|(
...
return|;
block|}
comment|/**      * @return a TShortIntIterator with access to this map's keys and values      */
...
return|;
block|}
comment|/**      * Inserts a key/value pair into the map.      *      * @param key   an<code>short</code> value      * @param value an<code>int</code> value      * @return the previous value associated with<tt>key</tt>,      *         or (short)0 if none was found.      */
DECL|method|put
specifier|public
name|int
name|put
...
return|;
block|}
comment|/**      * Inserts a key/value pair into the map if the specified key is not already      * associated with a value.      *      * @param key   an<code>short</code> value      * @param value an<code>int</code> value      * @return the previous value associated with<tt>key</tt>,      *         or (short)0 if none was found.      */
...
expr_stmt|;
block|}
comment|/**      * Deletes a key/value pair from the map.      *      * @param key an<code>short</code> value      * @return an<code>int</code> value, or (short)0 if no mapping for key exists      */
DECL|method|remove
specifier|public
name|int
name|remove
...
return|;
block|}
comment|/**      * Executes<tt>procedure</tt> for each key/value entry in the      * map.      *      * @param procedure a<code>TOShortIntProcedure</code> value      * @return false if the loop over the entries terminated because      *         the procedure returned false for some entry.      */
