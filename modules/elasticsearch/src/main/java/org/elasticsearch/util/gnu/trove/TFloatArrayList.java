...
begin_comment
comment|/**  * A resizable, array-backed list of float primitives.  *<p/>  * Created: Sat Dec 29 14:21:12 2001  *  * @author Eric D. Friedman  * @author Rob Eden  */
end_comment

begin_class
DECL|class|TFloatArrayList
specifier|public
class|class
...
literal|10
decl_stmt|;
comment|/**      * Creates a new<code>TFloatArrayList</code> instance with the      * default capacity.      */
DECL|method|TFloatArrayList
specifier|public
name|TFloatArrayList
parameter_list|()
block|{
...
expr_stmt|;
block|}
comment|/**      * Creates a new<code>TFloatArrayList</code> instance with the      * specified capacity.      *      * @param capacity an<code>int</code> value      */
DECL|method|TFloatArrayList
specifier|public
name|TFloatArrayList
parameter_list|(
...
expr_stmt|;
block|}
comment|/**      * Creates a new<code>TFloatArrayList</code> instance whose      * capacity is the greater of the length of<tt>values</tt> and      * DEFAULT_CAPACITY and whose initial contents are the specified      * values.      *      * @param values an<code>float[]</code> value      */
DECL|method|TFloatArrayList
specifier|public
name|TFloatArrayList
parameter_list|(
...
block|}
comment|// sizing
comment|/**      * Grow the internal array as needed to accommodate the specified      * number of elements.  The size of the array floats on each      * resize unless<tt>capacity</tt> requires more than twice the      * current capacity.      *      * @param capacity an<code>int</code> value      */
...
block|}
comment|// modifying
comment|/**      * Adds<tt>val</tt> to the end of the list, growing as needed.      *      * @param val an<code>float</code> value      */
DECL|method|add
specifier|public
name|void
name|add
...
expr_stmt|;
block|}
comment|/**      * Adds the values in the array<tt>vals</tt> to the end of the      * list, in order.      *      * @param vals an<code>float[]</code> value      */
DECL|method|add
specifier|public
name|void
name|add
...
expr_stmt|;
block|}
comment|/**      * Adds a subset of the values in the array<tt>vals</tt> to the      * end of the list, in order.      *      * @param vals   an<code>float[]</code> value      * @param offset the offset at which to start copying      * @param length the number of values to copy.      */
DECL|method|add
specifier|public
name|void
name|add
...
expr_stmt|;
block|}
comment|/**      * Inserts<tt>value</tt> into the list at<tt>offset</tt>.  All      * values including and to the right of<tt>offset</tt> are shifted      * to the right.      *      * @param offset an<code>int</code> value      * @param value  an<code>float</code> value      */
DECL|method|insert
specifier|public
name|void
name|insert
...
expr_stmt|;
block|}
comment|/**      * Inserts the array of<tt>values</tt> into the list at      *<tt>offset</tt>.  All values including and to the right of      *<tt>offset</tt> are shifted to the right.      *      * @param offset an<code>int</code> value      * @param values an<code>float[]</code> value      */
DECL|method|insert
specifier|public
name|void
name|insert
...
expr_stmt|;
block|}
comment|/**      * Returns the value at the specified offset.      *      * @param offset an<code>int</code> value      * @return an<code>float</code> value      */
DECL|method|get
specifier|public
name|float
name|get
...
return|;
block|}
comment|/**      * Returns the value at the specified offset without doing any      * bounds checking.      *      * @param offset an<code>int</code> value      * @return an<code>float</code> value      */
...
return|;
block|}
comment|/**      * Sets the value at the specified offset.      *      * @param offset an<code>int</code> value      * @param val    an<code>float</code> value      */
DECL|method|set
specifier|public
name|void
name|set
...
expr_stmt|;
block|}
comment|/**      * Sets the value at the specified offset and returns the      * previously stored value.      *      * @param offset an<code>int</code> value      * @param val    an<code>float</code> value      * @return the value previously stored at offset.      */
DECL|method|getSet
specifier|public
name|float
name|getSet
...
expr_stmt|;
block|}
comment|/**      * Sets the value at the specified offset without doing any bounds      * checking.      *      * @param offset an<code>int</code> value      * @param val    an<code>float</code> value      */
...
comment|// value
block|}
comment|/**      * Transform each value in the list using the specified function.      *      * @param function a<code>TFloatFunction</code> value      */
...
return|;
block|}
comment|/**      * Copies the contents of the list into a native array.      *      * @return an<code>float[]</code> value      */
...
return|;
block|}
comment|/**      * Copies a slice of the list into a native array.      *      * @param offset the offset at which to start copying      * @param len    the number of values to copy.      * @return an<code>float[]</code> value      */
DECL|method|toNativeArray
specifier|public
name|float
index|[]
...
block|}
comment|// comparing
comment|/**      * Compares this list to another list, value by value.      *      * @param other the object to compare against      * @return true if other is a TFloatArrayList and has exactly the      *         same values.      */
DECL|method|equals
specifier|public
name|boolean
name|equals
...
block|}
comment|// procedures
comment|/**      * Applies the procedure to each value in the list in ascending      * (front to back) order.      *      * @param procedure a<code>TFloatProcedure</code> value      * @return true if the procedure did not terminate prematurely.      */
DECL|method|forEach
specifier|public
name|boolean
name|forEach
...
return|;
block|}
comment|/**      * Applies the procedure to each value in the list in descending      * (back to front) order.      *      * @param procedure a<code>TFloatProcedure</code> value      * @return true if the procedure did not terminate prematurely.      */
...
block|}
comment|/**      * Searches the list front to back for the index of      *<tt>value</tt>.      *      * @param value an<code>float</code> value      * @return the first offset of the value, or -1 if it is not in      *         the list.      * @see #binarySearch for faster searches on sorted lists      */
DECL|method|indexOf
specifier|public
name|int
name|indexOf
...
return|;
block|}
comment|/**      * Searches the list back to front for the last index of      *<tt>value</tt>.      *      * @param value an<code>float</code> value      * @return the last offset of the value, or -1 if it is not in      *         the list.      * @see #binarySearch for faster searches on sorted lists      */
...
return|;
block|}
comment|/**      * Searches the list for<tt>value</tt>      *      * @param value an<code>float</code> value      * @return true if value is in the list.      */
