...
begin_comment
comment|/**  * An open addressed Map implementation for Object keys and int values.  *<p/>  * Created: Sun Nov  4 08:52:45 2001  *  * @author Eric D. Friedman  */
end_comment

begin_class
DECL|class|TObjectIntHashMap
specifier|public
class|class
...
name|_values
decl_stmt|;
comment|/**      * Creates a new<code>TObjectIntHashMap</code> instance with the default      * capacity and load factor.      */
DECL|method|TObjectIntHashMap
specifier|public
name|TObjectIntHashMap
parameter_list|()
block|{
...
expr_stmt|;
block|}
comment|/**      * Creates a new<code>TObjectIntHashMap</code> instance with a prime      * capacity equal to or greater than<tt>initialCapacity</tt> and      * with the default load factor.      *      * @param initialCapacity an<code>int</code> value      */
DECL|method|TObjectIntHashMap
specifier|public
name|TObjectIntHashMap
parameter_list|(
...
expr_stmt|;
block|}
comment|/**      * Creates a new<code>TObjectIntHashMap</code> instance with a prime      * capacity equal to or greater than<tt>initialCapacity</tt> and      * with the specified load factor.      *      * @param initialCapacity an<code>int</code> value      * @param loadFactor      a<code>float</code> value      */
DECL|method|TObjectIntHashMap
specifier|public
name|TObjectIntHashMap
parameter_list|(
...
expr_stmt|;
block|}
comment|/**      * Creates a new<code>TObjectIntHashMap</code> instance with the default      * capacity and load factor.      *      * @param strategy used to compute hash codes and to compare keys.      */
DECL|method|TObjectIntHashMap
specifier|public
name|TObjectIntHashMap
parameter_list|(
...
expr_stmt|;
block|}
comment|/**      * Creates a new<code>TObjectIntHashMap</code> instance whose capacity      * is the next highest prime above<tt>initialCapacity + 1</tt>      * unless that value is already prime.      *      * @param initialCapacity an<code>int</code> value      * @param strategy        used to compute hash codes and to compare keys.      */
DECL|method|TObjectIntHashMap
specifier|public
name|TObjectIntHashMap
parameter_list|(
...
return|;
block|}
comment|/**      * Inserts a key/value pair into the map.      *      * @param key   an<code>Object</code> value      * @param value an<code>int</code> value      * @return the previous value associated with<tt>key</tt>,      *         or (int)0 if none was found.      */
DECL|method|put
specifier|public
name|int
name|put
...
return|;
block|}
comment|/**      * Inserts a key/value pair into the map if the specified key is not already      * associated with a value.      *      * @param key   an<code>Object</code> value      * @param value an<code>int</code> value      * @return the previous value associated with<tt>key</tt>,      *         or (int)0 if none was found.      */
...
block|}
block|}
comment|/**      * retrieves the value for<tt>key</tt>      *      * @param key an<code>Object</code> value      * @return the value of<tt>key</tt> or (int)0 if no such mapping exists.      */
DECL|method|get
specifier|public
name|int
name|get
...
expr_stmt|;
block|}
comment|/**      * Deletes a key/value pair from the map.      *      * @param key an<code>Object</code> value      * @return an<code>int</code> value or (int)0 if no such mapping exists.      */
DECL|method|remove
specifier|public
name|int
name|remove
...
return|;
block|}
comment|/**      * Executes<tt>procedure</tt> for each key/value entry in the      * map.      *      * @param procedure a<code>TOObjectIntProcedure</code> value      * @return false if the loop over the entries terminated because      *         the procedure returned false for some entry.      */
