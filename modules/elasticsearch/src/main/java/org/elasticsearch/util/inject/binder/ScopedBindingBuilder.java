...
parameter_list|)
function_decl|;
comment|/**    * Instructs the {@link org.elasticsearch.util.inject.Injector} to eagerly initialize this    * singleton-scoped binding upon creation. Useful for application    * initialization logic.  See the EDSL examples at    * {@link org.elasticsearch.util.inject.Binder}.    */
