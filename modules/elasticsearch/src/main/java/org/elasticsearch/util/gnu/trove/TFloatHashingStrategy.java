...
begin_interface
DECL|interface|TFloatHashingStrategy
specifier|public
interface|interface
...
name|Serializable
block|{
comment|/**      * Computes a hash code for the specified float.  Implementors      * can use the float's own value or a custom scheme designed to      * minimize collisions for a known set of input.      *      * @param val float for which the hashcode is to be computed      * @return the hashCode      */
