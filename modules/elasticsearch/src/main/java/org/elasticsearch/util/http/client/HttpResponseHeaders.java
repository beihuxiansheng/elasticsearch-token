...
begin_class
DECL|class|HttpResponseHeaders
specifier|public
specifier|abstract
class|class
...
argument_list|>
block|{
DECL|field|traillingHeaders
specifier|private
specifier|final
name|boolean
name|traillingHeaders
decl_stmt|;
DECL|method|HttpResponseHeaders
specifier|public
name|HttpResponseHeaders
parameter_list|(
name|Url
...
expr_stmt|;
block|}
comment|/**      * Return the HTTP header      *      * @return an {@link Headers}      */
...
parameter_list|()
function_decl|;
comment|/**      * Return true is headers has been received after the response body.      *      * @return true is headers has been received after the response body.      */
DECL|method|isTraillingHeadersReceived
specifier|public
name|boolean
name|isTraillingHeadersReceived
parameter_list|()
block|{
return|return
name|traillingHeaders
