...
parameter_list|)
function_decl|;
comment|/**    * Visit a binding to a {@link org.elasticsearch.util.inject.Provider} that delegates to the binding for the    * provided type. This target is found only on injector bindings.    */
DECL|method|visit
name|V
name|visit
parameter_list|(
