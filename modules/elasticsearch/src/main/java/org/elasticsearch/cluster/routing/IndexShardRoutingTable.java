...
return|;
block|}
comment|/**      * Returns a regular shard iterator.      */
...
return|;
block|}
comment|/**      * Prefers execution on the local node if applicable.      */
DECL|method|preferLocalShardsIt
specifier|public
name|ShardIterator
...
expr_stmt|;
block|}
comment|// find the local one, and push it upfront
for|for
control|(
name|int
name|i
...
return|;
block|}
comment|/**      * Returns a random shards iterator.      */
