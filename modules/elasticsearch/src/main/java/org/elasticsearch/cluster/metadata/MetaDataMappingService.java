...
argument_list|)
expr_stmt|;
comment|// we also add it to the registered parsed mapping, since that's what we do when we merge
comment|// and, we won't wait for it to be created on this master node
name|IndexService
name|indexService
init|=
name|indicesService
