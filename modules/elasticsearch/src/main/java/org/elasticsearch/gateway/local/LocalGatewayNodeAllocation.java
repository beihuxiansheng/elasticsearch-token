...
name|StringBuilder
argument_list|(
literal|"failures when trying to list started shards on nodes:"
argument_list|)
decl_stmt|;
for|for
control|(
...
argument_list|)
decl_stmt|;
comment|// check if we need to throttle, NOTE, we don't check on NO since it does not apply
comment|// since this is our master data!
if|if
condition|(
name|nodeAllocations
operator|.
