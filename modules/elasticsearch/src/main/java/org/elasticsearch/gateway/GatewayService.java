...
comment|// also, don't reroute (or even initialize the routing table) for the indices created, we will do it
comment|// in one batch once creating those indices is done
for|for
control|(
specifier|final
name|IndexMetaData
...
name|submitStateUpdateTask
argument_list|(
literal|"gateway (marked as read, reroute, reason="
operator|+
name|reason
operator|+
literal|")"
...
name|info
argument_list|(
literal|"all indices created and rerouting has begun"
argument_list|)
expr_stmt|;
block|}
block|}
