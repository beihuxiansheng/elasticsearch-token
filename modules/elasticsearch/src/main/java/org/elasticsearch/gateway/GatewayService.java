...
decl_stmt|;
DECL|field|delayIndexCreation
specifier|private
specifier|final
name|TimeValue
name|delayIndexCreation
decl_stmt|;
...
comment|// TODO we need to maintain, on the cluster state, a flag that states if it was read from the gateway or not
comment|// so if we delay, and the first master failed to start, others will load it
name|this
operator|.
name|delayIndexCreation
operator|=
