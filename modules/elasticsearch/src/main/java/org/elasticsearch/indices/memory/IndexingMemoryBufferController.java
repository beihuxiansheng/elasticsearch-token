...
name|indexingBuffer
decl_stmt|;
DECL|field|inactiveShardIndexBufferSize
specifier|private
specifier|final
name|ByteSizeValue
name|inactiveShardIndexBufferSize
decl_stmt|;
...
name|getAsBytesSize
argument_list|(
literal|"inactive_shard_index_buffer_size"
argument_list|,
operator|new
name|ByteSizeValue
argument_list|(
...
name|debug
argument_list|(
literal|"using index_buffer_size [{}], with min_shard_index_buffer_size [{}], max_shard_index_buffer_size [{}], inactive_shard_index_buffer_size [{}], shard_inactive_time [{}]"
argument_list|,
name|this
operator|.
name|indexingBuffer
