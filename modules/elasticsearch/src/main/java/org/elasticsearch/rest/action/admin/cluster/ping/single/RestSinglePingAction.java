...
begin_package
DECL|package|org.elasticsearch.rest.action.admin.cluster.ping.single
package|package
name|org
operator|.
name|elasticsearch
...
begin_class
DECL|class|RestSinglePingAction
specifier|public
class|class
...
block|{
DECL|method|RestSinglePingAction
annotation|@
name|Inject
specifier|public
name|RestSinglePingAction
...
name|GET
argument_list|,
literal|"/_cluster/{index}/{type}/{id}/_ping"
argument_list|,
name|this
argument_list|)
expr_stmt|;
