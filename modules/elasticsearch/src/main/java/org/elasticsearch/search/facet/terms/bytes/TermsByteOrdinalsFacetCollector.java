...
begin_class
DECL|class|TermsByteOrdinalsFacetCollector
specifier|public
class|class
name|TermsByteOrdinalsFacetCollector
extends|extends
name|AbstractFacetCollector
block|{
...
name|excluded
decl_stmt|;
DECL|method|TermsByteOrdinalsFacetCollector
specifier|public
name|TermsByteOrdinalsFacetCollector
parameter_list|(
name|String
...
name|fieldName
operator|+
literal|"] doesn't have a type, can't run terms byte facet collector on it"
argument_list|)
throw|;
block|}
else|else
...
name|fieldName
operator|+
literal|"] is not of byte type, can't run terms byte facet collector on it"
argument_list|)
throw|;
block|}
name|this
