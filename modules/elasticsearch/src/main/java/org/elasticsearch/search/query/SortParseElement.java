...
argument_list|)
decl_stmt|;
DECL|field|SCRIPT_FIELD_NAME
specifier|public
specifier|static
specifier|final
name|String
name|SCRIPT_FIELD_NAME
init|=
literal|"_script"
decl_stmt|;
...
literal|"_doc"
decl_stmt|;
DECL|field|GEO_DISTANCE_FIELD_NAME
specifier|public
specifier|static
specifier|final
name|String
name|GEO_DISTANCE_FIELD_NAME
init|=
...
condition|)
block|{
comment|//TODO move to pluggable parsers, similar to facets. Builders already exists...
...
block|}
block|}
comment|/**      *<pre>      * "_script" : {      *      "script" : "doc[...]",      *      "order" : "asc"      * }      *</pre>      */
DECL|method|addScriptSortField
specifier|private
name|void
name|addScriptSortField
parameter_list|(
...
expr_stmt|;
block|}
comment|/**      *<pre>      * "_geo_distance" : {      *      "pin.location" : {      *      *      },      *      "order" : "asc"      * }      *</pre>      */
DECL|method|addGeoDistanceSortField
specifier|private
name|void
name|addGeoDistanceSortField
parameter_list|(
