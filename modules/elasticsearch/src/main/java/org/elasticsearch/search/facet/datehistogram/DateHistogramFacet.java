...
begin_comment
comment|/**  * A date histogram facet.  *  * @author kimchy (shay.banon)  */
end_comment

begin_interface
DECL|interface|DateHistogramFacet
specifier|public
interface|interface
...
name|Entry
block|{
comment|/**          * The time bucket start (in milliseconds).          */
DECL|method|time
name|long
name|time
parameter_list|()
