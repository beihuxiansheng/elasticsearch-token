...
begin_comment
comment|/**  * A custom directory that allows to forceSync (since the actual directory might disable it)  *  * @author kimchy (shay.banon)  */
end_comment

begin_interface
DECL|interface|ForceSyncDirectory
specifier|public
interface|interface
