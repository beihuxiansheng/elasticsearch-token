...
begin_comment
comment|/**  * Merge policy that tries to balance not doing large  * segment merges with not accumulating too many segments in  * the index, to provide for better performance in near  * real-time setting.  *<p/>  *<p>This is based on code from zoie, described in more detail  * at http://code.google.com/p/zoie/wiki/ZoieMergePolicy.</p>  *<p/>  *<p>See: https://issues.apache.org/jira/browse/LUCENE-1924</p>  */
end_comment

begin_comment
comment|// TODO monitor against Lucene 3.0 trunk, once we move to 3.0 remove this.
end_comment
