...
block|}
block|}
comment|// remove all version except for deletes, which we expire based on GC value
name|long
name|time
init|=
name|threadPool
...
argument_list|)
expr_stmt|;
comment|// we commit here on a fresh index since we want to have a commit point to support snapshotting
if|if
condition|(
name|create
condition|)
