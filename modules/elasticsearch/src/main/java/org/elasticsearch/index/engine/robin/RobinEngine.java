...
condition|)
block|{
comment|// if we force, we might not have committed, we need to check that its the same id
name|Map
argument_list|<
name|String
argument_list|,
...
condition|)
block|{
comment|// we did not commit anything, revert to the old translog
name|translog
operator|.
