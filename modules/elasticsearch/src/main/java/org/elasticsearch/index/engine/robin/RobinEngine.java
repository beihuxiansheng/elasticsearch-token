...
literal|0
decl_stmt|;
DECL|field|postFlushSearcher
specifier|private
specifier|volatile
name|Searcher
name|postFlushSearcher
decl_stmt|;
DECL|field|flushing
specifier|private
specifier|final
...
expr_stmt|;
block|}
comment|// only need to load for this flush version searcher, since we keep a map for all
comment|// the changes since the previous flush in memory
name|postFlushSearcher
operator|=
name|searcher
argument_list|()
