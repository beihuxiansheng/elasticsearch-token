...
block|{
comment|// if we have a commit point, check that we have all the files listed in it
if|if
condition|(
operator|!
name|commitPoints
...
name|trace
argument_list|(
literal|"not_recovering [{}], exists in local store and has same length [{}]"
argument_list|,
name|fileInfo
operator|.
name|physicalName
...
name|trace
argument_list|(
literal|"recovering [{}], exists in local store but has different length: gateway [{}], local [{}]"
argument_list|,
name|fileInfo
operator|.
name|physicalName
...
block|}
block|}
DECL|method|writeCommitPoint
specifier|private
name|void
name|writeCommitPoint
parameter_list|(
name|CommitPoint
name|commitPoint
parameter_list|)
