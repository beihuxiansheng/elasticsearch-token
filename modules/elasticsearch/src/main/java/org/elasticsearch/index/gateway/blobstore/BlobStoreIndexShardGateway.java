...
condition|)
block|{
comment|// we have reached the end of hte stream, we wrote partial operations, ignore the exception...
block|}
else|else
block|{
throw|throw
...
condition|)
block|{
comment|// flush the index, so we generate a new translog based on a new index version
name|indexShard
operator|.
name|flush
argument_list|(
