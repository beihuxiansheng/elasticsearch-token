...
expr_stmt|;
block|}
comment|/**      * Constructs a new analyzer component, with the index name and its settings and the analyzer name.      *      * @param index          The index name      * @param indexSettings  The index settings      * @param prefixSettings A settings prefix (like "com.mycompany") to simplify extracting the component settings      * @param name           The analyzer name      */
DECL|method|AbstractIndexAnalyzerProvider
specifier|public
name|AbstractIndexAnalyzerProvider
parameter_list|(
