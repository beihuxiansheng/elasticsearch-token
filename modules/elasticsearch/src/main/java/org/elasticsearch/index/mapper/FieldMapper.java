...
parameter_list|>
block|{
comment|/**      * The name of the field (this is not what we store in the index).      */
DECL|method|name
name|String
name|name
parameter_list|()
...
parameter_list|()
function_decl|;
comment|/**      * The full name of the field. If it is under a certain context (for example,      * in json it exists within an object with a given name), then the context      * will be included. Expected to end with the {@link #name()}.      */
