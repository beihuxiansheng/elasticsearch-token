...
begin_class
DECL|class|AbstractDoubleConcurrentMapFilterCache
specifier|public
specifier|abstract
class|class
...
name|weakCache
decl_stmt|;
DECL|method|AbstractDoubleConcurrentMapFilterCache
specifier|protected
name|AbstractDoubleConcurrentMapFilterCache
parameter_list|(
name|Index
...
return|return
operator|new
name|FilterWeakCacheFilterWrapper
argument_list|(
name|filterToCache
argument_list|,
name|this
...
return|;
block|}
comment|// check if its in the weak cache, if so, move it from weak to soft
name|ConcurrentMap
argument_list|<
name|Filter
argument_list|,
...
block|}
block|}
DECL|class|FilterWeakCacheFilterWrapper
specifier|static
class|class
name|FilterWeakCacheFilterWrapper
extends|extends
...
name|cache
decl_stmt|;
DECL|method|FilterWeakCacheFilterWrapper
name|FilterWeakCacheFilterWrapper
parameter_list|(
name|Filter
name|filter
...
name|docSet
decl_stmt|;
comment|// first check if its in the actual cache
name|ConcurrentMap
argument_list|<
name|Filter
argument_list|,
...
block|}
block|}
comment|// now, handle it in the weak cache
name|ConcurrentMap
argument_list|<
name|Filter
argument_list|,
