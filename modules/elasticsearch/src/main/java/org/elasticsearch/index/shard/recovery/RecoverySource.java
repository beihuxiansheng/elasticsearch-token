...
name|debug
argument_list|(
literal|"using concurrent_streams [{}], file_chunk_size [{}], translog_size [{}], translog_ops [{}], and compress [{}]"
argument_list|,
name|concurrentStreams
argument_list|,
name|fileChunkSize
...
name|info
argument_list|(
literal|"updating [index.shard.recovery.concurrent_streams] from [{}] to [{}]"
argument_list|,
name|RecoverySource
operator|.
name|this
