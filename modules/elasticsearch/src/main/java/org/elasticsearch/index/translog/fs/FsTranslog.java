...
argument_list|)
decl_stmt|;
comment|// use channel#write and not raf#write since it allows for concurrent writes
comment|// with regards to positions
name|raf
operator|.
name|channel
argument_list|()
...
argument_list|)
expr_stmt|;
comment|// sync here, so we make sure we read back teh data?
if|if
condition|(
name|useStream
condition|)
