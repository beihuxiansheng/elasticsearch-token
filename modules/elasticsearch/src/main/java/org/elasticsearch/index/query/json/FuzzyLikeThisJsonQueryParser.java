...
begin_comment
comment|/**  *<pre>  * {  *  fuzzyLikeThis : {  *      maxNumTerms : 12,  *      boost : 1.1,  *      fields : ["field1", "field2"]  *      likeText : "..."  *  }  * }  *</pre>  *  * @author kimchy (shay.banon)  */
end_comment
...
name|index
argument_list|,
literal|"fuzzyLikeThis requires 'likeText' to be specified"
argument_list|)
throw|;
block|}
name|FuzzyLikeThisQuery
