...
block|}
block|}
comment|// FROM HERE: When we move to a single remote call with all shard requests to the same node, then
comment|// the below classes can help
DECL|class|ShardsTransportHandler
class|class
name|ShardsTransportHandler
extends|extends
name|BaseTransportRequestHandler
argument_list|<
name|ShardsRequest
...
name|warn
argument_list|(
literal|"Failed to send broadcast response"
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
parameter_list|()
block|{
comment|// we handle the forking here...
return|return
literal|false
return|;
block|}
block|}
DECL|class|ShardsResponse
class|class
name|ShardsResponse
