...
return|;
block|}
comment|/**      * Sets the JSON source to index.      *      *<p>Note, its preferable to either set it using {@link #source(org.elasticsearch.util.xcontent.builder.XContentBuilder)}      * or using the {@link #source(byte[])}.      */
DECL|method|source
annotation|@
name|Required
specifier|public
