...
expr_stmt|;
block|}
DECL|method|getParsedTimestamp
specifier|public
name|long
...
block|{              }
block|}
comment|// The timestamp is always set as a parsable long
return|return
operator|-
literal|1
return|;
block|}
DECL|method|generateTimestamp
specifier|public
name|IndexRequest
...
return|;
block|}
DECL|method|unsafeSourceOffset
specifier|public
name|int
name|unsafeSourceOffset
parameter_list|()
block|{
return|return
name|this
...
return|;
block|}
DECL|method|unsafeSourceLength
specifier|public
name|int
name|unsafeSourceLength
parameter_list|()
block|{
return|return
name|this
...
return|;
block|}
DECL|method|processRoutingAndTimestamp
specifier|public
name|void
name|processRoutingAndTimestamp
parameter_list|(
name|MappingMetaData
name|mappingMd
parameter_list|)
...
throw|;
block|}
comment|// Process parsed timestamp found in source
if|if
condition|(
name|shouldParseTimestamp
operator|&&
