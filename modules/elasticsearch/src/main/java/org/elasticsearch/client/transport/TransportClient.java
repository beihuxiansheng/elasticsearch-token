...
argument_list|)
expr_stmt|;
comment|// disabled, still having problems with jgroups acting just as client
if|if
condition|(
name|settings
operator|.
...
expr_stmt|;
block|}
comment|/**      * Returns the current registered transport addresses to use (added using      * {@link #addTransportAddress(org.elasticsearch.util.transport.TransportAddress)}.      */
