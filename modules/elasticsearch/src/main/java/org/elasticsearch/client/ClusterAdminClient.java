...
parameter_list|)
function_decl|;
comment|/**      * Nodes info of the cluster.      *      * @param request  The nodes info request      * @param listener A listener to be notified with a result      * @see org.elasticsearch.client.Requests#nodesShutdown(String...)      */
DECL|method|nodesInfo
name|void
name|nodesInfo
parameter_list|(
