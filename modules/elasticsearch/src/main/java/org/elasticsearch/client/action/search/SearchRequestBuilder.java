...
return|;
block|}
comment|/**      * Adds a sort script.      *      * @param script The script to execute.      * @param type   The type of the result (can either be "string" or "number").      * @param order  The order.      */
DECL|method|addSortScript
specifier|public
name|SearchRequestBuilder
name|addSortScript
parameter_list|(
