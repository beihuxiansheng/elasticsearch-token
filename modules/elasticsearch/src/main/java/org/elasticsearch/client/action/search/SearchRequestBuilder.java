...
return|;
block|}
comment|/**      * Sets the source of the request as a json string. Note, settings anything other      * than the search type will cause this source to be overridden, consifer using      * {@link #setExtraSource(byte[])}.      */
DECL|method|setSource
specifier|public
name|SearchRequestBuilder
name|setSource
