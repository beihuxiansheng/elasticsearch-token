...
expr_stmt|;
block|}
comment|//        modules.add(new IndexersModule(settings));
name|modules
operator|.
name|add
argument_list|(
...
argument_list|()
expr_stmt|;
comment|//        injector.getInstance(IndexerManager.class).start();
name|injector
operator|.
name|getInstance
argument_list|(
...
argument_list|()
expr_stmt|;
comment|//        injector.getInstance(IndexerManager.class).stop();
name|injector
operator|.
name|getInstance
argument_list|(
...
argument_list|)
expr_stmt|;
comment|//        injector.getInstance(IndexerManager.class).close();
name|stopWatch
operator|.
name|stop
argument_list|()
