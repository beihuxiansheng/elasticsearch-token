...
begin_comment
comment|/**  * Expert: Maintains caches of term values.  *  *<p>Created: May 19, 2004 11:13:14 AM  *  * @see org.apache.lucene.util.FieldCacheSanityChecker  * @since lucene 1.4  */
end_comment

begin_comment
comment|// LUCENE MONITOR - Added the ability to listen to purge notifications, sadly no extension point in Lucene for this...
end_comment
...
name|FieldCache
block|{
DECL|method|setIndexReaderPurgedListener
name|void
