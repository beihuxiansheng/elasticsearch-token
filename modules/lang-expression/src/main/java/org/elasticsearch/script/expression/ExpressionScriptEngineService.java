...
argument_list|)
decl_stmt|;
comment|// these methods only work on dates, e.g. doc['datefield'].getYear()
...
literal|"getSeconds"
decl_stmt|;
comment|// these methods work on any field, e.g. doc['field'].sum()
...
literal|"count"
decl_stmt|;
comment|// these variables work on any field, e.g. doc['field'].value
...
block|}
block|}
DECL|method|getVariableValueSource
specifier|protected
name|ValueSource
name|getVariableValueSource
parameter_list|(
