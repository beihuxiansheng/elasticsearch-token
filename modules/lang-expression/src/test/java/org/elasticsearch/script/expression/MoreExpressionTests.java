...
expr_stmt|;
block|}
DECL|method|testDateObjectMethods
specifier|public
name|void
name|testDateObjectMethods
parameter_list|()
throws|throws
name|Exception
block|{
...
name|buildRequest
argument_list|(
literal|"doc['date0'].date.secondOfMinute - doc['date0'].date.minuteOfHour"
argument_list|)
operator|.
name|get
argument_list|()
...
name|buildRequest
argument_list|(
literal|"doc['date0'].date.getHourOfDay() + doc['date1'].date.dayOfMonth"
argument_list|)
operator|.
name|get
argument_list|()
...
name|buildRequest
argument_list|(
literal|"doc['date1'].date.monthOfYear + 1"
argument_list|)
operator|.
name|get
argument_list|()
...
argument_list|)
expr_stmt|;
comment|// make sure count() works for missing
name|rsp
operator|=
name|buildRequest
argument_list|(
literal|"doc['double2'].count()"
argument_list|)
operator|.
name|get
argument_list|()
...
argument_list|)
expr_stmt|;
comment|// make sure .empty works in the same way
name|rsp
operator|=
name|buildRequest
argument_list|(
literal|"doc['double2'].empty ? 5.0 : 2.0"
argument_list|)
operator|.
name|get
argument_list|()
...
argument_list|()
operator|+
literal|"should have contained does not exist for numeric field"
argument_list|,
name|e
operator|.
name|toString
...
name|contains
argument_list|(
literal|"does not exist for numeric field"
argument_list|)
argument_list|,
name|equalTo
argument_list|(
...
argument_list|()
operator|+
literal|"should have contained member variable [bogus] does not exist"
argument_list|,
name|e
operator|.
name|toString
...
name|contains
argument_list|(
literal|"Member variable [bogus] does not exist"
argument_list|)
argument_list|,
name|equalTo
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// access .empty
name|rsp
operator|=
name|buildRequest
argument_list|(
literal|"doc['location'].empty ? 1 : 0"
argument_list|)
operator|.
name|get
argument_list|()
...
argument_list|)
expr_stmt|;
comment|// call haversin
name|rsp
operator|=
name|buildRequest
argument_list|(
literal|"haversin(38.9072, 77.0369, doc['location'].lat, doc['location'].lon)"
argument_list|)
operator|.
name|get
argument_list|()
...
comment|// vip's have a 50% discount
name|rsp
operator|=
name|buildRequest
argument_list|(
literal|"doc['vip'] ? doc['price']/2 : doc['price']"
argument_list|)
operator|.
name|get
argument_list|()
