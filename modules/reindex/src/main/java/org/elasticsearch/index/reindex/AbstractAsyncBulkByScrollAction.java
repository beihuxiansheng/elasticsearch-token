...
begin_comment
comment|/**  * Abstract base for scrolling across a search and executing bulk actions on all  * results. All package private methods are package private so their tests can use them.  */
end_comment
