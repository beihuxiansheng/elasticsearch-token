...
return|;
block|}
comment|/**      * All of the bulk failures. Version conflicts are only included if the request sets abortOnVersionConflict to true (the default).      */
DECL|method|getBulkFailures
specifier|public
name|List
argument_list|<
name|Failure
