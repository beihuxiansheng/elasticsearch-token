...
argument_list|)
expr_stmt|;
comment|// Test extra fields for versions that need it
name|searchRequest
operator|=
operator|new
name|SearchRequest
...
literal|"fields"
argument_list|,
literal|"_source,_id,_parent,_routing,_ttl"
argument_list|)
argument_list|)
expr_stmt|;
comment|// But only versions before 1.0 force _source to be in the list
name|searchRequest
operator|=
operator|new
name|SearchRequest
...
literal|"fields"
argument_list|,
literal|"_id,_parent,_routing,_ttl"
argument_list|)
argument_list|)
expr_stmt|;
block|}
...
condition|)
block|{
comment|// Versions of Elasticsearch prior to 5.0 can't parse nanos or micros in TimeValue.
name|assertThat
argument_list|(
name|params
operator|.
...
expr_stmt|;
block|}
comment|// Source filtering is included if set up
name|searchRequest
operator|.
name|source
argument_list|()
...
name|query
operator|+
literal|",\"_source\":{\"includes\":[\"in1\",\"in2\"],\"excludes\":[\"out\"]}}"
argument_list|,
name|Streams
operator|.
name|copyToString
...
argument_list|)
expr_stmt|;
comment|// Test with version< 2.0.0
name|entity
operator|=
name|scrollEntity
argument_list|(
...
expr_stmt|;
block|}
DECL|method|testClearScrollEntity
specifier|public
name|void
name|testClearScrollEntity
parameter_list|()
throws|throws
name|IOException
block|{
