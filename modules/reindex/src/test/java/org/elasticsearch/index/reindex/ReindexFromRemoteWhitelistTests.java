...
expr_stmt|;
block|}
comment|/**      * Build a {@link RemoteInfo}, defaulting values that we don't care about in this test to values that don't hurt anything.      */
...
expr_stmt|;
block|}
DECL|method|testWhitelistedByPrefix
specifier|public
name|void
name|testWhitelistedByPrefix
parameter_list|()
block|{
name|checkRemoteWhitelist
argument_list|(
...
name|newRemoteInfo
argument_list|(
literal|"6e134134a1.us-east-1.aws.example.com"
argument_list|,
literal|9200
argument_list|)
argument_list|)
expr_stmt|;
block|}
DECL|method|testWhitelistedBySuffix
specifier|public
name|void
name|testWhitelistedBySuffix
parameter_list|()
block|{
name|checkRemoteWhitelist
argument_list|(
...
expr_stmt|;
block|}
DECL|method|testWhitelistedByInfix
specifier|public
name|void
name|testWhitelistedByInfix
parameter_list|()
block|{
name|checkRemoteWhitelist
argument_list|(
...
name|singletonList
argument_list|(
literal|"es*.example.com:9200"
argument_list|)
argument_list|)
argument_list|,
name|newRemoteInfo
argument_list|(
literal|"es1.example.com"
argument_list|,
literal|9200
argument_list|)
argument_list|)
expr_stmt|;
block|}
DECL|method|testLoopbackInWhitelistRemote
specifier|public
name|void
name|testLoopbackInWhitelistRemote
parameter_list|()
throws|throws
name|UnknownHostException
block|{
...
expr_stmt|;
block|}
DECL|method|testRejectMatchAll
specifier|public
name|void
name|testRejectMatchAll
parameter_list|()
block|{
name|assertMatchesTooMuch
argument_list|(
name|singletonList
argument_list|(
literal|"*"
...
expr_stmt|;
block|}
DECL|method|assertMatchesTooMuch
specifier|private
name|void
name|assertMatchesTooMuch
parameter_list|(
