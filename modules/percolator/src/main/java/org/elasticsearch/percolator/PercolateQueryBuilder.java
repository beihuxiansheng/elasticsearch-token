...
name|document
decl_stmt|;
DECL|field|documentXContentType
specifier|private
specifier|final
name|XContentType
...
decl_stmt|;
comment|/**      * @deprecated use {@link #PercolateQueryBuilder(String, String, BytesReference, XContentType)} with the document content type to avoid      * autodetection      */
annotation|@
name|Deprecated
