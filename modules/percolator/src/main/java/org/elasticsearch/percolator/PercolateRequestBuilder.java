...
begin_comment
comment|/**  * A builder the easy to use of defining a percolate request.  *  * @deprecated Instead use search API with {@link PercolateQueryBuilder}  */
end_comment
...
return|;
block|}
comment|/**      * Delegates to      * {@link PercolateSourceBuilder#addAggregation(PipelineAggregationBuilder)}      */
DECL|method|addAggregation
specifier|public
name|PercolateRequestBuilder
name|addAggregation
