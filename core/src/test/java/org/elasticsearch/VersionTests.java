...
block|}
block|}
DECL|method|testMinimumIndexCompatibilityVersion
specifier|public
name|void
name|testMinimumIndexCompatibilityVersion
parameter_list|()
block|{
name|assertEquals
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// from 6.0 on we are supporting the latest minor of the previous major... this might fail once we add a new version ie. 5.x is
comment|// released since we need to bump the supported minor in Version#minimumCompatibilityVersion()
name|Version
name|lastVersion
init|=
name|VersionUtils
...
name|assertEquals
argument_list|(
literal|"did you miss to bump the minor in Version#minimumCompatibilityVersion()"
argument_list|,
name|lastVersion
operator|.
name|minor
...
DECL|method|testLuceneVersionIsSameOnMinorRelease
specifier|public
name|void
name|testLuceneVersionIsSameOnMinorRelease
parameter_list|()
block|{
for|for
control|(
...
name|assertTrue
argument_list|(
literal|"lucene versions must be "
operator|+
name|other
operator|+
literal|">= "
...
argument_list|)
expr_stmt|;
comment|// should we also assert the lucene bugfix version?
block|}
block|}
block|}
block|}
...
name|version
operator|+
literal|" has been releaed don't use a new instance of this version"
argument_list|,
name|VersionUtils
operator|.
name|allReleasedVersions
...
expr_stmt|;
block|}
DECL|method|testIsCompatible
specifier|public
name|void
name|testIsCompatible
parameter_list|()
block|{
name|assertTrue
argument_list|(
...
name|assertFalse
argument_list|(
literal|"only compatible with the latest minor"
argument_list|,
name|isCompatible
argument_list|(
name|VersionUtils
