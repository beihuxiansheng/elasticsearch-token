...
annotation|@
name|Test
DECL|method|storePeroclateQueriesOnRecreatedIndex
specifier|public
name|void
name|storePeroclateQueriesOnRecreatedIndex
parameter_list|()
throws|throws
name|Exception
block|{
...
annotation|@
name|Test
DECL|method|testFailNicelyWithInnerHits
specifier|public
name|void
name|testFailNicelyWithInnerHits
parameter_list|()
throws|throws
name|Exception
block|{
...
name|fail
argument_list|(
literal|"Expected a parse error, because inner_hits isn't supported in the percolate api"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
name|Exception
block|{
comment|// We don't fail p/c queries, but those queries are unsuable because only one document can be provided in
