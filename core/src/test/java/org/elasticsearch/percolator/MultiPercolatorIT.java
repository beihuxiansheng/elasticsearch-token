...
expr_stmt|;
block|}
DECL|method|testStartTimeIsPropagatedToShardRequests
specifier|public
name|void
name|testStartTimeIsPropagatedToShardRequests
parameter_list|()
throws|throws
name|Exception
block|{
comment|// See: https://github.com/elastic/elasticsearch/issues/15908
...
literal|"date_field"
argument_list|,
literal|"type=date,format=strict_date_optional_time||epoch_millis"
argument_list|)
operator|.
name|get
argument_list|()
...
literal|"date_field"
argument_list|,
literal|"2015-07-21T10:28:01-07:00"
argument_list|)
argument_list|)
argument_list|)
operator|.
