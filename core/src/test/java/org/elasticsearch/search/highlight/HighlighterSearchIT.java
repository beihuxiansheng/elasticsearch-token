...
specifier|public
name|void
name|testPlainHighlighterWithLongUnanalyzedStringTerm
parameter_list|()
throws|throws
name|IOException
block|{
...
argument_list|()
expr_stmt|;
comment|// crate a term that is larger than the allowed 32766, index it and then try highlight on it
comment|// the search request should still succeed
name|StringBuilder
name|builder
init|=
operator|new
