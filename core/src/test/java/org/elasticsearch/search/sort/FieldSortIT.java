...
name|put
argument_list|(
literal|"doc['number'].value"
argument_list|,
name|vars
lambda|->
name|sortDoubleScript
argument_list|(
name|vars
argument_list|)
argument_list|)
...
name|put
argument_list|(
literal|"doc['keyword'].value"
argument_list|,
name|vars
lambda|->
name|sortStringScript
argument_list|(
name|vars
argument_list|)
argument_list|)
...
expr_stmt|;
block|}
DECL|method|testScriptFieldSort
specifier|public
name|void
name|testScriptFieldSort
parameter_list|()
throws|throws
name|Exception
block|{
