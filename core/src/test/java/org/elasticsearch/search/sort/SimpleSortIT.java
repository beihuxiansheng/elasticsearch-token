...
argument_list|()
expr_stmt|;
comment|//        searchResponse = client().prepareSearch().setSource(searchSourceBuilder.bytes()).execute().actionGet();
comment|//        assertOrderedSearchHits(searchResponse, "d1", "d2");
comment|//        assertThat((Double) searchResponse.getHits().getAt(0).getSortValues()[0], closeTo(GeoDistance.PLANE.calculate(2.5, 1, 2, 1, DistanceUnit.KILOMETERS), 1.e-4));
comment|//        assertThat((Double) searchResponse.getHits().getAt(1).getSortValues()[0], closeTo(GeoDistance.PLANE.calculate(4.5, 1, 2, 1, DistanceUnit.KILOMETERS), 1.e-4));
...
argument_list|)
expr_stmt|;
comment|//        String geoSortRequest = jsonBuilder().startObject().startArray("sort").startObject()
comment|//                .startObject("_geo_distance")
comment|//                .startArray("location").value(2f).value(2f).endArray()
comment|//                .field("unit", "km")
comment|//                .field("distance_type", "plane")
comment|//                .endObject()
comment|//                .endObject().endArray().string();
comment|//        searchResponse = client().prepareSearch().setSource(new BytesArray(geoSortRequest))
comment|//                .execute().actionGet();
comment|//        checkCorrectSortOrderForGeoSort(searchResponse);
comment|//
comment|//        geoSortRequest = jsonBuilder().startObject().startArray("sort").startObject()
comment|//                .startObject("_geo_distance")
comment|//                .field("location", "s037ms06g7h0")
comment|//                .field("unit", "km")
comment|//                .field("distance_type", "plane")
comment|//                .endObject()
comment|//                .endObject().endArray().string();
...
comment|//        searchResponse = client().prepareSearch().setSource(new BytesArray(geoSortRequest))
comment|//                .execute().actionGet();
comment|//        checkCorrectSortOrderForGeoSort(searchResponse); NOCOMMIT fix this
block|}
