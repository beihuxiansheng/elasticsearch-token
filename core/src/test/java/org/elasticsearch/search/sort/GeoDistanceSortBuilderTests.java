...
block|}
block|}
DECL|method|testCoerceIsDeprecated
specifier|public
name|void
name|testCoerceIsDeprecated
parameter_list|()
throws|throws
name|IOException
block|{
...
expr_stmt|;
block|}
DECL|method|testIgnoreMalformedIsDeprecated
specifier|public
name|void
name|testIgnoreMalformedIsDeprecated
parameter_list|()
throws|throws
name|IOException
block|{
...
return|;
block|}
DECL|method|testCommonCaseIsOptimized
specifier|public
name|void
name|testCommonCaseIsOptimized
parameter_list|()
throws|throws
name|IOException
block|{
comment|// make sure the below tests test something...
name|assertFalse
argument_list|(
name|SortField
operator|.
...
argument_list|()
decl_stmt|;
comment|// The common case should use LatLonDocValuesField.newDistanceSort
name|GeoDistanceSortBuilder
name|builder
init|=
operator|new
...
argument_list|)
expr_stmt|;
comment|// however this might be disabled by fancy options
name|builder
operator|=
operator|new
name|GeoDistanceSortBuilder
...
argument_list|)
expr_stmt|;
comment|// 2 points -> plain SortField with a custom comparator
name|builder
operator|=
operator|new
name|GeoDistanceSortBuilder
...
argument_list|)
expr_stmt|;
comment|// km rather than m -> plain SortField with a custom comparator
name|builder
operator|=
operator|new
name|GeoDistanceSortBuilder
...
argument_list|)
expr_stmt|;
comment|// descending means the max value should be considered rather than min
name|builder
operator|=
operator|new
name|GeoDistanceSortBuilder
...
argument_list|)
expr_stmt|;
comment|// can't use LatLon optimized sorting with nested fields
name|builder
operator|=
operator|new
name|GeoDistanceSortBuilder
...
argument_list|)
expr_stmt|;
comment|// can't use LatLon optimized sorting with DESC sorting
block|}
block|}
end_class
