...
block|}
comment|// Tests #16550
DECL|method|testHasChildWithNonDefaultGlobalSimilarity
specifier|public
name|void
name|testHasChildWithNonDefaultGlobalSimilarity
parameter_list|()
block|{
name|assertAcked
argument_list|(
...
argument_list|()
expr_stmt|;
name|verifyNonDefaultSimilarity
argument_list|()
expr_stmt|;
block|}
comment|// Tests #16550
DECL|method|testHasChildWithNonDefaultFieldSimilarity
specifier|public
name|void
name|testHasChildWithNonDefaultFieldSimilarity
parameter_list|()
block|{
name|assertAcked
argument_list|(
...
literal|"c_field"
argument_list|,
literal|"type=string,similarity=BM25"
argument_list|)
argument_list|)
expr_stmt|;
name|ensureGreen
...
block|}
comment|// Tests #16550
DECL|method|verifyNonDefaultSimilarity
specifier|private
name|void
name|verifyNonDefaultSimilarity
parameter_list|()
...
argument_list|()
expr_stmt|;
comment|// baseline: sum of scores of matching child docs outside of has_child query
name|SearchResponse
name|searchResponse
init|=
name|client
...
argument_list|()
decl_stmt|;
comment|// compare baseline to has_child with 'total' score_mode
name|searchResponse
operator|=
name|client
argument_list|()
