...
expr_stmt|;
block|}
DECL|method|testHasChildInnerHitsHighlighting
specifier|public
name|void
name|testHasChildInnerHitsHighlighting
parameter_list|()
throws|throws
name|Exception
block|{
...
literal|"searchText"
argument_list|,
literal|"type=text,term_vector=with_positions_offsets,index_options=offsets"
argument_list|)
operator|.
name|addMapping
argument_list|(
...
name|info
argument_list|(
literal|"Testing with highlight type [{}]"
argument_list|,
name|highlightType
argument_list|)
expr_stmt|;
