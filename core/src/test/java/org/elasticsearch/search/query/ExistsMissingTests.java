...
begin_class
DECL|class|ExistsMissingTests
specifier|public
class|class
name|ExistsMissingTests
extends|extends
name|ElasticsearchIntegrationTest
block|{
...
block|}
block|}
DECL|method|testNullValueUnset
specifier|public
name|void
name|testNullValueUnset
parameter_list|()
throws|throws
name|Exception
block|{
...
name|fail
argument_list|(
literal|"both existence and null_value can't be false"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
block|}
block|}
DECL|method|testNullValueSet
specifier|public
name|void
name|testNullValueSet
parameter_list|()
throws|throws
name|Exception
block|{
...
literal|"f"
argument_list|,
literal|"type=string,index=not_analyzed,null_value=bar"
argument_list|)
argument_list|)
expr_stmt|;
name|indexRandom
