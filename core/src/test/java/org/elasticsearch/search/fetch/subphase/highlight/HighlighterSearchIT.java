...
name|ESIntegTestCase
block|{
comment|// TODO as we move analyzers out of the core we need to move some of these into HighlighterWithAnalyzersTests
...
name|equalTo
argument_list|(
literal|"yet another<field2>test</field2>"
argument_list|)
argument_list|)
expr_stmt|;
block|}
...
literal|"field1"
argument_list|,
literal|"A sentence with few words. Another sentence with even more words."
argument_list|)
argument_list|)
expr_stmt|;
for|for
...
name|info
argument_list|(
literal|"--> highlighting and searching on 'field' with sentence boundary_scanner"
argument_list|)
expr_stmt|;
name|SearchSourceBuilder
name|source
...
literal|"field1"
argument_list|,
literal|"some quick and hairy brown:fox jumped over the lazy dog"
argument_list|)
argument_list|)
expr_stmt|;
name|logger
...
name|equalTo
argument_list|(
literal|"The quick<x>browse</x> button is a fancy thing, right<x>bro</x>?"
argument_list|)
argument_list|,
name|equalTo
argument_list|(
