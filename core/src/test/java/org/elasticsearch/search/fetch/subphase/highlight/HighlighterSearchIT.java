...
expr_stmt|;
block|}
DECL|method|testStringFieldHighlighting
specifier|public
name|void
name|testStringFieldHighlighting
parameter_list|()
throws|throws
name|IOException
block|{
comment|// check that string field highlighting on old indexes works
name|XContentBuilder
name|mappings
init|=
name|jsonBuilder
