...
name|setText
argument_list|(
literal|"This is some global Text"
argument_list|)
expr_stmt|;
block|}
if|if
...
argument_list|)
expr_stmt|;
comment|// deep comparison of analyzers is difficult here, but we check they are same class
name|assertEquals
argument_list|(
name|oldSchoolContext
operator|.
...
argument_list|)
expr_stmt|;
comment|// TODO consolidate text/prefix/regex
comment|//assertEquals(oldSchoolContext.getPrefix(), newSchoolContext.getPrefix());
comment|//assertEquals(oldSchoolContext.getRegex(), newSchoolContext.getRegex());
name|assertEquals
argument_list|(
name|oldSchoolContext
operator|.
...
expr_stmt|;
comment|// TODO consolidate text/prefix/regex
comment|//assertEquals(oldSchoolContext.getText(), newSchoolContext.getText());
name|assertEquals
argument_list|(
name|oldSchoolContext
operator|.
