...
block|}
block|}
DECL|method|testParsingExceptionOnUnknownSuggestion
specifier|public
name|void
name|testParsingExceptionOnUnknownSuggestion
parameter_list|()
throws|throws
name|IOException
block|{
...
name|assertEquals
argument_list|(
literal|"Could not parse suggestion keyed as [unknownSuggestion]"
argument_list|,
name|ex
operator|.
name|getMessage
