...
expr_stmt|;
block|}
comment|/**      * test that suggestion works if prefix is either provided via {@link CompletionSuggestionBuilder#text(String)} or      * {@link SuggestBuilder#setGlobalText(String)}      */
DECL|method|testTextAndGlobalText
specifier|public
name|void
name|testTextAndGlobalText
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// test that suggestion text takes precedence over global text
name|searchResponse
operator|=
name|client
argument_list|()
