...
comment|// - there can be inner search hits fields inside this option where we cannot add random stuff
comment|// - the root object should be excluded since it contains the named suggestion arrays
name|Predicate
argument_list|<
name|String
argument_list|>
...
block|}
block|}
comment|/**      * test that we parse nothing if RestSearchAction.TYPED_KEYS_PARAM isn't set while rendering xContent and we cannot find      * suggestion type information      */
DECL|method|testFromXContentWithoutTypeParam
specifier|public
name|void
name|testFromXContentWithoutTypeParam
parameter_list|()
throws|throws
name|IOException
block|{
