...
argument_list|)
expr_stmt|;
comment|// force the scan to complete measuring the time taken
comment|// the total time the scroll is open should be greater than this
comment|// the number of queries should equal the number of pages in the scan times the number of shards
name|long
name|time
init|=
name|System
