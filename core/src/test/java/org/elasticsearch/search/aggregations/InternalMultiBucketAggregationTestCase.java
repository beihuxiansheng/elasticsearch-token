...
argument_list|>
block|{
DECL|field|DEFAULT_MAX_NUMBER_OF_BUCKETS
specifier|private
specifier|static
specifier|final
name|int
name|DEFAULT_MAX_NUMBER_OF_BUCKETS
init|=
literal|10
decl_stmt|;
...
decl_stmt|;
DECL|field|maxNumberOfBuckets
name|int
name|maxNumberOfBuckets
init|=
name|DEFAULT_MAX_NUMBER_OF_BUCKETS
decl_stmt|;
DECL|method|randomNumberOfBuckets
specifier|protected
name|int
...
argument_list|()
operator|:
literal|"Maximum number of buckets exceeded for "
operator|+
name|instance
operator|.
name|getClass
