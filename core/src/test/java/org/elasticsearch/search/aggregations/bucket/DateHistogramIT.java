...
expr_stmt|;
block|}
DECL|method|addExpectedBucket
specifier|private
name|void
name|addExpectedBucket
parameter_list|(
name|DateTime
name|key
parameter_list|,
...
block|}
block|}
DECL|method|testSingleValuedFieldOrderedByTieBreaker
specifier|public
name|void
name|testSingleValuedFieldOrderedByTieBreaker
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
DECL|method|testMultiValuedFieldOrderedByCountDesc
specifier|public
name|void
name|testMultiValuedFieldOrderedByCountDesc
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
comment|/**      * Test date histogram aggregation with day interval, offset and      * extended bounds (see https://github.com/elastic/elasticsearch/issues/23776)      */
DECL|method|testSingleValueFieldWithExtendedBoundsOffset
specifier|public
name|void
name|testSingleValueFieldWithExtendedBoundsOffset
parameter_list|()
throws|throws
name|Exception
block|{
...
name|parse
argument_list|(
literal|"2016-01-03T08:00:00.000Z"
argument_list|)
argument_list|,
literal|1
argument_list|)
...
name|parse
argument_list|(
literal|"2016-01-06T08:00:00.000Z"
argument_list|)
argument_list|,
literal|3
argument_list|)
...
name|ExtendedBounds
argument_list|(
literal|"2016-01-01T06:00:00Z"
argument_list|,
literal|"2016-01-08T08:00:00Z"
argument_list|)
argument_list|)
argument_list|)
operator|.
...
name|assertEquals
argument_list|(
literal|"2016-01-01T06:00:00.000Z"
argument_list|,
name|buckets
operator|.
name|get
...
name|assertEquals
argument_list|(
literal|"2016-01-02T06:00:00.000Z"
argument_list|,
name|buckets
operator|.
name|get
...
name|assertEquals
argument_list|(
literal|"2016-01-03T06:00:00.000Z"
argument_list|,
name|buckets
operator|.
name|get
...
name|assertEquals
argument_list|(
literal|"2016-01-04T06:00:00.000Z"
argument_list|,
name|buckets
operator|.
name|get
...
name|assertEquals
argument_list|(
literal|"2016-01-05T06:00:00.000Z"
argument_list|,
name|buckets
operator|.
name|get
...
name|assertEquals
argument_list|(
literal|"2016-01-06T06:00:00.000Z"
argument_list|,
name|buckets
operator|.
name|get
...
name|assertEquals
argument_list|(
literal|"2016-01-07T06:00:00.000Z"
argument_list|,
name|buckets
operator|.
name|get
...
name|assertEquals
argument_list|(
literal|"2016-01-08T06:00:00.000Z"
argument_list|,
name|buckets
operator|.
name|get
...
expr_stmt|;
block|}
DECL|method|testSingleValuedFieldOrderedBySingleValueSubAggregationAscAndKeyDesc
specifier|public
name|void
name|testSingleValuedFieldOrderedBySingleValueSubAggregationAscAndKeyDesc
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
DECL|method|testSingleValuedFieldOrderedBySingleValueSubAggregationAscAndKeyAsc
specifier|public
name|void
name|testSingleValuedFieldOrderedBySingleValueSubAggregationAscAndKeyAsc
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
DECL|method|testSingleValuedFieldOrderedBySingleValueSubAggregationDescAndKeyAsc
specifier|public
name|void
name|testSingleValuedFieldOrderedBySingleValueSubAggregationDescAndKeyAsc
parameter_list|()
throws|throws
name|Exception
block|{
