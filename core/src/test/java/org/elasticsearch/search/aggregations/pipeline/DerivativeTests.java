...
annotation|@
name|Test
DECL|method|singleValueAggDerivative_invalidPath
specifier|public
name|void
name|singleValueAggDerivative_invalidPath
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|()
decl_stmt|;
comment|// If there is more than one root cause then something
comment|// unexpected happened and we should re-throw the original
comment|// exception
if|if
condition|(
name|rootCauses
