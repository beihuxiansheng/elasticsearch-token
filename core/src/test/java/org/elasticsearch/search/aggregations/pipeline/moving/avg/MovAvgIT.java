...
block|}
block|}
DECL|method|testPredictWithNonEmptyBuckets
specifier|public
name|void
name|testPredictWithNonEmptyBuckets
parameter_list|()
throws|throws
name|Exception
block|{
...
control|)
block|{
comment|// Extra so there is a bucket that only has second field
name|bulkBuilder
operator|.
name|add
argument_list|(
