...
condition|)
block|{
comment|// Lower down the number of buckets generated by multi bucket aggregation tests in
comment|// order to avoid too many aggregations to be created.
operator|(
operator|(
name|InternalMultiBucketAggregationTestCase
operator|)
...
block|}
block|}
DECL|method|testParsingExceptionOnUnknownAggregation
specifier|public
name|void
name|testParsingExceptionOnUnknownAggregation
parameter_list|()
throws|throws
name|IOException
block|{
...
name|assertEquals
argument_list|(
literal|"Could not parse aggregation keyed as [unknownAggregation]"
argument_list|,
name|ex
operator|.
name|getMessage
