...
name|SUITE
argument_list|)
DECL|class|SignificantTermsSignificanceScoreTests
specifier|public
class|class
name|SignificantTermsSignificanceScoreTests
extends|extends
name|ElasticsearchIntegrationTest
block|{
...
block|}
block|}
DECL|class|SimpleHeuristicBuilder
specifier|public
specifier|static
class|class
name|SimpleHeuristicBuilder
...
name|scriptHeuristicBuilder
init|=
name|getScriptSignificanceHeuristicBuilder
argument_list|()
decl_stmt|;
name|ensureYellow
argument_list|()
...
specifier|public
name|void
name|testNoNumberFormatExceptionWithDefaultScriptingEngine
parameter_list|()
throws|throws
name|ExecutionException
throws|,
...
name|Script
argument_list|(
literal|"_subset_freq/(_superset_freq - _subset_freq + 1)"
argument_list|)
argument_list|)
expr_stmt|;
name|ensureYellow
...
block|}
block|}
DECL|method|getScriptSignificanceHeuristicBuilder
specifier|private
name|ScriptHeuristic
operator|.
name|ScriptHeuristicBuilder
...
name|Script
argument_list|(
literal|"return _subset_freq + _subset_size + _superset_freq + _superset_size"
argument_list|)
expr_stmt|;
block|}
else|else
...
name|Script
argument_list|(
literal|"return param*(_subset_freq + _subset_size + _superset_freq + _superset_size)/param"
argument_list|,
name|ScriptType
operator|.
name|INLINE
...
name|Script
argument_list|(
literal|"significance_script_no_params"
argument_list|,
name|ScriptType
operator|.
name|FILE
...
name|Script
argument_list|(
literal|"significance_script_with_params"
argument_list|,
name|ScriptType
operator|.
name|FILE
