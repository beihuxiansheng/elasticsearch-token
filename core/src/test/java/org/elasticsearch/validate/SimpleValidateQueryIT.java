...
expr_stmt|;
block|}
DECL|method|testExplainWithRewriteValidateQueryAllShards
specifier|public
name|void
name|testExplainWithRewriteValidateQueryAllShards
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|()
expr_stmt|;
comment|// We are relying on specific routing behaviors for the result to be right, so
comment|// we cannot randomize the number of shards or change ids here.
name|client
argument_list|()
operator|.
name|prepareIndex
