...
decl_stmt|;
comment|/** Allows blocking on writing the index-N blob; this is a way to enforce blocking the      *  finalization of a snapshot, while permitting other IO operations to proceed unblocked. */
DECL|field|blockOnWriteIndexFile
specifier|private
specifier|volatile
name|boolean
name|blockOnWriteIndexFile
decl_stmt|;
DECL|field|atomicMove
specifier|private
specifier|volatile
name|boolean
name|atomicMove
...
expr_stmt|;
block|}
DECL|method|setBlockOnWriteIndexFile
specifier|public
name|void
...
condition|)
block|{
name|blockExecutionAndMaybeWait
argument_list|(
name|blobName
argument_list|)
expr_stmt|;
...
block|}
block|}
DECL|method|blockExecutionAndMaybeWait
specifier|private
name|void
name|blockExecutionAndMaybeWait
parameter_list|(
