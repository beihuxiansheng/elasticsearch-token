...
name|Object
argument_list|>
name|secondUnknonwTaggedConfig
init|=
operator|new
name|HashMap
argument_list|<>
...
name|singletonMap
argument_list|(
literal|"second_unknown_processor"
argument_list|,
name|secondUnknonwTaggedConfig
argument_list|)
argument_list|)
...
name|equalTo
argument_list|(
literal|"No processor type exists with name [second_unknown_processor]"
argument_list|)
argument_list|)
expr_stmt|;
name|assertThat
