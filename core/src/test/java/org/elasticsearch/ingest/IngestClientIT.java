...
expr_stmt|;
block|}
DECL|method|testPutWithPipelineError
specifier|public
name|void
name|testPutWithPipelineError
parameter_list|()
throws|throws
name|Exception
block|{
...
name|equalTo
argument_list|(
literal|"No processor type exists with name [not_found]"
argument_list|)
argument_list|)
expr_stmt|;
block|}
DECL|method|testPutWithProcessorFactoryError
specifier|public
name|void
name|testPutWithProcessorFactoryError
parameter_list|()
throws|throws
name|Exception
block|{
