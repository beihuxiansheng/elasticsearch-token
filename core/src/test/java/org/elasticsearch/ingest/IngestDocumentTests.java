...
name|ESTestCase
block|{
DECL|field|BOGUS_TIMESTAMP
specifier|private
specifier|static
specifier|final
name|Date
name|BOGUS_TIMESTAMP
init|=
operator|new
name|Date
argument_list|(
...
argument_list|)
decl_stmt|;
DECL|field|BOGUS_TIMESTAMP_NEW_DATE_FORMAT
specifier|private
specifier|static
specifier|final
name|ZonedDateTime
name|BOGUS_TIMESTAMP_NEW_DATE_FORMAT
init|=
name|ZonedDateTime
operator|.
name|of
...
name|ingestDocument
decl_stmt|;
DECL|field|ingestDocumentWithNewDateFormat
specifier|private
name|IngestDocument
name|ingestDocumentWithNewDateFormat
decl_stmt|;
DECL|method|getTestIngestDocument
specifier|public
name|IngestDocument
name|getTestIngestDocument
parameter_list|(
name|boolean
name|newDateFormat
parameter_list|)
...
annotation|@
name|Before
DECL|method|setIngestDocuments
specifier|public
name|void
name|setIngestDocuments
parameter_list|()
block|{
name|ingestDocument
operator|=
...
expr_stmt|;
block|}
DECL|method|testDefaultConstructorUsesDateClass
specifier|public
name|void
name|testDefaultConstructorUsesDateClass
parameter_list|()
block|{
name|IngestDocument
name|ingestDocument
...
expr_stmt|;
block|}
DECL|method|testNewDateFormat
specifier|public
name|void
name|testNewDateFormat
parameter_list|()
block|{
name|assertThat
argument_list|(
...
expr_stmt|;
block|}
DECL|method|testListHasFieldIndexOutOfBounds_fail
specifier|public
name|void
name|testListHasFieldIndexOutOfBounds_fail
parameter_list|()
block|{
name|assertTrue
argument_list|(
...
name|equalTo
argument_list|(
literal|"[2] is out of bounds for array with length [2] as part of path [list.2]"
argument_list|)
argument_list|)
expr_stmt|;
name|e
