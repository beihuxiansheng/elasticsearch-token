...
return|;
block|}
DECL|method|testCollectNodes
specifier|public
name|void
name|testCollectNodes
parameter_list|()
throws|throws
name|InterruptedException
throws|,
...
name|DiscoveryNode
argument_list|>
name|stringStringDiscoveryNodeBiFunction
parameter_list|)
block|{
try|try
block|{
...
name|assertEquals
argument_list|(
literal|"no such remote cluster: [no such cluster]"
argument_list|,
name|ex
operator|.
name|get
...
block|}
block|{
comment|// close all targets and check for the transport level failure path
name|IOUtils
operator|.
name|close
argument_list|(
