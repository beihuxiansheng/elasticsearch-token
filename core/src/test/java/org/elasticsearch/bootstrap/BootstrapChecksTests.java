...
expr_stmt|;
block|}
DECL|method|testNoLogMessageInNonProductionMode
specifier|public
name|void
name|testNoLogMessageInNonProductionMode
parameter_list|()
throws|throws
name|NodeValidationException
block|{
...
expr_stmt|;
block|}
DECL|method|testLogMessageInProductionMode
specifier|public
name|void
name|testLogMessageInProductionMode
parameter_list|()
throws|throws
name|NodeValidationException
block|{
...
expr_stmt|;
block|}
DECL|method|testClientJvmCheck
specifier|public
name|void
name|testClientJvmCheck
parameter_list|()
throws|throws
name|NodeValidationException
block|{
...
argument_list|<>
argument_list|(
literal|"Java HotSpot(TM) 32-Bit Client VM"
argument_list|)
decl_stmt|;
specifier|final
name|BootstrapCheck
...
name|containsString
argument_list|(
literal|"JVM is using the client VM [Java HotSpot(TM) 32-Bit Client VM] "
operator|+
literal|"but should be using a server VM for the best performance"
argument_list|)
argument_list|)
expr_stmt|;
name|vmName
...
expr_stmt|;
block|}
DECL|method|testUseSerialGCCheck
specifier|public
name|void
name|testUseSerialGCCheck
parameter_list|()
throws|throws
name|NodeValidationException
block|{
...
literal|""
operator|+
literal|"either it's the default for the VM ["
operator|+
name|JvmInfo
operator|.
name|jvmInfo
...
argument_list|()
operator|+
literal|"] or -XX:+UseSerialGC was explicitly specified"
argument_list|)
argument_list|)
expr_stmt|;
name|useSerialGC
...
expr_stmt|;
block|}
DECL|method|testSystemCallFilterCheck
specifier|public
name|void
name|testSystemCallFilterCheck
parameter_list|()
throws|throws
name|NodeValidationException
block|{
...
name|containsString
argument_list|(
literal|"system call filters failed to install; "
operator|+
literal|"check the logs and fix your configuration or disable system call filters at your own risk"
argument_list|)
argument_list|)
expr_stmt|;
name|isSystemCallFilterInstalled
...
expr_stmt|;
block|}
DECL|method|testMightForkCheck
specifier|public
name|void
name|testMightForkCheck
parameter_list|()
throws|throws
name|NodeValidationException
block|{
...
expr_stmt|;
block|}
DECL|method|testOnErrorCheck
specifier|public
name|void
name|testOnErrorCheck
parameter_list|()
throws|throws
name|NodeValidationException
block|{
...
expr_stmt|;
block|}
DECL|method|testOnOutOfMemoryErrorCheck
specifier|public
name|void
name|testOnOutOfMemoryErrorCheck
parameter_list|()
throws|throws
name|NodeValidationException
block|{
...
specifier|final
name|Runnable
name|disableMightFork
parameter_list|,
specifier|final
name|Runnable
name|enableMightFork
parameter_list|,
specifier|final
name|Consumer
argument_list|<
...
expr_stmt|;
block|}
DECL|method|testEarlyAccessCheck
specifier|public
name|void
name|testEarlyAccessCheck
parameter_list|()
throws|throws
name|NodeValidationException
block|{
...
argument_list|()
operator|+
literal|"] is an early-access build, only use release builds"
argument_list|)
argument_list|)
expr_stmt|;
comment|// if not on an early-access build, nothing should happen
name|javaVersion
operator|.
name|set
argument_list|(
...
argument_list|()
operator|+
literal|"] can cause data corruption when used with G1GC; upgrade to at least Java 8u40"
argument_list|)
argument_list|)
expr_stmt|;
comment|// if G1GC is disabled, nothing should happen
name|isG1GCEnabled
operator|.
name|set
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// if on or after update 40, nothing should happen independent of whether or not G1GC is enabled
name|isG1GCEnabled
operator|.
name|set
argument_list|(
...
expr_stmt|;
block|}
DECL|method|testAlwaysEnforcedChecks
specifier|public
name|void
name|testAlwaysEnforcedChecks
parameter_list|()
block|{
specifier|final
name|BootstrapCheck
...
argument_list|)
argument_list|,
literal|"testAlwaysEnforcedChecks"
argument_list|)
argument_list|)
decl_stmt|;
name|assertThat
