...
argument_list|)
argument_list|,
literal|"testOnOutOfMemoryErrorCheck"
argument_list|)
expr_stmt|;
comment|// if seccomp is enabled, and OnOutOfMemoryError is not, nothing
comment|// should happen
name|isSeccompInstalled
operator|.
name|set
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// if seccomp is enabled, and OnOutOfMemoryError is, the check
comment|// should be enforced, regardless of bootstrap checks being
...
expr_stmt|;
block|}
DECL|method|testIgnoringSystemChecks
specifier|public
name|void
name|testIgnoringSystemChecks
parameter_list|()
block|{
specifier|final
name|BootstrapCheck
...
argument_list|)
argument_list|,
literal|"testIgnoringSystemChecks"
argument_list|)
argument_list|)
decl_stmt|;
name|assertThat
...
argument_list|)
decl_stmt|;
comment|// nothing should happen if we ignore system checks
name|BootstrapCheck
operator|.
name|check
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// nothing should happen if we ignore all checks
name|BootstrapCheck
operator|.
name|check
argument_list|(
