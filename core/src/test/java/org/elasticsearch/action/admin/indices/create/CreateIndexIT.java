...
expr_stmt|;
block|}
DECL|method|testInvalidPartitionSize
specifier|public
name|void
name|testInvalidPartitionSize
parameter_list|()
block|{
name|BiFunction
argument_list|<
...
expr_stmt|;
block|}
DECL|method|testIndexNameInResponse
specifier|public
name|void
name|testIndexNameInResponse
parameter_list|()
block|{
name|CreateIndexResponse
name|response
...
name|assertEquals
argument_list|(
literal|"Should have index name in response"
argument_list|,
literal|"foo"
argument_list|,
name|response
