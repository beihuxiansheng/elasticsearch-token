...
argument_list|)
expr_stmt|;
comment|// Fail in a random way to make sure we can handle all these ways
name|Runnable
name|failureMode
init|=
name|randomFrom
...
name|info
argument_list|(
literal|"Throwing exception from taskOperation"
argument_list|)
expr_stmt|;
throw|throw
operator|new
name|RuntimeException
argument_list|(
literal|"Task level failure (direct)"
argument_list|)
throw|;
block|}
argument_list|,
...
name|info
argument_list|(
literal|"Calling listener synchronously with exception from taskOperation"
argument_list|)
expr_stmt|;
name|listener
operator|.
...
name|RuntimeException
argument_list|(
literal|"Task level failure (sync listener)"
argument_list|)
argument_list|)
expr_stmt|;
block|}
...
name|info
argument_list|(
literal|"Calling listener asynchronously with exception from taskOperation"
argument_list|)
expr_stmt|;
name|threadPool
operator|.
...
name|RuntimeException
argument_list|(
literal|"Task level failure (async listener)"
argument_list|)
argument_list|)
argument_list|)
expr_stmt|;
