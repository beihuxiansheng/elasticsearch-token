...
expr_stmt|;
block|}
DECL|method|testChildTasksCancellation
specifier|public
name|void
name|testChildTasksCancellation
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
decl_stmt|;
comment|// Cancel all child tasks without cancelling the main task, which should quit on its own
name|CancelTasksRequest
name|request
init|=
operator|new
...
argument_list|()
expr_stmt|;
comment|// Should have cancelled tasks on all nodes
name|assertThat
argument_list|(
name|response
operator|.
...
try|try
block|{
comment|// Make sure that main task is no longer running
name|ListTasksResponse
name|listTasksResponse
init|=
name|testNodes
