...
expr_stmt|;
block|}
DECL|method|testUpgradeConflictingMapping
specifier|public
name|void
name|testUpgradeConflictingMapping
parameter_list|()
throws|throws
name|Exception
block|{
...
name|indexName
init|=
literal|"index-conflicting-mappings-1.7.0"
decl_stmt|;
name|logger
operator|.
name|info
...
name|fail
argument_list|(
literal|"Should have failed to start the node"
argument_list|)
expr_stmt|;
block|}
catch|catch
