...
expr_stmt|;
block|}
DECL|method|testGetTaskWaitForCompletion
specifier|public
name|void
name|testGetTaskWaitForCompletion
parameter_list|()
throws|throws
name|Exception
block|{
...
lambda|->
block|{
comment|// Really we're just happy we didn't get any exceptions
name|assertNotNull
argument_list|(
name|response
operator|.
...
expr_stmt|;
block|}
comment|/**      * Test wait for completion.      * @param wait start waiting for a task. Accepts that id of the task to wait for and returns a future waiting for it.      * @param validator validate the response and return the task ids that were found      */
