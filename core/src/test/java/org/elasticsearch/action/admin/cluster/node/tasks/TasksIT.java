...
expr_stmt|;
block|}
DECL|method|testSearchTaskDescriptions
specifier|public
name|void
name|testSearchTaskDescriptions
parameter_list|()
block|{
name|registerTaskManageListeners
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// the search operation should produce one main task
name|List
argument_list|<
name|TaskInfo
argument_list|>
...
name|startsWith
argument_list|(
literal|"indices[test], types[doc], search_type["
argument_list|)
argument_list|)
expr_stmt|;
name|assertThat
...
argument_list|)
expr_stmt|;
comment|// check that if we have any shard-level requests they all have non-zero length description
name|List
argument_list|<
name|TaskInfo
argument_list|>
...
name|simpleMatch
argument_list|(
literal|"id[*], size[1], lastEmittedDoc[null]"
argument_list|,
name|taskInfo
operator|.
name|getDescription
...
expr_stmt|;
block|}
comment|// assert that all task descriptions have non-zero length
name|assertThat
argument_list|(
name|taskInfo
operator|.
