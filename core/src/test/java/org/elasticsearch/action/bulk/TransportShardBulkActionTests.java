...
expr_stmt|;
block|}
DECL|method|testProcessUpdateResponse
specifier|public
name|void
name|testProcessUpdateResponse
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
DECL|method|testExecuteUpdateRequestOnce
specifier|public
name|void
name|testExecuteUpdateRequestOnce
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
DECL|method|testExecuteUpdateRequestOnceWithFailure
specifier|public
name|void
name|testExecuteUpdateRequestOnceWithFailure
parameter_list|()
throws|throws
name|Exception
block|{
...
name|IllegalArgumentException
argument_list|(
literal|"I failed to do something!"
argument_list|)
decl_stmt|;
name|UpdateHelper
name|updateHelper
...
argument_list|)
expr_stmt|;
comment|// Assert that the document did not make it there, since it should have failed
name|assertDocCount
argument_list|(
name|shard
argument_list|,
...
expr_stmt|;
block|}
comment|/**      * Fake UpdateHelper that always returns whatever result you give it      */
DECL|class|MockUpdateHelper
specifier|private
specifier|static
class|class
name|MockUpdateHelper
...
block|}
block|}
comment|/**      * An update helper that always fails to prepare the update      */
DECL|class|FailingUpdateHelper
specifier|private
specifier|static
class|class
name|FailingUpdateHelper
...
name|e
decl_stmt|;
DECL|method|FailingUpdateHelper
name|FailingUpdateHelper
parameter_list|(
name|Exception
name|failure
...
name|info
argument_list|(
literal|"--> preparing failing update for {} - {}"
argument_list|,
name|s
argument_list|,
name|u
