...
argument_list|)
expr_stmt|;
comment|// Failed index requests should not be replicated (for now!)
name|writeRequest
operator|=
operator|new
name|IndexRequest
...
argument_list|,
operator|new
name|FailingMappingUpdatePerformer
argument_list|(
name|err
argument_list|)
argument_list|)
...
block|}
block|}
comment|/** Always returns the given failure */
DECL|class|FailingMappingUpdatePerformer
specifier|private
class|class
name|FailingMappingUpdatePerformer
implements|implements
...
name|e
decl_stmt|;
DECL|method|FailingMappingUpdatePerformer
name|FailingMappingUpdatePerformer
parameter_list|(
name|Exception
name|e
