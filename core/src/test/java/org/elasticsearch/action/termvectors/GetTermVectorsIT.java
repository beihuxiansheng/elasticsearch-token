...
expr_stmt|;
block|}
comment|// payloads are never made by the mapping in this test
name|assertNull
argument_list|(
name|infoString
operator|+
...
argument_list|)
expr_stmt|;
comment|// Since the index is empty, all of artificial document's "term_statistics" should be 0/absent
name|Terms
name|terms
init|=
name|resp
...
name|assertEquals
argument_list|(
literal|"sumDocFreq should be 0 for a non-existing field!"
argument_list|,
literal|0
argument_list|,
name|terms
...
name|assertEquals
argument_list|(
literal|"sumTotalTermFreq should be 0 for a non-existing field!"
argument_list|,
literal|0
argument_list|,
name|terms
...
argument_list|()
decl_stmt|;
comment|// we're guaranteed to receive terms for that field
while|while
condition|(
name|termsEnum
operator|.
...
name|term
operator|+
literal|"] does not exist in the index; ttf should be 0!"
argument_list|,
literal|0
argument_list|,
name|termsEnum
...
block|}
block|}
DECL|method|testArtificialDocWithPreference
specifier|public
name|void
name|testArtificialDocWithPreference
parameter_list|()
throws|throws
name|ExecutionException
throws|,
...
literal|"field1"
argument_list|,
literal|"random permutation"
argument_list|)
argument_list|)
expr_stmt|;
comment|// Get search shards
name|ClusterSearchShardsResponse
...
argument_list|)
decl_stmt|;
comment|// request termvectors of artificial document from each shard
name|int
...
name|assertEquals
argument_list|(
literal|"expected to find term statistics in exactly one shard!"
argument_list|,
literal|2
argument_list|,
name|sumTotalTermFreq
