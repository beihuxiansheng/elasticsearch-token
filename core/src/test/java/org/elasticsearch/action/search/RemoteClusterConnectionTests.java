...
begin_function
unit|}             }         }     }
DECL|method|installNodeStatsHandler
specifier|private
specifier|static
name|void
name|installNodeStatsHandler
parameter_list|(
name|TransportService
name|service
parameter_list|,
...
begin_function
unit|}      public
DECL|method|testGetConnectionInfo
name|void
name|testGetConnectionInfo
parameter_list|()
throws|throws
name|Exception
block|{
...
init|)
block|{
comment|// test no nodes connected
name|RemoteConnectionInfo
name|remoteConnectionInfo
operator|=
name|assertSerialization
argument_list|(
name|getRemoteConnectionInfo
argument_list|(
name|connection
argument_list|)
argument_list|)
...
begin_function
unit|}      public
DECL|method|testRemoteConnectionInfo
name|void
name|testRemoteConnectionInfo
parameter_list|()
throws|throws
name|IOException
block|{
...
begin_function
DECL|method|testRenderConnectionInfoXContent
specifier|public
name|void
name|testRenderConnectionInfoXContent
parameter_list|()
throws|throws
name|IOException
block|{
...
name|assertEquals
argument_list|(
literal|"{\"test_cluster\":{\"seeds\":[\"0.0.0.0:1\"],\"http_addresses\":[\"0.0.0.0:80\"],\"connected\":true,"
operator|+
literal|"\"num_nodes_connected\":3,\"max_connections_per_cluster\":4,\"initial_connect_timeout\":\"30m\"}}"
argument_list|,
name|builder
operator|.
name|string
...
name|assertEquals
argument_list|(
literal|"{\"some_other_cluster\":{\"seeds\":[\"0.0.0.0:1\",\"0.0.0.0:2\"],\"http_addresses\":[\"0.0.0.0:80\",\"0.0.0.0:81\"],"
operator|+
literal|"\"connected\":false,\"num_nodes_connected\":0,\"max_connections_per_cluster\":2,\"initial_connect_timeout\":\"30s\"}}"
argument_list|,
name|builder
operator|.
name|string
...
begin_function
DECL|method|getRemoteConnectionInfo
specifier|private
name|RemoteConnectionInfo
name|getRemoteConnectionInfo
parameter_list|(
