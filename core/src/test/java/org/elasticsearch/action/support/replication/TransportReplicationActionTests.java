...
begin_function
DECL|method|testRetryOnReplicaWithRealTransport
specifier|public
name|void
name|testRetryOnReplicaWithRealTransport
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// publish a new state (same as the old state with the version incremented)
name|setState
argument_list|(
name|clusterService
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// Assert that the request was retried, this time successfull
name|assertTrue
argument_list|(
literal|"action should have been successfully called on retry but was not"
argument_list|,
name|calledSuccessfully
operator|.
name|get
