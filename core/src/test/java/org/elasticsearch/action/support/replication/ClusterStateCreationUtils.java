...
return|;
block|}
comment|/**      * Creates cluster state with an index that has #(numberOfPrimaries) primary shards in the started state and no replicas.      * The cluster state contains #(numberOfNodes) nodes and assigns primaries to those nodes.      */
DECL|method|state
specifier|public
specifier|static
name|ClusterState
...
return|;
block|}
comment|/**      * Creates cluster state with the given indices, each index containing #(numberOfPrimaries)      * started primary shards and no replicas.  The cluster state contains #(numberOfNodes) nodes      * and assigns primaries to those nodes.      */
DECL|method|state
specifier|public
specifier|static
name|ClusterState
...
DECL|method|stateWithAssignedPrimariesAndReplicas
specifier|public
specifier|static
name|ClusterState
name|stateWithAssignedPrimariesAndReplicas
parameter_list|(
name|String
index|[]
name|indices
