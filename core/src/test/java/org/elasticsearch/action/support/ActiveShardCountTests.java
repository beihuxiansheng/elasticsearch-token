...
expr_stmt|;
block|}
DECL|method|testEnoughShardsActiveValueBased
specifier|public
name|void
name|testEnoughShardsActiveValueBased
parameter_list|()
block|{
comment|// enough shards active case
name|int
name|threshold
init|=
name|randomIntBetween
...
argument_list|)
expr_stmt|;
comment|// not enough shards active
name|waitForActiveShards
operator|=
name|ActiveShardCount
operator|.
...
argument_list|)
expr_stmt|;
comment|// wait for zero shards should always pass
name|assertTrue
argument_list|(
name|ActiveShardCount
operator|.
