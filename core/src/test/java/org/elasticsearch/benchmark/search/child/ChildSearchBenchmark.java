...
block|{
comment|/*         Run: MAVEN_OPTS=-Xmx4g mvn test-compile exec:java -Dexec.mainClass="org.elasticsearch.benchmark.search.child.ChildSearchBenchmark" -Dexec.classpathScope="test" -Dexec.args="bwc false"      */
DECL|method|main
specifier|public
specifier|static
name|void
...
argument_list|(
literal|"Uneven number of arguments"
argument_list|)
throw|;
block|}
for|for
...
argument_list|)
decl_stmt|;
comment|// enable bwc parent child mode:
if|if
condition|(
name|bwcMode
condition|)
