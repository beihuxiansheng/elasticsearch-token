...
expr_stmt|;
block|}
comment|// if there are no indices to open/close throw an exception
DECL|method|testOpenCloseWildCardsNoIndicesDefault
specifier|public
name|void
name|testOpenCloseWildCardsNoIndicesDefault
parameter_list|()
block|{
name|expectThrows
argument_list|(
...
expr_stmt|;
block|}
comment|// if there are no indices to open/close and allow_no_indices=true, the open/close is a no-op
DECL|method|testOpenCloseWildCardsNoIndicesAllowNoIndices
specifier|public
name|void
name|testOpenCloseWildCardsNoIndicesAllowNoIndices
parameter_list|()
throws|throws
