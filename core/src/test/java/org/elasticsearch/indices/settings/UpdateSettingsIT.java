...
name|ESIntegTestCase
block|{
DECL|method|testInvalidUpdateOnClosedIndex
specifier|public
name|void
name|testInvalidUpdateOnClosedIndex
parameter_list|()
block|{
name|createIndex
argument_list|(
...
name|put
argument_list|(
literal|"index.analysis.char_filter.invalid_char.type"
argument_list|,
literal|"invalid"
argument_list|)
argument_list|)
...
argument_list|()
argument_list|,
literal|"Unknown char_filter type [invalid] for [invalid_char]"
argument_list|)
expr_stmt|;
block|}
...
name|containsString
argument_list|(
literal|"final test setting [index.final], not updateable"
argument_list|)
argument_list|)
expr_stmt|;
name|indexMetaData
