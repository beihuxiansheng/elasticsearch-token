...
block|}
block|}
comment|/**      * Tests that teh {@link MapperService} created by {@link IndicesService#createIndexMapperService(IndexMetaData)} contains      * custom types and similarities registered by plugins      */
DECL|method|testStandAloneMapperServiceWithPlugins
specifier|public
name|void
name|testStandAloneMapperServiceWithPlugins
parameter_list|()
throws|throws
name|IOException
block|{
