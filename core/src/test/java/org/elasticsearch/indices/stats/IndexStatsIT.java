...
argument_list|)
decl_stmt|;
comment|// increasing the number of shards increases the number of chances any one stats request will hit a race
specifier|final
name|CreateIndexRequest
name|createIndexRequest
init|=
...
argument_list|()
expr_stmt|;
comment|// start threads that will index concurrently with stats requests
for|for
control|(
name|int
name|i
...
expr_stmt|;
block|}
comment|// start threads that will get stats concurrently with indexing
for|for
control|(
name|int
name|i
...
argument_list|()
expr_stmt|;
comment|// wait for a failure, or for fifteen seconds to elapse
name|latch
operator|.
name|await
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// stop all threads and wait for them to complete
name|stop
operator|.
name|set
argument_list|(
