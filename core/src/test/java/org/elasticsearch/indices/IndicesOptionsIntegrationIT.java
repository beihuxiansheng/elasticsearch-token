...
expr_stmt|;
block|}
DECL|method|testOpenCloseApiWildcards
specifier|public
name|void
name|testOpenCloseApiWildcards
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|()
expr_stmt|;
comment|// if there are no indices to open/close and allow_no_indices=true (default), the open/close is a no-op
name|verify
argument_list|(
name|client
argument_list|()
