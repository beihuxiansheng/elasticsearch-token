...
name|ESTestCase
block|{
DECL|field|emptyNodeSettings
specifier|private
specifier|final
name|Settings
name|emptyNodeSettings
init|=
name|Settings
operator|.
name|builder
...
block|}
block|}
comment|/**      * Tests that plugins can register pre-configured char filters that vary in behavior based on Elasticsearch version, Lucene version,      * and that do not vary based on version at all.      */
DECL|method|testPluginPreConfiguredCharFilters
specifier|public
name|void
name|testPluginPreConfiguredCharFilters
parameter_list|()
throws|throws
name|IOException
block|{
name|boolean
name|noVersionSupportsMultiTerm
init|=
name|randomBoolean
argument_list|()
decl_stmt|;
name|boolean
name|luceneVersionSupportsMultiTerm
init|=
name|randomBoolean
argument_list|()
decl_stmt|;
name|boolean
name|elasticsearchVersionSupportsMultiTerm
init|=
name|randomBoolean
argument_list|()
decl_stmt|;
...
name|put
argument_list|(
literal|"index.analysis.analyzer.no_version.tokenizer"
argument_list|,
literal|"keyword"
argument_list|)
operator|.
name|put
argument_list|(
literal|"index.analysis.analyzer.no_version.char_filter"
argument_list|,
literal|"no_version"
argument_list|)
operator|.
name|put
argument_list|(
literal|"index.analysis.analyzer.lucene_version.tokenizer"
argument_list|,
literal|"keyword"
argument_list|)
operator|.
name|put
argument_list|(
literal|"index.analysis.analyzer.lucene_version.char_filter"
argument_list|,
literal|"lucene_version"
argument_list|)
operator|.
name|put
argument_list|(
literal|"index.analysis.analyzer.elasticsearch_version.tokenizer"
argument_list|,
literal|"keyword"
argument_list|)
operator|.
name|put
argument_list|(
literal|"index.analysis.analyzer.elasticsearch_version.char_filter"
argument_list|,
literal|"elasticsearch_version"
argument_list|)
operator|.
...
expr_stmt|;
block|}
comment|/**      * Tests that plugins can register pre-configured token filters that vary in behavior based on Elasticsearch version, Lucene version,      * and that do not vary based on version at all.      */
DECL|method|testPluginPreConfiguredTokenFilters
specifier|public
name|void
name|testPluginPreConfiguredTokenFilters
parameter_list|()
throws|throws
name|IOException
block|{
...
name|put
argument_list|(
literal|"index.analysis.analyzer.no_version.filter"
argument_list|,
literal|"no_version"
argument_list|)
operator|.
...
name|put
argument_list|(
literal|"index.analysis.analyzer.lucene_version.filter"
argument_list|,
literal|"lucene_version"
argument_list|)
operator|.
...
name|put
argument_list|(
literal|"index.analysis.analyzer.elasticsearch_version.filter"
argument_list|,
literal|"elasticsearch_version"
argument_list|)
operator|.
...
block|}
comment|/**      * Tests that plugins can register pre-configured token filters that vary in behavior based on Elasticsearch version, Lucene version,      * and that do not vary based on version at all.      */
DECL|method|testPluginPreConfiguredTokenizers
specifier|public
name|void
name|testPluginPreConfiguredTokenizers
parameter_list|()
throws|throws
name|IOException
block|{
...
argument_list|()
decl_stmt|;
comment|// Simple tokenizer that always spits out a single token with some preconfigured characters
specifier|final
class|class
name|FixedTokenizer
extends|extends
...
argument_list|)
expr_stmt|;
comment|// These are current broken by https://github.com/elastic/elasticsearch/issues/24752
comment|//        assertEquals("test" + (noVersionSupportsMultiTerm ? "no_version" : ""),
comment|//                analyzers.get("no_version").normalize("", "test").utf8ToString());
comment|//        assertEquals("test" + (luceneVersionSupportsMultiTerm ? version.luceneVersion.toString() : ""),
comment|//                analyzers.get("lucene_version").normalize("", "test").utf8ToString());
comment|//        assertEquals("test" + (elasticsearchVersionSupportsMultiTerm ? version.toString() : ""),
comment|//                analyzers.get("elasticsearch_version").normalize("", "test").utf8ToString());
block|}
...
expr_stmt|;
block|}
comment|// Simple char filter that appends text to the term
DECL|class|AppendCharFilter
specifier|public
specifier|static
class|class
name|AppendCharFilter
...
name|appendMe
decl_stmt|;
DECL|field|offsetInAppendMe
specifier|private
name|int
name|offsetInAppendMe
init|=
operator|-
literal|1
decl_stmt|;
DECL|method|AppendCharFilter
specifier|public
name|AppendCharFilter
parameter_list|(
name|Reader
...
block|}
block|}
comment|// Simple token filter that appends text to the term
DECL|class|AppendTokenFilter
specifier|private
specifier|static
class|class
name|AppendTokenFilter
