...
expr_stmt|;
block|}
DECL|method|testDoubleAlias
specifier|public
name|void
name|testDoubleAlias
parameter_list|()
throws|throws
name|IOException
block|{
...
name|put
argument_list|(
literal|"index.analysis.analyzer.barfoo.alias"
argument_list|,
literal|"default"
argument_list|)
operator|.
name|put
argument_list|(
literal|"index.analysis.analyzer.barfoo.type"
argument_list|,
literal|"english"
argument_list|)
operator|.
...
name|assertEquals
argument_list|(
literal|"already registered analyzer with name: default"
argument_list|,
name|message
argument_list|)
expr_stmt|;
