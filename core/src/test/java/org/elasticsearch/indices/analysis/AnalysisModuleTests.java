...
expr_stmt|;
block|}
DECL|method|testAnalyzerAlias
specifier|public
name|void
name|testAnalyzerAlias
parameter_list|()
throws|throws
name|IOException
block|{
...
name|put
argument_list|(
literal|"index.analysis.analyzer.foobar_search.alias"
argument_list|,
...
name|put
argument_list|(
literal|"index.analysis.analyzer.foobar_search.type"
argument_list|,
literal|"english"
argument_list|)
operator|.
...
argument_list|()
argument_list|)
comment|// analyzer aliases are only allowed in 2.x indices
operator|.
name|put
argument_list|(
name|IndexMetaData
...
specifier|public
name|void
name|testAnalyzerAliasReferencesAlias
parameter_list|()
throws|throws
name|IOException
block|{
...
argument_list|)
expr_stmt|;
comment|// analyzer types are bound early before we resolve aliases
name|assertThat
argument_list|(
name|indexAnalyzers
operator|.
...
specifier|public
name|void
name|testAnalyzerAliasMoreThanOnce
parameter_list|()
throws|throws
name|IOException
block|{
...
name|put
argument_list|(
literal|"index.analysis.analyzer.foobar1.alias"
argument_list|,
literal|"default"
argument_list|)
operator|.
name|put
argument_list|(
literal|"index.analysis.analyzer.foobar1.type"
argument_list|,
literal|"english"
argument_list|)
comment|// analyzer aliases are only allowed in 2.x indices
...
name|assertEquals
argument_list|(
literal|"alias [default] is already used by [foobar]"
argument_list|,
name|ise
operator|.
name|getMessage
...
argument_list|()
argument_list|)
comment|// analyzer aliases are only allowed for 2.x indices
operator|.
name|put
argument_list|(
name|IndexMetaData
