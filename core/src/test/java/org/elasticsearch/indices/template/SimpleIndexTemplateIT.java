...
expr_stmt|;
block|}
DECL|method|testPartitionedTemplate
specifier|public
name|void
name|testPartitionedTemplate
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// provide more partitions than shards
name|IllegalArgumentException
name|eBadSettings
init|=
name|expectThrows
...
name|containsString
argument_list|(
literal|"partition size [6] should be a positive number "
operator|+
literal|"less than the number of shards [5]"
argument_list|)
argument_list|)
expr_stmt|;
comment|// provide an invalid mapping for a partitioned index
name|IllegalArgumentException
name|eBadMapping
init|=
name|expectThrows
...
name|containsString
argument_list|(
literal|"must have routing required for partitioned index"
argument_list|)
argument_list|)
expr_stmt|;
comment|// no templates yet
name|response
operator|=
name|client
argument_list|()
...
argument_list|)
expr_stmt|;
comment|// a valid configuration that only provides the partition size
name|assertAcked
argument_list|(
name|client
argument_list|()
...
argument_list|)
expr_stmt|;
comment|// create an index with too few shards
name|IllegalArgumentException
name|eBadIndex
init|=
name|expectThrows
...
argument_list|)
expr_stmt|;
comment|// finally, create a valid index
name|prepareCreate
argument_list|(
literal|"test_good"
argument_list|,
