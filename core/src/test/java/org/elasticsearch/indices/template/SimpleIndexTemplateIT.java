...
name|fail
argument_list|(
literal|"create index should have failed due to broken index templates mapping"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
name|fail
argument_list|(
literal|"index creation should have failed due to invalid alias filter in matching index template"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
name|fail
argument_list|(
literal|"put template should have failed due to alias with empty name"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
name|fail
argument_list|(
literal|"put template should have failed due to alias with multiple index routings"
argument_list|)
expr_stmt|;
block|}
catch|catch
