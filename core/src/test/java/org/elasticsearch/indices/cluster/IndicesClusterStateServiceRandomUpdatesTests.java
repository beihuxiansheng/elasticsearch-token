...
parameter_list|)
block|{
comment|// randomly remove no_master blocks
if|if
condition|(
name|randomBoolean
argument_list|()
...
expr_stmt|;
block|}
comment|// randomly add no_master blocks
if|if
condition|(
name|rarely
argument_list|()
...
expr_stmt|;
block|}
comment|// if no_master block is in place, make no other cluster state changes
if|if
condition|(
name|state
operator|.
