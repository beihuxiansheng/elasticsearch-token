...
annotation|@
name|Override
DECL|method|getTranslogStatus
specifier|protected
name|ShardIndexingStatus
name|getTranslogStatus
parameter_list|(
name|ShardId
name|shardId
parameter_list|)
...
condition|)
block|{
comment|// once a shard gets inactive it will be synced flushed and a new translog generation will be made
name|controller
operator|.
name|simulateFlush
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// we must make sure translog ops is never 0
name|controller
operator|.
name|forceCheck
argument_list|()
