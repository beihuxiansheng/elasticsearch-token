...
name|info
argument_list|(
literal|"Index creation timed out waiting for primaries to start - only index one doc and expect searches to fail"
argument_list|)
expr_stmt|;
block|}
else|else
...
name|info
argument_list|(
literal|"Index creation failed - only index one doc and expect searches to fail"
argument_list|)
expr_stmt|;
block|}
name|numDocs
