...
expr_stmt|;
block|}
comment|// Make sure we also pushed the tiny indexing buffer down to the underlying IndexWriter:
name|assertEquals
argument_list|(
name|EngineConfig
operator|.
...
annotation|@
name|Test
DECL|method|testIndexBufferSizeTwoShards
specifier|public
name|void
name|testIndexBufferSizeTwoShards
parameter_list|()
throws|throws
name|InterruptedException
block|{
...
annotation|@
name|Test
DECL|method|testIndexBufferNotPercent
specifier|public
name|void
name|testIndexBufferNotPercent
parameter_list|()
throws|throws
name|InterruptedException
block|{
comment|// #13487: Make sure you can specify non-percent sized index buffer and not hit NPE
name|createNode
argument_list|(
name|Settings
operator|.
