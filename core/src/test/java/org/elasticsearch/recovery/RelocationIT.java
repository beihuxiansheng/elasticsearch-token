...
name|TestLogging
argument_list|(
literal|"_root:DEBUG,org.elasticsearch.indices.recovery:TRACE,org.elasticsearch.index.shard.service:TRACE"
argument_list|)
annotation|@
name|LuceneTestCase
operator|.
...
name|bugUrl
operator|=
literal|"primary relocation needs to transfer the global check point. otherwise the new primary sends a "
operator|+
literal|"an unknown global checkpoint during sync, causing assertions to trigger"
argument_list|)
...
argument_list|()
operator|+
literal|" should have set the global checkpoint"
argument_list|,
name|primarySeqNoStats
operator|.
