...
name|emptyRegistry
decl_stmt|;
DECL|field|emptyIndexSettingsOfCurrentVersion
specifier|private
name|IndexSettings
name|emptyIndexSettingsOfCurrentVersion
decl_stmt|;
...
block|}
block|}
DECL|method|testPreConfiguredTokenFiltersAreCached
specifier|public
name|void
name|testPreConfiguredTokenFiltersAreCached
parameter_list|()
throws|throws
name|IOException
block|{
...
name|assertsBuiltOnce
init|=
operator|new
name|PreConfiguredTokenFilter
argument_list|(
literal|"asserts_built_once"
argument_list|,
literal|false
argument_list|,
name|PreBuiltCacheFactory
...
name|fail
argument_list|(
literal|"Attempted to build the token filter twice when it should have been cached"
argument_list|)
expr_stmt|;
block|}
return|return
...
init|(
name|AnalysisRegistry
name|registryWithPreBuiltTokenFilter
init|=
operator|new
name|AnalysisRegistry
argument_list|(
