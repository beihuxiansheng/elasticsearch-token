...
init|)
block|{
comment|// This config outputs different size of ngrams so graph analysis is disabled
name|assertTrue
argument_list|(
name|tokenStream
operator|.
...
init|)
block|{
comment|// This config uses only bigrams so graph analysis is enabled
name|assertFalse
argument_list|(
name|tokenStream
operator|.
