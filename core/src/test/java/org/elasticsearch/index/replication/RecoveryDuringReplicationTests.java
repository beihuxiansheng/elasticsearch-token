...
argument_list|)
expr_stmt|;
comment|// recovery has not completed, therefore the global checkpoint can have advanced on the primary
name|assertThat
argument_list|(
name|shards
operator|.
...
argument_list|)
expr_stmt|;
comment|// recovery is now in the process of being completed, therefore the global checkpoint can not have advanced on the primary
name|assertThat
argument_list|(
name|shards
operator|.
...
argument_list|)
expr_stmt|;
comment|// the global checkpoint advances can only advance here if a background global checkpoint sync fires
name|assertThat
argument_list|(
name|replica
operator|.
