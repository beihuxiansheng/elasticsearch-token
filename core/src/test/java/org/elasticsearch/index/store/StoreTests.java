...
return|;
block|}
comment|// this sucks it's a full copy of Lucene50SegmentInfoFormat but hey I couldn't find a way to make it write 4_5_0 versions
comment|// somebody was too paranoid when implementing this. ey rmuir, was that you? - go fix it :P
annotation|@
name|Override
specifier|public
name|void
...
block|{
comment|// even if we have a legacy checksum - if we use a new codec we should reuse
for|for
control|(
name|StoreFileMetaData
name|meta
...
block|}
block|{
comment|// negative check - wrong checksum
name|StoreFileMetaData
name|lucene
init|=
operator|new
...
block|}
block|{
comment|// negative check - wrong length
name|StoreFileMetaData
name|lucene
init|=
operator|new
...
block|}
block|{
comment|// negative check - wrong file
name|StoreFileMetaData
name|lucene
init|=
operator|new
...
specifier|public
name|void
name|testRecoveryDiffWithLegacyCommit
parameter_list|()
block|{
name|Map
argument_list|<
...
argument_list|)
expr_stmt|;
comment|// write one checksum file here - we expect it to survive all the cleanups
if|if
condition|(
name|randomBoolean
argument_list|()
...
name|assertEquals
argument_list|(
literal|"we wrote one checksum but it's gone now? - checksums are supposed to be kept"
argument_list|,
name|numChecksums
argument_list|,
literal|1
...
specifier|public
name|void
name|testCleanUpWithLegacyChecksums
parameter_list|()
throws|throws
name|IOException
block|{
