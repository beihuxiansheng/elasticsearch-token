...
argument_list|)
expr_stmt|;
comment|// check if primary has relocated to node3
name|assertEquals
argument_list|(
name|internalCluster
argument_list|()
...
name|Integer
argument_list|>
name|numPrimariesAndReplicas
init|=
name|randomPrimariesAndReplicas
argument_list|(
name|nodeCount
argument_list|)
decl_stmt|;
...
name|info
argument_list|(
literal|"--> creating index {} with {} primary shards and {} replicas"
argument_list|,
name|IDX
argument_list|,
name|numPrimaries
...
argument_list|)
expr_stmt|;
name|assertIndicesDirsDeleted
argument_list|(
name|nodes
argument_list|)
expr_stmt|;
block|}
DECL|method|testNodeJoinsWithoutShadowReplicaConfigured
specifier|public
name|void
name|testNodeJoinsWithoutShadowReplicaConfigured
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// the new node is not configured for a shadow replica index, so no shards should have been assigned to it
name|assertThat
argument_list|(
name|clusterHealth
operator|.
...
expr_stmt|;
block|}
DECL|method|assertIndicesDirsDeleted
specifier|private
specifier|static
name|void
name|assertIndicesDirsDeleted
...
block|}
block|}
DECL|method|randomPrimariesAndReplicas
specifier|private
specifier|static
name|Tuple
argument_list|<
...
condition|)
block|{
comment|// test with some nodes having no shards
name|numPrimaries
operator|=
literal|1
expr_stmt|;
...
block|{
comment|// test with all nodes having at least one shard
name|numPrimaries
operator|=
name|randomIntBetween
argument_list|(
