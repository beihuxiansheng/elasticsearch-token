...
block|}
block|}
DECL|method|testRecoveryUncommittedCorryptedCheckpoint
specifier|public
name|void
name|testRecoveryUncommittedCorryptedCheckpoint
parameter_list|()
throws|throws
name|IOException
block|{
...
condition|)
block|{
comment|// the buffered case will fail on the add if we exceed the buffer or will fail on the flush once we sync
if|if
condition|(
name|randomBoolean
argument_list|()
