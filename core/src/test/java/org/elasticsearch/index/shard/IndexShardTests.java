...
begin_function
DECL|method|testRefreshMetric
specifier|public
name|void
name|testRefreshMetric
parameter_list|()
throws|throws
name|IOException
block|{
...
argument_list|)
expr_stmt|;
comment|// one refresh on end of recovery, one on starting shard
name|long
name|initialTotalTime
init|=
name|shard
operator|.
name|refreshStats
...
begin_function
unit|}      public
DECL|method|testRecoverFromTranslog
name|void
name|testRecoverFromTranslog
parameter_list|()
throws|throws
name|IOException
block|{
...
begin_function
DECL|method|testTranslogOpToEngineOpConverter
specifier|public
name|void
name|testTranslogOpToEngineOpConverter
parameter_list|()
throws|throws
name|IOException
block|{
...
argument_list|)
decl_stmt|;
comment|// convert index op
name|Translog
operator|.
name|Index
name|translogIndexOp
init|=
operator|new
name|Translog
operator|.
...
argument_list|)
expr_stmt|;
comment|// convert delete op
name|Translog
operator|.
name|Delete
name|translogDeleteOp
init|=
operator|new
name|Translog
operator|.
