...
expr_stmt|;
block|}
DECL|method|testPostIndexWithException
specifier|public
name|void
name|testPostIndexWithException
parameter_list|()
throws|throws
name|IOException
block|{
name|createIndex
argument_list|(
literal|"testpostindexwithexception"
argument_list|)
expr_stmt|;
name|ensureGreen
argument_list|()
...
name|assertFalse
argument_list|(
literal|"it's already recovering"
argument_list|,
name|newShard
operator|.
name|recoverFromStore
...
expr_stmt|;
block|}
DECL|method|testListenersAreRemoved
specifier|public
name|void
name|testListenersAreRemoved
parameter_list|()
block|{
name|createIndex
argument_list|(
