...
condition|)
block|{
comment|// setSplitOnWhitespace(false) is disallowed when getAutoGeneratePhraseQueries() == true
name|queryStringQueryBuilder
operator|.
...
block|}
block|}
DECL|method|testToQueryWithGraph
specifier|public
name|void
name|testToQueryWithGraph
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// simple with additional tokens
name|query
operator|=
name|queryParser
operator|.
name|parse
argument_list|(
literal|"that guinea pig smells"
argument_list|)
expr_stmt|;
name|expectedQuery
operator|=
...
argument_list|)
expr_stmt|;
comment|// no parent should cause guinea and pig to be treated as separate tokens
name|query
operator|=
name|queryParser
operator|.
...
name|parse
argument_list|(
literal|"\"that guinea pig smells\"~2"
argument_list|)
expr_stmt|;
name|nearQuery
operator|=
...
expr_stmt|;
block|}
comment|/**      * Validates that {@code max_determinized_states} can be parsed and lowers the allowed number of determinized states.      */
DECL|method|testToQueryRegExpQueryMaxDeterminizedStatesParsing
specifier|public
name|void
name|testToQueryRegExpQueryMaxDeterminizedStatesParsing
parameter_list|()
throws|throws
name|Exception
block|{
...
name|containsString
argument_list|(
literal|"would result in more than 10 states"
argument_list|)
argument_list|)
expr_stmt|;
block|}
comment|/**      * Validates that {@code max_determinized_states} can be parsed and lowers the allowed number of determinized states.      */
DECL|method|testEnabledPositionIncrements
specifier|public
name|void
name|testEnabledPositionIncrements
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
DECL|method|testToQueryWildcardNonExistingFields
specifier|public
name|void
name|testToQueryWildcardNonExistingFields
parameter_list|()
throws|throws
name|IOException
block|{
...
block|}
block|}
DECL|method|testExistsFieldQuery
specifier|public
name|void
name|testExistsFieldQuery
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
DECL|method|testDisabledFieldNamesField
specifier|public
name|void
name|testDisabledFieldNamesField
parameter_list|()
throws|throws
name|Exception
block|{
...
operator|+
literal|"    \"max_determinized_states\" : 10000,\n"
operator|+
literal|"    \"enable_position_increments\" : true,\n"
operator|+
...
expr_stmt|;
block|}
DECL|method|testExpandedTerms
specifier|public
name|void
name|testExpandedTerms
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
DECL|method|testInvalidCombo
specifier|public
name|void
name|testInvalidCombo
parameter_list|()
throws|throws
name|IOException
block|{
...
argument_list|()
argument_list|,
literal|"it is disallowed to disable [split_on_whitespace] if [auto_generate_phrase_queries] is activated"
argument_list|)
expr_stmt|;
block|}
block|}
