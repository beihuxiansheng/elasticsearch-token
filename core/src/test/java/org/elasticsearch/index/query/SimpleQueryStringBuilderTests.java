...
expr_stmt|;
block|}
comment|/**              * TODO:              * Test disabled because we cannot check min should match consistently:              * https://github.com/elastic/elasticsearch/issues/23966              *                 if (queryBuilder.minimumShouldMatch() != null&& !boolQuery.isCoordDisabled()) {                 assertThat(boolQuery.getMinimumNumberShouldMatch(), greaterThan(0));                 }              *              **/
block|}
elseif|else
if|if
condition|(
...
name|bugUrl
operator|=
literal|"Waiting on fix for minimumShouldMatch https://github.com/elastic/elasticsearch/issues/23966"
argument_list|)
