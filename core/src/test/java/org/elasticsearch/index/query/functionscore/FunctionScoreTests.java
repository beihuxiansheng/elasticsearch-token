...
block|}
block|}
DECL|method|testExplanationAndScoreEqualsEvenIfNoFunctionMatches
specifier|public
name|void
name|testExplanationAndScoreEqualsEvenIfNoFunctionMatches
parameter_list|()
throws|throws
name|IOException
block|{
...
argument_list|)
decl_stmt|;
comment|// check for document that has no macthing function
name|FiltersFunctionScoreQuery
name|query
init|=
operator|new
...
argument_list|)
expr_stmt|;
comment|// check for document that has a matching function
name|query
operator|=
operator|new
name|FiltersFunctionScoreQuery
...
expr_stmt|;
block|}
DECL|method|testWeightFactorNeedsScore
specifier|public
name|void
name|testWeightFactorNeedsScore
parameter_list|()
block|{
for|for
control|(
