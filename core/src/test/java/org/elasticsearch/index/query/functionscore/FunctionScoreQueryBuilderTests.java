...
parameter_list|()
block|{
comment|// do not shuffle fields that may contain arbitrary content
return|return
name|SHUFFLE_PROTECTED_FIELDS
return|;
block|}
...
parameter_list|()
block|{
comment|//script_score.script.params can contain arbitrary parameters. no error is expected when adding additional objects
comment|//within the params object. Score functions get parsed in the data nodes, so they are not validated in the coord node.
return|return
operator|new
name|HashSet
argument_list|<>
