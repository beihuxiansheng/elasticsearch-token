...
comment|//few queries also don't support boost e.g. wrapper query and filter query
...
parameter_list|()
block|{
comment|// if no type is set then return random field name and value
if|if
condition|(
name|currentTypes
operator|==
...
break|break;
block|}
comment|// all other fields assigned to random string
comment|// unmapped fields
if|if
condition|(
name|randomBoolean
argument_list|()
