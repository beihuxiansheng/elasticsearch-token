...
expr_stmt|;
block|}
DECL|method|testMatchPhrasePrefixWithBoost
specifier|public
name|void
name|testMatchPhrasePrefixWithBoost
parameter_list|()
throws|throws
name|Exception
block|{
...
name|assumeTrue
argument_list|(
literal|"test runs only when the index version is on or after V_5_0_0_alpha1"
argument_list|,
name|context
operator|.
...
expr_stmt|;
block|{
comment|// field boost is applied on a single term query
...
block|}
block|{
comment|// field boost is ignored on phrase query
name|MatchPhrasePrefixQueryBuilder
name|builder
init|=
operator|new
