...
expr_stmt|;
block|}
DECL|method|testParsingToplevelArray
specifier|public
name|void
name|testParsingToplevelArray
parameter_list|()
throws|throws
name|IOException
block|{
...
expr_stmt|;
block|}
DECL|method|testParsingFiltersArray
specifier|public
name|void
name|testParsingFiltersArray
parameter_list|()
throws|throws
name|IOException
block|{
...
name|queryString
init|=
literal|"{ \"and\" : { \"filters\" : [ { \"match_all\" : {} } ], \"boost\" : 0.7 } }"
decl_stmt|;
name|XContentParser
name|parser
init|=
...
name|class
argument_list|)
DECL|method|testParsingExceptionNonFiltersElementArray
specifier|public
name|void
name|testParsingExceptionNonFiltersElementArray
parameter_list|()
throws|throws
name|IOException
block|{
...
name|queryString
init|=
literal|"{ \"and\" : { \"whatever_filters\" : [ { \"match_all\" : {} } ] } }"
decl_stmt|;
name|XContentParser
name|parser
init|=
