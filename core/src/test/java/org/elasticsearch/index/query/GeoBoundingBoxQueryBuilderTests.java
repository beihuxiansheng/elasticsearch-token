...
name|assertNull
argument_list|(
literal|"validation w/ coerce should ignore invalid "
operator|+
name|tester
operator|.
name|getClass
...
name|assertNotNull
argument_list|(
literal|"validation w/o coerce should detect invalid coordinate: "
operator|+
name|tester
operator|.
name|getClass
...
condition|)
block|{
comment|// TODO: remove the if statement once we always use LatLonPoint
name|Query
name|indexQuery
init|=
operator|(
