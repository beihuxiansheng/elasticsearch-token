...
name|assertEquals
argument_list|(
literal|"[match_phrase_prefix] requires fieldName"
argument_list|,
name|e
operator|.
name|getMessage
...
name|assertEquals
argument_list|(
literal|"[match_phrase_prefix] requires query value"
argument_list|,
name|e
operator|.
name|getMessage
...
name|assertEquals
argument_list|(
literal|"[match_phrase_prefix] query doesn't support multiple fields, found [message1] and [message2]"
argument_list|,
name|e
operator|.
name|getMessage
