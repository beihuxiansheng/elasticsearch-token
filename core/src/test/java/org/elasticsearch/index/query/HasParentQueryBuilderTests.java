...
block|{
comment|//TODO
comment|/*if (queryBuilder.score()) {                 assertThat(query, instanceOf(ParentQuery.class));                 ParentQuery pq = (ParentQuery) query;                 assertEquals(queryBuilder.boost(), pq.getBoost(), 0f);             } else {                 assertThat(query, instanceOf(ParentConstantScoreQuery.class));                 ParentConstantScoreQuery csq = (ParentConstantScoreQuery) query;                 assertEquals(queryBuilder.boost(), csq.getBoost(), 0f);             }*/
block|}
if|if
condition|(
name|queryBuilder
