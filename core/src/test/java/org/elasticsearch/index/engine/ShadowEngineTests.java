...
argument_list|)
expr_stmt|;
comment|// so that points report memory/disk usage
return|return
operator|new
name|ParsedDocument
argument_list|(
...
return|;
block|}
comment|//    protected Term newUid(String id) {
comment|//        return new Term("_uid", id);
comment|//    }
DECL|method|newUid
specifier|protected
name|Term
...
block|}
block|}
DECL|method|testRefreshListenersFails
specifier|public
name|void
name|testRefreshListenersFails
parameter_list|()
throws|throws
name|IOException
block|{
