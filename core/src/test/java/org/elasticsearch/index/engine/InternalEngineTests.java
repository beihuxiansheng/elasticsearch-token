...
block|}
block|}
DECL|method|testSegmentsWithIndexSort
specifier|public
name|void
name|testSegmentsWithIndexSort
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
block|{
block|@Override                     public long generateSeqNo(
argument_list|)
block|{
return|return
name|seqNos
...
begin_function
DECL|method|testCommitAdvancesMinTranslogForRecovery
specifier|public
name|void
name|testCommitAdvancesMinTranslogForRecovery
parameter_list|()
throws|throws
name|IOException
block|{
...
begin_function
DECL|method|testTranslogCleanUpPostCommitCrash
specifier|public
name|void
name|testTranslogCleanUpPostCommitCrash
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
comment|// test index with document failure
name|Engine
operator|.
name|IndexResult
name|indexResult
...
argument_list|)
expr_stmt|;
comment|// skip to the op that we added to the translog
name|Translog
operator|.
name|Operation
name|op
...
begin_function
DECL|method|testFillUpSequenceIdGapsOnRecovery
specifier|public
name|void
name|testFillUpSequenceIdGapsOnRecovery
parameter_list|()
throws|throws
name|IOException
block|{
...
decl_stmt|;
name|int
name|numDocsOnReplica
init|=
literal|0
decl_stmt|;
name|long
name|maxSeqIDOnReplica
init|=
operator|-
literal|1
decl_stmt|;
name|long
name|checkpointOnReplica
decl_stmt|;
try|try
block|{
for|for
...
argument_list|)
expr_stmt|;
comment|// now snapshot the tlog and ensure the primary term is updated
name|Translog
operator|.
name|Snapshot
name|snapshot
...
expr_stmt|;
block|}
comment|// now do it again to make sure we preserve values etc.
try|try
block|{
name|recoveringEngine
operator|=
