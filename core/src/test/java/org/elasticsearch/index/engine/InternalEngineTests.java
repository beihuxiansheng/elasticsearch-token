...
name|fail
argument_list|(
literal|"shouldn't have refreshed cause a flush is just done"
argument_list|)
argument_list|)
argument_list|)
expr_stmt|;
...
name|fail
argument_list|(
literal|"shouldn't have refreshed cause the document is deleted"
argument_list|)
argument_list|)
expr_stmt|;
name|assertThat
...
name|fail
argument_list|(
literal|"shouldn't have refreshed cause document doesn't exists"
argument_list|)
argument_list|)
expr_stmt|;
name|assertThat
