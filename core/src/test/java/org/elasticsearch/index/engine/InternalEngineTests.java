...
argument_list|)
expr_stmt|;
comment|// now, the old one should produce an indexing result
specifier|final
name|Engine
operator|.
name|Index
...
argument_list|)
expr_stmt|;
comment|// second time delete with same version should just produce the same version
specifier|final
name|Engine
operator|.
name|DeleteResult
name|deleteReplayResult
init|=
name|replicaEngine
operator|.
name|delete
...
argument_list|)
expr_stmt|;
comment|// now do the second index on the replica, it should result in the current version
specifier|final
name|Engine
operator|.
name|Index
