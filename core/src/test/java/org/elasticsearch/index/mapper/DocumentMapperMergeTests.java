...
begin_class
DECL|class|DocumentMapperMergeTests
specifier|public
class|class
name|DocumentMapperMergeTests
extends|extends
name|ESSingleNodeTestCase
block|{
...
expr_stmt|;
block|}
DECL|method|testMergeChildType
specifier|public
name|void
name|testMergeChildType
parameter_list|()
throws|throws
name|IOException
block|{
...
name|containsString
argument_list|(
literal|"The _parent field's type option can't be changed: [parent]->[new_parent]"
argument_list|)
argument_list|)
expr_stmt|;
block|}
DECL|method|testMergeAddingParent
specifier|public
name|void
name|testMergeAddingParent
parameter_list|()
throws|throws
name|IOException
block|{
