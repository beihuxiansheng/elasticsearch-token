...
expr_stmt|;
block|}
DECL|method|testIndexSortWithNestedFields
specifier|public
name|void
name|testIndexSortWithNestedFields
parameter_list|()
throws|throws
name|IOException
block|{
...
name|startsWith
argument_list|(
literal|"Rejecting mapping update to [test] as the final mapping would have more than 1 type: "
argument_list|)
argument_list|)
expr_stmt|;
block|}
