...
expr_stmt|;
block|}
DECL|method|testParseNullValue
specifier|public
name|void
name|testParseNullValue
parameter_list|()
throws|throws
name|Exception
block|{
...
name|mapper
init|=
name|createIndexWithTokenCountField
argument_list|()
decl_stmt|;
name|ParseContext
operator|.
...
expr_stmt|;
block|}
DECL|method|testParseEmptyValue
specifier|public
name|void
name|testParseEmptyValue
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
DECL|method|testParseNotNullValue
specifier|public
name|void
name|testParseNotNullValue
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
DECL|method|createIndexWithTokenCountField
specifier|private
name|DocumentMapper
name|createIndexWithTokenCountField
parameter_list|()
...
argument_list|(
literal|"Test object not parsed"
argument_list|)
argument_list|)
return|;
block|}
