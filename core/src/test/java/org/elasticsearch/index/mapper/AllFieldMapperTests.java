...
begin_class
DECL|class|AllFieldMapperTests
specifier|public
class|class
name|AllFieldMapperTests
extends|extends
name|ESSingleNodeTestCase
block|{
annotation|@
...
condition|)
block|{
comment|// The field "name.last" is boosted so we should see AllTokenStream used:
name|assertThat
argument_list|(
name|fields
index|[
...
name|copyToStringFromClasspath
argument_list|(
literal|"/org/elasticsearch/index/mapper/all/"
operator|+
literal|"multifield-mapping_include_in_all_set_to_false.json"
argument_list|)
decl_stmt|;
name|DocumentMapper
name|docMapper
...
parameter_list|()
block|{
comment|// We use to have a bug with the default mapping having null analyzers because
comment|// it was not fully constructed and was in particular lacking analyzers
name|IndexService
name|index
init|=
name|createIndex
