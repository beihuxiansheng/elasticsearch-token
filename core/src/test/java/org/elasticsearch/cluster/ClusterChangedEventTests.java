...
expr_stmt|;
block|}
comment|/**      * Test custom metadata change checks      */
DECL|method|testChangedCustomMetaDataSet
specifier|public
name|void
name|testChangedCustomMetaDataSet
parameter_list|()
block|{
specifier|final
name|int
...
argument_list|)
decl_stmt|;
comment|// no custom metadata present in any state
name|ClusterState
name|nextState
init|=
name|ClusterState
...
argument_list|)
expr_stmt|;
comment|// next state has new custom metadata
name|nextState
operator|=
name|nextState
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// next state has same custom metadata
name|nextState
operator|=
name|nextState
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// next state has equivalent custom metadata
name|nextState
operator|=
name|nextState
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// next state removes custom metadata
name|nextState
operator|=
name|originalState
expr_stmt|;
...
argument_list|)
expr_stmt|;
comment|// next state updates custom metadata
name|nextState
operator|=
name|nextState
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// next state adds new custom metadata type
...
argument_list|)
expr_stmt|;
comment|// next state adds two custom metadata type
name|nextState
operator|=
name|nextState
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// next state removes two custom metadata type
name|nextState
operator|=
name|originalState
expr_stmt|;
