...
argument_list|)
decl_stmt|;
DECL|field|INDICES_CHANGE_NUM_TESTS
specifier|private
specifier|static
specifier|final
name|int
name|INDICES_CHANGE_NUM_TESTS
init|=
literal|5
decl_stmt|;
...
expr_stmt|;
block|}
comment|/**      * Test that the indices created and indices deleted lists between two cluster states      * are correct when there is no change in the cluster UUID.  Also tests metadata equality      * between cluster states.      */
DECL|method|testMetaDataChangesOnNoMasterChange
specifier|public
name|void
name|testMetaDataChangesOnNoMasterChange
parameter_list|()
block|{
name|metaDataChangesCheck
argument_list|(
literal|false
argument_list|)
expr_stmt|;
block|}
comment|/**      * Test that the indices created and indices deleted lists between two cluster states      * are correct when there is a change in the cluster UUID.  Also tests metadata equality      * between cluster states.      */
DECL|method|testMetaDataChangesOnNewClusterUUID
specifier|public
name|void
name|testMetaDataChangesOnNewClusterUUID
parameter_list|()
block|{
name|metaDataChangesCheck
argument_list|(
...
expr_stmt|;
block|}
comment|// Tests that the indices change list is correct as well as metadata equality when the metadata has changed.
DECL|method|metaDataChangesCheck
specifier|private
specifier|static
name|void
name|metaDataChangesCheck
...
argument_list|)
decl_stmt|;
comment|// delete random # of indices from the next cluster state
specifier|final
name|List
argument_list|<
name|String
