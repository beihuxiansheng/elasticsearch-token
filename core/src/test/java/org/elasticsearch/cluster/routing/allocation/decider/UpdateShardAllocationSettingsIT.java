...
begin_comment
comment|/**  * An integration test for testing updating shard allocation/routing settings and  * ensuring the updated settings take effect as expected.  */
end_comment
...
literal|0
argument_list|)
DECL|class|UpdateShardAllocationSettingsIT
specifier|public
class|class
name|UpdateShardAllocationSettingsIT
extends|extends
name|ESIntegTestCase
block|{
comment|/**      * Tests that updating the {@link EnableAllocationDecider} related settings works as expected.      */
...
expr_stmt|;
block|}
comment|/**      * Tests that updating the {@link SameShardAllocationDecider#CLUSTER_ROUTING_ALLOCATION_SAME_HOST_SETTING} setting works as expected.      */
...
argument_list|)
expr_stmt|;
comment|// same same_host to true, since 2 nodes are started on the same host,
comment|// only primaries should be assigned
name|client
argument_list|()
operator|.
name|admin
...
name|assertFalse
argument_list|(
literal|"replica should be unassigned"
argument_list|,
name|clusterState
operator|.
...
argument_list|)
expr_stmt|;
comment|// now, update the same_host setting to allow shards to be allocated to multiple nodes on
comment|// the same host - the replica should get assigned
name|client
argument_list|()
operator|.
name|admin
...
name|assertTrue
argument_list|(
literal|"all shards should be assigned"
argument_list|,
name|clusterState
operator|.
name|getRoutingTable
