...
condition|)
block|{
comment|// make sure there is an active replica to prevent from going red
if|if
condition|(
name|clusterState
operator|.
...
name|debug
argument_list|(
literal|"not removing node [{}] as it holds a primary with no replacement"
argument_list|,
name|nodeId
argument_list|)
expr_stmt|;
...
name|info
argument_list|(
literal|"Done Balancing after [{}] iterations. State:\n{}"
argument_list|,
name|iterations
argument_list|,
name|clusterState
