...
argument_list|)
decl_stmt|;
comment|// a test only map that always returns the same value no matter what key is passed
DECL|class|StaticValueMap
specifier|private
specifier|static
specifier|final
class|class
...
argument_list|(
literal|"this is a test-only map that only supports #get(Object key)"
argument_list|)
throw|;
block|}
block|}
