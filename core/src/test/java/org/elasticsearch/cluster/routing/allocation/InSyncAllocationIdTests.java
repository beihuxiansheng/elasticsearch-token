...
expr_stmt|;
block|}
comment|/**      * Only trim set of allocation ids when the set grows      */
DECL|method|testInSyncIdsNotTrimmedWhenNotGrowing
specifier|public
name|void
name|testInSyncIdsNotTrimmedWhenNotGrowing
parameter_list|()
throws|throws
name|Exception
block|{
...
name|info
argument_list|(
literal|"decrease number of replicas to 0"
argument_list|)
expr_stmt|;
name|clusterState
operator|=
...
expr_stmt|;
block|}
comment|/**      * Don't remove allocation id of failed active primary if there is no replica to promote as primary.      */
DECL|method|testPrimaryAllocationIdNotRemovedFromInSyncSetWhenNoFailOver
specifier|public
name|void
name|testPrimaryAllocationIdNotRemovedFromInSyncSetWhenNoFailOver
parameter_list|()
throws|throws
name|Exception
block|{
