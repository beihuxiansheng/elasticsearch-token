...
name|info
argument_list|(
literal|"--> testing shard variants that shouldn't match the started shard"
argument_list|)
expr_stmt|;
name|result
operator|=
...
name|assertFalse
argument_list|(
literal|"wrong primary flag shouldn't start shard "
operator|+
name|initShard
operator|+
literal|"\ncurrent routing table:"
...
name|assertFalse
argument_list|(
literal|"relocating shard to node shouldn't start shard "
operator|+
name|initShard
operator|+
literal|"\ncurrent routing table:"
...
name|info
argument_list|(
literal|"--> testing shard variants that shouldn't match the relocating shard"
argument_list|)
expr_stmt|;
name|result
operator|=
...
name|assertFalse
argument_list|(
literal|"relocating shard to a different node shouldn't start shard "
operator|+
name|relocatingShard
operator|+
literal|"\ncurrent routing table:"
...
name|assertFalse
argument_list|(
literal|"relocating shard from a different node shouldn't start shard "
operator|+
name|relocatingShard
operator|+
literal|"\ncurrent routing table:"
...
name|assertFalse
argument_list|(
literal|"non-relocating shard shouldn't start shard"
operator|+
name|relocatingShard
operator|+
literal|"\ncurrent routing table:"
