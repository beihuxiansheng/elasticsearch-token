...
name|Exception
block|{
name|testFilteringByIndexWorks
argument_list|(
operator|new
name|String
index|[]
...
expr_stmt|;
block|}
comment|/**      * Retrieves the cluster state for the given indices and then checks      * that the cluster state returns coherent data for both routing table and metadata.      */
DECL|method|testFilteringByIndexWorks
specifier|private
name|void
name|testFilteringByIndexWorks
parameter_list|(
