...
return|;
block|}
DECL|method|testTimedOutUpdateTaskCleanedUp
specifier|public
name|void
name|testTimedOutUpdateTaskCleanedUp
parameter_list|()
throws|throws
name|Exception
block|{
...
name|containsString
argument_list|(
literal|"not be the cluster state update thread. Reason: [Blocking operation]"
argument_list|)
argument_list|)
expr_stmt|;
block|}
...
begin_function
DECL|method|testDisconnectFromNewlyAddedNodesIfClusterStatePublishingFails
specifier|public
name|void
name|testDisconnectFromNewlyAddedNodesIfClusterStatePublishingFails
parameter_list|()
throws|throws
name|InterruptedException
block|{
...
argument_list|)
decl_stmt|;
comment|// try to add node when cluster state publishing fails
name|failToCommit
operator|.
name|set
argument_list|(
