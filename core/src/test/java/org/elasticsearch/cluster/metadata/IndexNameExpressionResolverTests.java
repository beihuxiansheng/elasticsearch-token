...
expr_stmt|;
block|}
DECL|method|testConcreteIndicesWildcardAndAliases
specifier|public
name|void
name|testConcreteIndicesWildcardAndAliases
parameter_list|()
block|{
name|MetaData
operator|.
...
argument_list|()
decl_stmt|;
comment|// when ignoreAliases option is set, concreteIndexNames resolves the provided expressions
comment|// only against the defined indices
name|IndicesOptions
name|ignoreAliasesOptions
init|=
name|IndicesOptions
operator|.
name|fromOptions
...
argument_list|)
expr_stmt|;
comment|// when ignoreAliases option is not set, concreteIndexNames resolves the provided
comment|// expressions against the defined indices and aliases
name|IndicesOptions
name|indicesAndAliasesOptions
init|=
name|IndicesOptions
operator|.
name|fromOptions
...
expr_stmt|;
block|}
DECL|method|testIndexAliases
specifier|public
name|void
name|testIndexAliases
parameter_list|()
block|{
name|MetaData
operator|.
...
name|builder
argument_list|(
literal|"test-alias-non-filtering"
argument_list|)
argument_list|)
argument_list|)
decl_stmt|;
...
expr_stmt|;
block|}
DECL|method|testConcreteIndicesForDeprecatedPattern
specifier|public
name|void
name|testConcreteIndicesForDeprecatedPattern
parameter_list|()
block|{
name|MetaData
operator|.
...
name|assertWarnings
argument_list|(
literal|"support for '+' as part of index expressions is deprecated"
argument_list|)
expr_stmt|;
block|}
DECL|method|testDeleteIndexIgnoresAliases
specifier|public
name|void
name|testDeleteIndexIgnoresAliases
parameter_list|()
block|{
name|MetaData
operator|.
...
block|}
block|}
DECL|method|testIndicesAliasesRequestIgnoresAliases
specifier|public
name|void
name|testIndicesAliasesRequestIgnoresAliases
parameter_list|()
block|{
name|MetaData
operator|.
