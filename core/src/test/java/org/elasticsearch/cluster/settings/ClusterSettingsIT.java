...
block|}
block|}
comment|//    @TestLogging("_root:DEBUG")
...
expr_stmt|;
comment|//            } else {
comment|//                client().admin().cluster().prepareUpdateSettings().setTransientSettings(Settings.builder().putNull("logger.*")).execute().actionGet();
comment|//            }
name|assertEquals
argument_list|(
name|testLevel
