...
argument_list|()
argument_list|,
literal|"Failed to parse setting [discovery.zen.commit_timeout] with value [whatever] as a time value: unit is missing or unrecognized"
argument_list|)
expr_stmt|;
block|}
name|assertThat
...
block|{
comment|// Restore the default so subsequent tests require units:
name|assertFalse
argument_list|(
name|Settings
operator|.
