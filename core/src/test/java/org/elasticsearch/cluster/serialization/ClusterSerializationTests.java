...
expr_stmt|;
block|}
DECL|method|testSnapshotDeletionsInProgressSerialization
specifier|public
name|void
name|testSnapshotDeletionsInProgressSerialization
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
decl_stmt|;
comment|// serialize with current version
name|BytesStreamOutput
name|outStream
init|=
operator|new
...
argument_list|)
expr_stmt|;
comment|// serialize with old version
name|outStream
operator|=
operator|new
name|BytesStreamOutput
...
argument_list|)
expr_stmt|;
comment|// remove the custom and try serializing again with old version
name|clusterState
operator|=
name|ClusterState
operator|.
