...
expr_stmt|;
block|}
DECL|method|testRowOutOfBounds
specifier|public
name|void
name|testRowOutOfBounds
parameter_list|()
block|{
name|Table
name|table
...
name|assertEquals
argument_list|(
literal|"Invalid comparison of indices (0, 1): Table has 0 rows."
argument_list|,
name|e
operator|.
name|getMessage
...
expr_stmt|;
block|}
DECL|method|testUnknownHeader
specifier|public
name|void
name|testUnknownHeader
parameter_list|()
block|{
name|Table
name|table
...
name|assertEquals
argument_list|(
literal|"Unable to sort by unknown sort key `notaheader`"
argument_list|,
name|e
operator|.
name|getMessage
...
expr_stmt|;
block|}
DECL|method|testReversedSort
specifier|public
name|void
name|testReversedSort
parameter_list|()
block|{
name|Table
name|table
...
literal|"s"
argument_list|,
literal|"compare,second.compare"
argument_list|)
expr_stmt|;
name|List
argument_list|<
...
literal|"s"
argument_list|,
literal|"compare:desc,second.compare"
argument_list|)
expr_stmt|;
name|rowOrder
operator|=
