...
expr_stmt|;
block|}
DECL|method|testInstallPluginVerbose
specifier|public
name|void
name|testInstallPluginVerbose
parameter_list|()
throws|throws
name|IOException
block|{
...
expr_stmt|;
block|}
comment|/**      * @deprecated support for this is not going to stick around, seriously.      */
annotation|@
name|Deprecated
DECL|method|testAlreadyInstalledNotIsolated
specifier|public
name|void
name|testAlreadyInstalledNotIsolated
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// create a jar file in the plugin
name|Path
name|pluginJar
init|=
name|pluginDir
...
name|assertEquals
argument_list|(
literal|"unexpected exit status: output: "
operator|+
name|terminal
operator|.
name|getTerminalOutput
...
expr_stmt|;
block|}
DECL|method|testInstallSitePluginVerbose
specifier|public
name|void
name|testInstallSitePluginVerbose
parameter_list|()
throws|throws
name|IOException
block|{
