...
block|}
block|}
DECL|method|testPersistentNodeId
specifier|public
name|void
name|testPersistentNodeId
parameter_list|()
throws|throws
name|IOException
block|{
...
name|assertThat
argument_list|(
literal|"previous node didn't have local storage enabled, id should change"
argument_list|,
name|env
operator|.
name|nodeId
