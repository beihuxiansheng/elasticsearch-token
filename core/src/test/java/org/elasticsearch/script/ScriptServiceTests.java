...
block|}
block|}
DECL|method|testInvalidScriptNames
specifier|public
name|void
name|testInvalidScriptNames
parameter_list|()
throws|throws
name|IOException
block|{
...
expr_stmt|;
block|}
DECL|method|testValidScriptName
specifier|public
name|void
name|testValidScriptName
parameter_list|()
throws|throws
name|IOException
block|{
...
expr_stmt|;
block|}
DECL|method|testScriptChangesListenerOnceHiddenFileDetected
specifier|public
name|void
name|testScriptChangesListenerOnceHiddenFileDetected
parameter_list|()
throws|throws
name|IOException
block|{
...
parameter_list|)
block|{
comment|//script without name because it is a hidden file
name|assertThat
argument_list|(
name|ex
operator|.
...
name|containsString
argument_list|(
literal|"Unable to find on disk file script [] using lang [test]"
argument_list|)
argument_list|)
expr_stmt|;
block|}
