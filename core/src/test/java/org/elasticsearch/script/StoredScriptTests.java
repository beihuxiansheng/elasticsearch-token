...
expr_stmt|;
block|}
comment|// complex script using "code" backcompat
try|try
init|(
name|XContentBuilder
name|builder
...
name|assertWarnings
argument_list|(
literal|"Deprecated field [code] used, expected [source] instead"
argument_list|)
expr_stmt|;
...
expr_stmt|;
block|}
comment|// check for missing source parameter when parsing a script
try|try
init|(
name|XContentBuilder
name|builder
