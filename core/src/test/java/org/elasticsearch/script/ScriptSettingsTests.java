...
name|ESTestCase
block|{
DECL|method|testConflictingModesForLanguage
specifier|public
name|void
name|testConflictingModesForLanguage
parameter_list|()
block|{
...
name|fail
argument_list|(
literal|"should have seen conflicting settings"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
name|containsString
argument_list|(
literal|"conflicting settings [{off=[test1], on=[test2]}] for language [test3]"
argument_list|)
argument_list|,
name|containsString
argument_list|(
literal|"conflicting settings [{on=[test2], on=[test1]}] for language [test3]"
argument_list|)
argument_list|)
argument_list|)
expr_stmt|;
