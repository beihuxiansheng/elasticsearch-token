...
expr_stmt|;
block|}
DECL|method|testIgnoreResponseFromDifferentRound
specifier|public
name|void
name|testIgnoreResponseFromDifferentRound
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// handle a response with incorrect round id, wait on reroute incrementing
name|test
operator|.
...
argument_list|)
expr_stmt|;
comment|// fire a response (with correct round id), wait on reroute incrementing
name|test
operator|.
name|fireSimulationAndWait
argument_list|(
...
expr_stmt|;
block|}
DECL|method|testIgnoreFailureFromDifferentRound
specifier|public
name|void
name|testIgnoreFailureFromDifferentRound
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// handle a failure with incorrect round id, wait on reroute incrementing
name|test
operator|.
name|processAsyncFetch
argument_list|(
