...
expr_stmt|;
block|}
DECL|method|testUpdateTemplateMetaDataOnUpgrade
specifier|public
name|void
name|testUpdateTemplateMetaDataOnUpgrade
parameter_list|()
throws|throws
name|Exception
block|{
...
block|}
block|}
DECL|method|testIndexTemplateValidation
specifier|public
name|void
name|testIndexTemplateValidation
parameter_list|()
throws|throws
name|Exception
block|{
...
name|IllegalStateException
argument_list|(
literal|"template is incompatible"
argument_list|)
throw|;
block|}
argument_list|)
...
expr_stmt|;
block|}
DECL|method|testMultipleIndexTemplateUpgrade
specifier|public
name|void
name|testMultipleIndexTemplateUpgrade
parameter_list|()
throws|throws
name|Exception
block|{
...
name|metaData
operator|=
name|randomMetaDataWithIndexTemplates
argument_list|(
literal|"template1"
argument_list|,
literal|"template2"
...
return|;
block|}
DECL|method|randomMetaDataWithIndexTemplates
specifier|private
specifier|static
name|MetaData
name|randomMetaDataWithIndexTemplates
