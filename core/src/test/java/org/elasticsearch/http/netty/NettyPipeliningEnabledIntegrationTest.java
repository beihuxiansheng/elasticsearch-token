...
literal|1
argument_list|)
DECL|class|NettyPipeliningEnabledIntegrationTest
specifier|public
class|class
name|NettyPipeliningEnabledIntegrationTest
extends|extends
name|ElasticsearchIntegrationTest
block|{
annotation|@
...
name|ROOT
argument_list|,
literal|"Expected list of opaque ids to be monotonically increasing, got ["
operator|+
name|opaqueIds
operator|+
literal|"]"
