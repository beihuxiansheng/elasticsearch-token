...
name|info
argument_list|(
literal|"--> testing rejection of an old cluster state"
argument_list|)
expr_stmt|;
name|state
operator|=
...
name|fail
argument_list|(
literal|"node accepted state with an older version"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
parameter_list|)
block|{         }
comment|// an older version from a *new* master is OK!
name|ClusterState
name|previousState
init|=
name|ClusterState
...
argument_list|()
expr_stmt|;
comment|// another incoming state is OK. Should just override pending state
name|node
operator|.
name|action
operator|.
...
argument_list|()
expr_stmt|;
comment|// committing previous state should fail
try|try
block|{
name|node
operator|.
...
argument_list|)
expr_stmt|;
comment|// sadly, there are ways to percolate errors
name|assertThat
argument_list|(
name|channel
operator|.
...
argument_list|()
expr_stmt|;
comment|// committing second state should succeed
name|node
operator|.
name|action
operator|.
...
argument_list|()
expr_stmt|;
comment|// now check it was really committed
