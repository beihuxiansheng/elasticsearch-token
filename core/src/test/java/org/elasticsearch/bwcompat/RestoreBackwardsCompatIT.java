...
block|}
block|}
DECL|method|testRestoreSnapshotWithMissingChecksum
specifier|public
name|void
name|testRestoreSnapshotWithMissingChecksum
parameter_list|()
throws|throws
name|Exception
block|{
...
name|repoFileId
init|=
literal|"missing-checksum-repo-2.3.4"
decl_stmt|;
name|Path
name|repoFile
init|=
...
name|info
argument_list|(
literal|"-->  creating repository [{}] for repo file [{}]"
argument_list|,
name|repo
argument_list|,
name|repoFileId
...
name|info
argument_list|(
literal|"--> get snapshot and check its indices"
argument_list|)
expr_stmt|;
name|GetSnapshotsResponse
name|getSnapshotsResponse
