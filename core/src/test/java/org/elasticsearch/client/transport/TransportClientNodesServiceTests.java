...
block|}
block|}
DECL|method|testSniffNodesSamplerClosesConnections
specifier|public
name|void
name|testSniffNodesSamplerClosesConnections
parameter_list|()
throws|throws
name|Exception
block|{
...
name|TestThreadPool
argument_list|(
literal|"testSniffNodesSamplerClosesConnections"
argument_list|)
decl_stmt|;
name|Settings
name|remoteSettings
...
name|assertFalse
argument_list|(
literal|"Temporary ping connection must be opened"
argument_list|,
name|establishedConnections
operator|.
name|get
...
block|}
block|}
DECL|method|assertClosedConnections
specifier|private
name|void
name|assertClosedConnections
parameter_list|(
...
name|size
operator|+
literal|" closed connections but got "
operator|+
name|connections
operator|.
name|size
...
expr_stmt|;
block|}
DECL|method|assertOpenConnections
specifier|private
name|void
name|assertOpenConnections
parameter_list|(
...
name|size
operator|+
literal|" open connections but got "
operator|+
name|connections
operator|.
name|size
...
name|AssertionError
argument_list|(
literal|"Request handler is already marked as blocking"
argument_list|)
throw|;
block|}
block|}
DECL|method|releaseRequest
name|void
name|releaseRequest
parameter_list|()
block|{
