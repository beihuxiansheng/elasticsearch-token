...
decl_stmt|;
block|{
comment|// Read works for positive and negative numbers
name|BytesStreamOutput
name|output
init|=
operator|new
...
argument_list|)
expr_stmt|;
comment|// Use NoCheck variant so we can write negative numbers
name|StreamInput
name|input
init|=
name|output
...
condition|)
block|{
comment|// Write doesn't work for negative numbers
name|BytesStreamOutput
name|output
init|=
operator|new
...
name|assertTrue
argument_list|(
literal|"If we're not compatible with 5.1.1 we can drop the assertion below"
argument_list|,
name|Version
operator|.
name|CURRENT
...
name|ONE
block|,
DECL|enum constant|TWO
name|TWO
block|,
DECL|enum constant|THREE
name|THREE
block|}
end_enum
...
name|assertEquals
argument_list|(
literal|"Unknown TestEnum ordinal ["
operator|+
name|randomNumber
operator|+
literal|"]"
