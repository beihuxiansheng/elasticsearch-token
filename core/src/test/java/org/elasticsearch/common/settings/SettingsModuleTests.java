...
block|}
block|}
DECL|method|testOldMaxClauseCountSetting
specifier|public
name|void
name|testOldMaxClauseCountSetting
parameter_list|()
block|{
name|Settings
name|settings
...
name|assertEquals
argument_list|(
literal|"unknown setting [index.query.bool.max_clause_count] did you mean [indices.query.bool.max_clause_count]?"
argument_list|,
name|ex
operator|.
name|getMessage
...
expr_stmt|;
block|}
DECL|method|testRegisterShared
specifier|public
name|void
name|testRegisterShared
parameter_list|()
block|{
name|Property
name|scope
