...
name|assertEquals
argument_list|(
literal|"Failed to parse value [I am not a boolean] as only [true] or [false] are allowed."
argument_list|,
name|ex
operator|.
name|getMessage
...
block|}
block|}
DECL|method|testAffixKeySetting
specifier|public
name|void
name|testAffixKeySetting
parameter_list|()
block|{
name|Setting
argument_list|<
...
name|assertEquals
argument_list|(
literal|"prefix must end with a '.'"
argument_list|,
name|exc
operator|.
name|getMessage
...
expr_stmt|;
block|}
DECL|method|testGetAllConcreteSettings
specifier|public
name|void
name|testGetAllConcreteSettings
parameter_list|()
block|{
name|Setting
operator|.
...
expr_stmt|;
block|}
DECL|method|testAffixSettingsFailOnGet
specifier|public
name|void
name|testAffixSettingsFailOnGet
parameter_list|()
block|{
name|Setting
operator|.
...
expr_stmt|;
block|}
DECL|method|testRejectConflictProperties
specifier|public
name|void
name|testRejectConflictProperties
parameter_list|()
block|{
name|IllegalArgumentException
name|ex
...
name|containsString
argument_list|(
literal|"final setting [foo.bar] cannot be dynamic"
argument_list|)
argument_list|)
expr_stmt|;
block|}
DECL|method|testTimeValue
specifier|public
name|void
name|testTimeValue
parameter_list|()
