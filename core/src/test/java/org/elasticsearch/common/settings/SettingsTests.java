...
expr_stmt|;
block|}
DECL|method|testSecureSettingsPrefix
specifier|public
name|void
name|testSecureSettingsPrefix
parameter_list|()
block|{
...
name|setString
argument_list|(
literal|"test.prefix.foo"
argument_list|,
literal|"somethingsecure"
argument_list|)
expr_stmt|;
name|Settings
operator|.
...
expr_stmt|;
block|}
DECL|method|testGroupPrefix
specifier|public
name|void
name|testGroupPrefix
parameter_list|()
block|{
name|MockSecureSettings
name|secureSettings
...
expr_stmt|;
block|}
DECL|method|testGetAsArrayFailsOnDuplicates
specifier|public
name|void
name|testGetAsArrayFailsOnDuplicates
parameter_list|()
block|{
specifier|final
name|Settings
...
name|containsString
argument_list|(
literal|"settings object contains values for [foobar=foo] and [foobar.0=bar]"
argument_list|)
argument_list|)
argument_list|)
expr_stmt|;
