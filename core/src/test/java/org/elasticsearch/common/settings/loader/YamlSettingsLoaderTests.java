...
annotation|@
name|Test
DECL|method|testYamlSettingsNoFile
specifier|public
name|void
name|testYamlSettingsNoFile
parameter_list|()
throws|throws
name|Exception
block|{
...
init|=
literal|"org/elasticsearch/common/settings/loader/no-test-settings.yml"
decl_stmt|;
try|try
block|{
name|Settings
...
name|fail
argument_list|(
literal|"For a not exiting file an exception should be thrown."
argument_list|)
expr_stmt|;
block|}
catch|catch
