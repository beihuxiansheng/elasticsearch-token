...
for|for
control|(
name|BigArraysHelper
name|bigArraysHelper
range|:
name|bigArrayCreators
argument_list|(
name|maxSize
argument_list|,
literal|true
...
name|fail
argument_list|(
literal|"circuit breaker should trip"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
block|}
block|}
DECL|method|testEstimatedBytesSameAsActualBytes
specifier|public
name|void
name|testEstimatedBytesSameAsActualBytes
parameter_list|()
throws|throws
name|Exception
block|{
...
return|;
block|}
DECL|method|newBigArraysInstance
specifier|private
name|BigArrays
name|newBigArraysInstance
parameter_list|(
