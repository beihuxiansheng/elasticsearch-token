...
expr_stmt|;
block|}
DECL|method|testConstructObjectUsingContext
specifier|public
name|void
name|testConstructObjectUsingContext
parameter_list|()
throws|throws
name|IOException
block|{
...
return|;
block|}
DECL|method|buildContextParser
specifier|private
specifier|static
name|ConstructingObjectParser
argument_list|<
...
expr_stmt|;
block|}
DECL|method|testParseNamedObjectTwoFieldsInArrayConstructorArg
specifier|public
name|void
name|testParseNamedObjectTwoFieldsInArrayConstructorArg
parameter_list|()
throws|throws
name|IOException
block|{
...
name|assertEquals
argument_list|(
literal|"[named_object_holder] failed to parse field [named_in_constructor]"
argument_list|,
name|e
operator|.
name|getMessage
...
name|assertEquals
argument_list|(
literal|"[named_in_constructor] can be a single object with any number of fields or an array where each entry is an object with a "
operator|+
...
expr_stmt|;
block|}
DECL|method|testParseNamedObjectNoFieldsInArrayConstructorArg
specifier|public
name|void
name|testParseNamedObjectNoFieldsInArrayConstructorArg
parameter_list|()
throws|throws
name|IOException
block|{
...
expr_stmt|;
block|}
DECL|method|testParseNamedObjectJunkInArrayConstructorArg
specifier|public
name|void
name|testParseNamedObjectJunkInArrayConstructorArg
parameter_list|()
throws|throws
name|IOException
block|{
...
literal|"  {\"a\": {}}"
operator|+
literal|"],\"named_in_constructor\": {\"b\": {}}"
operator|+
literal|"}"
argument_list|)
decl_stmt|;
...
expr_stmt|;
block|}
DECL|method|testParseNamedObjectInOrderNotSupportedConstructorArg
specifier|public
name|void
name|testParseNamedObjectInOrderNotSupportedConstructorArg
parameter_list|()
throws|throws
name|IOException
block|{
...
name|assertEquals
argument_list|(
literal|"[named_in_constructor] doesn't support arrays. Use a single object with multiple fields."
argument_list|,
name|e
operator|.
name|getCause
