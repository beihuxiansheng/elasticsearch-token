...
expr_stmt|;
block|}
DECL|method|testEnsureNoSelfReferences
specifier|public
name|void
name|testEnsureNoSelfReferences
parameter_list|()
throws|throws
name|IOException
block|{
...
expr_stmt|;
block|}
comment|/**      * Test that the same map written multiple times do not trigger the self-reference check in      * {@link XContentBuilder#ensureNoSelfReferences(Object)}      */
DECL|method|testRepeatedMapsAndNoSelfReferences
specifier|public
name|void
name|testRepeatedMapsAndNoSelfReferences
parameter_list|()
throws|throws
name|Exception
block|{
...
name|expected
init|=
literal|"{'map':{'b2':{'b':'B'},'a':0,'c':[{'c':'C'},{'c':'C'}],'d1':{'d':'D'},'d2':{'d3':{'d':'D'}},'b1':{'b':'B'}}}"
decl_stmt|;
name|assertResult
argument_list|(
name|expected
...
expr_stmt|;
block|}
DECL|method|testSelfReferencingMapsOneLevel
specifier|public
name|void
name|testSelfReferencingMapsOneLevel
parameter_list|()
throws|throws
name|IOException
block|{
...
expr_stmt|;
block|}
DECL|method|testSelfReferencingMapsTwoLevels
specifier|public
name|void
name|testSelfReferencingMapsTwoLevels
parameter_list|()
throws|throws
name|IOException
block|{
...
expr_stmt|;
block|}
DECL|method|testSelfReferencingObjectsArray
specifier|public
name|void
name|testSelfReferencingObjectsArray
parameter_list|()
throws|throws
name|IOException
block|{
...
expr_stmt|;
block|}
DECL|method|testSelfReferencingIterable
specifier|public
name|void
name|testSelfReferencingIterable
parameter_list|()
throws|throws
name|IOException
block|{
...
expr_stmt|;
block|}
DECL|method|testSelfReferencingIterableOneLevel
specifier|public
name|void
name|testSelfReferencingIterableOneLevel
parameter_list|()
throws|throws
name|IOException
block|{
...
expr_stmt|;
block|}
DECL|method|testSelfReferencingIterableTwoLevels
specifier|public
name|void
name|testSelfReferencingIterableTwoLevels
parameter_list|()
throws|throws
name|IOException
block|{
...
name|assumeTrue
argument_list|(
literal|"Test only makes sense if XContent parser has strict duplicate checks enabled"
argument_list|,
name|XContent
operator|.
...
name|assertWarnings
argument_list|(
literal|"Deprecated field [deprecated] used, expected [test2] instead"
argument_list|)
expr_stmt|;
block|{
name|p
...
name|assertEquals
argument_list|(
literal|"Unknown Object [unknown]"
argument_list|,
name|e
operator|.
name|getMessage
...
name|assertEquals
argument_list|(
literal|"Unknown namedObject category [java.lang.String]"
argument_list|,
name|e
operator|.
name|getMessage
