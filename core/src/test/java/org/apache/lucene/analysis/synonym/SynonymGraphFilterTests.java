...
begin_class
DECL|class|SynonymGraphFilterTests
specifier|public
class|class
name|SynonymGraphFilterTests
extends|extends
name|BaseTokenStreamTestCase
block|{
comment|/**      * Set a side effect by {@link #getAnalyzer}.      */
...
DECL|method|testAccurateGraphQuery1
specifier|public
name|void
name|testAccurateGraphQuery1
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// "what happened" should NOT match:
name|in
operator|=
operator|new
name|CannedTokenStream
...
comment|// Needs TermAutomatonQuery, which is in sandbox still:
DECL|method|testAccurateGraphQuery2
specifier|public
name|void
name|testAccurateGraphQuery2
parameter_list|()
throws|throws
name|Exception
block|{
...
block|}
comment|// Needs TermAutomatonQuery, which is in sandbox still:
DECL|method|testAccurateGraphQuery3
specifier|public
name|void
name|testAccurateGraphQuery3
parameter_list|()
throws|throws
name|Exception
block|{
...
literal|"field"
argument_list|,
literal|"say what the fudge happened"
argument_list|,
name|Field
operator|.
name|Store
...
decl_stmt|;
comment|//if (VERBOSE) {
comment|//System.out.println("TEST: iter=" + i + " numEntries=" + numEntries);
comment|//}
for|for
control|(
name|int
...
comment|//if (VERBOSE) {
comment|//    System.out.println("TEST: make " + synCount + " syns");
comment|//    System.out.println("  bias for a over b=" + bias);
comment|//    System.out.println("  dedup=" + dedup);
comment|//    System.out.println("  sausage=" + sausage);
comment|//}
name|int
name|maxSynLength
init|=
...
expr_stmt|;
comment|//if (VERBOSE) {
comment|//    System.out.println("  " + syn);
comment|//}
name|add
argument_list|(
name|b
...
comment|//if (VERBOSE) {
comment|//    System.out.println("TEST: iter=" + iter + " doc=" + doc);
comment|//}
name|Automaton
name|expected
init|=
...
decl_stmt|;
comment|//if (VERBOSE) {
comment|//    System.out.println("  doc has " + tokens.length + " tokens");
comment|//}
name|int
name|i
init|=
...
comment|//if (VERBOSE) {
comment|//    System.out.println("  matches @ i=" + i + ": " + matches);
comment|//}
