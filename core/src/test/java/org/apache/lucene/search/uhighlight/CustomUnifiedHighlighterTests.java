...
name|ESTestCase
block|{
DECL|method|testCustomUnifiedHighlighter
specifier|public
name|void
name|testCustomUnifiedHighlighter
parameter_list|()
throws|throws
name|Exception
block|{
...
name|secondValue
init|=
literal|"This is the second highlighting value to perform highlighting on a longer text "
operator|+
literal|"that gets scored lower."
decl_stmt|;
name|Field
name|body2
init|=
