...
block|}
block|}
comment|// if port still not matches, just take port of first bound address
if|if
condition|(
name|publishPort
operator|<
...
condition|)
block|{
comment|// TODO: In case of DEFAULT_PROFILE we should probably fail here, as publish address does not match any bound address
comment|// In case of a custom profile, we might use the publish address of the default profile
name|publishPort
operator|=
name|boundAddresses
operator|.
