...
block|}
block|}
comment|/**      * Serializes the given message into a bytes representation and forwards to {@link #prepareSend(Version, TransportMessage,      * StreamOutput, ReleasableBytesStream)}      */
...
return|;
block|}
comment|/**      * prepares a implementation specific message to send across the network      */
DECL|method|prepareSend
specifier|protected
specifier|abstract
name|Message
...
name|IOException
function_decl|;
comment|/**      * Allows implementations to transform TransportMessages into implementation specific messages      */
...
parameter_list|>
block|{
comment|/**          * Creates an output to write the message header to.          */
DECL|method|getHeaderOutput
name|StreamOutput
name|getHeaderOutput
parameter_list|()
function_decl|;
comment|/**          * Returns the size of the message in bytes          */
DECL|method|size
name|int
name|size
parameter_list|()
function_decl|;
comment|/**          * sends the message to the channel          * @param channel the channe to send the message to          * @param onRequestSent a callback executed once the message has been fully send          */
DECL|method|send
name|void
name|send
parameter_list|(
