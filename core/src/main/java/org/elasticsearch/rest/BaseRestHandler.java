...
return|;
block|}
comment|/**      * @return the name of this handler. The name should be human readable and      *         should describe the action that will performed when this API is      *         called. This name is used in the response to the      *         {@link RestNodesUsageAction}.      */
DECL|method|getName
specifier|public
specifier|abstract
name|String
...
name|ROOT
argument_list|,
literal|"request [%s] contains unrecognized %s%s: "
argument_list|,
name|request
operator|.
name|path
