...
parameter_list|()
function_decl|;
comment|/**      * @return content of the request body or throw an exception if the body or content type is missing      */
DECL|method|requiredContent
specifier|public
specifier|final
name|BytesReference
...
argument_list|()
decl_stmt|;
comment|// will throw exception if body or content type missing
return|return
name|xContentType
operator|.
name|get
...
block|}
block|}
comment|/**      * Get the content of the request or the contents of the {@code source} param or throw an exception if both are missing.      * Prefer {@link #contentOrSourceParamParser()} or {@link #withContentOrSourceParamParserOrNull(CheckedConsumer)} if you need a parser.      */
