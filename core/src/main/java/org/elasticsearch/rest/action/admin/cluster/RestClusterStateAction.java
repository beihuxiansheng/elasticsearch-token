...
name|Fields
operator|.
name|CLUSTER_STATE_SIZE_IN_BYTES
argument_list|,
name|Fields
operator|.
name|CLUSTER_STATE_SIZE
argument_list|,
name|response
operator|.
...
decl_stmt|;
DECL|field|CLUSTER_STATE_SIZE_IN_BYTES
specifier|static
specifier|final
name|String
name|CLUSTER_STATE_SIZE_IN_BYTES
init|=
literal|"compressed_size_in_bytes"
decl_stmt|;
block|}
end_class
