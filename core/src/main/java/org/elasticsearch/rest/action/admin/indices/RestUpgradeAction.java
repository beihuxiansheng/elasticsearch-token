...
argument_list|)
block|{
block|@Override             public RestResponse buildResponse(UpgradeStatusResponse response
operator|,
name|XContentBuilder
name|builder
block|)
...
argument_list|)
block|{
block|@Override             public RestResponse buildResponse(UpgradeResponse response
operator|,
name|XContentBuilder
name|builder
block|)
