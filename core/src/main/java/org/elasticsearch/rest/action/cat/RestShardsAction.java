...
name|addCell
argument_list|(
literal|"recoverysource.type"
argument_list|,
literal|"alias:rs;default:false;desc:recovery source type"
argument_list|)
expr_stmt|;
name|table
operator|.
...
literal|"seq_no.max"
argument_list|,
literal|"alias:sqm,maxSeqNo;default:false;text-align:right;desc:max sequence number"
argument_list|)
expr_stmt|;
name|table
operator|.
...
argument_list|,
literal|"alias:sql,localCheckpoint;default:false;text-align:right;desc:local checkpoint"
argument_list|)
expr_stmt|;
name|table
operator|.
...
argument_list|,
literal|"alias:sqg,globalCheckpoint;default:false;text-align:right;desc:global checkpoint"
argument_list|)
expr_stmt|;
name|table
operator|.
