...
return|;
block|}
comment|/**      * The new search response listeners in the form of {@link BiConsumer}s added by this plugin.      * The listeners are invoked on the coordinating node, at the very end of the search request.      * This provides a convenient location if you wish to inspect/modify the final response (took time, etc).      * The BiConsumers are passed the original {@link SearchRequest} and the final {@link SearchResponse}      */
...
block|}
block|}
comment|/**      * Specification for a {@link Suggester}.      */
DECL|class|SuggesterSpec
class|class
name|SuggesterSpec
parameter_list|<
name|T
