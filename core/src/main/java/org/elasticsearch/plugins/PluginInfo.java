...
parameter_list|()
block|{     }
comment|/**      * Information about plugins      *      * @param name        Its name      * @param description Its description      * @param site        true if it's a site plugin      * @param jvm         true if it's a jvm plugin      * @param version     Version number      */
DECL|method|PluginInfo
name|PluginInfo
parameter_list|(
name|String
...
name|IllegalArgumentException
argument_list|(
literal|"Property [elasticsearch.version] is missing for jvm plugin ["
operator|+
name|name
operator|+
literal|"]"
...
name|IllegalArgumentException
argument_list|(
literal|"Property [java.version] is missing for jvm plugin ["
operator|+
name|name
operator|+
literal|"]"
...
name|IllegalArgumentException
argument_list|(
literal|"Property [classname] is missing for jvm plugin ["
operator|+
name|name
operator|+
literal|"]"
...
return|;
block|}
comment|/**      * @return true if jvm plugin has isolated classloader      */
...
return|;
block|}
comment|/**      * @return jvm plugin's classname      */
