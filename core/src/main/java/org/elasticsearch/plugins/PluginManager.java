...
name|println
argument_list|(
literal|"     elasticsearch-plugin-name    for Elasticsearch 2.0 Core plugin (download from download.elastic.co)"
argument_list|)
expr_stmt|;
name|SysOut
operator|.
name|println
argument_list|(
literal|"     elasticsearch/plugin/version for elasticsearch commercial plugins (download from download.elastic.co)"
argument_list|)
expr_stmt|;
name|SysOut
operator|.
...
name|println
argument_list|(
literal|"Elasticsearch Core plugins:"
argument_list|)
expr_stmt|;
for|for
control|(
