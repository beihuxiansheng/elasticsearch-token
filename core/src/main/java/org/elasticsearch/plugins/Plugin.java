...
return|;
block|}
comment|/**      * Returns parsers for named objects this plugin will parse from {@link XContentParser#namedObject(Class, String, Object)}.      * @see NamedWriteableRegistry      */
...
argument_list|>
argument_list|>
name|getIndexTemplateMetaDataUpgrader
parameter_list|()
block|{
return|return
name|UnaryOperator
...
return|;
block|}
comment|/**      * Provides a function to modify index meta data when an index is introduced into the cluster state for the first time.      *<p>      * Plugins should return the input index metadata via {@link UnaryOperator#identity()} if no upgrade is required.      *<p>      * The order of the index upgrader calls for the same index is undefined and can change between runs so, it is expected that      * plugins will modify only indices owned by them to avoid conflicts.      *<p>      * @return Never {@code null}. The same or upgraded {@code IndexMetaData}.      * @throws IllegalStateException if the node should not start because the index is unsupported      */
DECL|method|getIndexMetaDataUpgrader
specifier|public
name|UnaryOperator
argument_list|<
name|IndexMetaData
argument_list|>
name|getIndexMetaDataUpgrader
parameter_list|()
block|{
return|return
name|UnaryOperator
...
parameter_list|)
block|{}
comment|/**      * Old-style snapshot/restore extension point. {@code @Deprecated} and {@code final} to act as a signpost for plugin authors upgrading      * from 2.x.      *      * @deprecated implement {@link RepositoryPlugin} instead      */
annotation|@
name|Deprecated
DECL|method|onModule
specifier|public
...
parameter_list|)
block|{}
comment|/**      * Old-style cluster extension point. {@code @Deprecated} and {@code final} to act as a signpost for plugin authors upgrading      * from 2.x.      *      * @deprecated implement {@link ClusterPlugin} instead      */
annotation|@
name|Deprecated
DECL|method|onModule
specifier|public
