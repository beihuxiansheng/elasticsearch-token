...
argument_list|)
decl_stmt|;
DECL|field|V_5_3_3_ID_UNRELEASED
specifier|public
specifier|static
specifier|final
name|int
name|V_5_3_3_ID_UNRELEASED
init|=
literal|5030399
decl_stmt|;
DECL|field|V_5_3_3_UNRELEASED
specifier|public
specifier|static
specifier|final
name|Version
name|V_5_3_3_UNRELEASED
init|=
operator|new
name|Version
argument_list|(
...
condition|)
block|{
comment|// we only specialize for current major here
name|bwcMajor
operator|=
name|Version
operator|.
...
condition|)
block|{
comment|// all the future versions are compatible with first minor...
name|bwcMajor
operator|=
name|major
operator|-
