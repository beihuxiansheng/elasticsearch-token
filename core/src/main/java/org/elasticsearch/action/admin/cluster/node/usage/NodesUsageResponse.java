...
begin_comment
comment|/**  * The response for the nodes usage api which contains the individual usage  * statistics for all nodes queried.  */
end_comment

begin_class
DECL|class|NodesUsageResponse
specifier|public
class|class
...
name|ToXContent
block|{
DECL|method|NodesUsageResponse
name|NodesUsageResponse
parameter_list|()
block|{     }
DECL|method|NodesUsageResponse
