...
return|;
block|}
comment|/**      * Sets the source containing the transient settings to be updated. They will not survive a full cluster restart      * @deprecated use {@link #transientSettings(String, XContentType)} to avoid content type detection      */
annotation|@
name|Deprecated
DECL|method|transientSettings
specifier|public
...
return|;
block|}
comment|/**      * Sets the source containing the persistent settings to be updated. They will get applied cross restarts      * @deprecated use {@link #persistentSettings(String, XContentType)} to avoid content type detection      */
annotation|@
name|Deprecated
DECL|method|persistentSettings
specifier|public
