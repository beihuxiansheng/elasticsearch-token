...
parameter_list|()
block|{     }
comment|/**      * Information about plugins      *      * @param name        Its name      * @param description Its description      * @param site        true if it's a site plugin      * @param jvm         true if it's a jvm plugin      * @param version     Version number is applicable (NA otherwise)      */
DECL|method|PluginInfo
specifier|public
name|PluginInfo
parameter_list|(
