...
begin_comment
comment|/**  * Action for explaining shard allocation for a shard in the cluster  */
end_comment

begin_class
DECL|class|ClusterAllocationExplainAction
specifier|public
class|class
...
name|NAME
init|=
literal|"cluster:monitor/allocation/explain"
decl_stmt|;
DECL|method|ClusterAllocationExplainAction
specifier|private
name|ClusterAllocationExplainAction
parameter_list|()
block|{
