...
name|waitForStatus
decl_stmt|;
DECL|field|waitForNoRelocatingShards
specifier|private
name|boolean
...
return|;
block|}
DECL|method|waitForNoRelocatingShards
specifier|public
name|boolean
name|waitForNoRelocatingShards
parameter_list|()
...
condition|)
block|{
comment|// the default for cluster health request is 0, not 1
name|this
operator|.
name|waitForActiveShards
operator|=
