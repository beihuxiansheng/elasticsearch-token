...
return|;
block|}
comment|/**      * The settings to create the index with (either json or yaml format)      * @deprecated use {@link #setSettings(String, XContentType)} to avoid content type detection      */
annotation|@
name|Deprecated
DECL|method|setSettings
specifier|public
...
return|;
block|}
comment|/**      * Adds mapping that will be added when the index gets created.      *      * @param type   The mapping type      * @param source The mapping source      * @deprecated use {@link #addMapping(String, String, XContentType)} to avoid content type auto-detection      */
annotation|@
name|Deprecated
...
return|;
block|}
comment|/**      * Sets the settings and mappings as a single source.      * @deprecated use {@link #setSource(String, XContentType)}      */
annotation|@
name|Deprecated
...
return|;
block|}
comment|/**      * Sets the settings and mappings as a single source.      * @deprecated use {@link #setSource(BytesReference, XContentType)}      */
annotation|@
name|Deprecated
DECL|method|setSource
specifier|public
...
return|;
block|}
comment|/**      * Sets the settings and mappings as a single source.      * @deprecated use {@link #setSource(byte[], XContentType)}      */
annotation|@
name|Deprecated
DECL|method|setSource
specifier|public
...
return|;
block|}
comment|/**      * Sets the settings and mappings as a single source.      * @deprecated use {@link #setSource(byte[], int, int, XContentType)}      */
annotation|@
name|Deprecated
DECL|method|setSource
specifier|public
