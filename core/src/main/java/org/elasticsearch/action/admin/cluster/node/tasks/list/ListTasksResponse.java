...
return|;
block|}
comment|/**      * Set a reference to the {@linkplain DiscoveryNodes}. Used for calling {@link #toXContent(XContentBuilder, ToXContent.Params)} with      * {@code group_by=nodes}.      */
DECL|method|setDiscoveryNodes
specifier|public
name|void
...
argument_list|(
literal|"discoveryNodes must be set before calling toXContent with group_by=nodes"
argument_list|)
throw|;
block|}
name|builder
