...
condition|)
block|{
comment|// The task has no child tasks, so we can return immediately
name|logger
operator|.
name|trace
argument_list|(
...
block|{
comment|// The task has some child tasks, we need to wait for until ban is set on all nodes
name|logger
operator|.
name|trace
argument_list|(
