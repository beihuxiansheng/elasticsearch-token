...
return|;
block|}
comment|/**      * Sets repository-specific restore settings in JSON or YAML format      *<p>      * See repository documentation for more information.      *      * @param source repository-specific snapshot settings      * @return this request      * @deprecated use {@link #settings(String, XContentType)} to avoid content type detection      */
annotation|@
name|Deprecated
DECL|method|settings
specifier|public
...
return|;
block|}
comment|/**      * Sets repository-specific restore settings in JSON or YAML format      *<p>      * See repository documentation for more information.      *      * @param source repository-specific snapshot settings      * @param xContentType the content type of the source      * @return this request      */
DECL|method|settings
specifier|public
name|RestoreSnapshotRequest
name|settings
...
return|;
block|}
comment|/**      * Sets settings that should be added/changed in all restored indices      * @deprecated use {@link #indexSettings(String, XContentType)} to avoid content type detection      */
annotation|@
name|Deprecated
DECL|method|indexSettings
specifier|public
