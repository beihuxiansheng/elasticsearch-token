...
return|;
block|}
DECL|class|OperationWriteResult
specifier|abstract
specifier|static
class|class
name|OperationWriteResult
block|{
DECL|field|location
specifier|private
specifier|final
...
name|failure
decl_stmt|;
DECL|method|OperationWriteResult
specifier|protected
name|OperationWriteResult
parameter_list|(
annotation|@
...
block|}
block|}
comment|/**      * Simple result from a primary write action (includes response).      * Write actions have static method to return these so they can integrate with bulk.      */
DECL|class|PrimaryOperationResult
specifier|public
specifier|static
class|class
name|PrimaryOperationResult
...
name|response
decl_stmt|;
DECL|method|PrimaryOperationResult
specifier|public
name|PrimaryOperationResult
parameter_list|(
name|Response
...
block|}
block|}
comment|/**      * Simple result from a replica write action. Write actions have static method to return these so they can integrate with bulk.      */
DECL|class|ReplicaOperationResult
specifier|public
specifier|static
class|class
name|ReplicaOperationResult
...
name|OperationWriteResult
block|{
DECL|method|ReplicaOperationResult
specifier|public
name|ReplicaOperationResult
parameter_list|(
annotation|@
