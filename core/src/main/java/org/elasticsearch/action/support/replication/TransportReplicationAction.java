...
name|Exception
function_decl|;
comment|/**      * Synchronous replica operation on nodes with replica copies. This is done under the lock form      * {@link #getReplicaShardReference(ShardId, long)} (ShardId, long)}.      */
