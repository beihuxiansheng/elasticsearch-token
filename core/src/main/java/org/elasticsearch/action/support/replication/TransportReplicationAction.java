...
argument_list|>
block|{
DECL|field|SHARD_FAILURE_TIMEOUT
specifier|public
specifier|static
specifier|final
name|String
...
init|=
literal|"action.support.replication.shard.failure_timeout"
decl_stmt|;
...
name|mappingUpdatedAction
decl_stmt|;
DECL|field|shardFailedTimeout
specifier|private
specifier|final
name|TimeValue
name|shardFailedTimeout
decl_stmt|;
...
argument_list|)
expr_stmt|;
comment|// TODO: set a default timeout
name|shardFailedTimeout
operator|=
name|settings
operator|.
...
argument_list|,
operator|new
name|ReplicationFailedShardStateListener
argument_list|(
name|nodeId
argument_list|,
name|exp
...
block|}
block|}
DECL|class|ReplicationFailedShardStateListener
specifier|public
class|class
name|ReplicationFailedShardStateListener
implements|implements
...
name|failure
decl_stmt|;
DECL|method|ReplicationFailedShardStateListener
specifier|public
name|ReplicationFailedShardStateListener
parameter_list|(
name|String
...
name|trace
argument_list|(
literal|"timeout sending shard failure to master [{}]"
argument_list|,
name|e
argument_list|,
name|master
...
parameter_list|)
block|{
comment|// this enforces primary terms, if we're lagging an exception will be thrown.
name|counter
operator|.
...
block|}
block|}
comment|/** utility method for common tasks that should be done after a write operation */
