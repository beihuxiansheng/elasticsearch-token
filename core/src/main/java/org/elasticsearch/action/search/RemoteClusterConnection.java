...
return|;
block|}
comment|/**      * Fetches connection info for this connection      */
DECL|method|getConnectionInfo
specifier|public
name|void
...
condition|)
block|{
comment|// not connected we return immediately
name|RemoteConnectionInfo
name|remoteConnectionStats
init|=
operator|new
name|RemoteConnectionInfo
argument_list|(
...
condition|)
block|{
comment|// just in case non of the connected nodes have http enabled we get other http enabled nodes instead.
for|for
control|(
name|NodeInfo
name|info
...
block|{
break|break;
comment|// once we have enough return...
block|}
block|}
block|}
name|RemoteConnectionInfo
...
block|}
block|}
DECL|method|getNumNodesConnected
name|int
name|getNumNodesConnected
parameter_list|()
block|{
return|return
name|connectedNodes
