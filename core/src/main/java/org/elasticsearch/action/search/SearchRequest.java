...
expr_stmt|;
block|}
comment|/**      * The name of the stored template      *       * @deprecated use {@link #template()} instead.      */
annotation|@
name|Deprecated
DECL|method|templateName
specifier|public
...
return|;
block|}
comment|/**      * Template parameters used for rendering      *       * @deprecated use {@link #template()} instead.      */
annotation|@
name|Deprecated
DECL|method|templateParams
specifier|public
