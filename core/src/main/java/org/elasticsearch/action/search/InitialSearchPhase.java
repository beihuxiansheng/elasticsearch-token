...
block|}
block|}
comment|/**      * Executed once all shard results have been received and processed      * @see #onShardFailure(int, SearchShardTarget, Exception)      * @see #onShardSuccess(int, SearchPhaseResult)      */
...
parameter_list|)
function_decl|;
comment|/**      * Executed once for every successful shard level request.      * @param shardIndex the internal index for this shard. Each shard has an index / ordinal assigned that is used to reference      *                   it's results      * @param result the result returned form the shard      *      */
...
return|;
block|}
comment|/**          * Consumes a single shard result          * @param shardIndex the shards index, this is a 0-based id that is used to establish a 1 to 1 mapping to the searched shards          * @param result the shards result          */
