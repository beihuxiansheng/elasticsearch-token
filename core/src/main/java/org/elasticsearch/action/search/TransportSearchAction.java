...
block|}
decl_stmt|;
comment|// Only enrich the search response iff collapsing has been specified:
specifier|final
name|ActionListener
argument_list|<
name|SearchResponse
...
block|}
block|}
comment|/**      * Expands collapsed using the {@link CollapseBuilder#innerHit} options.      */
DECL|method|expandCollapsedHits
name|void
name|expandCollapsedHits
parameter_list|(
name|DiscoveryNode
