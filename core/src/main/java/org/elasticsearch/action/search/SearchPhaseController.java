...
block|{
comment|// no relevant docs - just return an empty array
return|return
name|EMPTY_DOCS
return|;
block|}
...
expr_stmt|;
block|}
comment|/**          * Creates a new search response from the given merged hits.          * @see #merge(boolean, ScoreDoc[], ReducedQueryPhase, Collection, IntFunction)          */
