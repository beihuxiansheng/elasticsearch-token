...
return|;
block|}
comment|/**      * Sets the source of the request as a SearchSourceBuilder. Note, settings anything other      * than the search type will cause this source to be overridden, consider using      * {@link #setExtraSource(SearchSourceBuilder)} instead.      */
...
return|;
block|}
comment|/**      * Sets the source of the request as a json string. Note, settings anything other      * than the search type will cause this source to be overridden, consider using      * {@link #setExtraSource(SearchSourceBuilder)} instead.      */
DECL|method|setSource
specifier|public
name|SearchRequestBuilder
name|setSource
...
return|;
block|}
comment|/**      * Sets the an addtional source of the request as a SearchSourceBuilder. All values and      * settings set on the extra source will override the corresponding settings on the specified      * source.      */
