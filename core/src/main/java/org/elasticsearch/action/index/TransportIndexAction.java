...
return|;
block|}
comment|/**      * Execute the given {@link IndexRequest} on a primary shard, throwing a      * {@link ReplicationOperation.RetryOnPrimaryException} if the operation needs to be re-tried.      */
