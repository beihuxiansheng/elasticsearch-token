...
return|;
block|}
comment|/**      * Sets an artificial document from which term vectors are requested for.      * @deprecated use {@link #doc(BytesReference, boolean, XContentType)} to avoid content auto detection      */
annotation|@
name|Deprecated
DECL|method|doc
specifier|public
