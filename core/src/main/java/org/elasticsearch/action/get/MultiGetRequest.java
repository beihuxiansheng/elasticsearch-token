...
name|ROOT
argument_list|,
literal|"unexpected token [%s], expected [%s]"
argument_list|,
name|token
argument_list|,
name|XContentParser
...
name|ROOT
argument_list|,
literal|"unknown key [%s] for a %s, expected [docs] or [ids]"
argument_list|,
name|currentFieldName
argument_list|,
name|token
...
name|ROOT
argument_list|,
literal|"unexpected token [%s], expected [%s] or [%s]"
argument_list|,
name|token
argument_list|,
name|XContentParser
...
argument_list|()
argument_list|,
literal|"Unsupported field [fields] used, expected [stored_fields] instead"
argument_list|)
throw|;
block|}
elseif|else
