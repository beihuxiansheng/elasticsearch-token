...
name|xContentType
decl_stmt|;
comment|/**      * Create a new request      * @deprecated use {@link #SimulatePipelineRequest(BytesReference, XContentType)} that does not attempt content autodetection      */
annotation|@
name|Deprecated
...
expr_stmt|;
block|}
comment|/**      * Creates a new request with the given source and its content type      */
DECL|method|SimulatePipelineRequest
specifier|public
name|SimulatePipelineRequest
parameter_list|(
