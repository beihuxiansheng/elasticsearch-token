...
return|;
block|}
comment|/**      * Adds a framed data in binary format      * @deprecated use {@link #add(byte[], int, int, XContentType)}      */
annotation|@
name|Deprecated
DECL|method|add
specifier|public
...
return|;
block|}
comment|/**      * Adds a framed data in binary format      * @deprecated use {@link #add(byte[], int, int, String, String, XContentType)}      */
annotation|@
name|Deprecated
DECL|method|add
specifier|public
