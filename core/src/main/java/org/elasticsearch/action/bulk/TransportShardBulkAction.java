...
argument_list|)
expr_stmt|;
comment|// The operation was successful, advance the translog
return|return
name|locationToSync
argument_list|(
name|originalLocation
...
argument_list|()
argument_list|,
comment|// Make sure to use request.indox() here, if you
...
name|replicaRequest
expr_stmt|;
comment|// Modify the replica request, if needed, and return a new translog location
name|location
operator|=
name|updateReplicaRequest
argument_list|(
...
return|;
block|}
DECL|method|shouldExecuteReplicaItem
specifier|static
name|boolean
name|shouldExecuteReplicaItem
parameter_list|(
specifier|final
name|BulkItemRequest
name|request
