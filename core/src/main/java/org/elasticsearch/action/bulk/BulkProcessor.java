...
expr_stmt|;
block|}
comment|/**      * Adds the data from the bytes to be processed by the bulk processor      * @deprecated use {@link #add(BytesReference, String, String, XContentType)} instead to avoid content type auto-detection      */
annotation|@
name|Deprecated
DECL|method|add
specifier|public
...
return|;
block|}
comment|/**      * Adds the data from the bytes to be processed by the bulk processor      * @deprecated use {@link #add(BytesReference, String, String, String, Object, XContentType)} instead to avoid content type      * auto-detection      */
annotation|@
name|Deprecated
DECL|method|add
specifier|public
