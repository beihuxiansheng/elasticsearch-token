...
return|;
block|}
comment|/**      * @param threadPool The threadPool that will be used to schedule retries.      */
DECL|method|using
specifier|public
name|Retry
name|using
...
expr_stmt|;
block|}
comment|/**      * Invokes #apply(BulkRequest, ActionListener). Backs off on the provided exception. Retries will be attempted using      * the provided schedule function.      *      * @param consumer The consumer to which apply the request and listener      * @param bulkRequest The bulk request that should be executed.      * @param settings settings      * @return the bulk response as returned by the client.      * @throws Exception Any exception thrown by the callable.      */
