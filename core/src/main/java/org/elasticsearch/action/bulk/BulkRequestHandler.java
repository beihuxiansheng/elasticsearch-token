...
name|warn
argument_list|(
literal|"Failed to executed bulk request {}."
argument_list|,
name|e
argument_list|,
name|executionId
...
parameter_list|)
block|{
comment|// This is intentionally wrong to avoid changing the behaviour implicitly with this PR. It will be fixed in #14833
name|Thread
operator|.
name|interrupted
argument_list|()
