...
return|;
block|}
comment|/**      * Adds a framed data in binary format      *      * @deprecated use {@link #add(BytesReference, String, String, XContentType)}      */
annotation|@
name|Deprecated
DECL|method|add
specifier|public
...
return|;
block|}
comment|/**      * Adds a framed data in binary format      *      * @deprecated use {@link #add(BytesReference, String, String, boolean, XContentType)}      */
annotation|@
name|Deprecated
DECL|method|add
specifier|public
...
name|source
argument_list|(
name|sliceTrimmingCarriageReturn
argument_list|(
name|data
argument_list|,
name|from
...
return|;
block|}
comment|/**      * Returns the sliced {@link BytesReference}. If the {@link XContentType} is JSON, the byte preceding the marker is checked to see      * if it is a carriage return and if so, the BytesReference is sliced so that the carriage return is ignored      */
DECL|method|sliceTrimmingCarriageReturn
specifier|private
name|BytesReference
name|sliceTrimmingCarriageReturn
parameter_list|(
