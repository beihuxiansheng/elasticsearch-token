...
argument_list|)
decl_stmt|;
DECL|field|SETTING_HTTP_CONTENT_TYPE_REQUIRED
specifier|public
specifier|static
specifier|final
name|Setting
...
argument_list|<>
argument_list|(
literal|"http.content_type.required"
argument_list|,
parameter_list|(
name|s
parameter_list|)
...
argument_list|(
literal|"http.content_type.required cannot be set to false. It exists only to make a rolling"
operator|+
literal|" upgrade easier"
argument_list|)
block|;             }
return|return
literal|true
