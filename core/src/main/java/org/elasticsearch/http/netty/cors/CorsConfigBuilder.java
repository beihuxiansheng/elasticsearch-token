...
begin_comment
comment|/**  * Builder used to configure and build a {@link CorsConfig} instance.  *  * This class was lifted from the Netty project:  *  https://github.com/netty/netty  */
end_comment

begin_class
DECL|class|CorsConfigBuilder
specifier|public
specifier|final
class|class
...
return|;
block|}
comment|/**      * Creates a {@link CorsConfigBuilder} instance with the specified origin.      *      * @return {@link CorsConfigBuilder} to support method chaining.      */
...
return|;
block|}
comment|/**      * Create a {@link CorsConfigBuilder} instance with the specified pattern origin.      *      * @param pattern the regular expression pattern to match incoming origins on.      * @return {@link CorsConfigBuilder} with the configured origin pattern.      */
...
return|;
block|}
comment|/**      * Creates a {@link CorsConfigBuilder} instance with the specified origins.      *      * @return {@link CorsConfigBuilder} to support method chaining.      */
...
return|;
block|}
comment|/**      * Disables CORS support.      *      * @return {@link CorsConfigBuilder} to support method chaining.      */
DECL|method|disable
specifier|public
name|CorsConfigBuilder
name|disable
...
return|;
block|}
comment|/**      * Specifies the allowed set of HTTP Request Methods that should be returned in the      * CORS 'Access-Control-Request-Method' response header.      *      * @param methods the {@link HttpMethod}s that should be allowed.      * @return {@link CorsConfigBuilder} to support method chaining.      */
...
return|;
block|}
comment|/**      * Specifies that no preflight response headers should be added to a preflight response.      *      * @return {@link CorsConfigBuilder} to support method chaining.      */
...
return|;
block|}
comment|/**      * Builds a {@link CorsConfig} with settings specified by previous method calls.      *      * @return {@link CorsConfig} the configured CorsConfig instance.      */
DECL|method|build
specifier|public
name|CorsConfig
name|build
