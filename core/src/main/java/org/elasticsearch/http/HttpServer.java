...
block|{
comment|// remove extraneous leading slashes, its not an absolute path.
while|while
condition|(
name|sitePath
operator|.
...
condition|)
block|{
comment|// If it's not a dir, we send a 403
if|if
condition|(
operator|!
name|attributes
...
return|return;
block|}
comment|// We don't serve dir but if index.html exists in dir we should serve it
name|file
operator|=
name|file
operator|.
