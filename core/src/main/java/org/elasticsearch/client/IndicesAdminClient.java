...
parameter_list|)
function_decl|;
comment|/**      * Shrinks an index using an explicit request allowing to specify the settings, mappings and aliases of the target index of the index.      */
...
parameter_list|)
function_decl|;
comment|/**      * Swaps the index pointed to by an alias given all provided conditions are satisfied      */
