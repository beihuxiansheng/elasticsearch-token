...
return|;
block|}
comment|/**      * Creates a get task request.      *      * @return The nodes tasks request      * @see org.elasticsearch.client.ClusterAdminClient#getTask(GetTaskRequest)      */
DECL|method|getTaskRequest
specifier|public
specifier|static
name|GetTaskRequest
name|getTaskRequest
