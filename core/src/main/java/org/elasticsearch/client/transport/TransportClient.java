...
expr_stmt|;
block|}
comment|/**      * Listener that allows to be notified whenever a node failure / disconnect happens      */
annotation|@
name|FunctionalInterface
DECL|interface|HostFailureListener
specifier|public
interface|interface
name|HostFailureListener
block|{
comment|/**          * Called once a node disconnect is detected.          * @param node the node that has been disconnected          * @param ex the exception causing the disconnection          */
