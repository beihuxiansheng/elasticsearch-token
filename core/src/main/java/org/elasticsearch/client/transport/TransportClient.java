...
return|;
block|}
comment|/**          * Add the given plugin to the client when it is created.          */
...
literal|false
argument_list|)
comment|//nocommit not too sure if these settings are needed here...
operator|.
name|put
argument_list|(
name|Node
