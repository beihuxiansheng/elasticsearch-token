...
parameter_list|)
function_decl|;
comment|/**      * Returns top N hot-threads samples per node. The hot-threads are only      * sampled for the node ids specified in the request. Nodes usage of the      * cluster.      *      * @param request      *            The nodes usage request      * @return The result future      * @see org.elasticsearch.client.Requests#nodesUsageRequest(String...)      */
DECL|method|nodesUsage
name|ActionFuture
argument_list|<
name|NodesUsageResponse
argument_list|>
...
parameter_list|)
function_decl|;
comment|/**      * Nodes usage of the cluster.      *      * @param request      *            The nodes usage request      * @param listener      *            A listener to be notified with a result      * @see org.elasticsearch.client.Requests#nodesUsageRequest(String...)      */
DECL|method|nodesUsage
name|void
name|nodesUsage
parameter_list|(
...
parameter_list|)
function_decl|;
comment|/**      * Nodes usage of the cluster.      */
DECL|method|prepareNodesUsage
name|NodesUsageRequestBuilder
name|prepareNodesUsage
parameter_list|(
name|String
modifier|...
name|nodesIds
...
parameter_list|)
function_decl|;
comment|/**      * Get a task.      *      * @param request the request      * @return the result future      * @see org.elasticsearch.client.Requests#getTaskRequest()      */
DECL|method|getTask
name|ActionFuture
argument_list|<
name|GetTaskResponse
...
parameter_list|)
function_decl|;
comment|/**      * Get a task.      *      * @param request the request      * @param listener A listener to be notified with the result      * @see org.elasticsearch.client.Requests#getTaskRequest()      */
DECL|method|getTask
name|void
name|getTask
parameter_list|(
...
parameter_list|()
function_decl|;
comment|/**      * Store a script in the cluster state      */
DECL|method|preparePutStoredScript
name|PutStoredScriptRequestBuilder
name|preparePutStoredScript
parameter_list|()
function_decl|;
comment|/**      * Delete a script from the cluster state      */
...
parameter_list|)
function_decl|;
comment|/**      * Get a script from the cluster state      */
