...
parameter_list|)
function_decl|;
comment|/**      * Builder for the field capabilities request.      */
DECL|method|prepareFieldCaps
name|FieldCapabilitiesRequestBuilder
name|prepareFieldCaps
parameter_list|()
function_decl|;
comment|/**      * An action that returns the field capabilities from the provided request      */
DECL|method|fieldCaps
name|ActionFuture
argument_list|<
name|FieldCapabilitiesResponse
argument_list|>
