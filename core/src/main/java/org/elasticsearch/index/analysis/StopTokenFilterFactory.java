...
argument_list|(
literal|"enable_position_increments is not supported anymore as of Lucene 4.4 as it can create broken token streams."
operator|+
literal|" Please fix your analysis chain or use an older compatibility version (<= 4.3)."
argument_list|)
throw|;
block|}
name|this
