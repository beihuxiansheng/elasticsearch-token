...
name|create
decl_stmt|;
comment|/**      * Standard ctor with all the power.      */
...
expr_stmt|;
block|}
comment|/**      * Convenience ctor for token streams that don't vary based on version.      */
DECL|method|PreConfiguredTokenFilter
specifier|public
name|PreConfiguredTokenFilter
parameter_list|(
...
argument_list|)
expr_stmt|;
comment|// TODO why oh why aren't these all CachingStrategy.ONE? They *can't* vary based on version because they don't get it, right?!
block|}
annotation|@
name|Override
DECL|method|get
