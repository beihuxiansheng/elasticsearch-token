...
name|IllegalArgumentException
argument_list|(
literal|"Unknown CharFilter type ["
operator|+
name|typeName
operator|+
literal|"] for ["
...
continue|continue;
block|}
comment|// register if it's not builtin
if|if
condition|(
name|indicesAnalysisService
operator|.
...
name|IllegalArgumentException
argument_list|(
literal|"Unknown TokenFilter type ["
operator|+
name|typeName
operator|+
literal|"] for ["
...
name|IllegalArgumentException
argument_list|(
literal|"Unknown Tokenizer type ["
operator|+
name|typeName
operator|+
literal|"] for ["
...
condition|)
block|{
comment|// custom analyzer, need to add it
name|type
operator|=
