...
parameter_list|)
block|{
comment|// nocommit: no need to wrap this exception after integrating master into feature/seq_no
throw|throw
operator|new
name|UncheckedIOException
argument_list|(
literal|"failed to sync translog after updating global checkpoint for shard "
operator|+
name|indexShard
operator|.
name|shardId
