...
literal|"none"
decl_stmt|;
DECL|field|INDEX_QUERY_CACHE_TYPE_SETTING
specifier|public
specifier|static
specifier|final
name|Setting
...
argument_list|()
decl_stmt|;
DECL|field|forceQueryCacheType
specifier|private
specifier|final
name|SetOnce
argument_list|<
...
return|;
block|}
comment|/**      * Forces a certain query cache type. If this is set      * the given cache type is overriding the default as well as the type      * set on the index level.      * NOTE: this can only be set once      *      * @see #INDEX_QUERY_CACHE_TYPE_SETTING      */
DECL|method|forceQueryCacheType
specifier|public
name|void
name|forceQueryCacheType
parameter_list|(
