...
operator|.
name|BYTES
comment|// minimum sequence number, introduced in 6.0.0
operator|+
name|Long
operator|.
name|BYTES
comment|// maximum sequence number, introduced in 6.0.0
operator|+
name|Long
operator|.
name|BYTES
...
return|;
block|}
DECL|method|readCheckpointV6_0_0
specifier|static
name|Checkpoint
name|readCheckpointV6_0_0
parameter_list|(
specifier|final
name|DataInput
name|in
...
DECL|method|readCheckpointV5_0_0
specifier|static
name|Checkpoint
name|readCheckpointV5_0_0
parameter_list|(
specifier|final
name|DataInput
name|in
