...
argument_list|)
decl_stmt|;
comment|// here we have to be lenient - nowhere else!
try|try
init|(
...
name|IllegalStateException
argument_list|(
literal|"non-legacy translog file ["
operator|+
name|path
operator|.
name|getFileName
...
argument_list|()
operator|+
literal|"] found on a translog that wasn't upgraded yet"
argument_list|)
throw|;
block|}
block|}
...
name|generation
decl_stmt|;
DECL|method|PathWithGeneration
specifier|public
name|PathWithGeneration
parameter_list|(
name|Path
