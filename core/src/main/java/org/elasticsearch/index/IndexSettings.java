...
argument_list|)
decl_stmt|;
DECL|field|INDEX_SEQ_NO_CHECKPOINT_SYNC_INTERVAL
specifier|public
specifier|static
specifier|final
name|Setting
...
decl_stmt|;
DECL|field|globalCheckpointInterval
specifier|private
specifier|final
name|TimeValue
name|globalCheckpointInterval
decl_stmt|;
...
return|;
block|}
comment|/**      * Returns this interval in which the primary shards of this index should check and advance the global checkpoint      */
DECL|method|getGlobalCheckpointInterval
specifier|public
name|TimeValue
