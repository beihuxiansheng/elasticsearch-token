...
argument_list|)
decl_stmt|;
comment|/**      * The number of active shard copies required for a write operation.      */
DECL|field|WAIT_FOR_ACTIVE_SHARDS_SETTING
specifier|public
specifier|static
specifier|final
name|Setting
...
argument_list|<>
argument_list|(
literal|"index.write.wait_for_active_shards"
argument_list|,
literal|"1"
argument_list|,
name|ActiveShardCount
