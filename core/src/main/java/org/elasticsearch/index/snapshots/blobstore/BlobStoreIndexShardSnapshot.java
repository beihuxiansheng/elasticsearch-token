...
return|;
block|}
comment|/**          * Checks if the checksum for the file is unknown. This only is possible on an empty shard's          * segments_N file which was created in older Lucene versions.          */
DECL|method|hasUnknownChecksum
specifier|public
name|boolean
...
name|ElasticsearchParseException
argument_list|(
literal|"missing or invalid written_by ["
operator|+
name|writtenByStr
operator|+
literal|"]"
...
name|ElasticsearchParseException
argument_list|(
literal|"missing checksum for name ["
operator|+
name|name
operator|+
literal|"]"
...
argument_list|)
decl_stmt|;
DECL|field|PARSE_INDEX_VERSION
specifier|private
specifier|static
specifier|final
name|ParseField
name|PARSE_INDEX_VERSION
init|=
operator|new
name|ParseField
argument_list|(
...
argument_list|)
decl_stmt|;
DECL|field|PARSE_NUMBER_OF_FILES
specifier|private
specifier|static
specifier|final
name|ParseField
name|PARSE_NUMBER_OF_FILES
init|=
operator|new
name|ParseField
argument_list|(
...
argument_list|)
decl_stmt|;
DECL|field|PARSE_TOTAL_SIZE
specifier|private
specifier|static
specifier|final
name|ParseField
name|PARSE_TOTAL_SIZE
init|=
operator|new
name|ParseField
argument_list|(
