...
name|version
decl_stmt|;
comment|/** the seq number of the operation that last changed the associated uuid */
DECL|field|seqNo
specifier|final
name|long
name|seqNo
decl_stmt|;
comment|/** the the term of the operation that last changed the associated uuid */
DECL|field|term
specifier|final
name|long
name|term
