...
return|;
block|}
comment|/**      * Inspects exception thrown when executing index or delete operations      *      * @return failure if the failure is a document specific failure (e.g. analysis chain failure)      * @throws ElasticsearchException if the failure caused the engine to fail      * (e.g. out of disk, lucene tragic event)      *      * Note: pkg-private for testing      */
