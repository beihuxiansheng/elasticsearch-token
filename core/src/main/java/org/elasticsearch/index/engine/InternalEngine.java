...
comment|// searcher managers, one for searching which is only refreshed by the schedule the user asks for, and another for version
comment|// map interactions:
name|boolean
name|useRefresh
init|=
name|versionMapRefreshPending
