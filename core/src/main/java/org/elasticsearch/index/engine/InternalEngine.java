...
return|;
block|}
comment|/**      * Inspects exception thrown when executing index or delete operations      *      * @return failure if the failure is a document specific failure (e.g. analysis chain failure)      * or throws Exception if the failure caused the engine to fail (e.g. out of disk, lucene tragic event)      *<p>      * Note: pkg-private for testing      */
DECL|method|checkIfDocumentFailureOrThrow
specifier|final
name|Exception
name|checkIfDocumentFailureOrThrow
parameter_list|(
