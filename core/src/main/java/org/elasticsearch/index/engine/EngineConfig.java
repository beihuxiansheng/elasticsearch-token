...
literal|true
decl_stmt|;
DECL|field|flushWhenLastMergeFinished
specifier|private
specifier|volatile
name|boolean
name|flushWhenLastMergeFinished
init|=
literal|false
decl_stmt|;
...
return|;
block|}
comment|/**      * Returns<code>true</code> iff then engine should be flushed once the last merged finished.      */
DECL|method|isFlushWhenLastMergeFinished
specifier|public
name|boolean
...
return|;
block|}
comment|/**      * Set to<code>true</code> iff then engine should be flushed once the last merged finished.      */
DECL|method|setFlushWhenLastMergeFinished
specifier|public
name|void
