...
return|;
block|}
comment|/**      * returns true if the engine is allowed to optimize indexing operations with an auto-generated ID      */
DECL|method|isAutoGeneratedIDsOptimizationEnabled
specifier|public
name|boolean
