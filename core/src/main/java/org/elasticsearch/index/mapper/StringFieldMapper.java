...
name|IllegalArgumentException
argument_list|(
literal|"The [string] type is removed in 5.0 and automatic upgrade failed because parameters "
operator|+
name|unsupportedParameters
operator|+
literal|" are not supported for automatic upgrades. You should now use either a [text] "
operator|+
