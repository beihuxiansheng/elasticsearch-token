...
parameter_list|()
block|{
comment|// TODO: this should be the same as the mapper type name, except fielddata expects int...
return|return
literal|"int"
return|;
block|}
...
block|}
block|}
DECL|method|IntegerFieldMapper
specifier|protected
name|IntegerFieldMapper
parameter_list|(
name|String
...
block|}
block|}
DECL|class|CustomIntegerNumericField
specifier|public
specifier|static
class|class
name|CustomIntegerNumericField
...
name|number
decl_stmt|;
DECL|method|CustomIntegerNumericField
specifier|public
name|CustomIntegerNumericField
parameter_list|(
name|int
