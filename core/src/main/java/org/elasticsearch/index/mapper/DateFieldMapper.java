...
block|}
block|}
comment|// This check needs to be done after fromInclusive and toInclusive
comment|// are resolved so we can throw an exception if they are invalid
comment|// even if there are no points in the shard
if|if
condition|(
name|PointValues
operator|.
