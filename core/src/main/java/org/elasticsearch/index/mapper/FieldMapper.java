...
name|NONE
decl_stmt|;
comment|// backcompat for "fielddata: format: docvalues" for now...
name|boolean
...
condition|)
block|{
comment|// this forces the doc_values setting to be written, so fielddata does not mask the original setting
name|defaultDocValues
operator|=
literal|true
expr_stmt|;
