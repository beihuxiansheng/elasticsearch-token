...
argument_list|()
decl_stmt|;
comment|// create an empty root object which updates will be propagated into
name|RootObjectMapper
operator|.
name|Builder
name|rootBuilder
...
argument_list|)
decl_stmt|;
comment|// find common elements with the previously processed dynamic mapper
name|int
name|keepBefore
init|=
literal|1
...
argument_list|)
expr_stmt|;
comment|// Add parent mappers that don't exist in dynamic mappers
while|while
condition|(
name|keepBefore
operator|<
