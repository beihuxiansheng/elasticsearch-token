...
condition|)
block|{
comment|// Downgrade "text" to "string" in indexes created in 2.x so you can use modern syntax against old indexes
name|Set
argument_list|<
name|String
argument_list|>
...
name|IllegalArgumentException
argument_list|(
literal|"Automatic downgrade from [text] to [string] failed because parameters "
operator|+
name|unsupportedParameters
operator|+
...
block|}
block|{
comment|// Downgrade "fielddata" (default in string is true, default in text is false)
name|Object
name|fielddata
init|=
name|node
...
name|IllegalArgumentException
argument_list|(
literal|"can't parse [fielddata] value for ["
operator|+
name|fielddata
operator|+
literal|"] for field ["
