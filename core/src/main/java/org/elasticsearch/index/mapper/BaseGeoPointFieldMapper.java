...
parameter_list|)
block|{
comment|// version 5.0 cuts over to LatLonPoint and no longer indexes geohash, or lat/lon separately
if|if
condition|(
name|context
operator|.
...
block|}
block|}
DECL|class|LegacyGeoPointFieldType
specifier|public
specifier|static
class|class
name|LegacyGeoPointFieldType
...
name|lonFieldType
decl_stmt|;
DECL|method|LegacyGeoPointFieldType
name|LegacyGeoPointFieldType
parameter_list|()
block|{}
DECL|method|LegacyGeoPointFieldType
...
block|}
block|}
DECL|method|legacyDoXContentBody
specifier|protected
name|void
name|legacyDoXContentBody
parameter_list|(
