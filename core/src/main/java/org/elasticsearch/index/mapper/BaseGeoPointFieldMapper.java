...
return|;
block|}
comment|/**              * we don't have a specific type for geo_point so we use an empty {@link FieldStats.Text}.              * TODO: we should maybe support a new type that knows how to (de)encode the min/max information              */
return|return
operator|new
name|FieldStats
operator|.
