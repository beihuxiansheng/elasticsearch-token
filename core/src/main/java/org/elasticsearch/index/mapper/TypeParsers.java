...
argument_list|)
decl_stmt|;
comment|//TODO 22298: Remove this method and have all call-sites use<code>XContentMapValues.nodeBooleanValue(node)</code> directly.
...
block|}
comment|//TODO 22298: Remove this method and have all call-sites use<code>XContentMapValues.nodeBooleanValue(node)</code> directly.
DECL|method|nodeBooleanValueLenient
specifier|public
specifier|static
name|boolean
name|nodeBooleanValueLenient
...
name|deprecated
argument_list|(
literal|"Expected a boolean for property [{}] for field [{}] but got [{}]"
argument_list|,
name|propertyName
argument_list|,
name|fieldName
...
name|deprecated
argument_list|(
literal|"The [norms{enabled:true/false}] way of specifying norms is deprecated, please use "
operator|+
literal|"[norms:true/false] instead"
argument_list|)
expr_stmt|;
block|}
else|else
