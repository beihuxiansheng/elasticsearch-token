...
argument_list|(
literal|"[_all] is disabled in 6.0. As a replacement, you can use an [copy_to] "
operator|+
literal|"on mapping fields to create your own catch all field."
argument_list|)
throw|;
block|}
name|Builder
...
condition|)
block|{
comment|// So there is no "enabled" field, however, the index was created prior to 6.0,
comment|// and therefore the default for this particular index should be "true" for
comment|// enabling _all
name|builder
operator|.
name|enabled
argument_list|(
...
condition|)
block|{
comment|// The index was created prior to 6.0, and therefore the default for this
comment|// particular index should be "true" for enabling _all
return|return
operator|new
name|AllFieldMapper
argument_list|(
