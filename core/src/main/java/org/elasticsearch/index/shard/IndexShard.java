...
name|state
argument_list|,
literal|"shard is not a replica"
argument_list|)
throw|;
block|}
return|return
...
block|}
block|}
comment|/**      * increments the ongoing operations counter on a primary shard. Returns the primary term of this shard.      */
DECL|method|incrementOperationCounterOnPrimary
specifier|public
name|long
...
return|;
block|}
comment|/**      * increments the ongoing operations counter. If the given primary term is lower then the one in {@link #shardRouting}      * an {@link IllegalIndexShardStateException} is thrown.      */
DECL|method|incrementOperationCounterOnReplica
specifier|public
name|void
...
block|}
block|}
DECL|field|queryShardContextCache
specifier|private
name|CloseableThreadLocal
argument_list|<
name|QueryShardContext
...
argument_list|()
block|{
comment|// TODO We should get rid of this threadlocal but I think it should be a sep change
annotation|@
name|Override
specifier|protected
name|QueryShardContext
...
return|;
block|}
comment|/**      * Returns a threadlocal QueryShardContext for this shard.      */
