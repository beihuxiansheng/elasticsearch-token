...
literal|"version"
decl_stmt|;
comment|// for pre-5.0 shards that have not yet been active
...
condition|)
block|{
comment|// ES versions before 6.0 wrote this for legacy reasons, just ignore for now and remove in 7.0
block|}
else|else
block|{
throw|throw
