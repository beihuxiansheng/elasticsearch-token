...
condition|)
block|{
comment|// we delay the actual creation of the sort order for this index because the mapping has not been merged yet.
comment|// The sort order is validated right after the merge of the mapping later in the process.
name|this
operator|.
name|indexSortSupplier
operator|=
...
begin_function
DECL|method|getIndexSortSupplier
specifier|public
name|Supplier
argument_list|<
name|Sort
