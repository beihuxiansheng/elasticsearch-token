...
block|}
block|}
comment|/**          * Set the {@link #size()} and ensure that the {@link #values} array can          * store at least that many entries.          */
DECL|method|resize
specifier|protected
name|void
name|resize
...
expr_stmt|;
block|}
comment|/**          * Fetch the first field value or 0 millis after epoch if there are no          * in.          */
DECL|method|getValue
specifier|public
name|ReadableDateTime
name|getValue
...
return|;
block|}
comment|/**          * Fetch the first value. Added for backwards compatibility with 5.x when date fields were {@link Longs}.          */
annotation|@
name|Deprecated
DECL|method|getDate
specifier|public
...
name|deprecated
argument_list|(
literal|"getDate is no longer necisary on date fields as the value is now a date."
argument_list|)
expr_stmt|;
return|return
name|getValue
...
return|;
block|}
comment|/**          * Fetch all the values. Added for backwards compatibility with 5.x when date fields were {@link Longs}.          */
annotation|@
name|Deprecated
DECL|method|getDates
specifier|public
...
name|deprecated
argument_list|(
literal|"getDates is no longer necisary on date fields as the values are now dates."
argument_list|)
expr_stmt|;
return|return
name|this
...
block|}
block|}
DECL|class|BinaryScriptDocValues
specifier|abstract
specifier|static
class|class
name|BinaryScriptDocValues
parameter_list|<
name|T
parameter_list|>
extends|extends
...
name|count
decl_stmt|;
DECL|method|BinaryScriptDocValues
name|BinaryScriptDocValues
parameter_list|(
name|SortedBinaryDocValues
name|in
...
control|)
block|{
comment|// We need to make a copy here, because BytesBinaryDVAtomicFieldData's SortedBinaryDocValues
comment|// implementation reuses the returned BytesRef. Otherwise we would end up with the same BytesRef
comment|// instance for all slots in the values array.
name|values
index|[
name|i
index|]
