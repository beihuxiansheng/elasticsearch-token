...
decl_stmt|;
comment|/**          * @param docType                   The type of the document being percolated          * @param queryRegistry             The registry holding all the percolator queries as Lucene queries.          * @param documentSource            The source of the document being percolated          * @param percolatorIndexSearcher   The index searcher on top of the in-memory index that holds the document being percolated          * @param percolateTypeQuery        A query that identifies all document containing percolator queries          */
DECL|method|Builder
specifier|public
name|Builder
parameter_list|(
...
block|{
return|return
literal|"PercolatorQuery{document_type={"
operator|+
name|documentType
operator|+
