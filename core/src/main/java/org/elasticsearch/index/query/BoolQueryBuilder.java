...
return|;
block|}
comment|/**      * Adds a list of queries that<b>must</b> appear in the matching documents and will      * contribute to scoring.      */
DECL|method|must
specifier|public
name|BoolQueryBuilder
name|must
...
return|;
block|}
comment|/**      * Adds a list of queries that<b>must</b> appear in the matching documents but will      * not contribute to scoring.      */
DECL|method|filter
specifier|public
name|BoolQueryBuilder
name|filter
...
return|;
block|}
comment|/**      * Adds a list of queries that<b>must not</b> appear in the matching documents.      */
DECL|method|mustNot
specifier|public
name|BoolQueryBuilder
name|mustNot
...
return|;
block|}
comment|/**      * Adds a list of clauses that<i>should</i> be matched by the returned documents. For a boolean query with no      *<tt>MUST</tt> clauses one or more<code>SHOULD</code> clauses must match a document      * for the BooleanQuery to match.      *      * @see #minimumNumberShouldMatch(int)      */
DECL|method|should
specifier|public
name|BoolQueryBuilder
name|should
