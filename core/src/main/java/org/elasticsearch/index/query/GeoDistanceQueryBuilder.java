...
literal|"memory"
decl_stmt|;
comment|/** Default for coercing lon/lat values to a standard coordinate system */
...
literal|false
decl_stmt|;
comment|/** Default for accepting accept geo points with invalid latitude or longitude */
...
name|DEFAULT_OPTIMIZE_BBOX
decl_stmt|;
comment|/** Whether or not to normalize longitude and latitude values to a standard coordinate system */
DECL|field|coerce
specifier|private
name|boolean
name|coerce
...
name|DEFAULT_COERCE
decl_stmt|;
comment|/** Whether or not to accept geo points with invalid latitude or longitude */
...
argument_list|()
decl_stmt|;
comment|/** For serialization purposes only. */
...
name|IllegalArgumentException
argument_list|(
literal|"optimizeBbox must not be null or empty"
argument_list|)
throw|;
block|}
name|this
...
argument_list|(
literal|"center point latitude is invalid number: "
operator|+
name|center
operator|.
name|getLat
...
name|addValidationError
argument_list|(
literal|"center point longitude is invalid number: "
operator|+
name|center
operator|.
name|getLon
...
name|addValidationError
argument_list|(
literal|"field name must be non-null and non-empty"
argument_list|,
name|validationException
argument_list|)
expr_stmt|;
