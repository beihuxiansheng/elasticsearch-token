...
literal|true
decl_stmt|;
comment|/** Default for flag controlling whether payloads are collected */
DECL|field|DEFAULT_COLLECT_PAYLOADS
specifier|public
specifier|static
name|boolean
...
return|;
block|}
comment|/**      * @param collectPayloads flag controlling whether payloads are collected      */
...
argument_list|(
literal|"query must include [clauses]"
argument_list|,
name|validationException
argument_list|)
expr_stmt|;
...
name|addValidationError
argument_list|(
literal|"[clauses] contains null element"
argument_list|,
name|validationException
argument_list|)
expr_stmt|;
