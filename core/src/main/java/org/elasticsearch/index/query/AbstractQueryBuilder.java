...
argument_list|(
literal|"lucene query boost is already set, override setFinalBoost to define how to combine lucene boost with main boost"
argument_list|)
throw|;
block|}
name|query
