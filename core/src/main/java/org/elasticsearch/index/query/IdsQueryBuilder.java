...
name|EMPTY_ARRAY
decl_stmt|;
comment|/**      * Creates a new IdsQueryBuilder with no types specified upfront      */
...
block|}
comment|/**      * Creates a new IdsQueryBuilder by providing the types of the documents to look for      * @deprecated Replaced by {@link #types(String...)}      */
annotation|@
name|Deprecated
DECL|method|IdsQueryBuilder
specifier|public
