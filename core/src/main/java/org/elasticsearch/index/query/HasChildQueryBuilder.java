...
DECL|method|shortCircuitCutoff
specifier|public
name|HasChildQueryBuilder
name|shortCircuitCutoff
parameter_list|(
...
name|NAME
operator|+
literal|"]  requires non-negative 'short_circuit_cutoff' field"
argument_list|)
throw|;
block|}
name|this
...
return|;
block|}
comment|/**      * Returns what cut off point only to evaluate parent documents that contain the matching parent id terms      * instead of evaluating all parent docs. The default is {@value #DEFAULT_SHORT_CIRCUIT_CUTOFF}      */
DECL|method|shortCircuitCutoff
specifier|public
name|int
name|shortCircuitCutoff
