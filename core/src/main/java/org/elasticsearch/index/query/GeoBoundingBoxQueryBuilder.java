...
name|IllegalArgumentException
argument_list|(
literal|"top cannot be the same as bottom: "
operator|+
name|top
operator|+
literal|" == "
...
name|IllegalArgumentException
argument_list|(
literal|"left cannot be the same as right: "
operator|+
name|left
operator|+
literal|" == "
...
return|;
block|}
comment|/**      * Adds points from a single geohash.      * @param geohash The geohash for computing the bounding box.      */
DECL|method|setCorners
specifier|public
name|GeoBoundingBoxQueryBuilder
name|setCorners
...
parameter_list|)
block|{
comment|// get the bounding box of the geohash and set topLeft and bottomRight
name|Rectangle
name|ghBBox
init|=
name|GeoHashUtils
