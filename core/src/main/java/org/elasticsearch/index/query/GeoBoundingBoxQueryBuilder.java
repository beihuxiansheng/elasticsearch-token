...
literal|"geo_bbox"
decl_stmt|;
comment|/** Default for geo point coerce (as of this writing false). */
...
literal|false
decl_stmt|;
comment|/** Default for skipping geo point validation (as of this writing false). */
...
argument_list|)
decl_stmt|;
comment|/** Whether or not to infer correct coordinates for wrapping bounding boxes.*/
DECL|field|coerce
specifier|private
name|boolean
name|coerce
...
name|DEFAULT_COERCE
decl_stmt|;
comment|/** Whether or not to skip geo point validation. */
...
return|;
block|}
comment|/**      * Specify whether or not to try and fix broken/wrapping bounding boxes.      * If set to true, also enables ignoreMalformed thus disabling geo point      * validation altogether.      **/
DECL|method|coerce
specifier|public
name|GeoBoundingBoxQueryBuilder
name|coerce
