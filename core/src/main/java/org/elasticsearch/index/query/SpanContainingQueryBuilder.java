...
argument_list|)
decl_stmt|;
comment|/**      * @param big the big clause, it must enclose {@code little} for a match.      * @param little the little clause, it must be contained within {@code big} for a match.      */
DECL|method|SpanContainingQueryBuilder
specifier|public
name|SpanContainingQueryBuilder
parameter_list|(
name|SpanQueryBuilder
...
condition|)
block|{
comment|//preserve potential inner boost coming from lucene (default is big.boost)
name|query
operator|.
name|setBoost
argument_list|(
