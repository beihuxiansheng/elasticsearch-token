...
name|queryText
decl_stmt|;
comment|/** Boost to apply to resulting Lucene query. Defaults to 1.0*/
DECL|field|boost
specifier|private
name|float
name|boost
...
name|analyzer
decl_stmt|;
comment|/** Name of the query. Optional.*/
...
argument_list|)
decl_stmt|;
comment|/** Operators available for linking boolean clauses. */
comment|// Move out after #11345 is in.
DECL|enum|Operator
specifier|public
specifier|static
enum|enum
...
argument_list|(
literal|"cannot parse Operator from ordinal "
operator|+
name|ordinal
argument_list|)
throw|;
...
return|;
block|}
comment|/** Returns the boost to apply to resulting Lucene query.*/
DECL|method|boost
specifier|public
name|float
name|boost
...
return|;
block|}
comment|/** Set the name for this query. */
...
return|;
block|}
comment|/** Returns the name for this query. */
DECL|method|queryName
specifier|public
name|String
name|queryName
...
expr_stmt|;
block|}
comment|// safety check - https://github.com/elastic/elasticsearch/pull/11696#discussion-diff-32532468
if|if
condition|(
name|query
operator|!=
