...
name|DEFAULT_FLAGS
decl_stmt|;
comment|/** Flag specifying whether query should be forced to expand to all searchable fields */
DECL|field|useAllFields
specifier|private
name|Boolean
name|useAllFields
decl_stmt|;
comment|/** Whether or not the lenient flag has been set or not */
DECL|field|lenientSet
specifier|private
name|boolean
name|lenientSet
init|=
...
argument_list|)
expr_stmt|;
comment|// Need to use lenient mode when using "all-mode" so exceptions aren't thrown due to mismatched types
name|newSettings
operator|.
name|lenient
argument_list|(
