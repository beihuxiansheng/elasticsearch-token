...
argument_list|()
decl_stmt|;
comment|// Starting with v3.0 indices, it should no longer be possible to redefine built-in similarities
if|if
condition|(
name|BUILT_IN
operator|.
...
control|)
block|{
comment|// Avoid overwriting custom providers for indices older that v3.0
if|if
condition|(
name|providers
operator|.
