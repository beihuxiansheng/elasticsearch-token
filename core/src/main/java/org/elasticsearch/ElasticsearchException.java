...
argument_list|)
block|,
DECL|enum constant|GROOVY_SCRIPT_COMPILATION_EXCEPTION
name|GROOVY_SCRIPT_COMPILATION_EXCEPTION
argument_list|(
name|org
operator|.
name|elasticsearch
...
argument_list|)
block|,
DECL|enum constant|PERCOLATOR_EXCEPTION
name|PERCOLATOR_EXCEPTION
argument_list|(
name|org
operator|.
name|elasticsearch
...
argument_list|)
block|,
DECL|enum constant|GROOVY_SCRIPT_EXECUTION_EXCEPTION
name|GROOVY_SCRIPT_EXECUTION_EXCEPTION
argument_list|(
name|org
operator|.
name|elasticsearch
