...
argument_list|)
block|,
comment|// 85 used to be for AlreadyExpiredException
...
begin_comment
comment|/**      * Returns an array of all registered handle IDs. These are the IDs for every registered      * exception.      *      * @return an array of all registered handle IDs      */
end_comment
...
begin_comment
comment|/**      * Returns an array of all registered pairs of handle IDs and exception classes. These pairs are      * provided for every registered exception.      *      * @return an array of all registered pairs of handle IDs and exception classes      */
end_comment
