...
name|warn
argument_list|(
literal|"ignoring unknown {} setting: [{}] with value [{}]; archiving"
argument_list|,
name|settingType
argument_list|,
name|e
...
name|ParameterizedMessage
argument_list|(
literal|"ignoring invalid {} setting: [{}] with value [{}]; archiving"
argument_list|,
name|settingType
argument_list|,
name|e
