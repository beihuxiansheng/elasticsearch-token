...
condition|)
block|{
comment|// we don't have an open shard on the store, validate the files on disk are openable
name|ShardPath
name|shardPath
init|=
literal|null
...
name|append
argument_list|(
literal|"NodeGatewayStartedShards["
argument_list|)
operator|.
name|append
argument_list|(
