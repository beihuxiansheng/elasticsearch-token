...
literal|false
assert|;
comment|// use in-sync allocation ids to select nodes
specifier|final
name|NodeShardsResult
name|nodeShardsResult
init|=
name|buildNodeShardsResult
argument_list|(
name|unassignedShard
argument_list|,
name|snapshotRestore
...
block|{
comment|// there were no shard copies that were eligible for being assigned the allocation,
comment|// so all fetched shard data are ineligible shards
name|ineligibleShards
operator|=
name|fetchedShardData
operator|.
...
DECL|method|buildNodeShardsResult
specifier|protected
specifier|static
name|NodeShardsResult
name|buildNodeShardsResult
