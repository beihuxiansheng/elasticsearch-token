...
name|debug
argument_list|(
literal|"[{}][{}]: found {} allocations of {} based on allocation ids: [{}]"
argument_list|,
name|shard
operator|.
name|index
...
return|;
block|}
comment|/**      * Split the list of nodes to lists of yes/no/throttle nodes based on allocation deciders      */
