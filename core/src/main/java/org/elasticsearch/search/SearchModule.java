...
expr_stmt|;
block|}
comment|/**      * Register a query.      *      * @param reader the reader registered for this query's builder. Typically a reference to a constructor that takes a      *        {@link org.elasticsearch.common.io.stream.StreamInput}      * @param parser the parser the reads the query builder from xcontent      * @param names all names by which this query might be parsed. The first name is special as it is the name by under which the reader is      *        registered. So it is the name that the query should use as its {@link NamedWriteable#getWriteableName()}.      */
...
expr_stmt|;
block|}
comment|/**      * Register a query.      * TODO remove this in favor of registerQuery      */
...
argument_list|()
decl_stmt|;
comment|// TODO remove this when we retire registerQueryParser
for|for
control|(
name|Supplier
argument_list|<
