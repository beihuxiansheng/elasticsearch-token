...
argument_list|()
expr_stmt|;
name|registerBuiltinSignificanceHeuristics
argument_list|()
expr_stmt|;
name|registerBuiltinMovingAverageModels
argument_list|()
expr_stmt|;
name|registerBuiltinSubFetchPhases
argument_list|()
expr_stmt|;
...
return|;
block|}
comment|/**      * Registers a {@link FetchSubPhase} instance. This sub phase is executed when docuemnts are fetched for instanced to highlight      * documents.      */
...
return|;
block|}
comment|/**      * Register a {@link MovAvgModel}.      *      * @param modelName the name(s) at which the model is parsed and streamed. The {@link ParseField#getPreferredName()} is the name under      *        which it is streamed. All named work for the parser.      * @param reader reads the model from a stream      * @param parser reads the model from an XContentParser      */
...
expr_stmt|;
block|}
DECL|method|registerBuiltinSignificanceHeuristics
specifier|private
name|void
name|registerBuiltinSignificanceHeuristics
parameter_list|()
...
expr_stmt|;
block|}
DECL|method|registerBuiltinMovingAverageModels
specifier|private
name|void
name|registerBuiltinMovingAverageModels
parameter_list|()
...
expr_stmt|;
block|}
DECL|method|registerBuiltinSubFetchPhases
specifier|private
name|void
name|registerBuiltinSubFetchPhases
parameter_list|()
