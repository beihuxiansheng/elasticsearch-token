...
return|;
block|}
comment|/**      * Register an aggregation.      *      * @param builderReader reads the {@link AggregationBuilder} from a stream      * @param internalReader reads the {@link InternalAggregation} from a stream      * @param aggregationParser reads the aggregation builder from XContent      * @param aggregationName names by which the aggregation may be parsed. The first name is special because it is the name that the reader      *        is registered under.      */
