...
name|name
decl_stmt|;
comment|/**          * Register an aggregation.          *          * @param builderReader reads the {@link AggregationBuilder} from a stream          * @param parser reads the aggregation builder from XContent          * @param name names by which the aggregation may be parsed. The first name is special because it is the name that the reader is          *        registered under.          */
...
expr_stmt|;
block|}
comment|/**          * Add a reader for the shard level results of the aggregation with {@linkplain #name}'s {@link ParseField#getPreferredName()} as          * the {@link NamedWriteable#getWriteableName()}.          */
...
block|}
block|}
comment|/**      * Register a pipeline aggregation.      */
...
name|name
decl_stmt|;
comment|/**          * Register a pipeline aggregation.          *          * @param builderReader reads the {@link PipelineAggregationBuilder} from a stream          * @param parser reads the aggregation builder from XContent          * @param name names by which the aggregation may be parsed. The first name is special because it is the name that the reader is          *        registered under.          */
...
return|;
block|}
comment|/**          * Add a reader for the shard level bucket results of the aggregation with {@linkplain name}'s {@link ParseField#getPreferredName()}          * as the {@link NamedWriteable#getWriteableName()}.          */
DECL|method|addBucketReader
specifier|public
name|PipelineAggregationSpec
name|addBucketReader
parameter_list|(
name|Writeable
operator|.
name|Reader
