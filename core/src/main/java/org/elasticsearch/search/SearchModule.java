...
name|suggesters
decl_stmt|;
comment|/**      * Map from name to score parser and its ParseField.      */
...
argument_list|()
decl_stmt|;
DECL|field|scoreFunctionsRegistry
specifier|private
specifier|final
name|ScoreFunctionsRegistry
name|scoreFunctionsRegistry
...
DECL|method|getScoreFunctionsRegistry
specifier|public
name|ScoreFunctionsRegistry
name|getScoreFunctionsRegistry
parameter_list|()
block|{
return|return
name|scoreFunctionsRegistry
