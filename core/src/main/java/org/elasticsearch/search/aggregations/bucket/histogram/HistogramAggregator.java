...
expr_stmt|;
block|}
DECL|method|getHistogramFactory
specifier|public
name|InternalHistogram
operator|.
name|Factory
...
argument_list|()
decl_stmt|;
comment|// we need to round the bounds given by the user and we have to do it for every aggregator we create
...
block|}
block|}
DECL|class|DateHistogramFactory
specifier|public
specifier|static
class|class
...
name|dateHistogramInterval
decl_stmt|;
DECL|method|DateHistogramFactory
specifier|public
name|DateHistogramFactory
parameter_list|(
name|String
