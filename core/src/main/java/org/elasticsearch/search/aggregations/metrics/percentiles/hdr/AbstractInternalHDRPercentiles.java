...
parameter_list|()
block|{
comment|// we cannot use state.hashCode at the moment because of:
comment|// https://github.com/HdrHistogram/HdrHistogram/issues/81
comment|// TODO: upgrade the HDRHistogram library
return|return
name|Objects
operator|.
name|hash
...
name|state
operator|.
name|getIntegerToDoubleValueConversionRatio
argument_list|()
argument_list|,
name|state
operator|.
