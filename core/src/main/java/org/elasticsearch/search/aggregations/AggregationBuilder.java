...
begin_comment
comment|/**  * A base class for all bucket aggregation builders. NORELEASE REMOVE WHEN AGG  * REFACTORING IS COMPLETE  */
end_comment
...
name|aggregations
decl_stmt|;
DECL|field|aggregatorFactories
specifier|private
name|List
argument_list|<
...
expr_stmt|;
block|}
comment|/**      * Add a sub aggregation to this aggregation. NORELEASE REMOVE THIS WHEN AGG      * REFACTOR IS COMPLETE      */
annotation|@
...
block|}
block|}
comment|/**      * Sets the meta data to be included in the aggregation response      */
