...
return|;
block|}
comment|/**      * Create a new {@link SignificantTextAggregationBuilder} aggregation with the given name and text field name      */
DECL|method|significantText
specifier|public
specifier|static
name|SignificantTextAggregationBuilder
name|significantText
parameter_list|(
name|String
name|name
parameter_list|,
