...
throw|;
block|}
comment|// If the user doesn't set a preference for cost minimization, ask what the model prefers
if|if
condition|(
name|minimize
operator|==
...
condition|)
block|{
comment|// If the user asks to minimize, but this model doesn't support it, throw exception
throw|throw
operator|new
name|SearchParseException
argument_list|(
...
name|model
operator|+
literal|"] model cannot be minimized."
argument_list|,
literal|null
argument_list|)
throw|;
