...
name|ElasticsearchParseException
argument_list|(
literal|"Unknown string parameter in Include/Exclude clause: "
operator|+
name|currentFieldName
argument_list|)
throw|;
...
name|ElasticsearchParseException
argument_list|(
literal|"Unknown numeric parameter in Include/Exclude clause: "
operator|+
name|currentFieldName
argument_list|)
throw|;
...
name|IllegalArgumentException
argument_list|(
literal|"Partitioned Include cannot be used in combination with excludes"
argument_list|)
throw|;
block|}
return|return
