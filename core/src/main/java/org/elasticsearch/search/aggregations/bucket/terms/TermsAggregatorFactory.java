...
throw|;
block|}
comment|// return the SubAggCollectionMode that this aggregation should use based on the expected size
comment|// and the cardinality of the field
...
condition|)
block|{
comment|// use breadth_first if the cardinality is bigger than the expected size or unknown (-1)
return|return
name|SubAggCollectionMode
operator|.
name|BREADTH_FIRST
