...
name|valueCount
decl_stmt|;
DECL|field|lookupGlobalOrd
specifier|protected
specifier|final
name|GlobalOrdLookupFunction
name|lookupGlobalOrd
decl_stmt|;
...
name|bucketOrds
decl_stmt|;
DECL|interface|GlobalOrdLookupFunction
specifier|public
interface|interface
name|GlobalOrdLookupFunction
block|{
...
literal|null
expr_stmt|;
comment|/**          * Remap global ords to dense bucket ordinals if any sub-aggregator cannot be deferred.          * Sub-aggregators expect dense buckets and allocate memories based on this assumption.          * Deferred aggregators are safe because the selected ordinals are remapped when the buckets          * are replayed.          */
name|boolean
...
return|;
block|}
DECL|method|collectGlobalOrd
specifier|private
name|void
name|collectGlobalOrd
parameter_list|(
name|int
name|doc
parameter_list|,
