...
block|}
decl_stmt|;
comment|/**      * a {@link FieldOptions.Builder} with default settings      */
DECL|method|defaultFieldOptions
specifier|public
specifier|final
specifier|static
name|Builder
...
return|;
block|}
comment|/**      * parse options only present in top level highlight builder (`tags_schema`, `encoder` and nested `fields`)      */
annotation|@
name|Override
...
expr_stmt|;
block|}
comment|/**          * parse options only present in field highlight builder (`fragment_offset`, `matched_fields`)          */
annotation|@
name|Override
DECL|method|doFromXContent
specifier|protected
...
argument_list|()
argument_list|,
literal|"unknown token type [{}], expected field name"
argument_list|,
name|parser
operator|.
name|currentToken
