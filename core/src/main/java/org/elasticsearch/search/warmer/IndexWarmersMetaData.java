...
argument_list|)
expr_stmt|;
comment|// NOCOMMIT need context from somewhere
block|}
comment|//                    } else if (token == XContentParser.Token.VALUE_EMBEDDED_OBJECT) {
comment|//                        if ("source".equals(currentFieldName)) {
comment|//                            source = new BytesArray(parser.binaryValue());
comment|//                        } NORELEASE do we need this?
block|}
elseif|else
if|if
condition|(
