...
begin_comment
comment|/**  * The base builder for rescorers. Wraps a conrete instance of {@link RescoreBuilder} and  * adds the ability to specify the optional `window_size` parameter  */
end_comment

begin_class
DECL|class|RescoreBaseBuilder
specifier|public
class|class
...
argument_list|)
decl_stmt|;
DECL|method|RescoreBaseBuilder
specifier|public
name|RescoreBaseBuilder
parameter_list|(
name|RescoreBuilder
