...
block|}
block|}
comment|/**          * Workaround to detect parent/child query          */
DECL|field|PARENT_CHILD_QUERY_NAME
specifier|private
specifier|static
specifier|final
name|String
name|PARENT_CHILD_QUERY_NAME
init|=
literal|"HasChildQueryBuilder$LateParsingQuery"
decl_stmt|;
DECL|method|isChildOrParentQuery
specifier|private
specifier|static
name|boolean
name|isChildOrParentQuery
