...
argument_list|)
decl_stmt|;
DECL|field|BOUNDARY_SCANNER_FIELD
specifier|public
specifier|static
specifier|final
name|ParseField
name|BOUNDARY_SCANNER_FIELD
init|=
operator|new
name|ParseField
argument_list|(
literal|"boundary_scanner"
argument_list|)
decl_stmt|;
...
argument_list|)
decl_stmt|;
DECL|field|BOUNDARY_SCANNER_LOCALE_FIELD
specifier|public
specifier|static
specifier|final
name|ParseField
name|BOUNDARY_SCANNER_LOCALE_FIELD
init|=
operator|new
name|ParseField
argument_list|(
literal|"boundary_scanner_locale"
argument_list|)
decl_stmt|;
...
return|;
block|}
comment|/**      * When using the highlighterType<tt>fvh</tt> this setting      * controls which scanner to use for fragment boundaries, and defaults to "simple".      */
annotation|@
name|SuppressWarnings
argument_list|(
literal|"unchecked"
...
return|;
block|}
comment|/**      * @return the value set by {@link #boundaryScannerType(String)}      */
DECL|method|boundaryScannerType
specifier|public
name|BoundaryScannerType
name|boundaryScannerType
...
return|;
block|}
comment|/**      * When using the highlighterType<tt>fvh</tt> and boundaryScannerType<tt>break_iterator</tt>, this setting      * controls the locale to use by the BreakIterator, defaults to "root".      */
annotation|@
name|SuppressWarnings
argument_list|(
literal|"unchecked"
...
return|;
block|}
comment|/**      * @return the value set by {@link #boundaryScannerLocale(String)}      */
DECL|method|boundaryScannerLocale
specifier|public
name|Locale
name|boundaryScannerLocale
