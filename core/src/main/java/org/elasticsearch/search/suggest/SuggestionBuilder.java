...
argument_list|)
decl_stmt|;
comment|/**      * Creates a new suggestion.      * @param fieldname field to fetch the candidate suggestions from      */
...
return|;
block|}
comment|/**      * Subclass should return a new instance, reading itself from the input string      * @param in the input string to read from      * @param fieldname the fieldname needed for ctor or concrete suggestion      */
