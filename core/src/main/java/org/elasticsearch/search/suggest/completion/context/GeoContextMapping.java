...
return|;
block|}
DECL|method|innerParseQueryContext
specifier|private
...
name|ElasticsearchParseException
argument_list|(
literal|"context must have either lat/lon or geohash"
argument_list|)
throw|;
block|}
block|}
...
argument_list|(
literal|"boost must be a string representing a numeric value, but was ["
operator|+
name|parser
operator|.
name|text
...
name|ElasticsearchParseException
argument_list|(
literal|"boost must be in the interval [0..2147483647], but was ["
operator|+
name|number
operator|.
name|longValue
...
name|ElasticsearchParseException
argument_list|(
literal|"neighbours array must have only numbers"
argument_list|)
throw|;
block|}
block|}
...
name|ElasticsearchParseException
argument_list|(
literal|"neighbours must be a number or a list of numbers"
argument_list|)
throw|;
block|}
block|}
...
name|ElasticsearchParseException
argument_list|(
literal|"precision must be a number"
argument_list|)
throw|;
block|}
block|}
...
name|ElasticsearchParseException
argument_list|(
literal|"contexts field expected string or object but was ["
operator|+
name|token
operator|.
name|name
