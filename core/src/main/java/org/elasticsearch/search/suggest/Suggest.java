...
literal|null
decl_stmt|;
comment|// the "size" parameter and the SortBy for TermSuggestion cannot be parsed from the response, use default values
comment|// TODO investigate if we can use NamedXContentRegistry instead of this switch
switch|switch
condition|(
name|type
condition|)
...
argument_list|()
argument_list|,
literal|"Unknown suggestion type [{}]"
argument_list|,
name|type
argument_list|)
throw|;
