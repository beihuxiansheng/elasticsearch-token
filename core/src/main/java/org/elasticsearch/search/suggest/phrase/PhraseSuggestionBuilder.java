...
argument_list|)
expr_stmt|;
comment|// NORELEASE write Map<String, List<CandidateGenerator>> generators = new HashMap<>();
block|}
annotation|@
name|Override
...
argument_list|()
expr_stmt|;
comment|// NORELEASE read Map<String, List<CandidateGenerator>> generators;
return|return
name|builder
return|;
block|}
...
argument_list|)
operator|&&
comment|// NORELEASE Objects.equals(generator, other.generator)&&
name|Objects
operator|.
name|equals
argument_list|(
