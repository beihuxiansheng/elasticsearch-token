...
expr_stmt|;
block|}
comment|/**      * Creates a new {@link SortBuilder} from the query held by the {@link QueryParseContext}      * in {@link org.elasticsearch.common.xcontent.XContent} format      *      * @param parseContext      *            the input parse context. The state on the parser contained in      *            this context will be changed as a side effect of this method call      * @param fieldName      *            in some sort syntax variations the field name precedes the xContent object that      *            specifies further parameters, e.g. in '{Â "foo": { "order" : "asc"} }'. When      *            parsing the inner object, the field name can be passed in via this argument      *      * @return the new sort builder instance      */
