...
argument_list|)
decl_stmt|;
comment|/**      * Enables low-level, frequent search cancellation checks. Enabling low-level checks will make long running searches to react      * to the cancellation request faster. However, since it will produce more cancellation checks it might slow the search performance      * down.      */
DECL|field|LOW_LEVEL_CANCELLATION_SETTING
specifier|public
specifier|static
specifier|final
name|Setting
...
name|boolSetting
argument_list|(
literal|"search.low_level_cancellation"
argument_list|,
literal|false
argument_list|,
name|Property
...
expr_stmt|;
block|}
DECL|method|setLowLevelCancellation
specifier|private
name|void
name|setLowLevelCancellation
parameter_list|(
...
parameter_list|)
block|{
comment|// once an index is removed due to deletion or closing, we can just clean up all the pending search context information
