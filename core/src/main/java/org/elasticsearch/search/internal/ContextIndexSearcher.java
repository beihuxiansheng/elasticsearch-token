...
name|IOException
block|{
comment|// Wrap the caller's collector with various wrappers e.g. those used to siphon
comment|// matches off for aggregation or to impose a time-limit on collection.
specifier|final
name|boolean
name|timeoutSet
init|=
