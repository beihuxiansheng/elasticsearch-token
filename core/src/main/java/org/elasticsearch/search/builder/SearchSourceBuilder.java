...
return|;
block|}
comment|/**      * Sets no stored fields to be loaded, resulting in only id and type to be returned      * per field.      */
DECL|method|noStoredFields
specifier|public
name|SearchSourceBuilder
name|noStoredFields
parameter_list|()
...
return|;
block|}
comment|/**      * Gets the stored fields to load and return as part of the search request.      */
DECL|method|storedFields
specifier|public
name|List
argument_list|<
