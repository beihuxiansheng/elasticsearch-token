...
return|;
block|}
comment|/**      * Reads a set using reader to decode the set elements.      */
DECL|method|readSet
specifier|public
parameter_list|<
name|T
...
return|;
block|}
comment|/**      * FunctionalInterface for methods that read an object from the stream.      */
annotation|@
name|FunctionalInterface
DECL|interface|ObjectReader
specifier|public
specifier|static
interface|interface
name|ObjectReader
