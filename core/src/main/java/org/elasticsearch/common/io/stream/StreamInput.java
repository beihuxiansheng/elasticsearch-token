...
return|;
block|}
comment|/**      * Reads an enum with type E that was serialized based on the value of it's ordinal      */
DECL|method|readEnum
specifier|public
parameter_list|<
name|E
extends|extends
