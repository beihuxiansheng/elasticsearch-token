...
return|;
block|}
comment|/**      * Computes the bounding box coordinates from a given geohash      *      * @param geohash Geohash of the defined cell      * @return GeoRect rectangle defining the bounding box      */
DECL|method|bbox
specifier|public
specifier|static
name|Rectangle
...
parameter_list|)
block|{
comment|// bottom left is the coordinate
name|GeoPoint
name|bottomLeft
init|=
name|GeoPoint
...
argument_list|)
decl_stmt|;
comment|// shift away the level
name|ghLong
operator|>>>=
literal|4
expr_stmt|;
comment|// deinterleave and add 1 to lat and lon to get topRight
name|long
name|lat
init|=
name|BitUtil
...
return|;
block|}
comment|/** returns the latitude value from the string based geohash */
