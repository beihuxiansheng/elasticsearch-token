...
return|;
block|}
comment|/**      * Add a new hole to the polygon      * @param hole linear ring defining the hole      * @param coerce if set to true, will close the hole by adding starting point as end point      * @return this      */
DECL|method|hole
specifier|public
name|PolygonBuilder
name|hole
