...
return|;
block|}
comment|/** check if point is within a rectangle      * todo: move this to lucene Rectangle class      */
DECL|method|rectangleContainsPoint
specifier|public
specifier|static
name|boolean
...
condition|)
block|{
comment|// if rectangle crosses the dateline we only check if the lon is>= min or max
return|return
name|r
operator|.
