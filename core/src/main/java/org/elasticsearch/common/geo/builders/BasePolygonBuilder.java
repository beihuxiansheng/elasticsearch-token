...
name|POLYGON
decl_stmt|;
comment|// Linear ring defining the shell of the polygon
DECL|field|shell
specifier|protected
name|Ring
argument_list|<
...
name|shell
decl_stmt|;
comment|// List of linear rings defining the holes of the polygon
DECL|field|holes
specifier|protected
specifier|final
name|ArrayList
...
return|;
block|}
comment|/**      * Add a array of points to the shell of the polygon      * @param coordinates coordinates of the new points to add      * @return this      */
DECL|method|points
specifier|public
name|E
name|points
...
return|;
block|}
comment|/**      * Close the shell of the polygon      * @return parent      */
DECL|method|close
specifier|public
name|ShapeBuilder
name|close
