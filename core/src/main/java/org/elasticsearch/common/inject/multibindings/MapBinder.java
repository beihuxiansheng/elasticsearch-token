...
return|;
block|}
DECL|class|MapBinderProviderWithDependencies
specifier|public
specifier|static
class|class
name|MapBinderProviderWithDependencies
parameter_list|<
name|K
parameter_list|,
name|V
...
literal|"rawtypes"
argument_list|)
comment|// code is silly stupid with generics
DECL|field|binder
specifier|private
specifier|final
name|RealMapBinder
...
argument_list|)
comment|// code is silly stupid with generics
DECL|method|MapBinderProviderWithDependencies
name|MapBinderProviderWithDependencies
parameter_list|(
name|RealMapBinder
name|binder
