...
block|{
comment|// Otherwise, the generator is not filtered and has the same type: we can potentially optimize the write
name|writeObjectRaw
argument_list|(
name|fieldName
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// we could potentially optimize this to not rely on exception logic...
name|String
name|sValue
init|=
name|content
