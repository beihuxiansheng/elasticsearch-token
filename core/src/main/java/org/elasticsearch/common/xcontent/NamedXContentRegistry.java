...
function_decl|;
block|}
comment|/**      * Parses an object with the type T from parser.      * @deprecated prefer {@link FromXContent} if possible      */
annotation|@
name|Deprecated
DECL|interface|FromXContentWithContext
specifier|public
interface|interface
name|FromXContentWithContext
parameter_list|<
name|T
parameter_list|>
block|{
...
expr_stmt|;
block|}
comment|/**          * Creates a new entry which can be stored by the registry.          * @deprecated prefer {@link Entry#Entry(Class, ParseField, FromXContent)}. Contexts will be removed when possible          */
annotation|@
name|Deprecated
DECL|method|Entry
specifier|public
