...
if|if
condition|(
name|isSameMediaTypeOrFormatAs
argument_list|(
name|mediaType
argument_list|,
name|type
...
return|;
block|}
comment|/**      * Attempts to match the given media type with the known {@link XContentType} values. This match is done in a case-insensitive manner.      * The provided media type should not include any parameters. This method is suitable for parsing part of the {@code Content-Type}      * HTTP header. This method will return {@code null} if no match is found      */
DECL|method|fromMediaType
specifier|public
specifier|static
name|XContentType
name|fromMediaType
...
name|mediaType
argument_list|,
literal|"mediaType cannot be null"
argument_list|)
operator|.
name|toLowerCase
argument_list|(
...
return|;
block|}
DECL|method|isSameMediaTypeOrFormatAs
specifier|private
specifier|static
name|boolean
name|isSameMediaTypeOrFormatAs
