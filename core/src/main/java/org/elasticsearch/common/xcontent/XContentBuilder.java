...
comment|// Raw fields
comment|//////////////////////////////////
comment|/**      * Writes a raw field with the value taken from the bytes in the stream      * @deprecated use {@link #rawField(String, InputStream, XContentType)} to avoid content type auto-detection      */
annotation|@
name|Deprecated
...
return|;
block|}
comment|/**      * Writes a raw field with the given bytes as the value      * @deprecated use {@link #rawField(String name, BytesReference, XContentType)} to avoid content type auto-detection      */
annotation|@
name|Deprecated
DECL|method|rawField
specifier|public
...
return|;
block|}
comment|/**      * Writes a value with the source coming directly from the bytes      * @deprecated use {@link #rawValue(BytesReference, XContentType)} to avoid content type auto-detection      */
annotation|@
name|Deprecated
