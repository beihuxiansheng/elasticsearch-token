...
name|date
decl_stmt|;
comment|// We use 01/01/1970 as a base date so that things keep working with date
comment|// fields that are filled with times without dates
if|if
condition|(
name|roundUpIfNoTime
condition|)
...
argument_list|(
literal|"Parse failure at index ["
operator|+
name|position
operator|+
literal|"] of ["
...
name|IllegalArgumentException
argument_list|(
literal|"Unrecognized chars at the end of ["
operator|+
name|value
operator|+
literal|"]: ["
