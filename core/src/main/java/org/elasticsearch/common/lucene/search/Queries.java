...
name|Queries
block|{
DECL|field|NON_NESTED_TYPE_AUTOMATON
specifier|private
specifier|static
specifier|final
name|Automaton
name|NON_NESTED_TYPE_AUTOMATON
decl_stmt|;
static|static
block|{
name|Automaton
name|nestedTypeAutomaton
init|=
name|Operations
operator|.
name|concatenate
...
expr_stmt|;
block|}
comment|// We use a custom class rather than AutomatonQuery directly in order to
comment|// have a better toString
DECL|class|NonNestedQuery
specifier|private
specifier|static
class|class
name|NonNestedQuery
...
parameter_list|()
block|{
comment|// we use this automaton query rather than a negation of newNestedFilter
comment|// since purely negative queries against high-cardinality clauses are costly
return|return
operator|new
name|NonNestedQuery
argument_list|()
...
DECL|method|maybeApplyMinimumShouldMatch
specifier|public
specifier|static
name|Query
