...
condition|)
block|{
comment|// delete directory recursively as long as it is empty (only contains empty directories),
comment|// which is the reason we aren't deleting any files, only the directories on the post-visit
name|Files
operator|.
name|walkFileTree
argument_list|(
