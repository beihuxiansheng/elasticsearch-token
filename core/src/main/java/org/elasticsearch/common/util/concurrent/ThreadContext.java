...
return|;
block|}
comment|/**      * Just like {@link #stashContext()} but no default context is set.      * @param preserveResponseHeaders if set to<code>true</code> the response headers of the restore thread will be preserved.      */
...
return|;
block|}
comment|/**      * Same as {@link #newRestorableContext(boolean)} but wraps an existing context to restore.      * @param storedContext the context to restore      */
DECL|method|wrapRestorable
specifier|public
name|Supplier
argument_list|<
name|StoredContext
...
return|;
block|}
comment|/**      * Add the {@code value} for the specified {@code key} Any duplicate {@code value} is ignored.      *      * @param key         the header name      * @param value       the header value      */
...
expr_stmt|;
block|}
comment|/**      * Add the {@code value} for the specified {@code key} with the specified {@code uniqueValue} used for de-duplication. Any duplicate      * {@code value} after applying {@code uniqueValue} is ignored.      *      * @param key         the header name      * @param value       the header value      * @param uniqueValue the function that produces de-duplication values      */
DECL|method|addResponseHeader
specifier|public
name|void
name|addResponseHeader
...
block|}
block|}
DECL|method|putResponseHeaders
specifier|private
name|ThreadContextStruct
name|putResponseHeaders
parameter_list|(
...
name|in
decl_stmt|;
DECL|field|creatorsContext
specifier|private
specifier|final
name|ThreadContext
operator|.
name|StoredContext
name|creatorsContext
decl_stmt|;
DECL|field|threadsOriginalContext
specifier|private
name|ThreadContext
operator|.
name|StoredContext
name|threadsOriginalContext
init|=
literal|null
decl_stmt|;
