...
init|=
name|readOnlyIndexMetaDataStateFormat
argument_list|()
decl_stmt|;
...
return|;
block|}
DECL|method|readOnlyIndexMetaDataStateFormat
specifier|static
name|MetaDataStateFormat
argument_list|<
name|IndexMetaData
...
parameter_list|()
block|{
comment|// NOTE: XContentType param is not used as we use the format read from the serialized index state
return|return
operator|new
name|MetaDataStateFormat
argument_list|<
