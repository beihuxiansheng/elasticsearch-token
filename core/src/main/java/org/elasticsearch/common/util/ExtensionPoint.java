...
expr_stmt|;
block|}
comment|/**      * Subclasses can bind their type, map or set exentions here.      */
...
argument_list|>
block|{
DECL|method|TypeExtensionPoint
specifier|public
name|TypeExtensionPoint
parameter_list|(
name|String
...
argument_list|()
decl_stmt|;
comment|/**          * Creates a new {@link org.elasticsearch.common.util.ExtensionPoint.SetExtensionPoint}          *          * @param name           the human readable underscore case name of the extension poing. This is used in error messages etc.          * @param extensionClass the base class that should be extended          * @param singletons     a list of singletons to bind with this extension point - these are bound in {@link #bind(Binder)}          */
DECL|method|SetExtensionPoint
specifier|public
name|SetExtensionPoint
parameter_list|(
name|String
