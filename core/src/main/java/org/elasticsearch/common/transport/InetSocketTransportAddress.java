...
block|{
comment|// TODO: do we really need this option, why do resolving? - remove this as a follow-up
...
name|reason
operator|=
literal|"if explicitly configured we do hostName reverse lookup"
argument_list|)
comment|// TODO remove this?
DECL|method|maybeLookupHostname
specifier|private
name|String
name|maybeLookupHostname
parameter_list|()
