...
DECL|field|_STANDARD_DECODABET
specifier|private
specifier|final
specifier|static
name|byte
...
DECL|field|_URL_SAFE_DECODABET
specifier|private
specifier|final
specifier|static
name|byte
...
block|}
comment|// end encodeBytes
comment|/**      * Encodes a byte array into Base64 notation.      *<p>      * Example options:<pre>      *   GZIP: gzip-compresses object before encoding it.      *   DO_BREAK_LINES: break lines at 76 characters      *<i>Note: Technically, this makes your encoding non-compliant.</i>      *</pre>      *<p>      * Example:<code>encodeBytes( myData, Base64.GZIP )</code> or      *<p>      * Example:<code>encodeBytes( myData, Base64.GZIP | Base64.DO_BREAK_LINES )</code>      *<p>      * As of v 2.3, if there is an error with the GZIP stream,      * the method will throw an java.io.IOException.<b>This is new to v2.3!</b>      * In earlier versions, it just returned a null value, but      * in retrospect that's a pretty poor way to handle it.      *      * @param source  The data to convert      * @param off     Offset in array where conversion should begin      * @param len     Length of data to convert      * @param options Specified options      * @return The Base64-encoded data as a String      * @throws java.io.IOException      if there is an error      * @throws NullPointerException     if source array is null      * @throws IllegalArgumentException if source array, offset, or length are invalid      * @see Base64#GZIP      * @see Base64#DO_BREAK_LINES      * @since 2.0      */
DECL|method|encodeBytes
specifier|public
specifier|static
name|String
...
DECL|method|encodeBytesToBytes
specifier|public
specifier|static
name|byte
index|[]
...
return|;
block|}
comment|/**      * Similar to {@link #encodeBytes(byte[], int, int, int)} but returns      * a byte array instead of instantiating a String. This is more efficient      * if you're working with I/O streams and have large data sets to encode.      *      * @param source  The data to convert      * @param off     Offset in array where conversion should begin      * @param len     Length of data to convert      * @param options Specified options      * @return The Base64-encoded data as a String      * @throws java.io.IOException      if there is an error      * @throws NullPointerException     if source array is null      * @throws IllegalArgumentException if source array, offset, or length are invalid      * @see Base64#GZIP      * @see Base64#DO_BREAK_LINES      * @since 2.3.1      */
DECL|method|encodeBytesToBytes
specifier|public
specifier|static
name|byte
...
DECL|method|encodeNonCompressedBytes
specifier|private
specifier|static
name|byte
index|[]
...
block|}
block|}
DECL|method|encodeCompressedBytes
specifier|private
specifier|static
name|byte
index|[]
...
condition|)
block|{
comment|// check if the equals sign is somewhere in between
if|if
condition|(
name|i
operator|+
...
name|ROOT
argument_list|,
literal|"Found equals sign at position %d of the base64 string, not at the end"
argument_list|,
name|i
argument_list|)
argument_list|)
...
throw|;
block|}
comment|// enf if: equals sign and next character not as well
block|}
comment|// end else:
block|}
