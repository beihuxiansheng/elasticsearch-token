...
argument_list|)
decl_stmt|;
comment|/** Name of the setting to use to disable required units for byte size, time settings. */
DECL|field|SETTINGS_REQUIRE_UNITS
specifier|public
specifier|static
specifier|final
name|String
...
init|=
literal|"settings_require_units"
decl_stmt|;
DECL|field|settingsRequireUnits
specifier|private
specifier|static
name|boolean
name|settingsRequireUnits
init|=
literal|true
decl_stmt|;
DECL|method|setSettingsRequireUnits
specifier|public
specifier|static
name|void
...
expr_stmt|;
block|}
DECL|method|getSettingsRequireUnits
specifier|public
specifier|static
name|boolean
...
return|;
block|}
comment|/**          * Removes the specified value from the given key.          * Returns true if the value was found and removed, false otherwise.          */
...
parameter_list|)
block|{
comment|// TODO: this is too crazy, we should just have a multimap...
name|String
name|oldValue
init|=
name|get
...
block|}
block|}
comment|// found the value, shift values after it back one index
name|int
name|j
init|=
name|i
...
return|;
block|}
DECL|class|StartsWithPredicate
specifier|private
specifier|static
specifier|final
class|class
...
name|prefix
decl_stmt|;
DECL|method|StartsWithPredicate
specifier|public
name|StartsWithPredicate
parameter_list|(
name|String
