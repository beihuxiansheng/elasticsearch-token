...
return|;
block|}
comment|/**      * Returns the cluster settings defaults      */
...
return|;
block|}
comment|/**      * Returns a settings object that contains all clustersettings that are not      * already set in the given source.      */
DECL|method|diff
specifier|public
name|Settings
name|diff
