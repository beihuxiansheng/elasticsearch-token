...
expr_stmt|;
block|}
comment|/**      * Creates a new Setting instance, unfiltered      * @param key the settings key for this setting.      * @param fallBackSetting a setting to fall back to if the current setting is not set.      * @param parser a parser that parses the string rep into a complex datatype.      * @param dynamic true iff this setting can be dynamically updateable      * @param scope the scope of this setting      */
DECL|method|Setting
specifier|public
name|Setting
parameter_list|(
...
argument_list|(
literal|"dynamic settings can't be updated use #getConcreteSetting for updating"
argument_list|)
throw|;
block|}
annotation|@
...
name|IllegalArgumentException
argument_list|(
literal|"key must match setting but didn't ["
operator|+
name|key
operator|+
literal|"]"
