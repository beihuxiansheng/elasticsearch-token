...
expr_stmt|;
block|}
comment|/**      * Adds a settings consumer for affix settings. Affix settings have a namespace associated to it that needs to be available to the      * consumer in order to be processed correctly.      */
DECL|method|addAffixUpdateConsumer
specifier|public
specifier|synchronized
parameter_list|<
name|T
...
control|)
block|{
comment|// settings iterate in deterministic fashion
try|try
block|{
name|validate
argument_list|(
