...
return|;
block|}
comment|/**      * Archives broken or unknown settings. Any setting that is not recognized or fails      * validation will be archived. This means the setting is prefixed with {@value ARCHIVED_SETTINGS_PREFIX}      * and remains in the settings object. This can be used to detect broken settings via APIs.      */
DECL|method|archiveUnknownOrBrokenSettings
specifier|public
name|Settings
...
name|warn
argument_list|(
literal|"found unknown setting: {} value: {} - archiving"
argument_list|,
name|entry
operator|.
name|getKey
