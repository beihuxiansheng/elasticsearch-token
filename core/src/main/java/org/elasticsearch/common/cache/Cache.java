...
parameter_list|)
block|{
comment|// if the future ended exceptionally, we do not want to pollute the cache
comment|// however, we have to take care to ensure that the polluted entry has not already been replaced
try|try
init|(
name|ReleasableLock
name|ignored
