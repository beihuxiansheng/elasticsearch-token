...
return|;
block|}
comment|/**          * put an entry into the segment          *          * @param key the key of the entry to add to the cache          * @param value the value of the entry to add to the cache          * @param now the access time of this entry          * @param onlyIfAbsent whether or not an existing entry should be replaced          * @return a tuple of the new entry and the existing entry, if there was one otherwise null          */
DECL|method|put
name|Tuple
argument_list|<
name|Entry
