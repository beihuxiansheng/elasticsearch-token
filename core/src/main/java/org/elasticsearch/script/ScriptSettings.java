...
control|)
block|{
comment|// This will be easier once ScriptMode is transitioned to booleans
if|if
condition|(
name|scriptType
operator|.
...
name|defaultNonFileScriptMode
decl_stmt|;
comment|// Like "script.engine.groovy.inline"
specifier|final
name|Setting
argument_list|<
name|ScriptMode
argument_list|>
name|langGlobalSetting
init|=
operator|new
name|Setting
argument_list|<>
...
return|;
block|}
comment|// the next fallback is settings configured for this engine and script type
if|if
condition|(
name|langGlobalSetting
operator|.
