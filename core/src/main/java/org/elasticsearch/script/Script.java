...
expr_stmt|;
block|}
comment|/**      * Convenience method to call {@link Script#parse(XContentParser, ParseFieldMatcher, String)}      * using the default scripting language.      */
DECL|method|parse
specifier|public
specifier|static
name|Script
...
return|;
block|}
comment|/**      * Convenience method to call {@link Script#parse(XContentParser, ParseFieldMatcher, String)} using the      * {@link ParseFieldMatcher} and scripting language provided by the {@link QueryParseContext}.      */
DECL|method|parse
specifier|public
specifier|static
name|Script
