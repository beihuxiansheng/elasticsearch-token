...
return|;
block|}
comment|// Check if any of the indices to be closed are currently being restored from a snapshot and fail closing if such an index
comment|// is found as closing an index that is being restored makes the index unusable (it cannot be recovered).
name|RestoreInProgress
name|restore
init|=
name|currentState
