...
block|{
comment|// we didn't find the index in the clusterstate - maybe it was deleted
comment|// NOTE: this doesn't fail the entire batch only the current PutMapping request we are processing
throw|throw
operator|new
name|IndexNotFoundException
argument_list|(
...
condition|)
block|{
comment|// TODO this seems impossible given we use indexServiceSafe above
continue|continue;
block|}
name|CompressedXContent
name|existingSource
