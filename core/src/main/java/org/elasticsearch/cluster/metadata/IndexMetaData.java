...
name|ToXContent
block|{
comment|/**      * This class will be removed in v7.0      */
annotation|@
name|Deprecated
...
argument_list|)
decl_stmt|;
DECL|field|INDEX_READ_ONLY_ALLOW_DELETE_BLOCK
specifier|public
specifier|static
specifier|final
name|ClusterBlock
...
literal|12
argument_list|,
literal|"index read-only / allow delete (api)"
argument_list|,
literal|false
argument_list|,
literal|false
...
name|IllegalArgumentException
argument_list|(
literal|"es.index.max_number_of_shards must be> 0"
argument_list|)
throw|;
block|}
return|return
...
specifier|final
name|String
name|SETTING_ROUTING_PARTITION_SIZE
init|=
literal|"index.routing_partition_size"
decl_stmt|;
DECL|field|INDEX_ROUTING_PARTITION_SIZE_SETTING
specifier|public
specifier|static
specifier|final
name|Setting
...
argument_list|)
decl_stmt|;
DECL|field|SETTING_READ_ONLY_ALLOW_DELETE
specifier|public
specifier|static
specifier|final
name|String
...
init|=
literal|"index.blocks.read_only_allow_delete"
decl_stmt|;
DECL|field|INDEX_BLOCKS_READ_ONLY_ALLOW_DELETE_SETTING
specifier|public
specifier|static
specifier|final
name|Setting
...
literal|"_na_"
decl_stmt|;
DECL|field|INDEX_ROUTING_REQUIRE_GROUP_PREFIX
specifier|public
specifier|static
specifier|final
name|String
...
decl_stmt|;
DECL|field|INDEX_ROUTING_INCLUDE_GROUP_PREFIX
specifier|public
specifier|static
specifier|final
name|String
...
decl_stmt|;
DECL|field|INDEX_ROUTING_EXCLUDE_GROUP_PREFIX
specifier|public
specifier|static
specifier|final
name|String
...
argument_list|)
decl_stmt|;
DECL|field|INDEX_ROUTING_INITIAL_RECOVERY_GROUP_SETTING
specifier|public
specifier|static
specifier|final
name|Setting
...
name|groupSetting
argument_list|(
literal|"index.routing.allocation.initial_recovery."
argument_list|)
decl_stmt|;
comment|// this is only setable internally not a registered setting!!
comment|/**      * The number of active shard copies to check for before proceeding with a write operation.      */
DECL|field|SETTING_WAIT_FOR_ACTIVE_SHARDS
specifier|public
specifier|static
specifier|final
name|Setting
...
argument_list|)
decl_stmt|;
DECL|field|KEY_IN_SYNC_ALLOCATIONS
specifier|public
specifier|static
specifier|final
name|String
...
literal|"version"
decl_stmt|;
DECL|field|KEY_ROUTING_NUM_SHARDS
specifier|static
specifier|final
name|String
name|KEY_ROUTING_NUM_SHARDS
init|=
literal|"routing_num_shards"
decl_stmt|;
...
literal|"state-"
decl_stmt|;
DECL|field|routingNumShards
specifier|private
specifier|final
name|int
name|routingNumShards
decl_stmt|;
DECL|field|routingFactor
specifier|private
specifier|final
name|int
name|routingFactor
decl_stmt|;
DECL|field|routingPartitionSize
specifier|private
specifier|final
name|int
name|routingPartitionSize
decl_stmt|;
...
name|customs
decl_stmt|;
DECL|field|inSyncAllocationIds
specifier|private
specifier|final
name|ImmutableOpenIntMap
argument_list|<
...
name|excludeFilters
decl_stmt|;
DECL|field|initialRecoveryFilters
specifier|private
specifier|final
name|DiscoveryNodeFilters
...
return|;
block|}
DECL|method|getRoutingPartitionSize
specifier|public
name|int
name|getRoutingPartitionSize
parameter_list|()
block|{
return|return
name|routingPartitionSize
return|;
block|}
DECL|method|isRoutingPartitionedIndex
specifier|public
name|boolean
...
return|;
block|}
comment|/**      * Returns the configured {@link #SETTING_WAIT_FOR_ACTIVE_SHARDS}, which defaults      * to an active shard count of 1 if not specified.      */
...
return|;
block|}
DECL|field|INDEX_SHRINK_SOURCE_UUID_KEY
specifier|public
specifier|static
specifier|final
name|String
name|INDEX_SHRINK_SOURCE_UUID_KEY
init|=
literal|"index.shrink.source.uuid"
decl_stmt|;
DECL|field|INDEX_SHRINK_SOURCE_NAME_KEY
specifier|public
specifier|static
specifier|final
name|String
name|INDEX_SHRINK_SOURCE_NAME_KEY
init|=
literal|"index.shrink.source.name"
decl_stmt|;
DECL|field|INDEX_SHRINK_SOURCE_UUID
specifier|public
specifier|static
specifier|final
name|Setting
...
argument_list|)
decl_stmt|;
DECL|field|INDEX_SHRINK_SOURCE_NAME
specifier|public
specifier|static
specifier|final
name|Setting
...
argument_list|)
decl_stmt|;
DECL|method|getMergeSourceIndex
specifier|public
name|Index
...
return|;
block|}
DECL|method|inSyncAllocationIds
specifier|public
name|Set
argument_list|<
name|String
...
annotation|@
name|Nullable
DECL|method|getInitialRecoveryFilters
specifier|public
name|DiscoveryNodeFilters
...
return|;
block|}
comment|/**          * Sets the number of shards that should be used for routing. This should only be used if the number of shards in          * an index has changed ie if the index is shrunk.          */
DECL|method|setRoutingNumShards
specifier|public
name|Builder
name|setRoutingNumShards
parameter_list|(
...
return|;
block|}
comment|/**          * Returns number of shards that should be used for routing. By default this method will return the number of shards          * for this index.          *          * @see #setRoutingNumShards(int)          * @see #numberOfShards()          */
DECL|method|getRoutingNumShards
specifier|public
name|int
...
return|;
block|}
comment|/**          * Returns the number of shards.          *          * @return the provided value or -1 if it has not been set.          */
DECL|method|numberOfShards
specifier|public
name|int
name|numberOfShards
...
return|;
block|}
comment|/**          * Returns the number of replicas.          *          * @return the provided value or -1 if it has not been set.          */
DECL|method|numberOfReplicas
specifier|public
name|int
name|numberOfReplicas
...
return|;
block|}
DECL|method|routingPartitionSize
specifier|public
name|Builder
name|routingPartitionSize
parameter_list|(
...
return|;
block|}
comment|/**          * Returns the routing partition size.          *          * @return the provided value or -1 if it has not been set.          */
DECL|method|routingPartitionSize
specifier|public
name|int
name|routingPartitionSize
...
return|;
block|}
DECL|method|putInSyncAllocationIds
specifier|public
name|Builder
name|putInSyncAllocationIds
parameter_list|(
...
name|IllegalArgumentException
argument_list|(
literal|"routing partition size ["
operator|+
name|routingPartitionSize
operator|+
literal|"] should be a positive number"
operator|+
literal|" less than the number of shards ["
operator|+
name|getRoutingNumShards
argument_list|()
operator|+
...
throw|;
block|}
comment|// fill missing slots in inSyncAllocationIds with empty set if needed and make all entries immutable
name|ImmutableOpenIntMap
operator|.
name|Builder
argument_list|<
...
argument_list|>
argument_list|>
name|filledInSyncAllocationIds
init|=
name|ImmutableOpenIntMap
operator|.
name|builder
...
operator|+
literal|"number of shard copies ["
operator|+
operator|(
name|numberOfReplicas
operator|+
...
return|;
block|}
comment|/**      * Returns the routing factor for this index. The default is<tt>1</tt>.      *      * @see #getRoutingFactor(IndexMetaData, int) for details      */
DECL|method|getRoutingFactor
specifier|public
name|int
...
parameter_list|,
name|IndexMetaData
name|sourceIndexMetadata
parameter_list|,
name|int
name|numTargetShards
parameter_list|)
block|{
if|if
condition|(
...
name|IllegalArgumentException
argument_list|(
literal|"the number of target shards ("
operator|+
name|numTargetShards
operator|+
literal|") must be greater than the shard id: "
operator|+
name|shardId
argument_list|)
throw|;
...
parameter_list|,
name|int
name|targetNumberOfShards
parameter_list|)
block|{
name|int
name|sourceNumberOfShards
init|=
name|sourceIndexMetadata
operator|.
name|getNumberOfShards
...
name|IllegalArgumentException
argument_list|(
literal|"the number of source shards ["
operator|+
name|sourceNumberOfShards
operator|+
literal|"] must be a must be a multiple of ["
operator|+
name|targetNumberOfShards
operator|+
literal|"]"
