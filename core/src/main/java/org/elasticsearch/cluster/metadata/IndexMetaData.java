...
return|;
block|}
comment|/**      * The term of the current selected primary. This is a non-negative number incremented when      * a primary shard is assigned after a full cluster restart (see {@link ShardRouting#initialize(java.lang.String, long)}      * or a replica shard is promoted to a primary (see {@link ShardRouting#moveToPrimary()}).      **/
...
expr_stmt|;
block|}
comment|// TODO move it somewhere where it will be useful for other code?
DECL|method|fieldEquals
specifier|private
specifier|static
name|boolean
name|fieldEquals
