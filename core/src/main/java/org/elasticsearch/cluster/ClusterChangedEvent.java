...
return|;
block|}
comment|/**      * Returns a set of custom meta data types when any custom metadata for the cluster has changed      * between the previous cluster state and the new cluster state. custom meta data types are      * returned iff they have been added, updated or removed between the previous and the current state      */
DECL|method|changedCustomMetaDataSet
specifier|public
name|Set
argument_list|<
name|String
...
name|Custom
argument_list|>
name|currentCustomMetaData
range|:
name|currentCustoms
control|)
block|{
comment|// new custom md added or existing custom md changed
if|if
condition|(
name|previousCustoms
operator|.
...
block|}
block|}
comment|// existing custom md deleted
for|for
control|(
name|ObjectObjectCursor
argument_list|<
