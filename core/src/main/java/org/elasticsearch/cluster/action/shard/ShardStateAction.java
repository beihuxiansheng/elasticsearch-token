...
expr_stmt|;
block|}
DECL|method|extractShardsToBeApplied
specifier|static
name|List
argument_list|<
name|ShardRoutingEntry
...
name|debug
argument_list|(
literal|"{} ignoring shard {}, unknown index in {}"
argument_list|,
name|shardRouting
operator|.
name|shardId
...
name|debug
argument_list|(
literal|"{} ignoring shard {}, different index uuid, current {}, got {}"
argument_list|,
name|shardRouting
operator|.
name|shardId
...
continue|continue;
block|}
comment|// more debug info will be logged by the allocation service
name|logger
operator|.
name|trace
argument_list|(
literal|"{} will apply shard {} {}"
argument_list|,
name|shardRouting
operator|.
name|shardId
