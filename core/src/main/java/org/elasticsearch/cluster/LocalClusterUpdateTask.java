...
return|;
block|}
comment|/**      * node stepped down as master or has lost connection to the master      */
DECL|method|noMaster
specifier|public
specifier|static
name|ClusterTasksResult
argument_list|<
...
return|;
block|}
comment|/**      * locally apply cluster state received from a master      */
