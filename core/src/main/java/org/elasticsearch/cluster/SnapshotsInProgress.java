...
literal|"snapshots"
decl_stmt|;
comment|// denotes an undefined repository state id, which will happen when receiving a cluster state with
comment|// a snapshot in progress from a pre 5.2.x node
DECL|field|UNDEFINED_REPOSITORY_STATE_ID
specifier|public
specifier|static
specifier|final
name|long
...
literal|2L
decl_stmt|;
comment|// the version where repository state ids were introduced
DECL|field|REPOSITORY_ID_INTRODUCED_VERSION
specifier|private
specifier|static
specifier|final
name|Version
name|REPOSITORY_ID_INTRODUCED_VERSION
init|=
name|Version
operator|.
name|V_5_2_0
...
block|{
return|return
literal|"ShardSnapshotStatus[state="
operator|+
name|state
operator|+
literal|", nodeId="
...
literal|"start_time"
decl_stmt|;
DECL|field|REPOSITORY_STATE_ID
specifier|private
specifier|static
specifier|final
name|String
name|REPOSITORY_STATE_ID
init|=
