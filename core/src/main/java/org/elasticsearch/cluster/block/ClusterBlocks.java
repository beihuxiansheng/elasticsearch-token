...
return|;
block|}
DECL|method|generateLevelHolders
specifier|private
specifier|static
name|ImmutableLevelHolder
index|[]
...
parameter_list|)
block|{
comment|// let's remove all blocks for this index and add them back -- no need to remove all individual blocks....
name|indices
operator|.
name|remove
argument_list|(
