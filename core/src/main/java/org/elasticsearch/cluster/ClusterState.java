...
condition|)
block|{
comment|// before the stated version, there were no SnapshotDeletionsInProgress, so
comment|// don't transfer over the wire protocol
name|omitSnapshotDeletions
operator|=
literal|true
expr_stmt|;
...
name|customsDiff
operator|=
name|removeSnapshotDeletionsCustomDiff
argument_list|(
name|customsDiff
argument_list|)
expr_stmt|;
...
expr_stmt|;
block|}
DECL|method|removeSnapshotDeletionsCustomDiff
specifier|private
name|Diff
argument_list|<
name|ImmutableOpenMap
