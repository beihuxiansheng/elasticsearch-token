...
begin_comment
comment|/**  * Allocates an unassigned stale primary shard to a specific node. Use with extreme care as this will result in data loss.  * Allocation deciders are ignored.  */
end_comment

begin_class
DECL|class|AllocateStalePrimaryAllocationCommand
specifier|public
class|class
...
name|NAME
init|=
literal|"allocate_stale_primary"
decl_stmt|;
DECL|field|STALE_PRIMARY_PARSER
specifier|private
specifier|static
specifier|final
name|ObjectParser
