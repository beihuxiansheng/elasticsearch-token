...
parameter_list|)
function_decl|;
comment|/**      * Called when an initializing replica is reinitialized. This happens when a primary relocation completes, which      * reinitializes all currently initializing replicas as their recovery source node changes      */
DECL|method|initializedReplicaReinitialized
name|void
name|initializedReplicaReinitialized
parameter_list|(
name|ShardRouting
name|oldReplica
parameter_list|,
name|ShardRouting
name|reinitializedReplica
parameter_list|)
function_decl|;
