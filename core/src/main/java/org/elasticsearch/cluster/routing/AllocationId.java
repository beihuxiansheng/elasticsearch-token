...
return|;
block|}
comment|/**      * Creates a new allocation id representing a cancelled relocation.      */
...
return|;
block|}
comment|/**      * Creates a new allocation id finalizing a relocation, moving the transient      * relocation id to be the actual id.      */
