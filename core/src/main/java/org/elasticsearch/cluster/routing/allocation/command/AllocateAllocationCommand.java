...
name|NO
argument_list|,
literal|"allocate_allocation_command"
argument_list|,
...
literal|"allocate_allocation_command"
argument_list|,
literal|"trying to allocate a primary shard "
operator|+
name|shardId
operator|+
...
continue|continue;
block|}
comment|// if we force allocation of a primary, we need to move the unassigned info back to treat it as if
comment|// it was index creation
if|if
condition|(
name|unassigned
operator|.
...
name|INDEX_CREATED
argument_list|,
literal|"force allocation from previous reason "
operator|+
name|unassigned
operator|.
name|unassignedInfo
