...
expr_stmt|;
block|}
comment|/**      * @param reason               the cause for making this shard unassigned. See {@link Reason} for more information.      * @param message              more information about cause.      * @param failure              the shard level failure that caused this shard to be unassigned, if exists.      * @param unassignedTimeNanos  the time to use as the base for any delayed re-assignment calculation      * @param unassignedTimeMillis the time of unassignment used to display to in our reporting.      * @param delayed              if allocation of this shard is delayed due to INDEX_DELAYED_NODE_LEFT_TIMEOUT_SETTING.      */
DECL|method|UnassignedInfo
specifier|public
name|UnassignedInfo
parameter_list|(
...
return|;
block|}
comment|/**      * Returns the appropriate {@link ClusterHealthStatus} for an unassigned primary shard      * based on its unassigned information and allocation id history.      */
DECL|method|unassignedPrimaryShardHealth
specifier|public
specifier|static
name|ClusterHealthStatus
