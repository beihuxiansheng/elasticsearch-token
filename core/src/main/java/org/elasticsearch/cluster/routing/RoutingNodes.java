...
return|;
block|}
comment|/**          * Marks a shard as temporarily ignored and adds it to the ignore unassigned list.          * Should be used with caution, typically,          * the correct usage is to removeAndIgnore from the iterator.          * @see #ignored()          * @see UnassignedIterator#removeAndIgnore(AllocationStatus)          * @see #isIgnoredEmpty()          * @return true iff the decision caused a change to the unassigned info          */
...
return|;
block|}
comment|/**              * Unsupported operation, just there for the interface. Use {@link #removeAndIgnore(AllocationStatus)} or              * {@link #initialize(String, String, long)}.              */
annotation|@
name|Override
DECL|method|remove
specifier|public
...
return|;
block|}
comment|/**          * Returns<code>true</code> iff any unassigned shards are marked as temporarily ignored.          * @see UnassignedShards#ignoreShard(ShardRouting, AllocationStatus)          * @see UnassignedIterator#removeAndIgnore(AllocationStatus)          */
