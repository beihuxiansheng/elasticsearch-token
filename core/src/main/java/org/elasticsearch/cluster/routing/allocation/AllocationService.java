...
parameter_list|)
block|{
comment|// make sure index meta data and routing tables are in sync w.r.t active allocation ids
name|MetaData
operator|.
name|Builder
...
argument_list|)
operator|:
literal|"primary term should only increase. Index primary term ["
operator|+
name|indexMetaData
operator|.
name|primaryTerm
...
argument_list|)
operator|+
literal|"] but primary routing is "
operator|+
name|primary
assert|;
if|if
