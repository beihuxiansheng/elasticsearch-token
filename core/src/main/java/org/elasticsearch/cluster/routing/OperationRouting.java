...
operator|)
operator|:
literal|"A routing value is required for gets from a partitioned index"
assert|;
name|effectiveRouting
operator|=
name|id
...
block|{
comment|// we would have still got 0 above but this check just saves us an unnecessary hash calculation
name|partitionOffset
operator|=
literal|0
expr_stmt|;
...
return|;
block|}
DECL|method|calculateScaledShardId
specifier|private
specifier|static
name|int
name|calculateScaledShardId
