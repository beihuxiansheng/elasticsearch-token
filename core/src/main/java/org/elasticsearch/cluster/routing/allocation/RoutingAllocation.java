...
argument_list|()
decl_stmt|;
DECL|field|restoreInProgressUpdater
specifier|private
specifier|final
name|RestoreInProgressUpdater
name|restoreInProgressUpdater
...
return|;
block|}
comment|/**      * Returns updated {@link RestoreInProgress} based on the changes that were made to the routing nodes      */
DECL|method|updateRestoreInfoWithRoutingChanges
specifier|public
name|RestoreInProgress
name|updateRestoreInfoWithRoutingChanges
parameter_list|(
name|RestoreInProgress
name|restoreInProgress
parameter_list|)
