...
literal|false
operator|:
literal|"expected initializing replica shard "
operator|+
name|oldReplica
assert|;
assert|assert
...
literal|false
operator|:
literal|"expected reinitialized replica shard "
operator|+
name|reinitializedReplica
assert|;
assert|assert
...
literal|false
operator|:
literal|"expected allocation id to change for reinitialized replica shard (old: "
operator|+
name|oldReplica
operator|+
literal|" new: "
