...
name|IllegalStateException
argument_list|(
literal|"a primary shard routing "
operator|+
name|shardRouting
operator|+
literal|" is a primary that is recovering from "
operator|+
literal|"a known allocation id but has no corresponding entry in the in-sync "
operator|+
literal|"allocation set "
operator|+
name|inSyncAllocationIds
