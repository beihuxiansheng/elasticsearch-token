...
begin_class
DECL|class|BootstrapChecks
specifier|final
class|class
name|BootstrapChecks
block|{
DECL|method|BootstrapChecks
specifier|private
name|BootstrapChecks
parameter_list|()
block|{     }
...
block|}
block|}
comment|/**      * Bootstrap check for early-access builds from OpenJDK.      */
DECL|class|EarlyAccessCheck
specifier|static
class|class
name|EarlyAccessCheck
implements|implements
...
name|ROOT
argument_list|,
literal|"Java version [%s] is an early-access build, only use release builds"
argument_list|,
name|javaVersion
argument_list|()
argument_list|)
