...
argument_list|()
expr_stmt|;
comment|// set properties for problematic plugins
name|setPluginCodebaseProperties
argument_list|(
name|environment
argument_list|)
expr_stmt|;
...
name|compile
argument_list|(
literal|".*lucene-test-framework-.*\\.jar$"
argument_list|)
argument_list|,
literal|"es.security.jar.lucene.testframework"
argument_list|)
expr_stmt|;
name|m
operator|.
...
name|compile
argument_list|(
literal|".*randomizedtesting-runner-.*\\.jar$"
argument_list|)
argument_list|,
literal|"es.security.jar.randomizedtesting.runner"
argument_list|)
expr_stmt|;
name|m
operator|.
...
name|compile
argument_list|(
literal|".*junit4-ant-.*\\.jar$"
argument_list|)
argument_list|,
literal|"es.security.jar.randomizedtesting.junit4"
argument_list|)
expr_stmt|;
name|m
operator|.
...
argument_list|,
literal|"org.elasticsearch.script.expression.ExpressionPlugin"
argument_list|)
expr_stmt|;
name|m
operator|.
...
literal|"lang-groovy"
argument_list|,
literal|"org.elasticsearch.script.groovy.GroovyPlugin"
argument_list|)
expr_stmt|;
name|m
operator|.
...
argument_list|,
literal|"org.elasticsearch.plugin.javascript.JavaScriptPlugin"
argument_list|)
expr_stmt|;
name|m
operator|.
...
literal|"lang-python"
argument_list|,
literal|"org.elasticsearch.plugin.python.PythonPlugin"
argument_list|)
expr_stmt|;
name|SPECIAL_PLUGINS
operator|=
...
literal|"proper use of URL"
argument_list|)
DECL|method|setPluginCodebaseProperties
specifier|static
name|void
name|setPluginCodebaseProperties
parameter_list|(
