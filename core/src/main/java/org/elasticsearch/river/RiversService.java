...
name|trace
argument_list|(
literal|"river {} has no routing node"
argument_list|,
name|routing
operator|.
name|riverName
...
name|trace
argument_list|(
literal|"river {} is already allocated"
argument_list|,
name|routing
operator|.
name|riverName
...
block|{
comment|//this should never happen as we've just found the _meta document in RiversRouter
name|logger
operator|.
name|warn
argument_list|(
literal|"{}/{}/_meta document not found"
argument_list|,
name|riverIndexName
argument_list|,
name|routing
...
block|}
block|}
DECL|method|prepareGetMetaDocument
specifier|private
name|GetRequestBuilder
name|prepareGetMetaDocument
parameter_list|(
