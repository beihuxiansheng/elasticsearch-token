...
name|indexSnapshots
decl_stmt|;
comment|/**      * Whether the repository data is in the legacy (pre 5.0) format      */
...
return|;
block|}
comment|/**      * Returns whether the repository data format is in the legacy (pre 5.0) format or not      */
DECL|method|isLegacyFormat
specifier|public
name|boolean
name|isLegacyFormat
parameter_list|()
