...
literal|"meta-"
decl_stmt|;
DECL|field|LEGACY_METADATA_PREFIX
specifier|private
specifier|static
specifier|final
name|String
name|LEGACY_METADATA_PREFIX
init|=
literal|"metadata-"
decl_stmt|;
DECL|field|METADATA_SUFFIX
specifier|private
specifier|static
specifier|final
name|String
...
block|{
comment|// We don't know which version was the snapshot created with - try deleting both current and legacy metadata
name|snapshotsBlobContainer
operator|.
name|deleteBlob
argument_list|(
...
return|;
block|}
comment|/**      * Returns name of metadata blob      *      * @param snapshotId snapshot id      * @param legacy true if legacy (pre-2.0.0) format should be used      * @return name of metadata blob      */
