...
expr_stmt|;
block|}
comment|/**      * Creates a new {@link ElasticsearchCorruptionException} with the given exceptions stacktrace.      * This constructor copies the stacktrace as well as the message from the given      * {@code Throwable} into this exception.      *      * @param ex the exception cause      */
DECL|method|ElasticsearchCorruptionException
specifier|public
name|ElasticsearchCorruptionException
parameter_list|(
