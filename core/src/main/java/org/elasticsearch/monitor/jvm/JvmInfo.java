...
parameter_list|)
block|{
comment|// unable to deduce the state of compressed oops
comment|// usingCompressedOops will hold its default value of null
block|}
name|INSTANCE
operator|=
name|info
...
name|EMPTY_ARRAY
decl_stmt|;
DECL|field|usingCompressedOops
specifier|private
name|Boolean
name|usingCompressedOops
decl_stmt|;
...
return|;
block|}
DECL|method|usingCompressedOops
specifier|public
name|Boolean
name|usingCompressedOops
parameter_list|()
