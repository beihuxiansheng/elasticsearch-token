...
name|fileStore
operator|+
literal|", majorDeviceNumber="
operator|+
name|majorDeviceNumber
operator|+
literal|", minorDeviceNumber="
operator|+
name|minorDeviceNumber
operator|+
literal|'}'
...
block|}
block|}
comment|/**      * Resolve a specific nodes/{node.id} path for the specified path and node lock id.      *      * @param path       the path      * @param nodeLockId the node lock id      * @return the resolved path      */
DECL|method|resolveNodePath
specifier|public
specifier|static
name|Path
name|resolveNodePath
...
name|info
argument_list|(
literal|"using [{}] data paths, mounts [{}], net usable_space [{}], net total_space [{}], types [{}]"
argument_list|,
name|nodePaths
operator|.
name|length
...
name|addAll
argument_list|(
name|availableIndexFoldersForPath
argument_list|(
name|nodePath
argument_list|)
argument_list|)
...
return|;
block|}
comment|/**      * Return all directory names in the nodes/{node.id}/indices directory for the given node path.      *      * @param nodePath the path      * @return all directories that could be indices for the given node path.      * @throws IOException if an I/O exception occurs traversing the filesystem      */
DECL|method|availableIndexFoldersForPath
specifier|public
name|Set
argument_list|<
name|String
