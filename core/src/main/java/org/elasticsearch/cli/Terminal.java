...
block|}
block|}
comment|/**      * Prompt for a yes or no answer from the user. This method will loop until 'y' or 'n'      * (or the default empty value) is entered.      */
DECL|method|promptYesNo
specifier|public
specifier|final
name|boolean
name|promptYesNo
...
name|println
argument_list|(
literal|"Did not understand answer '"
operator|+
name|answer
operator|+
literal|"'"
