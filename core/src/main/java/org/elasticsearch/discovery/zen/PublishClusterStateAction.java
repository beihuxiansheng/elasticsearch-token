...
decl_stmt|;
DECL|interface|IncomingClusterStateListener
specifier|public
interface|interface
name|IncomingClusterStateListener
block|{
comment|/**          * called when a new incoming cluster state has been received.          * Should validate the incoming state and throw an exception if it's not a valid successor state.          */
DECL|method|onIncomingClusterState
name|void
name|onIncomingClusterState
parameter_list|(
name|ClusterState
name|incomingState
parameter_list|)
function_decl|;
comment|/**          * called when a cluster state has been committed and is ready to be processed          */
DECL|method|onClusterStateCommitted
name|void
name|onClusterStateCommitted
parameter_list|(
name|String
name|stateUUID
parameter_list|,
...
name|namedWriteableRegistry
decl_stmt|;
DECL|field|incomingClusterStateListener
specifier|private
specifier|final
name|IncomingClusterStateListener
name|incomingClusterStateListener
