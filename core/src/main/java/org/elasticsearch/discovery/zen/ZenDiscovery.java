...
name|PingContextProvider
block|{
DECL|field|REJOIN_ON_MASTER_GONE_SETTING
specifier|public
specifier|final
specifier|static
name|Setting
...
decl_stmt|;
DECL|field|SETTING_MASTER_ELECTION_WAIT_FOR_JOINS_TIMEOUT
specifier|public
specifier|final
specifier|static
name|String
name|SETTING_MASTER_ELECTION_WAIT_FOR_JOINS_TIMEOUT
init|=
...
name|debug
argument_list|(
literal|"using ping_timeout [{}], join.timeout [{}], master_election.filter_client [{}], master_election.filter_data [{}]"
argument_list|,
name|this
operator|.
name|pingTimeout
...
return|;
block|}
DECL|method|setRejoingOnMasterGone
specifier|private
name|void
name|setRejoingOnMasterGone
parameter_list|(
