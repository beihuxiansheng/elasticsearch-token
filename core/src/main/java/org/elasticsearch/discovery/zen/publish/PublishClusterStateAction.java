...
operator|+
literal|"received version [%d] with uuid [%s], last seen version [%d] with uuid [%s]"
argument_list|,
name|incomingState
operator|.
name|version
...
name|ROOT
argument_list|,
literal|"received cluster state older than current cluster state; "
operator|+
literal|"received version [%d] with uuid [%s], current version [%d]"
argument_list|,
name|incomingState
operator|.
name|version
