...
name|stream
argument_list|()
comment|// filter to shards that track seq# and should be taken into consideration for checkpoint tracking
comment|// shards on old nodes will go through a file based recovery which will also transfer seq# information.
operator|.
name|filter
argument_list|(
name|sr
