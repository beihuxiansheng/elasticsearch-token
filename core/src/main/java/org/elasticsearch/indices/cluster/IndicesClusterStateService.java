...
argument_list|)
decl_stmt|;
comment|/*                  * Filter to shards that track sequence numbers and should be taken into consideration for checkpoint tracking. Shards on                  * old nodes will go through a file-based recovery which will also transfer sequence number information.                  */
specifier|final
name|Set
argument_list|<
name|String
...
name|activeIds
init|=
name|allocationIdsForShardsOnNodesThatUnderstandSeqNos
argument_list|(
name|indexShardRoutingTable
operator|.
name|activeShards
...
block|}
block|}
DECL|method|allocationIdsForShardsOnNodesThatUnderstandSeqNos
specifier|private
name|Set
argument_list|<
name|String
...
name|IOException
function_decl|;
comment|/**          * Update the primary term. This method should only be invoked on primary shards.          *          * @param primaryTerm the new primary term          */
