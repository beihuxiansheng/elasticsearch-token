...
literal|true
argument_list|,
literal|"failed updating shard of the new meta data"
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
argument_list|()
operator|:
literal|"only allow initializing shard routing to be recovered: "
operator|+
name|shardRouting
assert|;
if|if
...
literal|null
operator|:
literal|"peer recovery started but sourceNode is null for "
operator|+
name|shardRouting
assert|;
name|RecoveryState
...
block|{
comment|// recover from a snapshot
return|return
operator|new
name|RecoveryState
argument_list|(
...
name|IOException
function_decl|;
comment|/**          * update the shard about the current active allocation ids. only called on a primary shard          *          * @param activeIds       set of active allocation ids          * @param initializingIds set of initializing allocations ids          */
