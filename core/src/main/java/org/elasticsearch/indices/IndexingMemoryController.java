...
argument_list|(
literal|"unknown value for [indices.memory.index_buffer_size]: must be X% or a size value (e.g. XMB) but was: "
operator|+
name|s
argument_list|)
throw|;
...
name|IllegalArgumentException
argument_list|(
literal|"unknown value for [indices.memory.index_buffer_size]: must be X% or a size value (e.g. XMB) but "
operator|+
name|t
operator|.
name|getMessage
