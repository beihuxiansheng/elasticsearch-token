...
block|}
block|}
comment|/**          * goes through all existing shards and check whether there are changes in their active status          */
...
parameter_list|)
block|{
comment|// Count how many shards are now active:
name|int
