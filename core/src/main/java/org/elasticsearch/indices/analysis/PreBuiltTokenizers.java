...
name|MultiTermAwareComponent
block|{}
comment|/**      * Old style resolution for {@link TokenizerFactory}. Exists entirely to keep      * {@link CustomNormalizerProvider#build(java.util.Map, java.util.Map)} working during the migration.      */
