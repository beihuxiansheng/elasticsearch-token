...
init|=
name|setupPreConfiguredCharFilters
argument_list|(
name|plugins
argument_list|)
decl_stmt|;
...
return|;
block|}
DECL|method|setupPreConfiguredCharFilters
specifier|static
name|Map
argument_list|<
name|String
...
argument_list|<>
argument_list|(
literal|"pre-configured char_filter"
argument_list|)
decl_stmt|;
comment|// No char filter are available in lucene-core so none are built in to Elasticsearch core
for|for
control|(
name|AnalysisPlugin
name|plugin
...
return|;
block|}
DECL|method|setupPreConfiguredTokenFilters
specifier|static
name|Map
argument_list|<
name|String
...
argument_list|<>
argument_list|(
literal|"pre-configured token_filter"
argument_list|)
decl_stmt|;
comment|// Add filters available in lucene-core
name|preConfiguredTokenFilters
operator|.
name|register
argument_list|(
...
argument_list|)
expr_stmt|;
comment|/* Note that "stop" is available in lucene-core but it's pre-built          * version uses a set of English stop words that are in          * lucene-analyzers-common so "stop" is defined in the analysis-common          * module. */
for|for
control|(
name|AnalysisPlugin
name|plugin
...
return|;
block|}
DECL|method|setupPreConfiguredTokenizers
specifier|static
name|Map
argument_list|<
name|String
...
argument_list|<>
argument_list|(
literal|"pre-configured tokenizer"
argument_list|)
decl_stmt|;
comment|// Temporary shim to register old style pre-configured tokenizers
for|for
control|(
...
argument_list|(
literal|"Caching strategy unsupported by temporary shim ["
operator|+
name|tokenizer
operator|+
literal|"]"
...
expr_stmt|;
block|}
comment|// Temporary shim for aliases. TODO deprecate after they are moved
name|preConfiguredTokenizers
operator|.
name|register
argument_list|(
...
argument_list|)
decl_stmt|;
comment|// TODO: provide built-in normalizer providers?
comment|// TODO: pluggability?
return|return
name|normalizers
return|;
block|}
