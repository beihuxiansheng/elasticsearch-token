...
begin_package
DECL|package|org.elasticsearch.indices.cache.request
package|package
name|org
operator|.
name|elasticsearch
...
DECL|field|INDEX_CACHE_REQUEST_ENABLED
specifier|public
specifier|static
specifier|final
name|String
...
annotation|@
name|Deprecated
DECL|field|DEPRECATED_INDEX_CACHE_REQUEST_ENABLED
specifier|public
specifier|static
specifier|final
name|String
...
decl_stmt|;
DECL|field|INDICES_CACHE_REQUEST_CLEAN_INTERVAL
specifier|public
specifier|static
specifier|final
name|String
...
init|=
literal|"indices.requests.cache.clean_interval"
decl_stmt|;
...
annotation|@
name|Deprecated
DECL|field|DEPRECATED_INDICES_CACHE_QUERY_SIZE
specifier|public
specifier|static
specifier|final
name|String
name|DEPRECATED_INDICES_CACHE_QUERY_SIZE
init|=
...
init|=
literal|"indices.requests.cache.concurrency_level"
decl_stmt|;
...
name|DEPRECATED_INDICES_CACHE_QUERY_SIZE
operator|+
literal|"] settings is now deprecated, use ["
operator|+
name|INDICES_CACHE_QUERY_SIZE
operator|+
literal|"] instead"
...
argument_list|)
decl_stmt|;
comment|// cacheBuilder.concurrencyLevel(concurrencyLevel);
if|if
condition|(
name|expire
operator|!=
