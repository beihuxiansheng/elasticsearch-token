...
name|debug
argument_list|(
literal|"delaying recovery of {} due to target allocation id mismatch (expected: [{}], but was: [{}])"
argument_list|,
name|request
operator|.
name|shardId
...
name|DelayRecoveryException
argument_list|(
literal|"source node has the state of the target shard to have allocation id ["
operator|+
name|targetShardRouting
operator|.
name|allocationId
