...
operator|)
operator|:
literal|"peer recovery requires source node, recovery type: "
operator|+
name|recoverySource
operator|.
name|getType
...
return|;
block|}
comment|/**      * Returns recovery source node (only non-null if peer recovery)      */
annotation|@
name|Nullable
