...
begin_comment
comment|/**  * Acts like forever growing T[], but internally uses a  * circular buffer to reuse instances of T.  *  * TODO: un-fork once we are on Lucene 6.4.0  */
end_comment

begin_class
DECL|class|XRollingBuffer
specifier|public
specifier|abstract
class|class
name|XRollingBuffer
