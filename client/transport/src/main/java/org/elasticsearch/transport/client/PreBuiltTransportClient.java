...
expr_stmt|;
block|}
comment|/**      * Netty wants to do some unwelcome things like use unsafe and replace a private field, or use a poorly considered buffer recycler. This      * method disables these things by default, but can be overridden by setting the corresponding system properties.      */
...
name|setSystemPropertyIfUnset
argument_list|(
literal|"io.netty.recycler.maxCapacityPerThread"
argument_list|,
name|Integer
operator|.
name|toString
...
argument_list|)
DECL|method|setSystemPropertyIfUnset
specifier|private
specifier|static
name|void
name|setSystemPropertyIfUnset
