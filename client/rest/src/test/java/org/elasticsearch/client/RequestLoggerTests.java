...
literal|4
case|:
comment|// Evil entity without a charset
name|entity
operator|=
operator|new
name|StringEntity
...
block|}
block|}
DECL|method|testResponseWarnings
specifier|public
name|void
name|testResponseWarnings
parameter_list|()
throws|throws
name|Exception
block|{
...
name|append
argument_list|(
literal|"/index/type/_api] returned "
argument_list|)
operator|.
name|append
argument_list|(
...
name|warning
init|=
literal|"this is warning number "
operator|+
name|i
decl_stmt|;
name|warnings
