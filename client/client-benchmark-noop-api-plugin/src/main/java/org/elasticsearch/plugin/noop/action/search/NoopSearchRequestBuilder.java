...
begin_class
DECL|class|NoopSearchRequestBuilder
specifier|public
class|class
...
argument_list|>
block|{
DECL|method|NoopSearchRequestBuilder
specifier|public
name|NoopSearchRequestBuilder
parameter_list|(
name|ElasticsearchClient
...
return|;
block|}
comment|/**      * The a string representation search type to execute, defaults to {@link org.elasticsearch.action.search.SearchType#DEFAULT}. Can be      * one of "dfs_query_then_fetch"/"dfsQueryThenFetch", "dfs_query_and_fetch"/"dfsQueryAndFetch",      * "query_then_fetch"/"queryThenFetch", and "query_and_fetch"/"queryAndFetch".      */
DECL|method|setSearchType
specifier|public
name|NoopSearchRequestBuilder
name|setSearchType
...
return|;
block|}
comment|/**      * Delegates to {@link org.elasticsearch.search.builder.SearchSourceBuilder#suggest(SuggestBuilder)}      */
DECL|method|suggest
specifier|public
name|NoopSearchRequestBuilder
name|suggest
