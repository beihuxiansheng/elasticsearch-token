...
return|return;
block|}
comment|// Yes, this approach is prone to coordinated omission *but* we have to consider that we want to benchmark a closed system
comment|// with backpressure here instead of an open system. So this is actually correct in this case.
name|long
name|start
init|=
name|System
