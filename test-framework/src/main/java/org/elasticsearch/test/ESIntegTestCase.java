...
argument_list|)
expr_stmt|;
name|setRandomIndexNormsLoading
argument_list|(
name|random
argument_list|,
name|builder
...
return|;
block|}
DECL|method|setRandomIndexNormsLoading
specifier|private
specifier|static
name|Settings
operator|.
...
control|)
block|{
comment|// see https://github.com/elasticsearch/elasticsearch/issues/8706
specifier|final
name|DeleteResponse
name|deleteResponse
init|=
...
expr_stmt|;
block|}
comment|/** Enables translog flushing for the specified index */
DECL|method|enableTranslogFlush
specifier|public
specifier|static
name|void
...
return|;
block|}
comment|/** Return the mock plugins the cluster should use. These may be randomly omitted based on the cluster seed. */
...
return|;
block|}
comment|/**      * Returns a random JODA Time Zone based on Java Time Zones      */
...
name|timeZone
decl_stmt|;
comment|// It sounds like some Java Time Zones are unknown by JODA. For example: Asia/Riyadh88
comment|// We need to fallback in that case to a known time zone
try|try
block|{
name|timeZone
operator|=
