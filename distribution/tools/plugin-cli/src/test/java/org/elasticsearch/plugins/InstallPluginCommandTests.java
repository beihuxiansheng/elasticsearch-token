...
name|ESTestCase
block|{
DECL|field|SKIP_JARHELL_COMMAND
specifier|private
specifier|static
name|InstallPluginCommand
name|SKIP_JARHELL_COMMAND
init|=
operator|new
name|InstallPluginCommand
argument_list|()
...
block|}
block|}
DECL|method|testPlatformBinPermissions
specifier|public
name|void
name|testPlatformBinPermissions
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
decl_stmt|;
comment|// a file created with Files.createFile() should not have execute permissions
name|Set
argument_list|<
name|PosixFilePermission
argument_list|>
...
argument_list|)
expr_stmt|;
comment|// check that the installed program has execute permissions, even though the one added to the plugin didn't
name|Path
name|installedPlatformBinDir
init|=
name|env
operator|.
name|v2
