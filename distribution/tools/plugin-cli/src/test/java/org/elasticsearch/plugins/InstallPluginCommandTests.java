...
name|ESTestCase
block|{
DECL|field|skipJarHellCommand
specifier|private
name|InstallPluginCommand
name|skipJarHellCommand
decl_stmt|;
DECL|field|defaultCommand
specifier|private
name|InstallPluginCommand
name|defaultCommand
decl_stmt|;
...
DECL|method|createPluginUrl
specifier|static
name|String
name|createPluginUrl
parameter_list|(
name|String
name|name
parameter_list|,
...
block|}
block|}
DECL|method|testMissingPluginId
specifier|public
name|void
name|testMissingPluginId
parameter_list|()
throws|throws
name|IOException
block|{
...
expr_stmt|;
block|}
DECL|method|testInstallFailsIfPreviouslyRemovedPluginFailed
specifier|public
name|void
name|testInstallFailsIfPreviouslyRemovedPluginFailed
parameter_list|()
throws|throws
name|Exception
block|{
...
name|ROOT
argument_list|,
literal|"found file [%s] from a failed attempt to remove the plugin [failed]; execute [elasticsearch-plugin remove failed]"
argument_list|,
name|removing
argument_list|)
decl_stmt|;
...
expr_stmt|;
block|}
DECL|method|testUnknownPlugin
specifier|public
name|void
name|testUnknownPlugin
parameter_list|()
throws|throws
name|Exception
block|{
...
block|}
block|}
DECL|method|testPluginPermissions
specifier|public
name|void
name|testPluginPermissions
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
DECL|method|testOfficialPluginsHelpSorted
specifier|public
name|void
name|testOfficialPluginsHelpSorted
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|()
decl_stmt|;
comment|// first find the beginning of our list of official plugins
while|while
condition|(
name|line
operator|.
name|endsWith
argument_list|(
literal|"may be installed by name:"
argument_list|)
operator|==
literal|false
condition|)
...
expr_stmt|;
block|}
comment|// now check each line compares greater than the last, until we reach an empty line
name|String
name|prev
init|=
name|reader
...
specifier|public
name|void
name|testOfficialPluginsIncludesXpack
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
DECL|method|testInstallMisspelledOfficialPlugins
specifier|public
name|void
name|testInstallMisspelledOfficialPlugins
parameter_list|()
throws|throws
name|Exception
block|{
...
name|containsString
argument_list|(
literal|"Unknown plugin xpack, did you mean [x-pack]?"
argument_list|)
argument_list|)
expr_stmt|;
name|e
...
name|containsString
argument_list|(
literal|"Unknown plugin analysis-smartnc, did you mean [analysis-smartcn]?"
argument_list|)
argument_list|)
expr_stmt|;
name|e
...
name|containsString
argument_list|(
literal|"Unknown plugin repository, did you mean any of [repository-s3, repository-gcs]?"
argument_list|)
argument_list|)
expr_stmt|;
name|e
...
name|containsString
argument_list|(
literal|"Unknown plugin unknown_plugin"
argument_list|)
argument_list|)
expr_stmt|;
block|}
DECL|method|testBatchFlag
specifier|public
name|void
name|testBatchFlag
parameter_list|()
...
expr_stmt|;
block|}
DECL|method|testQuietFlagDisabled
specifier|public
name|void
name|testQuietFlagDisabled
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
DECL|method|testQuietFlagEnabled
specifier|public
name|void
name|testQuietFlagEnabled
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
DECL|method|testPluginAlreadyInstalled
specifier|public
name|void
name|testPluginAlreadyInstalled
parameter_list|()
throws|throws
name|Exception
block|{
...
literal|"] already exists; "
operator|+
literal|"if you need to update the plugin, uninstall it first using command 'remove fake'"
argument_list|)
argument_list|)
expr_stmt|;
block|}
...
argument_list|)
decl_stmt|;
comment|// if batch is enabled, we also want to add a security policy
name|String
name|pluginZip
init|=
name|createPlugin
...
expr_stmt|;
block|}
DECL|method|assertInstallPluginFromUrl
specifier|public
name|void
name|assertInstallPluginFromUrl
parameter_list|(
name|String
name|pluginId
parameter_list|,
...
expr_stmt|;
block|}
DECL|method|testOfficalPlugin
specifier|public
name|void
name|testOfficalPlugin
parameter_list|()
throws|throws
name|Exception
block|{
...
name|url
init|=
literal|"https://artifacts.elastic.co/downloads/elasticsearch-plugins/analysis-icu/analysis-icu-"
operator|+
name|Version
operator|.
name|CURRENT
...
expr_stmt|;
block|}
DECL|method|testOfficalPluginStaging
specifier|public
name|void
name|testOfficalPluginStaging
parameter_list|()
throws|throws
name|Exception
block|{
...
name|url
init|=
literal|"https://staging.elastic.co/"
operator|+
name|Version
operator|.
name|CURRENT
operator|+
literal|"-abc123/downloads/elasticsearch-plugins/analysis-icu/analysis-icu-"
operator|+
name|Version
operator|.
name|CURRENT
...
expr_stmt|;
block|}
DECL|method|testOfficalPlatformPlugin
specifier|public
name|void
name|testOfficalPlatformPlugin
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
DECL|method|testOfficalPlatformPluginStaging
specifier|public
name|void
name|testOfficalPlatformPluginStaging
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
DECL|method|testMavenPlugin
specifier|public
name|void
name|testMavenPlugin
parameter_list|()
throws|throws
name|Exception
block|{
...
name|url
init|=
literal|"https://repo1.maven.org/maven2/mygroup/myplugin/1.0.0/myplugin-1.0.0.zip"
decl_stmt|;
name|assertInstallPluginFromUrl
argument_list|(
literal|"mygroup:myplugin:1.0.0"
argument_list|,
literal|"myplugin"
argument_list|,
name|url
...
expr_stmt|;
block|}
DECL|method|testMavenPlatformPlugin
specifier|public
name|void
name|testMavenPlatformPlugin
parameter_list|()
throws|throws
name|Exception
block|{
...
name|url
init|=
literal|"https://repo1.maven.org/maven2/mygroup/myplugin/1.0.0/myplugin-"
operator|+
name|Platforms
operator|.
name|PLATFORM_NAME
