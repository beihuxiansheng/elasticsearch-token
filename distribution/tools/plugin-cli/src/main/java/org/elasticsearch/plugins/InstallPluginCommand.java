...
return|;
block|}
comment|// pkg private so tests can override
DECL|method|getStagingHash
name|String
name|getStagingHash
parameter_list|()
block|{
...
return|;
block|}
comment|/** Returns the url for an official elasticsearch plugin. */
DECL|method|getElasticUrl
specifier|private
name|String
name|getElasticUrl
parameter_list|(
...
name|ROOT
argument_list|,
literal|"https://staging.elastic.co/%s-%s/downloads/elasticsearch-plugins/%s"
argument_list|,
name|version
argument_list|,
name|stagingHash
...
name|ROOT
argument_list|,
literal|"https://artifacts.elastic.co/downloads/elasticsearch-plugins/%s"
argument_list|,
name|pluginId
argument_list|)
expr_stmt|;
...
return|;
block|}
comment|/** Returns the url for an elasticsearch plugin in maven. */
DECL|method|getMavenUrl
specifier|private
name|String
name|getMavenUrl
parameter_list|(
...
name|ROOT
argument_list|,
literal|"https://repo1.maven.org/maven2/%s/%s/%s"
argument_list|,
name|groupId
argument_list|,
name|artifactId
...
return|;
block|}
comment|/**      * Returns {@code true} if the given url exists, and {@code false} otherwise.      *      * The given url must be {@code https} and existing means a {@code HEAD} request returns 200.      */
comment|// pkg private for tests to manipulate
annotation|@
name|SuppressForbidden
argument_list|(
name|reason
operator|=
literal|"Make HEAD request using URLConnection.connect()"
argument_list|)
DECL|method|urlExists
name|boolean
name|urlExists
parameter_list|(
name|Terminal
...
name|VERBOSE
argument_list|,
literal|"Checking if url exists: "
operator|+
name|urlString
argument_list|)
expr_stmt|;
...
argument_list|)
operator|:
literal|"Only http urls can be checked"
assert|;
name|HttpURLConnection
name|urlConnection
init|=
