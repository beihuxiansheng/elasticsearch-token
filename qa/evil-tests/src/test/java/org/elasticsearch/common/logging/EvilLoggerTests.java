...
block|}
block|}
DECL|method|testPrefixLoggerMarkersCanBeCollected
specifier|public
name|void
name|testPrefixLoggerMarkersCanBeCollected
parameter_list|()
throws|throws
name|IOException
throws|,
...
literal|19
decl_stmt|;
comment|// to ensure enough markers that the GC should collect some when we force a GC below
for|for
control|(
name|int
name|i
