...
specifier|public
class|class
name|UpgradeClusterClientYamlTestSuiteIT
extends|extends
name|ESClientYamlSuiteTestCase
block|{
annotation|@
...
return|;
block|}
DECL|method|UpgradeClusterClientYamlTestSuiteIT
specifier|public
name|UpgradeClusterClientYamlTestSuiteIT
parameter_list|(
name|ClientYamlTestCandidate
...
argument_list|()
argument_list|)
comment|// increase the timeout so that we can actually see the result of failed cluster health
comment|// calls that have a default timeout of 30s
operator|.
name|put
argument_list|(
name|ESRestTestCase
operator|.
name|CLIENT_RETRY_TIMEOUT
argument_list|,
literal|"40s"
argument_list|)
operator|.
