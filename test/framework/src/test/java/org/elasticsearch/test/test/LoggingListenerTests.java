...
expr_stmt|;
block|}
DECL|method|testInvalidClassTestLoggingAnnotation
specifier|public
name|void
name|testInvalidClassTestLoggingAnnotation
parameter_list|()
throws|throws
name|Exception
block|{
...
name|equalTo
argument_list|(
literal|"invalid test logging annotation [abc]"
argument_list|)
argument_list|)
expr_stmt|;
block|}
DECL|method|testInvalidMethodTestLoggingAnnotation
specifier|public
name|void
name|testInvalidMethodTestLoggingAnnotation
parameter_list|()
throws|throws
name|Exception
block|{
...
name|equalTo
argument_list|(
literal|"invalid test logging annotation [abc:INFO:WARN]"
argument_list|)
argument_list|)
expr_stmt|;
block|}
comment|/**      * Dummy class used to create a JUnit suite description that has the {@link TestLogging} annotation.      */
annotation|@
name|TestLogging
argument_list|(
...
name|AnnotatedTestClass
block|{      }
comment|/**      * Dummy class used to create a JUnit suite description that doesn't have the {@link TestLogging} annotation, but its test methods have      * it.      */
...
block|{          }
block|}
comment|/**      * Dummy class with an invalid {@link TestLogging} annotation.      */
annotation|@
name|TestLogging
argument_list|(
literal|"abc"
argument_list|)
DECL|class|InvalidClass
specifier|public
specifier|static
class|class
name|InvalidClass
block|{      }
comment|/**      * Dummy class with an invalid {@link TestLogging} annotation on a method.      */
DECL|class|InvalidMethod
specifier|public
specifier|static
class|class
name|InvalidMethod
...
name|TestLogging
argument_list|(
literal|"abc:INFO:WARN"
argument_list|)
DECL|method|invalidMethod
specifier|public
name|void
name|invalidMethod
parameter_list|()
