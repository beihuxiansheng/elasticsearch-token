...
expr_stmt|;
block|}
comment|// Stashed value is whole property name
name|Stash
name|stash
init|=
operator|new
...
name|evaluate
argument_list|(
literal|"field1.$object\\.subobject.element1"
argument_list|,
name|stash
argument_list|)
expr_stmt|;
...
argument_list|)
expr_stmt|;
comment|// Stashed value is part of property name
name|stash
operator|.
name|stashValue
argument_list|(
...
name|evaluate
argument_list|(
literal|"field1.${placeholder}ments.element1"
argument_list|,
name|stash
argument_list|)
expr_stmt|;
...
argument_list|)
expr_stmt|;
comment|// Stashed value is inside of property name
name|stash
operator|.
name|stashValue
argument_list|(
...
name|evaluate
argument_list|(
literal|"field1.e${placeholder}ments.element1"
argument_list|,
name|stash
argument_list|)
expr_stmt|;
...
argument_list|)
expr_stmt|;
comment|// Multiple stashed values in property name
name|stash
operator|.
name|stashValue
argument_list|(
...
name|evaluate
argument_list|(
literal|"field1.e${placeholder}me${placeholder2}.element1"
argument_list|,
name|stash
argument_list|)
expr_stmt|;
...
argument_list|)
expr_stmt|;
comment|// Stashed value is part of property name and has dots
name|stashedObject
operator|.
name|put
argument_list|(
...
name|evaluate
argument_list|(
literal|"field1.${object\\.subobject}ments.element1"
argument_list|,
name|stash
argument_list|)
expr_stmt|;
