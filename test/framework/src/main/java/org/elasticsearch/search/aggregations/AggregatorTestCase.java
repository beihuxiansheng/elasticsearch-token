...
name|ESTestCase
block|{
DECL|field|NESTEDFIELD_PREFIX
specifier|private
specifier|static
specifier|final
name|String
name|NESTEDFIELD_PREFIX
init|=
literal|"nested_"
decl_stmt|;
DECL|field|releasables
specifier|private
name|List
argument_list|<
name|Releasable
...
argument_list|()
decl_stmt|;
comment|/** Create a factory for the given aggregation builder. */
DECL|method|createAggregatorFactory
specifier|protected
...
return|;
block|}
comment|/**      * sub-tests that need a more complex mock can overwrite this      */
...
expr_stmt|;
block|}
comment|// now do the final reduce
annotation|@
name|SuppressWarnings
argument_list|(
literal|"unchecked"
...
block|}
block|}
comment|/**      * Added to randomly run with more assertions on the index reader level,      * like {@link org.apache.lucene.util.LuceneTestCase#wrapReader(IndexReader)}, which can't be used because it also      * wraps in the IndexReader with other implementations that we can't handle. (e.g. ParallelCompositeReader)      */
DECL|method|maybeWrapReaderEs
specifier|protected
specifier|static
name|IndexReader
...
annotation|@
name|After
DECL|method|cleanupReleasables
specifier|private
name|void
name|cleanupReleasables
parameter_list|()
block|{
name|Releasables
operator|.
