...
expr_stmt|;
block|}
comment|// TODO drop aliases once they are moved to module
name|tokenizers
operator|.
name|put
argument_list|(
...
name|assertThat
argument_list|(
literal|"pre configured token filter not registered with test"
argument_list|,
name|preConfiguredTokenFilters
operator|.
name|keySet
...
name|assertNotNull
argument_list|(
literal|"test claims pre built tokenizer ["
operator|+
name|name
operator|+
literal|"] should be available but it wasn't"
...
name|assertThat
argument_list|(
literal|"pre configured tokenizer not registered with test"
argument_list|,
name|preConfiguredTokenizers
operator|.
name|keySet
...
name|assertNotNull
argument_list|(
literal|"test claims pre built char filter ["
operator|+
name|name
operator|+
literal|"] should be available but it wasn't"
...
name|assertThat
argument_list|(
literal|"pre configured char filter not registered with test"
argument_list|,
name|preConfiguredCharFilters
operator|.
name|keySet
