...
block|}
block|}
comment|/**      * Returns a random {@link ShardInfo} object with on or more {@link ShardInfo.Failure} if requested.      *      * @param random   Random generator      * @param failures If true, the {@link ShardInfo} will have random failures      * @return a random {@link ShardInfo}      */
...
return|;
block|}
DECL|method|randomShardInfoFailures
specifier|public
specifier|static
name|ShardInfo
operator|.
