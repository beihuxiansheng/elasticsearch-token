...
begin_comment
comment|/**  * Specification of an Elasticsearch endpoint used by the YAML specs to generate REST requests.  */
end_comment

begin_class
DECL|class|ClientYamlSuiteRestApi
specifier|public
class|class
...
name|REQUIRED
block|}
DECL|method|ClientYamlSuiteRestApi
name|ClientYamlSuiteRestApi
parameter_list|(
name|String
name|location
