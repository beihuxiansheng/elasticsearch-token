...
condition|)
block|{
comment|// connecting to an already connected node is a no-op
throw|throw
operator|new
name|ConnectTransportException
argument_list|(
...
return|;
block|}
comment|/**      * simulates a disconnect by disconnecting from the underlying transport and throwing a      * {@link ConnectTransportException}      */
DECL|method|simulateDisconnect
specifier|private
name|void
name|simulateDisconnect
parameter_list|(
...
expr_stmt|;
block|}
comment|/**      * simulates a disconnect by disconnecting from the underlying transport and throwing a      * {@link ConnectTransportException}, due to a specific cause exception      */
DECL|method|simulateDisconnect
specifier|private
name|void
name|simulateDisconnect
...
condition|)
block|{
comment|// this a connected node, disconnecting from it will be up the exception
name|transport
operator|.
...
block|}
block|}
comment|/**      * simulates a disconnect by closing the connection and throwing a      * {@link ConnectTransportException}      */
DECL|method|simulateDisconnect
specifier|private
name|void
name|simulateDisconnect
...
name|connection
decl_stmt|;
DECL|method|FilteredConnection
specifier|private
name|FilteredConnection
parameter_list|(
name|Transport
...
block|}
block|}
DECL|method|getOriginalTransport
specifier|public
name|Transport
...
literal|0
operator|:
literal|"still open connections: "
operator|+
name|openConnections
assert|;
block|}
