...
literal|null
decl_stmt|;
DECL|field|searchProxyNode
specifier|private
specifier|static
name|Node
name|searchProxyNode
decl_stmt|;
annotation|@
name|BeforeClass
...
if|if
condition|(
name|useSearchProxyNode
argument_list|()
condition|)
block|{
name|searchProxyNode
operator|=
name|startSearchProxyNode
argument_list|()
expr_stmt|;
block|}
block|}
...
index|[]
block|{
literal|"test_remote_cluster|_all"
block|}
return|;
block|}
name|String
...
parameter_list|)
block|{
comment|// we copy the request to ensure we never modify the original request
try|try
init|(
name|BytesStreamOutput
name|out
...
return|;
block|}
DECL|method|useSearchProxyNode
specifier|protected
name|boolean
name|useSearchProxyNode
parameter_list|()
...
literal|false
return|;
comment|// nocommit - lets enable this globally
block|}
DECL|method|startSearchProxyNode
specifier|private
specifier|synchronized
name|Node
name|startSearchProxyNode
