...
begin_class
DECL|class|AbstractStreamableXContentTestCase
specifier|public
specifier|abstract
class|class
name|AbstractStreamableXContentTestCase
parameter_list|<
name|T
extends|extends
name|ToXContent
...
argument_list|>
block|{
comment|/**      * Generic test that creates new instance from the test instance and checks      * both for equality and asserts equality on the two queries.      */
