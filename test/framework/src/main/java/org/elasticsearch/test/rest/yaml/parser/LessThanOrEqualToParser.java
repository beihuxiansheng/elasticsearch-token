...
begin_comment
comment|/**  * Parser for lte assert section  */
end_comment

begin_class
DECL|class|LessThanOrEqualToParser
specifier|public
class|class
...
name|ClientYamlTestParseException
argument_list|(
literal|"lte section can only be used with objects that support natural ordering, found "
operator|+
name|stringObjectTuple
operator|.
name|v2
