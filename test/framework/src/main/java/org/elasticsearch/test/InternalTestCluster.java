...
argument_list|()
operator|+
literal|" is not configured after restart of ["
operator|+
name|name
operator|+
literal|"]"
...
name|IllegalStateException
argument_list|(
literal|"cluster failed to form with expected nodes "
operator|+
name|expectedNodes
operator|+
...
name|AssertionError
argument_list|(
literal|"interrupted while starting nodes"
argument_list|,
name|e
argument_list|)
throw|;
