...
expr_stmt|;
block|}
comment|/**      * Ensures that at least<code>n</code> data nodes are present in the cluster.      * if more nodes than<code>n</code> are present this method will not      * stop any of the running nodes.  Each newly started node will use the given      * input settings.      */
DECL|method|ensureAtLeastNumDataNodes
specifier|public
name|void
name|ensureAtLeastNumDataNodes
