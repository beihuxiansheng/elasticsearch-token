...
name|object
decl_stmt|;
DECL|method|createFromResponse
specifier|public
specifier|static
name|ObjectPath
...
return|;
block|}
comment|/**      * Create a new {@link XContentBuilder} from the xContent object underlying this {@link ObjectPath}.      * This only works for {@link ObjectPath} instances created from an xContent object, not from nested      * substructures. We throw an {@link UnsupportedOperationException} in those cases.      */
annotation|@
name|SuppressWarnings
argument_list|(
literal|"unchecked"
argument_list|)
DECL|method|toXContentBuilder
specifier|public
name|XContentBuilder
...
argument_list|(
literal|"Only ObjectPath created from a map supported."
argument_list|)
throw|;
block|}
return|return
