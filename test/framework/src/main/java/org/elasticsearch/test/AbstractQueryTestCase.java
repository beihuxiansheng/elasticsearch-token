...
literal|"mapped_int"
decl_stmt|;
DECL|field|INT_RANGE_FIELD_NAME
specifier|protected
specifier|static
specifier|final
name|String
...
literal|"mapped_date"
decl_stmt|;
DECL|field|DATE_RANGE_FIELD_NAME
specifier|protected
specifier|static
specifier|final
name|String
...
name|randomTypes
decl_stmt|;
comment|/**      * used to check warning headers of the deprecation logger      */
...
expr_stmt|;
block|}
comment|/**      * Check that there are no unaccounted warning headers. These should be checked with {@link #checkWarningHeaders(String...)} in the      * appropriate test      */
annotation|@
name|After
...
name|this
operator|::
name|changeNameOrBoost
argument_list|)
expr_stmt|;
block|}
block|}
DECL|method|changeNameOrBoost
specifier|private
name|QB
name|changeNameOrBoost
parameter_list|(
