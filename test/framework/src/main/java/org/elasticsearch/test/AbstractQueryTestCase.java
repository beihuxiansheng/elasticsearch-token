...
argument_list|()
decl_stmt|;
name|unknownObjectExceptionTest
argument_list|(
name|validQuery
argument_list|)
expr_stmt|;
...
name|IOException
block|{
comment|//TODO building json by concatenating strings makes the code unmaintainable, we should rewrite this test
name|assertThat
argument_list|(
name|validQuery
argument_list|,
...
decl_stmt|;
name|int
name|objectHoldingArbitraryContentLevel
init|=
literal|0
decl_stmt|;
for|for
...
condition|)
block|{
comment|//track where we are within the object that holds arbitrary content
name|objectHoldingArbitraryContentLevel
operator|--
expr_stmt|;
block|}
...
condition|)
block|{
comment|//reset the flag once we have traversed the whole object that holds arbitrary content
name|expectedException
operator|=
literal|true
expr_stmt|;
