...
decl_stmt|;
DECL|field|CLIENT_RETRY_TIMEOUT
specifier|public
specifier|static
specifier|final
name|String
...
init|=
literal|"client.retry.timeout"
decl_stmt|;
DECL|field|CLIENT_SOCKET_TIMEOUT
specifier|public
specifier|static
specifier|final
name|String
...
argument_list|()
expr_stmt|;
name|waitForClusterStateUpdatesToFinish
argument_list|()
expr_stmt|;
...
block|}
comment|/**      * Waits for the cluster state updates to have been processed, so that no cluster      * state updates are still in-progress when the next test starts.      */
DECL|method|waitForClusterStateUpdatesToFinish
specifier|private
name|void
name|waitForClusterStateUpdatesToFinish
parameter_list|()
...
name|StringBuilder
argument_list|(
literal|"there are still running tasks:"
argument_list|)
decl_stmt|;
for|for
control|(
...
name|fail
argument_list|(
literal|"cannot get cluster's pending tasks: "
operator|+
name|e
operator|.
name|getMessage
