...
name|LOGGER_CLASS
init|=
literal|"org.elasticsearch.common.logging.ESLogger"
decl_stmt|;
...
name|lineNumber
argument_list|,
literal|"Could not determine size of varargs array"
argument_list|)
argument_list|)
expr_stmt|;
continue|continue;
...
block|{
comment|// don't check logger usage for logger.warn(someObject) as someObject will be fully logged
continue|continue;
block|}
block|}
name|PlaceHolderStringBasicValue
