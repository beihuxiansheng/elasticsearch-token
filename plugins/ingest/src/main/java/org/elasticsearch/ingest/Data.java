...
return|;
block|}
comment|/**      * add `value` to path in document. If path does not exist,      * nested maps will be put in as parent key values until      * leaf key name in path is reached.      *      * @param path The path within the document in dot-notation      * @param value The value to put in for the path key      */
