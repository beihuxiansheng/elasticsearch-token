...
argument_list|)
expr_stmt|;
name|assertMetadataFileIsNotEncrypted
argument_list|(
literal|"test-snap"
argument_list|)
expr_stmt|;
...
argument_list|)
expr_stmt|;
name|assertMetadataFileIsEncrypted
argument_list|(
literal|"test-snap"
argument_list|)
expr_stmt|;
...
expr_stmt|;
block|}
DECL|method|assertMetadataFileIsEncrypted
specifier|private
name|void
name|assertMetadataFileIsEncrypted
parameter_list|(
...
name|assertThat
argument_list|(
literal|"The file hasn't been encrypted properly, its content is still readable!"
argument_list|,
name|jsonReader
operator|.
name|nextName
...
parameter_list|)
block|{
comment|// The json is not valid, the file is encrypted
comment|// MalformedJsonException can't be catched directly so the following
comment|//   assertion is necessary to avoid silent failures.
name|assertThat
argument_list|(
name|e
argument_list|,
...
block|}
block|}
DECL|method|assertMetadataFileIsNotEncrypted
specifier|private
name|void
name|assertMetadataFileIsNotEncrypted
parameter_list|(
...
name|assertThat
argument_list|(
literal|"The file wasn't decrypted properly"
argument_list|,
name|jsonReader
operator|.
name|nextName
...
argument_list|)
expr_stmt|;
comment|// The beginning of the file looks like json. If it was encrypted, it wouldn't.
block|}
