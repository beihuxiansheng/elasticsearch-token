...
argument_list|()
expr_stmt|;
comment|// doc_values are disabled for bwc with indices created before V_5_0_0_alpha4
name|defaultFieldType
operator|.
...
condition|)
block|{
comment|// Make sure that the doc_values are disabled on indices created before V_5_0_0_alpha4
name|fieldType
operator|.
name|setHasDocValues
argument_list|(
