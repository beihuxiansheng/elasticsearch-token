...
begin_comment
comment|/**  * Value Converter to marshal objects between Java and Javascript.  *  * @author kimchy (shay.banon)  */
end_comment
...
return|;
block|}
comment|/**      * Convert an object from any repository serialized value to a valid script object.      * This includes converting Collection multi-value properties into JavaScript Array objects.      *      * @param services Repository Services Registry      * @param scope    Scripting scope      * @param qname    QName of the property value for conversion      * @param value    Property value      * @return Value safe for scripting usage      */
