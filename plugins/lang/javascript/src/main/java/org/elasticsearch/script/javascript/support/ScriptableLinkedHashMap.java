...
begin_comment
comment|/**  * Implementation of a Scriptable Map. This is the best choice for maps that want to represent  * JavaScript associative arrays - allowing access via key and integer index. It maintains and  * respects insertion order of the elements and allows either string or integer keys.  *  * @author kimchy (shay.banon)  */
end_comment
