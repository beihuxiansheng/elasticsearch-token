...
begin_comment
comment|/**  * This class provides an empty implementation of {@link PlanAParserVisitor},  * which can be extended to create a visitor which only needs to handle a subset  * of the available methods.  *  * @param<T> The return type of the visit operation. Use {@link Void} for  * operations with no return type.  */
end_comment

begin_class
DECL|class|PlanAParserBaseVisitor
class|class
