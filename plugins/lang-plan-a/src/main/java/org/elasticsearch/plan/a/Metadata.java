...
return|;
block|}
comment|/**      * Acts as both the Plan A API and white-list for what types and methods are allowed.      */
...
name|source
decl_stmt|;
comment|/**      * Toot node of the ANTLR tree for the Plan A script.      */
DECL|field|root
specifier|final
name|ParserRuleContext
name|root
...
argument_list|()
decl_stmt|;
comment|/**      * Constructor.      * @param definition The Plan A definition.      * @param source The source text for the script.      * @param root The root ANTLR node.      * @param settings The compile-time settings.      */
