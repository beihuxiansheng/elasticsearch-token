...
name|ElasticSearchIllegalStateException
argument_list|(
literal|"No cloud blobstore service started, have you configured the 'cloud.type' setting?"
argument_list|)
throw|;
block|}
return|return
...
return|;
block|}
DECL|class|BlobStorSettingsFilter
specifier|private
specifier|static
class|class
name|BlobStorSettingsFilter
...
name|remove
argument_list|(
literal|"cloud.blobstore.account"
argument_list|)
expr_stmt|;
block|}
block|}
