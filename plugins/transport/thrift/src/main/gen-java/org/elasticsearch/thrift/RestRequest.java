...
argument_list|)
decl_stmt|;
DECL|field|PARAMS_FIELD_DESC
specifier|private
specifier|static
specifier|final
name|TField
name|PARAMS_FIELD_DESC
init|=
operator|new
name|TField
argument_list|(
...
decl_stmt|;
name|String
name|__this__params_copy_key
init|=
name|other_element_key
decl_stmt|;
name|String
name|__this__params_copy_value
init|=
name|other_element_value
decl_stmt|;
name|__this__params
...
expr_stmt|;
block|}
comment|/**      * Returns true if field params is set (has been asigned a value) and false otherwise      */
DECL|method|isSetParams
specifier|public
name|boolean
name|isSetParams
parameter_list|()
