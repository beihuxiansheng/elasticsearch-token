...
decl_stmt|;
block|}
comment|/**          * discovery.ec2.host_type: The type of host type to use to communicate with other instances.          * Can be one of private_ip, public_ip, private_dns, public_dns or meta:XXXX where          * XXXX is the metadata field name we will read the address from. Defaults to private_ip.          */
