...
argument_list|)
decl_stmt|;
comment|/**      * cloud.aws.read_timeout: Socket read timeout. Shared with repository-s3 plugin      */
...
argument_list|)
decl_stmt|;
comment|/**          * cloud.aws.ec2.read_timeout: Socket read timeout. Defaults to cloud.aws.read_timeout          * @see AwsEc2Service#READ_TIMEOUT          */
DECL|field|READ_TIMEOUT
name|Setting
argument_list|<
name|TimeValue
...
name|timeSetting
argument_list|(
literal|"cloud.aws.ec2.read_timeout"
argument_list|,
name|AwsEc2Service
operator|.
name|READ_TIMEOUT
