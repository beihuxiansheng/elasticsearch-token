...
name|assumeTrue
argument_list|(
literal|"https://bugs.freebsd.org/bugzilla/show_bug.cgi?id=193246"
argument_list|,
name|Constants
operator|.
name|FREE_BSD
...
block|}
block|}
comment|// This test is here because when running on FreeBSD, if no tests are
comment|// executed for the 'multicast' project it will assume everything
comment|// failed, so we need to have at least one test that runs.
DECL|method|testAlwaysRun
specifier|public
name|void
name|testAlwaysRun
parameter_list|()
