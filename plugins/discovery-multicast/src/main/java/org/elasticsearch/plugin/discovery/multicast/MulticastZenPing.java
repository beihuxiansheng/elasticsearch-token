...
block|}
decl_stmt|;
DECL|field|PING_SIZE_ESTIMATE
specifier|private
specifier|static
specifier|final
name|int
name|PING_SIZE_ESTIMATE
init|=
literal|150
decl_stmt|;
DECL|field|address
...
name|simpleString
argument_list|(
literal|"discovery.zen.ping.multicast.address"
argument_list|,
literal|false
argument_list|,
name|Setting
...
argument_list|(
literal|"discovery.zen.ping.multicast.buffer_size"
argument_list|,
operator|new
name|ByteSizeValue
argument_list|(
...
name|intSetting
argument_list|(
literal|"discovery.zen.ping.multicast.ttl"
argument_list|,
literal|3
argument_list|,
literal|0
...
argument_list|)
decl_stmt|;
DECL|field|PING_ENABLED_SETTING
specifier|public
specifier|static
specifier|final
name|Setting
...
argument_list|)
decl_stmt|;
DECL|field|DEFERE_TO_INTERFACE_SETTING
specifier|public
specifier|static
specifier|final
name|Setting
...
literal|"deprecation"
argument_list|)
comment|// Used to support funky configuration options
DECL|method|getMulticastInterface
specifier|private
name|InetAddress
name|getMulticastInterface
parameter_list|()
