...
name|assertNoViolations
argument_list|(
literal|"Classes ending with [Tests] or [IT] or extending ["
operator|+
name|check
operator|.
name|testClass
...
argument_list|()
operator|+
literal|"] must be in src/test/java"
argument_list|,
name|check
operator|.
name|testsInMain
...
argument_list|()
operator|+
literal|" should end with IT as they are integration tests"
argument_list|,
name|check
operator|.
...
name|testClass
argument_list|,
literal|"--test-class is required"
argument_list|)
expr_stmt|;
name|this
operator|.
...
specifier|protected
name|void
name|visitIntegrationTestClass
parameter_list|(
name|Class
argument_list|<
name|?
...
name|packageName
decl_stmt|;
comment|/**          * Visit classes named like a test.          */
DECL|method|visitTestClass
specifier|protected
specifier|abstract
name|void
name|visitTestClass
...
parameter_list|)
function_decl|;
comment|/**          * Visit classes named like an integration test.          */
DECL|method|visitIntegrationTestClass
specifier|protected
specifier|abstract
name|void
name|visitIntegrationTestClass
...
parameter_list|)
function_decl|;
comment|/**          * Visit classes not named like a test at all.          */
DECL|method|visitOtherClass
specifier|protected
specifier|abstract
name|void
name|visitOtherClass
...
return|;
block|}
comment|/**          * Is this class a test case?          */
DECL|method|isTestCase
specifier|protected
name|boolean
name|isTestCase
parameter_list|(
